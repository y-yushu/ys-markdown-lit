import { g as Ze, s as $e } from "./chunk-RZ5BOZE2-B0kcaVf8.js";
import { _ as p, l as ve, c as D, o as et, r as tt, u as Ie, d as H, b as st, a as it, s as at, g as nt, p as rt, q as ut, k as x, y as lt, x as ct, i as ot, P as M } from "./index-BX-ZM0Ir.js";
var Oe = function() {
  var e = /* @__PURE__ */ p(function(v, l, c, d) {
    for (c = c || {}, d = v.length; d--; c[v[d]] = l) ;
    return c;
  }, "o"), i = [1, 18], r = [1, 19], u = [1, 20], a = [1, 41], o = [1, 42], A = [1, 26], f = [1, 24], T = [1, 25], _ = [1, 32], he = [1, 33], de = [1, 34], C = [1, 45], pe = [1, 35], Ae = [1, 36], fe = [1, 37], ge = [1, 38], Ce = [1, 27], me = [1, 28], be = [1, 29], Ee = [1, 30], ye = [1, 31], m = [1, 44], b = [1, 46], E = [1, 43], k = [1, 47], Te = [1, 9], h = [1, 8, 9], J = [1, 58], Z = [1, 59], $ = [1, 60], ee = [1, 61], te = [1, 62], ke = [1, 63], De = [1, 64], se = [1, 8, 9, 41], we = [1, 76], V = [1, 8, 9, 12, 13, 22, 39, 41, 44, 66, 67, 68, 69, 70, 71, 72, 77, 79], ie = [1, 8, 9, 12, 13, 17, 20, 22, 39, 41, 44, 48, 58, 66, 67, 68, 69, 70, 71, 72, 77, 79, 84, 99, 101, 102], ae = [13, 58, 84, 99, 101, 102], R = [13, 58, 71, 72, 84, 99, 101, 102], Ve = [13, 58, 66, 67, 68, 69, 70, 84, 99, 101, 102], Fe = [1, 98], G = [1, 115], U = [1, 107], z = [1, 113], K = [1, 108], Y = [1, 109], Q = [1, 110], W = [1, 111], j = [1, 112], X = [1, 114], Pe = [22, 58, 59, 80, 84, 85, 86, 87, 88, 89], Be = [1, 8, 9, 39, 41, 44], ne = [1, 8, 9, 22], Me = [1, 143], Re = [1, 8, 9, 59], N = [1, 8, 9, 22, 58, 59, 80, 84, 85, 86, 87, 88, 89], _e = {
    ...
    performAction: /* @__PURE__ */ p(function(l, c, d, n, g, t, q) {
      var s = t.length - 1;
      switch (g) {
        case 8:
          this.$ = t[s - 1];
    ...
    parse: /* @__PURE__ */ p(function(l) {
      var c = this, d = [0], n = [], g = [null], t = [], q = this.table, s = "", ue = 0, Ge = 0, Xe = 2, Ue = 1, qe = t.slice.call(arguments, 1), y = Object.create(this.lexer), I = { yy: {} };
      ...
      function ze() {
        var B;
        return B = n.pop() || y.lex() || Ue, typeof B != "number" && (B instanceof Array && (n = B, B = n.pop()), B = c.symbols_[B] || B), B;
      }
      p(ze, "lex");
      for (var F, O, S, Le, P = {}, le, L, Ke, ce; ; ) {
        if (O = d[d.length - 1], this.defaultActions[O] ? S = this.defaultActions[O] : ((F === null || typeof F > "u") && (F = ze()), S = q[O] && q[O][F]), typeof S > "u" || !S.length || !S[0]) {
          var xe = "";
          ce = [];
          for (le in q[O])
...
` + y.showPosition() + `
Expecting ` + ce.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : xe = "Parse error on line " + (ue + 1) + ": Unexpected " + (F == Ue ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(xe, {
            text: y.match,
        ...
        switch (S[0]) {
          ...
          case 2:
            if (L = this.productions_[S[1]][1], P.$ = g[g.length - L], P._$ = {
              ...
              g,
              t
            ].concat(qe)), typeof Le < "u")
              return Le;
            L && (d = d.slice(0, -1 * L * 2), g = g.slice(0, -1 * L), t = t.slice(0, -1 * L)), d.push(this.productions_[S[1]][0]), g.push(P.$), t.push(P._$), Ke = q[d[d.length - 2]][d[d.length - 1]], d.push(Ke);
            break;
          case 3:
            return !0;
        }
    ...
    var v = {
      EOF: 1,
      parseError: /* @__PURE__ */ p(function(c, d) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ p(function(l, c) {
...
` + c + "^";
      ...
      test_match: /* @__PURE__ */ p(function(l, c) {
        var d, n, g;
        ...
        }, this.yytext += l[0], this.match += l[0], this.matches = l, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(l[0].length), this.matched += l[0], d = this.performAction.call(this, this.yy, this, c, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), d)
          return d;
        if (this._backtrack) {
          for (var t in g)
            this[t] = g[t];
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var g = this._currentRules(), t = 0; t < g.length; t++)
          if (d = this._input.match(this.rules[g[t]]), d && (!c || d[0].length > c[0].length)) {
        ...
        return c ? (l = this.test_match(c, g[n]), l !== !1 ? l : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ p(function(c, d, n, g) {
        switch (n) {
          case 0:
            return 60;
          case 1:
  ...
  parseMember(e) {
    ...
    if (this.memberType === "method") {
      ...
      if (a) {
        ...
        if (Ye.includes(o) && (this.visibility = o), this.id = a[2], this.parameters = a[3] ? a[3].trim() : "", i = a[4] ? a[4].trim() : "", this.returnType = a[5] ? a[5].trim() : "", i === "") {
      ...
      const u = e.length, a = e.substring(0, 1), o = e.substring(u - 1);
      Ye.includes(a) && (this.visibility = a), /[$*]/.exec(o) && (i = o), this.id = e.substring(
        this.visibility === "" ? 0 : 1,
        i === "" ? u : u - 1
      );
    }
...
}, oe = "classId-", We = 0, w = /* @__PURE__ */ p((e) => x.sanitizeText(e, D()), "sanitizeText"), mt = class {
  constructor() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = [], this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.functions = [], this.lineType = {
      ...
      let i = H(".mermaidTooltip");
      (i._groups || i)[0][0] === null && (i = H("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), H(e).select("svg").selectAll("g.node").on("mouseover", (a) => {
        const o = H(a.currentTarget);
        if (o.attr("title") === null)
          return;
        const f = this.getBoundingClientRect();
        i.transition().duration(200).style("opacity", ".9"), i.text(o.attr("title")).style("left", window.scrollX + f.left + (f.right - f.left) / 2 + "px").style("top", window.scrollY + f.top - 14 + document.body.scrollTop + "px"), i.html(i.html().replace(/&lt;br\/&gt;/g, "<br/>")), o.classed("hover", !0);
      }).on("mouseout", (a) => {
        i.transition().duration(500).style("opacity", 0), H(a.currentTarget).classed("hover", !1);
      });
...
}, ht = /* @__PURE__ */ p((e) => `g.classGroup text {
...
`, "getStyles"), bt = ht, dt = /* @__PURE__ */ p((e, i = "TB") => {
  if (!e.doc)
    return i;
  let r = i;
  ...
  return r;
}, "getDir"), pt = /* @__PURE__ */ p(function(e, i) {
  return i.db.getClasses();
}, "getClasses"), At = /* @__PURE__ */ p(async function(e, i, r, u) {
  ve.info("REF0:"), ve.info("Drawing class diagram (v3)", i);
  const { securityLevel: a, state: o, layout: A } = D(), f = u.db.getData(), T = Ze(i, a);
  f.type = u.type, f.layoutAlgorithm = et(A), f.nodeSpacing = o?.nodeSpacing || 50, f.rankSpacing = o?.rankSpacing || 50, f.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], f.diagramId = i, await tt(f, T);
  const _ = 8;
  Ie.insertTitle(
    T,
  ...
  ), $e(T, _, "classDiagram", o?.useMaxWidth ?? !0);
}, "draw"), Et = {
  getClasses: pt,
  draw: At,
  getDir: dt
