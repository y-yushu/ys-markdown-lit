import { p as Y } from "./chunk-4BMEZGHF-BdmMgu3H.js";
import { I as K } from "./chunk-XZIHB7SX-xCYMwkJb.js";
import { _ as l, q as U, p as V, s as X, g as J, a as Q, b as Z, l as b, c as rr, d as er, u as tr, C as ar, y as sr, k as C, D as nr, E as or, F as cr, G as ir } from "./index-BX-ZM0Ir.js";
import { p as dr } from "./radar-MK3ICKWK-qg_lRv0H.js";
var x = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var xr = /* @__PURE__ */ l(function() {
...
}, qr = rr(), v = qr?.gitGraph, L = 10, k = 40, E = 4, T = 2, M = 8, m = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), O = 30, R = /* @__PURE__ */ new Map(), q = [], B = 0, u = "LR", Ar = /* @__PURE__ */ l(() => {
  ...
  t.forEach((d) => {
    ...
    o.parents.length ? (n = Fr(o), e = Math.max(n, e)) : a.push(o), zr(o, n);
  }), n = e, a.forEach((d) => {
    Dr(d, n, s);
  }), t.forEach((d) => {
    const o = r.get(d);
  ...
  return s;
}, "findClosestParentPos"), Fr = /* @__PURE__ */ l((t) => Pr(t) + k, "calculateCommitPosition"), zr = /* @__PURE__ */ l((t, r) => {
...
}, "getCommitPosition"), F = /* @__PURE__ */ l((t, r, s) => {
  if (!v)
  ...
  u === "BT" && (o && Hr(h, r, a), h = h.reverse()), h.forEach(($) => {
    ...
    const i = Kr(g, a, o);
    if (s) {
      const y = jr(g), p = g.customType ?? g.type, _ = m.get(g.branch)?.index ?? 0;
  ...
  s.type === x.MERGE && r.id !== s.parents[0] && (g = m.get(r.branch)?.index);
  let i;
  if (d) {
...
`, "id:", r, s), !v)
  ...
  }), F(o, R, !1), v.showBranches && Jr(o, d), Xr(o, R), F(o, R, !0), tr.insertTitle(
    o,
    "gitTitleText",
    v.titleTopMargin ?? 0,
    a.getDiagramTitle()
