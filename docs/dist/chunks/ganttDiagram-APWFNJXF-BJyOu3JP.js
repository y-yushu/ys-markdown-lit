import { aS as nn, aT as An, aU as rn, aV as an, aW as sn, aX as se, aY as Ln, _ as h, g as In, s as Wn, q as On, p as Hn, a as Nn, b as Vn, c as _t, d as Bt, e as Pn, aZ as at, l as Kt, k as zn, j as Rn, y as qn, u as Bn } from "./index-BX-ZM0Ir.js";
import { g as we } from "./_commonjsHelpers-C6fGbg64.js";
import { b as Zn, t as Oe, c as Xn, a as Gn, l as Qn } from "./linear-PGmMNvKf.js";
...
function on(t, e) {
  ...
  function C(x) {
    var X = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()), O = a ?? (e.tickFormat ? e.tickFormat.apply(e, n) : Kn), D = Math.max(i, 0) + k, I = e.range(), V = +I[0] + M, W = +I[I.length - 1] + M, B = (e.bandwidth ? rr : nr)(e.copy(), M), j = x.selection ? x.selection() : x, w = j.selectAll(".domain").data([null]), H = j.selectAll(".tick").data(X, e).order(), b = H.exit(), F = H.enter().append("g").attr("class", "tick"), _ = H.select("line"), S = H.select("text");
