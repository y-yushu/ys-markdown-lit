import { _ as w, aq as F, ar as Y, as as _, at as H, l as r, c as V, au as q, av as U, af as $, ak as z, ag as P, ae as K, aw as Q, ax as W, ay as Z } from "./index-BX-ZM0Ir.js";
import { G as B } from "./graph-iD5y8-BI.js";
import { l as I } from "./layout-DwePOJds.js";
import { i as b } from "./_baseUniq-BQqVdRLZ.js";
import { c as L } from "./clone-DwsAL1rQ.js";
import { m as A } from "./_basePickBy-CC5cZEYK.js";
function v(e) {
  var t = {
    options: {
...
var d = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), te = /* @__PURE__ */ w(() => {
  ...
  for (const i of n)
    if (r.debug(
      ...
      r.warn("Old graph before copy", v(e)), G(i, e, u, i), e.setNode(i, {
        ...
        label: d.get(i).label,
        graph: u
      }), r.warn("New graph after copy node: (", i, ")", v(u)), r.debug("Old graph after copy", v(e));
    } else
      r.warn(
        "Cluster ** ",
        i,
  ...
  const c = u.insert("g").attr("class", "clusters"), m = u.insert("g").attr("class", "edgePaths"), h = u.insert("g").attr("class", "edgeLabels"), X = u.insert("g").attr("class", "nodes");
  await Promise.all(
...
Parent cluster`,
  ...
  F(a, e.markers, e.type, e.diagramId), Y(), _(), H(), te(), e.nodes.forEach((o) => {
    ...
    if (o.start === o.end) {
      ...
      const h = structuredClone(o), X = structuredClone(o), p = structuredClone(o);
      h.label = "", h.arrowTypeEnd = "none", h.id = l + "-cyclic-special-1", X.arrowTypeStart = "none", X.arrowTypeEnd = "none", X.id = l + "-cyclic-special-mid", p.label = "", m.isGroup && (h.fromCluster = l, p.toCluster = l), p.id = l + "-cyclic-special-2", p.arrowTypeStart = "none", n.setEdge(l, u, h, l + "-cyclic-special-0"), n.setEdge(u, c, X, l + "-cyclic-special-1"), n.setEdge(c, l, p, l + "-cyc<lic-special-2");
    } else
      n.setEdge(o.start, o.end, { ...o }, o.id);
  }), r.warn("Graph at first:", JSON.stringify(v(n))), ie(n), r.warn("Graph after XAX:", JSON.stringify(v(n)));
  const i = V();
  await j(
    a,
    n,
