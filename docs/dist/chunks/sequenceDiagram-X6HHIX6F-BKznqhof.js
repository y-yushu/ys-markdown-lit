import { a as fe, b as Vt, g as Pt, d as xe, c as Te, e as ye } from "./chunk-D6G4REZN-BlwqSY9J.js";
import { I as Ee } from "./chunk-XZIHB7SX-xCYMwkJb.js";
import { _ as u, n as be, c as $, d as It, l as G, j as Jt, e as me, f as we, k as v, b as Ut, s as ve, p as Ie, a as Le, g as _e, q as Pe, y as Ae, i as Lt, u as Y, L as ot, M as Et, N as Zt, Z as ke, O as Qt, E as Dt } from "./index-BX-ZM0Ir.js";
var Ct = function() {
...
var Ne = Ct, Se = {
  ...
  addProperties(t, e) {
    const c = this.getActor(t);
    try {
      const s = Lt(e.text, $()), r = JSON.parse(s);
...
`, "getStyles"), Oe = Ce, ut = 18 * 2, jt = "actor-top", $t = "actor-bottom", Be = "actor-box", Gt = "actor-man", Yt = /* @__PURE__ */ u(function(t, e) {
  ...
  const r = await Qt(e.text, Dt()), o = s.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(r).node().getBoundingClientRect();
  ...
  let c = 0, s = 0;
  const r = e.text.split(v.lineBreakRegex), [i, o] = Zt(e.fontSize);
  ...
  if (e.sectionTitles !== void 0) {
    for (const [I, A] of Object.entries(e.sectionTitles))
      if (A.message) {
        T.text = A.message, T.x = e.startx + (e.stopx - e.startx) / 2, T.y = e.sections[I].y + r + i, T.class = "loopText", T.anchor = "middle", T.valign = "middle", T.tspan = !1, T.fontFamily = d, T.fontSize = a, T.fontWeight = f, T.wrap = e.wrap, ot(T.text) ? (e.starty = e.sections[I].y, await _t(E, T, e)) : Tt(E, T);
        let O = Math.round(
  ...
  async function s(i, o, h, d, a, f, E, g) {
    ...
    A.append("div").style("text-align", "center").style("vertical-align", "middle").html(await Qt(i, Dt())), e(i, m, h, d, a, f, E, g), r(A, E);
  }
  u(s, "byKatex");
  function r(i, o) {
    for (const h in o)
...
var as = /* @__PURE__ */ u(async function(t, e, c, s) {
  ...
  we(n, t), t.fontFamily && (n.actorFontFamily = n.noteFontFamily = n.messageFontFamily = t.fontFamily), t.fontSize && (n.actorFontSize = n.noteFontSize = n.messageFontSize = t.fontSize), t.fontWeight && (n.actorFontWeight = n.noteFontWeight = n.messageFontWeight = t.fontWeight);
...
var is = /* @__PURE__ */ u(async function(t, e, c, s) {
  ...
  let o;
  r === "sandbox" && (o = It("#i" + e));
  const h = r === "sandbox" ? It(o.nodes()[0].contentDocument.body) : It("body"), d = r === "sandbox" ? o.nodes()[0].contentDocument : document;
  x.init(), G.debug(s.db);
