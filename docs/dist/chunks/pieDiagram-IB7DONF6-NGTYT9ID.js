import { p as V } from "./chunk-4BMEZGHF-BdmMgu3H.js";
import { a7 as S, a2 as F, aF as U, _ as u, g as j, s as q, a as H, b as Z, q as J, p as K, l as z, c as Q, D as X, H as Y, N as tt, e as et, y as at, F as rt } from "./index-BX-ZM0Ir.js";
import { p as nt } from "./radar-MK3ICKWK-qg_lRv0H.js";
import { d as P } from "./arc-BfM7Ot4R.js";
...
function lt() {
  var t = ot, a = st, h = null, s = S(0), p = S(F), x = S(0);
  function i(e) {
    var r, l = (e = U(e)).length, d, A, m = 0, c = new Array(l), n = new Array(l), v = +s.apply(this, arguments), w = Math.min(F, Math.max(-F, p.apply(this, arguments) - v)), f, T = Math.min(Math.abs(w) / l, x.apply(this, arguments)), $ = T * (w < 0 ? -1 : 1), g;
    for (r = 0; r < l; ++r)
