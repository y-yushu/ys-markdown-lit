import { g as Oe, d as Re } from "./chunk-D6G4REZN-BlwqSY9J.js";
import { _ as g, s as Se, g as De, a as Pe, b as Be, c as Dt, d as Nt, l as he, e as Ie, f as Me, h as Tt, i as pe, j as Le, w as Ne, k as Jt, m as ue } from "./index-BX-ZM0Ir.js";
var jt = function() {
    ...
    if (s)
      ...
      for (const n of a)
        t[e].width = Math.max(
          Tt(n, o),
          t[e].width
        ), r = ue(n, o), t[e].height = t[e].height + r;
    }
}
...
var O0 = /* @__PURE__ */ g(function(e, t, s, o) {
  ...
  d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * _.diagramMarginX).attr("y", p.starty + _.diagramMarginY), Ie(i, O, P, _.useMaxWidth);
  const M = d ? 60 : 0;
  i.attr(
    "viewBox",
