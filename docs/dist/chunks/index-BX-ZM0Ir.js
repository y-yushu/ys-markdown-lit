  ...
  return El || (El = 1, function(e, t) {
    (function(r, i) {
      ...
      var r = 1e3, i = 6e4, n = 36e5, a = "millisecond", o = "second", s = "minute", l = "hour", c = "day", h = "week", u = "month", f = "quarter", d = "year", g = "date", m = "Invalid Date", y = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, x = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, b = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(E) {
        var M = ["th", "st", "nd", "rd"], T = E % 100;
        return "[" + E + (M[(T - 20) % 10] || M[T] || M[0]) + "]";
      } }, w = function(E, M, T) {
        var $ = String(E);
        return !$ || $.length >= M ? E : "" + Array(M + 1 - $.length).join(T) + E;
      }, C = { s: w, z: function(E) {
        var M = -E.utcOffset(), T = Math.abs(M), $ = Math.floor(T / 60), A = T % 60;
        return (M <= 0 ? "+" : "-") + w($, 2, "0") + ":" + w(A, 2, "0");
      }, m: function E(M, T) {
        if (M.date() < T.date()) return -E(T, M);
        var $ = 12 * (T.year() - M.year()) + (T.month() - M.month()), A = M.clone().add($, u), N = T - A < 0, q = M.clone().add($ + (N ? -1 : 1), u);
        return +(-($ + (T - A) / (N ? A - q : q - A)) || 0);
      }, a: function(E) {
        return E < 0 ? Math.ceil(E) || 0 : Math.floor(E);
      }, p: function(E) {
        return { M: u, y: d, w: h, d: c, D: g, h: l, m: s, s: o, ms: a, Q: f }[E] || String(E || "").toLowerCase().replace(/s$/, "");
      }, u: function(E) {
        return E === void 0;
      } }, k = "en", L = {};
      L[k] = b;
      var S = "$isDayjsObject", D = function(E) {
        return E instanceof z || !(!E || !E[S]);
      }, R = function E(M, T, $) {
        var A;
        if (!M) return k;
        if (typeof M == "string") {
        ...
        return T.date = E, T.args = arguments, new z(T);
      }, B = C;
      B.l = R, B.i = D, B.w = function(E, M) {
        return O(E, { locale: M.$L, utc: M.$u, x: M.$x, $offset: M.$offset });
      };
      var z = function() {
        function E(T) {
          this.$L = R(T.locale, null, !0), this.parse(T), this.$x = this.$x || T.x || {}, this[S] = !0;
        }
        var M = E.prototype;
        return M.parse = function(T) {
          this.$d = function($) {
            ...
            if (typeof A == "string" && !/Z$/i.test(A)) {
              var q = A.match(y);
              if (q) {
                var Z = q[2] - 1 || 0, at = (q[7] || "0").substring(0, 3);
                return N ? new Date(Date.UTC(q[1], Z, q[3] || 1, q[4] || 0, q[5] || 0, q[6] || 0, at)) : new Date(q[1], Z, q[3] || 1, q[4] || 0, q[5] || 0, q[6] || 0, at);
              }
            }
            return new Date(A);
          }(T), this.init();
          ...
          return B.u(T) ? this[$] : this.set(A, T);
        }, M.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, M.valueOf = function() {
          return this.$d.getTime();
        }, M.startOf = function(T, $) {
          var A = this, N = !!B.u($) || $, q = B.p(T), Z = function(ie, Ct) {
            var ne = B.w(A.$u ? Date.UTC(A.$y, Ct, ie) : new Date(A.$y, Ct, ie), A);
            return N ? ne : ne.endOf(c);
          }, at = function(ie, Ct) {
            return B.w(A.toDate()[ie].apply(A.toDate("s"), (N ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(Ct)), A);
          }, nt = this.$W, dt = this.$M, st = this.$D, Gt = "set" + (this.$u ? "UTC" : "");
          switch (q) {
            case d:
              return N ? Z(1, 0) : Z(31, 11);
            case u:
              return N ? Z(1, dt) : Z(0, dt + 1);
            case h:
              var $t = this.$locale().weekStart || 0, Ie = (nt < $t ? nt + 7 : nt) - $t;
              return Z(N ? st - Ie : st + (6 - Ie), dt);
            case c:
            case g:
              return at(Gt + "Hours", 0);
            case l:
              return at(Gt + "Minutes", 1);
            case s:
              return at(Gt + "Seconds", 2);
            case o:
              return at(Gt + "Milliseconds", 3);
            default:
              return this.clone();
          }
        }, M.endOf = function(T) {
          ...
          var A, N = B.p(T), q = "set" + (this.$u ? "UTC" : ""), Z = (A = {}, A[c] = q + "Date", A[g] = q + "Date", A[u] = q + "Month", A[d] = q + "FullYear", A[l] = q + "Hours", A[s] = q + "Minutes", A[o] = q + "Seconds", A[a] = q + "Milliseconds", A)[N], at = N === c ? this.$D + ($ - this.$W) : $;
          if (N === u || N === d) {
            var nt = this.clone().set(g, 1);
            nt.$d[Z](at), nt.init(), this.$d = nt.set(g, Math.min(this.$D, nt.daysInMonth())).$d;
          } else Z && this.$d[Z](at);
          ...
          var A, N = this;
          T = Number(T);
          var q = B.p($), Z = function(dt) {
            var st = O(N);
            return B.w(st.date(st.date() + Math.round(dt * T)), N);
          };
          if (q === u) return this.set(u, this.$M + T);
          if (q === d) return this.set(d, this.$y + T);
          if (q === c) return Z(1);
          if (q === h) return Z(7);
          var at = (A = {}, A[s] = i, A[l] = n, A[o] = r, A)[q] || 1, nt = this.$d.getTime() + T * at;
          return B.w(nt, this);
          ...
          var N = T || "YYYY-MM-DDTHH:mm:ssZ", q = B.z(this), Z = this.$H, at = this.$m, nt = this.$M, dt = A.weekdays, st = A.months, Gt = A.meridiem, $t = function(Ct, ne, Zt, Pe) {
            return Ct && (Ct[ne] || Ct($, N)) || Zt[ne].slice(0, Pe);
          }, Ie = function(Ct) {
            return B.s(Z % 12 || 12, Ct, "0");
          }, ie = Gt || function(Ct, ne, Zt) {
            var Pe = Ct < 12 ? "AM" : "PM";
            return Zt ? Pe.toLowerCase() : Pe;
          };
          return N.replace(x, function(Ct, ne) {
            return ne || function(Zt) {
              switch (Zt) {
                case "YY":
                ...
                case "MM":
                  return B.s(nt + 1, 2, "0");
                case "MMM":
                  return $t(A.monthsShort, nt, st, 3);
                case "MMMM":
                  return $t(st, nt);
                case "D":
                  return $.$D;
                ...
                case "d":
                  return String($.$W);
                case "dd":
                  return $t(A.weekdaysMin, $.$W, dt, 2);
                case "ddd":
                  return $t(A.weekdaysShort, $.$W, dt, 3);
                case "dddd":
                  return dt[$.$W];
                case "H":
                  return String(Z);
          ...
          var N, q = this, Z = B.p($), at = O(T), nt = (at.utcOffset() - this.utcOffset()) * i, dt = this - at, st = function() {
            return B.m(q, at);
          };
          switch (Z) {
            case d:
      ...
      return O.prototype = P, [["$ms", a], ["$s", o], ["$m", s], ["$H", l], ["$W", c], ["$M", u], ["$y", d], ["$D", g]].forEach(function(E) {
        P[E[1]] = function(M) {
          return this.$g(M, E[0], E[1]);
        };
      }), O.extend = function(E, M) {
        return E.$i || (E(M, z, O), E.$i = !0), O;
      }, O.locale = R, O.isDayjs = D, O.unix = function(E) {
        return O(1e3 * E);
...
const Gm = /* @__PURE__ */ qm(Ym), pn = {
  ...
  hsl2rgb: ({ h: e, s: t, l: r }, i) => {
    ...
    switch (i) {
      case "r":
        return pn.hue2rgb(a, n, e + 1 / 3) * 255;
      case "g":
        return pn.hue2rgb(a, n, e) * 255;
      case "b":
        return pn.hue2rgb(a, n, e - 1 / 3) * 255;
    }
  },
...
class Km {
  /* CONSTRUCTOR */
  constructor(t, r) {
    this.color = r, this.changed = !1, this.data = t, this.type = new Zm();
  }
  /* API */
  set(t, r) {
    return this.color = r, this.changed = !1, this.data = t, this.type.type = At.ALL, this;
  }
  /* HELPERS */
  _ensureHSL() {
  ...
  get r() {
    ...
    return !this.type.is(At.HSL) && r !== void 0 ? r : (this._ensureHSL(), rt.channel.hsl2rgb(t, "r"));
  }
  get g() {
    const t = this.data, r = t.g;
    return !this.type.is(At.HSL) && r !== void 0 ? r : (this._ensureHSL(), rt.channel.hsl2rgb(t, "g"));
  }
  get b() {
    const t = this.data, r = t.b;
    return !this.type.is(At.HSL) && r !== void 0 ? r : (this._ensureHSL(), rt.channel.hsl2rgb(t, "b"));
  }
  get h() {
    const t = this.data, r = t.h;
    return !this.type.is(At.RGB) && r !== void 0 ? r : (this._ensureRGB(), rt.channel.rgb2hsl(t, "h"));
  }
  get s() {
    const t = this.data, r = t.s;
    return !this.type.is(At.RGB) && r !== void 0 ? r : (this._ensureRGB(), rt.channel.rgb2hsl(t, "s"));
  }
  get l() {
    const t = this.data, r = t.l;
    return !this.type.is(At.RGB) && r !== void 0 ? r : (this._ensureRGB(), rt.channel.rgb2hsl(t, "l"));
  }
  get a() {
    return this.data.a;
  }
  /* SETTERS */
  set r(t) {
    this.type.set(At.RGB), this.changed = !0, this.data.r = t;
  }
  set g(t) {
    this.type.set(At.RGB), this.changed = !0, this.data.g = t;
  }
  set b(t) {
    this.type.set(At.RGB), this.changed = !0, this.data.b = t;
  }
  set h(t) {
    this.type.set(At.HSL), this.changed = !0, this.data.h = t;
  }
  set s(t) {
    this.type.set(At.HSL), this.changed = !0, this.data.s = t;
  }
  set l(t) {
    this.type.set(At.HSL), this.changed = !0, this.data.l = t;
  }
  set a(t) {
    this.changed = !0, this.data.a = t;
  }
}
const fa = new Km({ r: 0, g: 0, b: 0, a: 0 }, "transparent"), Ar = {
  /* VARIABLES */
  ...
  stringify: (e) => {
    const t = Ar.stringify(e);
    for (const r in wi.colors)
      if (wi.colors[r] === t)
        return r;
  }
}, fi = {
  ...
  parse: (e) => {
    if (typeof e != "string")
      return e;
    const t = Ar.parse(e) || fi.parse(e) || rr.parse(e) || wi.parse(e);
    if (t)
      return t;
    throw new Error(`Unsupported color format: "${e}"`);
  },
  stringify: (e) => !e.changed && e.color ? e.color : e.type.is(At.HSL) || e.data.r === void 0 ? rr.stringify(e) : e.a < 1 || !Number.isInteger(e.r) || !Number.isInteger(e.g) || !Number.isInteger(e.b) ? fi.stringify(e) : Ar.stringify(e)
}, dh = (e, t) => {
  const r = ye.parse(e);
  for (const i in t)
  ...
  return ye.stringify(n);
}, Qm = (e) => {
  const { r: t, g: r, b: i } = ye.parse(e), n = 0.2126 * rt.channel.toLinear(t) + 0.7152 * rt.channel.toLinear(r) + 0.0722 * rt.channel.toLinear(i);
  return rt.lang.round(n);
}, Jm = (e) => Qm(e) >= 0.5, Pi = (e) => !Jm(e), ph = (e, t, r) => {
  const i = ye.parse(e), n = i[t], a = rt.channel.clamp[t](n + r);
  return n !== a && (i[t] = a), ye.stringify(i);
}, H = (e, t) => ph(e, "l", t), J = (e, t) => ph(e, "l", -t), _ = (e, t) => {
  const r = ye.parse(e), i = {};
  for (const n in t)
    t[n] && (i[n] = r[n] + t[n]);
  return dh(e, i);
}, t0 = (e, t, r = 50) => {
  const { r: i, g: n, b: a, a: o } = ye.parse(e), { r: s, g: l, b: c, a: h } = ye.parse(t), u = r / 100, f = u * 2 - 1, d = o - h, m = ((f * d === -1 ? f : (f + d) / (1 + f * d)) + 1) / 2, y = 1 - m, x = i * m + s * y, b = n * m + l * y, w = a * m + c * y, C = o * u + h * (1 - u);
  return vi(x, b, w, C);
}, W = (e, t = 100) => {
  const r = ye.parse(e);
  return r.r = 255 - r.r, r.g = 255 - r.g, r.b = 255 - r.b, t0(r, e, t);
};
...
ds || (ds = function(t, r, i) {
  return t.apply(r, i);
});
ps || (ps = function(t, r) {
  return new t(...r);
});
const en = zt(Array.prototype.forEach), n0 = zt(Array.prototype.lastIndexOf), Fl = zt(Array.prototype.pop), Jr = zt(Array.prototype.push), a0 = zt(Array.prototype.splice), gn = zt(String.prototype.toLowerCase), Ga = zt(String.prototype.toString), Ol = zt(String.prototype.match), ti = zt(String.prototype.replace), s0 = zt(String.prototype.indexOf), o0 = zt(String.prototype.trim), ae = zt(Object.prototype.hasOwnProperty), Ot = zt(RegExp.prototype.test), ei = l0(TypeError);
function zt(e) {
  return function(t) {
...
function Qe(e) {
  const t = mh(null);
  for (const [r, i] of gh(e))
    ae(e, r) && (Array.isArray(i) ? t[r] = c0(i) : i && typeof i == "object" && i.constructor === Object ? t[r] = Qe(i) : t[r] = i);
  return t;
}
function ri(e, t) {
  for (; e !== null; ) {
...
function bh() {
  ...
  const t = (Q) => bh(Q);
  if (t.version = "3.2.5", t.removed = [], !e || !e.document || e.document.nodeType !== ii.document || !e.Element)
  ...
  const i = r, n = i.currentScript, {
    ...
    DOMParser: f,
    trustedTypes: d
  } = e, g = l.prototype, m = ri(g, "cloneNode"), y = ri(g, "remove"), x = ri(g, "nextSibling"), b = ri(g, "childNodes"), w = ri(g, "parentNode");
  ...
  let B = zl();
  t.isSupported = typeof gh == "function" && typeof w == "function" && L && L.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: z,
    ERB_EXPR: P,
    TMPLIT_EXPR: E,
  ...
  const at = ot({}, [...Dl, ...Xa, ...Va, ...Za, ...Rl]);
  let nt = null;
  const dt = ot({}, [...Il, ...Ka, ...Pl, ...rn]);
  let st = Object.seal(mh(null, {
    tagNameCheck: {
      writable: !0,
      configurable: !1,
      enumerable: !0,
  ...
  })), Gt = null, $t = null, Ie = !0, ie = !0, Ct = !1, ne = !0, Zt = !1, Pe = !0, Ze = !1, Na = !1, za = !1, br = !1, Xi = !1, Vi = !1, hl = !0, ul = !1;
  const Lm = "user-content-";
  let Wa = !0, Zr = !1, wr = {}, vr = null;
  const fl = ot({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
  let dl = null;
  const pl = ot({}, ["audio", "video", "img", "source", "image", "track"]);
  let qa = null;
  const gl = ot({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Zi = "http://www.w3.org/1998/Math/MathML", Ki = "http://www.w3.org/2000/svg", ve = "http://www.w3.org/1999/xhtml";
  let _r = ve, Ha = !1, ja = null;
  const Am = ot({}, [Zi, Ki, ve], Ga);
  let Qi = ot({}, ["mi", "mo", "mn", "ms", "mtext"]), Ji = ot({}, ["annotation-xml"]);
  const Mm = ot({}, ["title", "style", "font", "a", "script"]);
  let Kr = null;
  const Em = ["application/xhtml+xml", "text/html"], $m = "text/html";
  let _t = null, Cr = null;
  const Fm = r.createElement("form"), ml = function(v) {
    return v instanceof RegExp || v instanceof Function;
  }, Ua = function() {
    let v = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!(Cr && Cr === v)) {
      if ((!v || typeof v != "object") && (v = {}), v = Qe(v), Kr = // eslint-disable-next-line unicorn/prefer-includes
      Em.indexOf(v.PARSER_MEDIA_TYPE) === -1 ? $m : v.PARSER_MEDIA_TYPE, _t = Kr === "application/xhtml+xml" ? Ga : gn, Z = ae(v, "ALLOWED_TAGS") ? ot({}, v.ALLOWED_TAGS, _t) : at, nt = ae(v, "ALLOWED_ATTR") ? ot({}, v.ALLOWED_ATTR, _t) : dt, ja = ae(v, "ALLOWED_NAMESPACES") ? ot({}, v.ALLOWED_NAMESPACES, Ga) : Am, qa = ae(v, "ADD_URI_SAFE_ATTR") ? ot(Qe(gl), v.ADD_URI_SAFE_ATTR, _t) : gl, dl = ae(v, "ADD_DATA_URI_TAGS") ? ot(Qe(pl), v.ADD_DATA_URI_TAGS, _t) : pl, vr = ae(v, "FORBID_CONTENTS") ? ot({}, v.FORBID_CONTENTS, _t) : fl, Gt = ae(v, "FORBID_TAGS") ? ot({}, v.FORBID_TAGS, _t) : {}, $t = ae(v, "FORBID_ATTR") ? ot({}, v.FORBID_ATTR, _t) : {}, wr = ae(v, "USE_PROFILES") ? v.USE_PROFILES : !1, Ie = v.ALLOW_ARIA_ATTR !== !1, ie = v.ALLOW_DATA_ATTR !== !1, Ct = v.ALLOW_UNKNOWN_PROTOCOLS || !1, ne = v.ALLOW_SELF_CLOSE_IN_ATTR !== !1, Zt = v.SAFE_FOR_TEMPLATES || !1, Pe = v.SAFE_FOR_XML !== !1, Ze = v.WHOLE_DOCUMENT || !1, br = v.RETURN_DOM || !1, Xi = v.RETURN_DOM_FRAGMENT || !1, Vi = v.RETURN_TRUSTED_TYPE || !1, za = v.FORCE_BODY || !1, hl = v.SANITIZE_DOM !== !1, ul = v.SANITIZE_NAMED_PROPS || !1, Wa = v.KEEP_CONTENT !== !1, Zr = v.IN_PLACE || !1, q = v.ALLOWED_URI_REGEXP || yh, _r = v.NAMESPACE || ve, Qi = v.MATHML_TEXT_INTEGRATION_POINTS || Qi, Ji = v.HTML_INTEGRATION_POINTS || Ji, st = v.CUSTOM_ELEMENT_HANDLING || {}, v.CUSTOM_ELEMENT_HANDLING && ml(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (st.tagNameCheck = v.CUSTOM_ELEMENT_HANDLING.tagNameCheck), v.CUSTOM_ELEMENT_HANDLING && ml(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (st.attributeNameCheck = v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), v.CUSTOM_ELEMENT_HANDLING && typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (st.allowCustomizedBuiltInElements = v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), Zt && (ie = !1), Xi && (br = !0), wr && (Z = ot({}, Rl), nt = [], wr.html === !0 && (ot(Z, Dl), ot(nt, Il)), wr.svg === !0 && (ot(Z, Xa), ot(nt, Ka), ot(nt, rn)), wr.svgFilters === !0 && (ot(Z, Va), ot(nt, Ka), ot(nt, rn)), wr.mathMl === !0 && (ot(Z, Za), ot(nt, Pl), ot(nt, rn))), v.ADD_TAGS && (Z === at && (Z = Qe(Z)), ot(Z, v.ADD_TAGS, _t)), v.ADD_ATTR && (nt === dt && (nt = Qe(nt)), ot(nt, v.ADD_ATTR, _t)), v.ADD_URI_SAFE_ATTR && ot(qa, v.ADD_URI_SAFE_ATTR, _t), v.FORBID_CONTENTS && (vr === fl && (vr = Qe(vr)), ot(vr, v.FORBID_CONTENTS, _t)), Wa && (Z["#text"] = !0), Ze && ot(Z, ["html", "head", "body"]), Z.table && (ot(Z, ["tbody"]), delete Gt.tbody), v.TRUSTED_TYPES_POLICY) {
        ...
        C = v.TRUSTED_TYPES_POLICY, k = C.createHTML("");
      } else
        C === void 0 && (C = v0(d, n)), C !== null && typeof k == "string" && (k = C.createHTML(""));
      Nt && Nt(v), Cr = v;
    }
  }, yl = ot({}, [...Xa, ...Va, ...h0]), xl = ot({}, [...Za, ...u0]), Om = function(v) {
    let I = w(v);
    (!I || !I.tagName) && (I = {
      namespaceURI: _r,
      tagName: "template"
    });
    const Y = gn(v.tagName), gt = gn(I.tagName);
    return ja[v.namespaceURI] ? v.namespaceURI === Ki ? I.namespaceURI === ve ? Y === "svg" : I.namespaceURI === Zi ? Y === "svg" && (gt === "annotation-xml" || Qi[gt]) : !!yl[Y] : v.namespaceURI === Zi ? I.namespaceURI === ve ? Y === "math" : I.namespaceURI === Ki ? Y === "math" && Ji[gt] : !!xl[Y] : v.namespaceURI === ve ? I.namespaceURI === Ki && !Ji[gt] || I.namespaceURI === Zi && !Qi[gt] ? !1 : !xl[Y] && (Mm[Y] || !yl[Y]) : !!(Kr === "application/xhtml+xml" && ja[v.namespaceURI]) : !1;
  }, he = function(v) {
    Jr(t.removed, {
      element: v
    });
    ...
    Kr === "application/xhtml+xml" && _r === ve && (v = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + v + "</body></html>");
    const gt = C ? C.createHTML(v) : v;
    if (_r === ve)
      try {
        I = new f().parseFromString(gt, Kr);
      } catch {
      }
    if (!I || !I.documentElement) {
      I = L.createDocument(_r, "template", null);
      try {
        I.documentElement.innerHTML = Ha ? k : gt;
      } catch {
      }
    }
    const Lt = I.body || I.documentElement;
    return v && Y && Lt.insertBefore(r.createTextNode(Y), Lt.childNodes[0] || null), _r === ve ? R.call(I, Ze ? "html" : "body")[0] : Ze ? I.documentElement : Lt;
  }, wl = function(v) {
    return S.call(
      v.ownerDocument || v,
      v,
  ...
  const _l = function(v) {
    let I = null;
    if (_e(B.beforeSanitizeElements, v, null), Ya(v))
      return he(v), !0;
    const Y = _t(v.nodeName);
    if (_e(B.uponSanitizeElement, v, {
      tagName: Y,
      allowedTags: Z
    }), v.hasChildNodes() && !vl(v.firstElementChild) && Ot(/<[/\w!]/g, v.innerHTML) && Ot(/<[/\w!]/g, v.textContent) || v.nodeType === ii.progressingInstruction || Pe && v.nodeType === ii.comment && Ot(/<[/\w]/g, v.data))
      return he(v), !0;
    if (!Z[Y] || Gt[Y]) {
      if (!Gt[Y] && kl(Y) && (st.tagNameCheck instanceof RegExp && Ot(st.tagNameCheck, Y) || st.tagNameCheck instanceof Function && st.tagNameCheck(Y)))
        return !1;
      if (Wa && !vr[Y]) {
        const gt = w(v) || v.parentNode, Lt = b(v) || v.childNodes;
        if (Lt && gt) {
          const kt = Lt.length;
          for (let Wt = kt - 1; Wt >= 0; --Wt) {
            const ue = m(Lt[Wt], !0);
            ue.__removalCount = (v.__removalCount || 0) + 1, gt.insertBefore(ue, x(v));
          }
        }
      }
      return he(v), !0;
    }
    return v instanceof l && !Om(v) || (Y === "noscript" || Y === "noembed" || Y === "noframes") && Ot(/<\/no(script|embed|frames)/i, v.innerHTML) ? (he(v), !0) : (Zt && v.nodeType === ii.text && (I = v.textContent, en([z, P, E], (gt) => {
      I = ti(I, gt, " ");
    }), v.textContent !== I && (Jr(t.removed, {
      element: v.cloneNode()
    }), v.textContent = I)), _e(B.afterSanitizeElements, v, null), !1);
  }, Cl = function(v, I, Y) {
    if (hl && (I === "id" || I === "name") && (Y in r || Y in Fm))
      return !1;
    if (!(ie && !$t[I] && Ot(M, I))) {
      if (!(Ie && Ot(T, I))) {
        if (!nt[I] || $t[I]) {
          if (
            ...
            !(kl(v) && (st.tagNameCheck instanceof RegExp && Ot(st.tagNameCheck, v) || st.tagNameCheck instanceof Function && st.tagNameCheck(v)) && (st.attributeNameCheck instanceof RegExp && Ot(st.attributeNameCheck, I) || st.attributeNameCheck instanceof Function && st.attributeNameCheck(I)) || // Alternative, second condition checks if it's an `is`-attribute, AND
            // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
            I === "is" && st.allowCustomizedBuiltInElements && (st.tagNameCheck instanceof RegExp && Ot(st.tagNameCheck, Y) || st.tagNameCheck instanceof Function && st.tagNameCheck(Y)))
          ) return !1;
        } else if (!qa[I]) {
          if (!Ot(q, ti(Y, A, ""))) {
            if (!((I === "src" || I === "xlink:href" || I === "href") && v !== "script" && s0(Y, "data:") === 0 && dl[v])) {
              if (!(Ct && !Ot($, ti(Y, A, "")))) {
                if (Y)
                  return !1;
              }
    ...
    return v !== "annotation-xml" && Ol(v, N);
  }, Sl = function(v) {
    _e(B.beforeSanitizeAttributes, v, null);
    const {
      attributes: I
    } = v;
    if (!I || Ya(v))
    ...
    for (; gt--; ) {
      ...
      let Ft = kt === "value" ? ue : o0(ue);
      if (Y.attrName = Qr, Y.attrValue = Ft, Y.keepAttr = !0, Y.forceKeepAttr = void 0, _e(B.uponSanitizeAttribute, v, Y), Ft = Y.attrValue, ul && (Qr === "id" || Qr === "name") && (tn(kt, v), Ft = Lm + Ft), Pe && Ot(/((--!?|])>)|<\/(style|title)/i, Ft)) {
        tn(kt, v);
        continue;
      }
      if (Y.forceKeepAttr || (tn(kt, v), !Y.keepAttr))
        continue;
      if (!ne && Ot(/\/>/i, Ft)) {
        tn(kt, v);
        continue;
      ...
      const Tl = _t(v.nodeName);
      if (Cl(Tl, Qr, Ft)) {
        if (C && typeof d == "object" && typeof d.getAttributeType == "function" && !Wt)
          switch (d.getAttributeType(Tl, Qr)) {
            case "TrustedHTML": {
              Ft = C.createHTML(Ft);
              break;
            }
            case "TrustedScriptURL": {
              Ft = C.createScriptURL(Ft);
              break;
            }
          }
        try {
          Wt ? v.setAttributeNS(Wt, kt, Ft) : v.setAttribute(kt, Ft), Ya(v) ? he(v) : Fl(t.removed);
        } catch {
        }
      }
    }
    _e(B.afterSanitizeAttributes, v, null);
  }, Dm = function Q(v) {
    let I = null;
    const Y = wl(v);
    for (_e(B.beforeSanitizeShadowDOM, v, null); I = Y.nextNode(); )
      _e(B.uponSanitizeShadowNode, I, null), _l(I), Sl(I), I.content instanceof a && Q(I.content);
    _e(B.afterSanitizeShadowDOM, v, null);
  };
  return t.sanitize = function(Q) {
    let v = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, I = null, Y = null, gt = null, Lt = null;
    if (Ha = !Q, Ha && (Q = "<!-->"), typeof Q != "string" && !vl(Q))
    ...
    if (!t.isSupported)
      return Q;
    if (Na || Ua(v), t.removed = [], typeof Q == "string" && (Zr = !1), Zr) {
      if (Q.nodeName) {
        const ue = _t(Q.nodeName);
        if (!Z[ue] || Gt[ue])
          throw ei("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (Q instanceof s)
      I = bl("<!---->"), Y = I.ownerDocument.importNode(Q, !0), Y.nodeType === ii.element && Y.nodeName === "BODY" || Y.nodeName === "HTML" ? I = Y : I.appendChild(Y);
    else {
      if (!br && !Zt && !Ze && // eslint-disable-next-line unicorn/prefer-includes
      Q.indexOf("<") === -1)
        return C && Vi ? C.createHTML(Q) : Q;
      if (I = bl(Q), !I)
        return br ? null : Vi ? k : "";
    }
    I && za && he(I.firstChild);
    const kt = wl(Zr ? Q : I);
    for (; gt = kt.nextNode(); )
      _l(gt), Sl(gt), gt.content instanceof a && Dm(gt.content);
    if (Zr)
      return Q;
    if (br) {
      if (Xi)
        for (Lt = D.call(I.ownerDocument); I.firstChild; )
          Lt.appendChild(I.firstChild);
      else
        Lt = I;
      return (nt.shadowroot || nt.shadowrootmode) && (Lt = O.call(i, Lt, !0)), Lt;
    }
    let Wt = Ze ? I.outerHTML : I.innerHTML;
    return Ze && Z["!doctype"] && I.ownerDocument && I.ownerDocument.doctype && I.ownerDocument.doctype.name && Ot(xh, I.ownerDocument.doctype.name) && (Wt = "<!DOCTYPE " + I.ownerDocument.doctype.name + `>
` + Wt), Zt && en([z, P, E], (ue) => {
      Wt = ti(Wt, ue, " ");
    }), C && Vi ? C.createHTML(Wt) : Wt;
    ...
    Cr || Ua({});
    const Y = _t(Q), gt = _t(v);
    return Cl(Y, gt, I);
  }, t.addHook = function(Q, v) {
    typeof v == "function" && Jr(B[Q], v);
  }, t.removeHook = function(Q, v) {
    if (v !== void 0) {
      const I = n0(B[Q], v);
      return I === -1 ? void 0 : a0(B[Q], I, 1)[0];
    }
    return Fl(B[Q]);
...
var $r = bh(), wh = Object.defineProperty, p = (e, t) => wh(e, "name", { value: t, configurable: !0 }), _0 = (e, t) => {
  for (var r in t)
    wh(e, r, { get: t[r], enumerable: !0 });
}, Ce = {
  trace: 0,
  debug: 1,
  info: 2,
...
}, oo = /* @__PURE__ */ p(function(e = "fatal") {
  let t = Ce.fatal;
  typeof e == "string" ? e.toLowerCase() in Ce && (t = Ce[e]) : typeof e == "number" && (t = e), F.trace = () => {
  }, F.debug = () => {
  }, F.info = () => {
  }, F.warn = () => {
  }, F.error = () => {
  }, F.fatal = () => {
  }, t <= Ce.fatal && (F.fatal = console.error ? console.error.bind(console, Kt("FATAL"), "color: orange") : console.log.bind(console, "\x1B[35m", Kt("FATAL"))), t <= Ce.error && (F.error = console.error ? console.error.bind(console, Kt("ERROR"), "color: orange") : console.log.bind(console, "\x1B[31m", Kt("ERROR"))), t <= Ce.warn && (F.warn = console.warn ? console.warn.bind(console, Kt("WARN"), "color: orange") : console.log.bind(console, "\x1B[33m", Kt("WARN"))), t <= Ce.info && (F.info = console.info ? console.info.bind(console, Kt("INFO"), "color: lightblue") : console.log.bind(console, "\x1B[34m", Kt("INFO"))), t <= Ce.debug && (F.debug = console.debug ? console.debug.bind(console, Kt("DEBUG"), "color: lightgreen") : console.log.bind(console, "\x1B[32m", Kt("DEBUG"))), t <= Ce.trace && (F.trace = console.debug ? console.debug.bind(console, Kt("TRACE"), "color: lightgreen") : console.log.bind(console, "\x1B[32m", Kt("TRACE")));
}, "setLogLevel"), Kt = /* @__PURE__ */ p((e) => `%c${Gm().format("ss.SSS")} : ${e} : `, "format"), vh = /^-{3}\s*[\n\r](.*?)[\n\r]-{3}\s*[\n\r]+/s, _i = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, C0 = /\s*%%.*\n/gm, _h = class extends Error {
  static {
...
}, Fr = {}, lo = /* @__PURE__ */ p(function(e, t) {
  e = e.replace(vh, "").replace(_i, "").replace(C0, `
`);
  for (const [r, { detector: i }] of Object.entries(Fr))
    if (i(e, t))
      return r;
  throw new _h(
    `No diagram type detected matching given configuration for text: ${e}`
  );
}, "detectType"), Ch = /* @__PURE__ */ p((...e) => {
  for (const { id: t, detector: r, loader: i } of e)
    kh(t, r, i);
}, "registerLazyLoadedDiagrams"), kh = /* @__PURE__ */ p((e, t, r) => {
  Fr[e] && F.warn(`Detector with key ${e} already exists. Overwriting.`), Fr[e] = { detector: t, loader: r }, F.debug(`Detector with key ${e} added${r ? " with loader" : ""}`);
}, "addDetector"), k0 = /* @__PURE__ */ p((e) => Fr[e].loader, "getDiagramLoader"), gs = /* @__PURE__ */ p((e, t, { depth: r = 2, clobber: i = !1 } = {}) => {
  const n = { depth: r, clobber: i };
  return Array.isArray(t) && !Array.isArray(e) ? (t.forEach((a) => gs(e, a, n)), e) : Array.isArray(t) && Array.isArray(e) ? (t.forEach((a) => {
    ...
    typeof t[a] == "object" && (e[a] === void 0 || typeof e[a] == "object") ? (e[a] === void 0 && (e[a] = Array.isArray(t[a]) ? [] : {}), e[a] = gs(e[a], t[a], { depth: r - 1, clobber: i })) : (i || typeof e[a] != "object" && typeof t[a] != "object") && (e[a] = t[a]);
  }), e);
}, "assignWithDepth"), Bt = gs, da = "#ffffff", pa = "#f2f2f2", Dt = /* @__PURE__ */ p((e, t) => t ? _(e, { s: -40, l: 10 }) : _(e, { s: -40, l: -10 }), "mkBorder"), S0 = class {
  static {
    p(this, "Theme");
  }
  constructor() {
  ...
  updateColors() {
    ...
    for (let t = 0; t < this.THEME_COLOR_LIMIT; t++)
      this.darkMode ? this["cScalePeer" + t] = this["cScalePeer" + t] || H(this["cScale" + t], 10) : this["cScalePeer" + t] = this["cScalePeer" + t] || J(this["cScale" + t], 10);
    this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
    for (let t = 0; t < this.THEME_COLOR_LIMIT; t++)
      this["cScaleLabel" + t] = this["cScaleLabel" + t] || this.scaleLabelColor;
    const e = this.darkMode ? -4 : -1;
    for (let t = 0; t < 5; t++)
      this["surface" + t] = this["surface" + t] || _(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) }), this["surfacePeer" + t] = this["surfacePeer" + t] || _(this.mainBkg, { h: 180, s: -15, l: e * (8 + t * 3) });
    ...
    }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? J(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || this.primaryColor, this.git1 = this.git1 || this.secondaryColor, this.git2 = this.git2 || this.tertiaryColor, this.git3 = this.git3 || _(this.primaryColor, { h: -30 }), this.git4 = this.git4 || _(this.primaryColor, { h: -60 }), this.git5 = this.git5 || _(this.primaryColor, { h: -90 }), this.git6 = this.git6 || _(this.primaryColor, { h: 60 }), this.git7 = this.git7 || _(this.primaryColor, { h: 120 }), this.darkMode ? (this.git0 = H(this.git0, 25), this.git1 = H(this.git1, 25), this.git2 = H(this.git2, 25), this.git3 = H(this.git3, 25), this.git4 = H(this.git4, 25), this.git5 = H(this.git5, 25), this.git6 = H(this.git6, 25), this.git7 = H(this.git7, 25)) : (this.git0 = J(this.git0, 25), this.git1 = J(this.git1, 25), this.git2 = J(this.git2, 25), this.git3 = J(this.git3, 25), this.git4 = J(this.git4, 25), this.git5 = J(this.git5, 25), this.git6 = J(this.git6, 25), this.git7 = J(this.git7, 25)), this.gitInv0 = this.gitInv0 || W(this.git0), this.gitInv1 = this.gitInv1 || W(this.git1), this.gitInv2 = this.gitInv2 || W(this.git2), this.gitInv3 = this.gitInv3 || W(this.git3), this.gitInv4 = this.gitInv4 || W(this.git4), this.gitInv5 = this.gitInv5 || W(this.git5), this.gitInv6 = this.gitInv6 || W(this.git6), this.gitInv7 = this.gitInv7 || W(this.git7), this.branchLabelColor = this.branchLabelColor || (this.darkMode ? "black" : this.labelTextColor), this.gitBranchLabel0 = this.gitBranchLabel0 || this.branchLabelColor, this.gitBranchLabel1 = this.gitBranchLabel1 || this.branchLabelColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.branchLabelColor, this.gitBranchLabel3 = this.gitBranchLabel3 || this.branchLabelColor, this.gitBranchLabel4 = this.gitBranchLabel4 || this.branchLabelColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.branchLabelColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.branchLabelColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || da, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || pa;
  }
  calculate(e) {
    if (typeof e != "object") {
      this.updateColors();
  ...
  updateColors() {
    ...
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this["cScaleInv" + e] = this["cScaleInv" + e] || W(this["cScale" + e]);
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this["cScalePeer" + e] = this["cScalePeer" + e] || H(this["cScale" + e], 10);
    for (let e = 0; e < 5; e++)
      this["surface" + e] = this["surface" + e] || _(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) }), this["surfacePeer" + e] = this["surfacePeer" + e] || _(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) });
  ...
  updateColors() {
    ...
    }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.labelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || this.primaryColor, this.git1 = this.git1 || this.secondaryColor, this.git2 = this.git2 || this.tertiaryColor, this.git3 = this.git3 || _(this.primaryColor, { h: -30 }), this.git4 = this.git4 || _(this.primaryColor, { h: -60 }), this.git5 = this.git5 || _(this.primaryColor, { h: -90 }), this.git6 = this.git6 || _(this.primaryColor, { h: 60 }), this.git7 = this.git7 || _(this.primaryColor, { h: 120 }), this.darkMode ? (this.git0 = H(this.git0, 25), this.git1 = H(this.git1, 25), this.git2 = H(this.git2, 25), this.git3 = H(this.git3, 25), this.git4 = H(this.git4, 25), this.git5 = H(this.git5, 25), this.git6 = H(this.git6, 25), this.git7 = H(this.git7, 25)) : (this.git0 = J(this.git0, 25), this.git1 = J(this.git1, 25), this.git2 = J(this.git2, 25), this.git3 = J(this.git3, 25), this.git4 = J(this.git4, 25), this.git5 = J(this.git5, 25), this.git6 = J(this.git6, 25), this.git7 = J(this.git7, 25)), this.gitInv0 = this.gitInv0 || J(W(this.git0), 25), this.gitInv1 = this.gitInv1 || W(this.git1), this.gitInv2 = this.gitInv2 || W(this.git2), this.gitInv3 = this.gitInv3 || W(this.git3), this.gitInv4 = this.gitInv4 || W(this.git4), this.gitInv5 = this.gitInv5 || W(this.git5), this.gitInv6 = this.gitInv6 || W(this.git6), this.gitInv7 = this.gitInv7 || W(this.git7), this.gitBranchLabel0 = this.gitBranchLabel0 || W(this.labelTextColor), this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor, this.gitBranchLabel3 = this.gitBranchLabel3 || W(this.labelTextColor), this.gitBranchLabel4 = this.gitBranchLabel4 || this.labelTextColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.labelTextColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.labelTextColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.labelTextColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || da, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || pa;
  }
  calculate(e) {
  ...
  updateColors() {
    ...
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this["cScaleLabel" + e] = this["cScaleLabel" + e] || this.scaleLabelColor;
    for (let e = 0; e < 5; e++)
      this["surface" + e] = this["surface" + e] || _(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) }), this["surfacePeer" + e] = this["surfacePeer" + e] || _(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) });
  ...
  updateColors() {
    ...
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this["cScaleInv" + e] = this["cScaleInv" + e] || W(this["cScale" + e]);
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this.darkMode ? this["cScalePeer" + e] = this["cScalePeer" + e] || H(this["cScale" + e], 10) : this["cScalePeer" + e] = this["cScalePeer" + e] || J(this["cScale" + e], 10);
    this.scaleLabelColor = this.scaleLabelColor || (this.darkMode ? "black" : this.labelTextColor), this.cScaleLabel0 = this.cScaleLabel0 || this.cScale1, this.cScaleLabel2 = this.cScaleLabel2 || this.cScale1;
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
      this["cScaleLabel" + e] = this["cScaleLabel" + e] || this.scaleLabelColor;
    for (let e = 0; e < 5; e++)
      this["surface" + e] = this["surface" + e] || _(this.mainBkg, { l: -(5 + e * 5) }), this["surfacePeer" + e] = this["surfacePeer" + e] || _(this.mainBkg, { l: -(8 + e * 5) });
    ...
    this.pie12 = this.pie0, this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || _(this.primaryColor, { r: 5, g: 5, b: 5 }), this.quadrant3Fill = this.quadrant3Fill || _(this.primaryColor, { r: 10, g: 10, b: 10 }), this.quadrant4Fill = this.quadrant4Fill || _(this.primaryColor, { r: 15, g: 15, b: 15 }), this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor, this.quadrant2TextFill = this.quadrant2TextFill || _(this.primaryTextColor, { r: -5, g: -5, b: -5 }), this.quadrant3TextFill = this.quadrant3TextFill || _(this.primaryTextColor, { r: -10, g: -10, b: -10 }), this.quadrant4TextFill = this.quadrant4TextFill || _(this.primaryTextColor, { r: -15, g: -15, b: -15 }), this.quadrantPointFill = this.quadrantPointFill || Pi(this.quadrant1Fill) ? H(this.quadrant1Fill) : J(this.quadrant1Fill), this.quadrantPointTextFill = this.quadrantPointTextFill || this.primaryTextColor, this.quadrantXAxisTextFill = this.quadrantXAxisTextFill || this.primaryTextColor, this.quadrantYAxisTextFill = this.quadrantYAxisTextFill || this.primaryTextColor, this.quadrantInternalBorderStrokeFill = this.quadrantInternalBorderStrokeFill || this.primaryBorderColor, this.quadrantExternalBorderStrokeFill = this.quadrantExternalBorderStrokeFill || this.primaryBorderColor, this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor, this.xyChart = {
      ...
      legendBoxSize: this.radar?.legendBoxSize || 12,
      legendFontSize: this.radar?.legendFontSize || 12
    }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.edgeLabelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = J(this.pie1, 25) || this.primaryColor, this.git1 = this.pie2 || this.secondaryColor, this.git2 = this.pie3 || this.tertiaryColor, this.git3 = this.pie4 || _(this.primaryColor, { h: -30 }), this.git4 = this.pie5 || _(this.primaryColor, { h: -60 }), this.git5 = this.pie6 || _(this.primaryColor, { h: -90 }), this.git6 = this.pie7 || _(this.primaryColor, { h: 60 }), this.git7 = this.pie8 || _(this.primaryColor, { h: 120 }), this.gitInv0 = this.gitInv0 || W(this.git0), this.gitInv1 = this.gitInv1 || W(this.git1), this.gitInv2 = this.gitInv2 || W(this.git2), this.gitInv3 = this.gitInv3 || W(this.git3), this.gitInv4 = this.gitInv4 || W(this.git4), this.gitInv5 = this.gitInv5 || W(this.git5), this.gitInv6 = this.gitInv6 || W(this.git6), this.gitInv7 = this.gitInv7 || W(this.git7), this.branchLabelColor = this.branchLabelColor || this.labelTextColor, this.gitBranchLabel0 = this.branchLabelColor, this.gitBranchLabel1 = "white", this.gitBranchLabel2 = this.branchLabelColor, this.gitBranchLabel3 = "white", this.gitBranchLabel4 = this.branchLabelColor, this.gitBranchLabel5 = this.branchLabelColor, this.gitBranchLabel6 = this.branchLabelColor, this.gitBranchLabel7 = this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || da, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || pa;
  }
  calculate(e) {
    if (typeof e != "object") {
      this.updateColors();
...
}, Th = /* @__PURE__ */ p((e, t = "") => Object.keys(e).reduce((r, i) => Array.isArray(e[i]) ? r : typeof e[i] == "object" && e[i] !== null ? [...r, t + i, ...Th(e[i], "")] : [...r, t + i], []), "keyify"), D0 = new Set(Th(Sh, "")), Bh = Sh, Mn = /* @__PURE__ */ p((e) => {
  if (F.debug("sanitizeDirective called with", e), !(typeof e != "object" || e == null)) {
    ...
    for (const t of Object.keys(e)) {
      if (F.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !D0.has(t) || e[t] == null) {
        F.debug("sanitize deleting key: ", t), delete e[t];
        continue;
      }
      if (typeof e[t] == "object") {
        F.debug("sanitizing object", t), Mn(e[t]);
        continue;
      }
      const r = ["themeCSS", "fontFamily", "altFontFamily"];
      for (const i of r)
        t.includes(i) && (F.debug("sanitizing css option", t), e[t] = R0(e[t]));
    }
    if (e.themeVariables)
...
}, "sanitizeDirective"), R0 = /* @__PURE__ */ p((e) => {
  let t = 0, r = 0;
  for (const i of e) {
    if (t < r)
...
}, "sanitizeCss"), Or = Object.freeze(Bh), Ht = Bt({}, Or), Lh, Dr = [], Ci = Bt({}, Or), ga = /* @__PURE__ */ p((e, t) => {
  let r = Bt({}, e), i = {};
  for (const n of t)
    Eh(n), i = Bt(i, n);
  if (r = Bt(r, i), i.theme && i.theme in Le) {
    const n = Bt({}, Lh), a = Bt(
      n.themeVariables || {},
      i.themeVariables
    );
  ...
  return Ci = r, $h(Ci), Ci;
}, "updateCurrentConfig"), I0 = /* @__PURE__ */ p((e) => (Ht = Bt({}, Or), Ht = Bt(Ht, e), e.theme && Le[e.theme] && (Ht.themeVariables = Le[e.theme].getThemeVariables(e.themeVariables)), ga(Ht, Dr), Ht), "setSiteConfig"), P0 = /* @__PURE__ */ p((e) => {
  Lh = Bt({}, e);
}, "saveConfigFromInitialize"), N0 = /* @__PURE__ */ p((e) => (Ht = Bt(Ht, e), ga(Ht, Dr), Ht), "updateSiteConfig"), Ah = /* @__PURE__ */ p(() => Bt({}, Ht), "getSiteConfig"), Mh = /* @__PURE__ */ p((e) => ($h(e), Bt(Ci, e), Yt()), "setConfig"), Yt = /* @__PURE__ */ p(() => Bt({}, Ci), "getConfig"), Eh = /* @__PURE__ */ p((e) => {
  e && (["secure", ...Ht.secure ?? []].forEach((t) => {
    Object.hasOwn(e, t) && (F.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
  }), Object.keys(e).forEach((t) => {
    t.startsWith("__") && delete e[t];
  }), Object.keys(e).forEach((t) => {
    typeof e[t] == "string" && (e[t].includes("<") || e[t].includes(">") || e[t].includes("url(data:")) && delete e[t], typeof e[t] == "object" && Eh(e[t]);
  }));
}, "sanitize"), z0 = /* @__PURE__ */ p((e) => {
  Mn(e), e.fontFamily && !e.themeVariables?.fontFamily && (e.themeVariables = {
    ...e.themeVariables,
    fontFamily: e.fontFamily
  }), Dr.push(e), ga(Ht, Dr);
}, "addDirective"), En = /* @__PURE__ */ p((e = Ht) => {
  Dr = [], ga(e, Dr);
}, "reset"), W0 = {
  LAZY_LOAD_DEPRECATED: "The configuration options lazyLoadedDiagrams and loadExternalDiagramsAtStartup are deprecated. Please use registerExternalDiagrams instead."
}, Wl = {}, q0 = /* @__PURE__ */ p((e) => {
  Wl[e] || (F.warn(W0[e]), Wl[e] = !0);
}, "issueWarning"), $h = /* @__PURE__ */ p((e) => {
  e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && q0("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), Ni = /<br\s*\/?>/gi, H0 = /* @__PURE__ */ p((e) => e ? Dh(e).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), j0 = /* @__PURE__ */ (() => {
  let e = !1;
  return () => {
    e || (Fh(), e = !0);
  };
...
p(Fh, "setupDompurifyHooks");
var Oh = /* @__PURE__ */ p((e) => (j0(), $r.sanitize(e)), "removeScript"), ql = /* @__PURE__ */ p((e, t) => {
  if (t.flowchart?.htmlLabels !== !1) {
    const r = t.securityLevel;
    r === "antiscript" || r === "strict" ? e = Oh(e) : r !== "loose" && (e = Dh(e), e = e.replace(/</g, "&lt;").replace(/>/g, "&gt;"), e = e.replace(/=/g, "&equals;"), e = X0(e));
  }
  return e;
}, "sanitizeMore"), lr = /* @__PURE__ */ p((e, t) => e && (t.dompurifyConfig ? e = $r.sanitize(ql(e, t), t.dompurifyConfig).toString() : e = $r.sanitize(ql(e, t), {
  FORBID_TAGS: ["style"]
}).toString(), e), "sanitizeText"), U0 = /* @__PURE__ */ p((e, t) => typeof e == "string" ? lr(e, t) : e.flat().map((r) => lr(r, t)), "sanitizeTextOrArray"), Y0 = /* @__PURE__ */ p((e) => Ni.test(e), "hasBreaks"), G0 = /* @__PURE__ */ p((e) => e.split(Ni), "splitBreaks"), X0 = /* @__PURE__ */ p((e) => e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), Dh = /* @__PURE__ */ p((e) => e.replace(Ni, "#br#"), "breakToPlaceholder"), V0 = /* @__PURE__ */ p((e) => {
  let t = "";
...
}, "getUrl"), vt = /* @__PURE__ */ p((e) => !(e === !1 || ["false", "null", "0"].includes(String(e).trim().toLowerCase())), "evaluate"), Z0 = /* @__PURE__ */ p(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.max(...t);
}, "getMax"), K0 = /* @__PURE__ */ p(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.min(...t);
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    if (n === "," && i > 0 && i + 1 < t.length) {
      ...
      Q0(a, o) && (n = a + "," + o, i++, r.pop());
    }
    r.push(J0(n));
  }
  return r.join("");
}, "parseGenericTypes"), ms = /* @__PURE__ */ p((e, t) => Math.max(0, e.split(t).length - 1), "countOccurrence"), Q0 = /* @__PURE__ */ p((e, t) => {
  const r = ms(e, "~"), i = ms(t, "~");
  return r === 1 && i === 1;
}, "shouldCombineSets"), J0 = /* @__PURE__ */ p((e) => {
  const t = ms(e, "~");
  let r = !1;
  if (t <= 1)
    return e;
...
}, "processSet"), jl = /* @__PURE__ */ p(() => window.MathMLElement !== void 0, "isMathMLSupported"), ys = /\$\$(.*)\$\$/g, Rr = /* @__PURE__ */ p((e) => (e.match(ys)?.length ?? 0) > 0, "hasKatex"), zL = /* @__PURE__ */ p(async (e, t) => {
  e = await co(e, t);
  const r = document.createElement("div");
  r.innerHTML = e, r.id = "katex-temp", r.style.visibility = "hidden", r.style.position = "absolute", r.style.top = "0", document.querySelector("body")?.insertAdjacentElement("beforeend", r);
  const n = { width: r.clientWidth, height: r.clientHeight };
  return r.remove(), n;
}, "calculateMathMLDimensions"), co = /* @__PURE__ */ p(async (e, t) => {
  if (!Rr(e))
    return e;
  if (!(jl() || t.legacyMathML || t.forceLegacyMathML))
    return e.replace(ys, "MathML is unsupported in this environment.");
  const { default: r } = await import("./katex-BBtz5V9r.js"), i = t.forceLegacyMathML || !jl() && t.legacyMathML ? "htmlAndMathml" : "mathml";
  return e.split(Ni).map(
  ...
  getMax: Z0,
  getMin: K0
}, ty = /* @__PURE__ */ p(function(e, t) {
  for (let r of t)
    e.attr(r[0], r[1]);
}, "d3Attrs"), ey = /* @__PURE__ */ p(function(e, t, r) {
  let i = /* @__PURE__ */ new Map();
  return r ? (i.set("width", "100%"), i.set("style", `max-width: ${t}px;`)) : (i.set("height", e), i.set("width", t)), i;
}, "calculateSvgSizeAttrs"), Rh = /* @__PURE__ */ p(function(e, t, r, i) {
  const n = ey(t, r, i);
  ty(e, n);
}, "configureSvgSize"), ry = /* @__PURE__ */ p(function(e, t, r, i) {
  const n = t.node().getBBox(), a = n.width, o = n.height;
  F.info(`SVG bounds: ${a}x${o}`, n);
  let s = 0, l = 0;
  F.info(`Graph bounds: ${s}x${l}`, e), s = a + r * 2, l = o + r * 2, F.info(`Calculated bounds: ${s}x${l}`), Rh(t, l, s, i);
  const c = `${n.x - r} ${n.y - r} ${n.width + 2 * r} ${n.height + 2 * r}`;
  t.attr("viewBox", c);
}, "setupGraphViewbox"), mn = {}, iy = /* @__PURE__ */ p((e, t, r) => {
  let i = "";
  return e in mn && mn[e] ? i = mn[e](r) : F.warn(`No theme found for ${e}`), ` & {
  ...
  ${t}
`;
}, "getStyles"), ny = /* @__PURE__ */ p((e, t) => {
  t !== void 0 && (mn[e] = t);
}, "addStylesForDiagram"), ay = iy, Ih = {};
_0(Ih, {
  clear: () => sy,
  getAccDescription: () => hy,
  getAccTitle: () => ly,
  getDiagramTitle: () => fy,
  setAccDescription: () => cy,
  setAccTitle: () => oy,
  setDiagramTitle: () => uy
});
var ho = "", uo = "", fo = "", po = /* @__PURE__ */ p((e) => lr(e, Yt()), "sanitizeText"), sy = /* @__PURE__ */ p(() => {
  ho = "", fo = "", uo = "";
}, "clear"), oy = /* @__PURE__ */ p((e) => {
  ho = po(e).replace(/^\s+/g, "");
}, "setAccTitle"), ly = /* @__PURE__ */ p(() => ho, "getAccTitle"), cy = /* @__PURE__ */ p((e) => {
  fo = po(e).replace(/\n\s+/g, `
`);
}, "setAccDescription"), hy = /* @__PURE__ */ p(() => fo, "getAccDescription"), uy = /* @__PURE__ */ p((e) => {
  uo = po(e);
}, "setDiagramTitle"), fy = /* @__PURE__ */ p(() => uo, "getDiagramTitle"), Ul = F, dy = oo, ht = Yt, WL = Mh, qL = Or, go = /* @__PURE__ */ p((e) => lr(e, ht()), "sanitizeText"), py = ry, gy = /* @__PURE__ */ p(() => Ih, "getCommonDb"), $n = {}, Fn = /* @__PURE__ */ p((e, t, r) => {
  $n[e] && Ul.warn(`Diagram with id ${e} already registered. Overwriting.`), $n[e] = t, r && kh(e, r), ny(e, t.styles), t.injectUtils?.(
    Ul,
    dy,
    ht,
    go,
...
}, "registerDiagram"), xs = /* @__PURE__ */ p((e) => {
  if (e in $n)
    return $n[e];
  throw new my(e);
}, "getDiagram"), my = class extends Error {
  static {
...
p(Ph, "isObject");
function Nh(e) {
  return Array.isArray(e) ? e : mo(e) ? [] : [e];
}
p(Nh, "toArray");
function zh(e, t) {
  var r, i, n, a;
...
p(qh, "isNegativeZero");
var yy = mo, xy = Ph, by = Nh, wy = Wh, vy = qh, _y = zh, wt = {
  isNothing: yy,
  isObject: xy,
  toArray: by,
  repeat: wy,
...
p(Ir, "YAMLException$1");
Ir.prototype = Object.create(Error.prototype);
Ir.prototype.constructor = Ir;
Ir.prototype.toString = /* @__PURE__ */ p(function(t) {
...
function Hh(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(o - l < 0); l++)
    c = yn(
      ...
      u
    ), s = wt.repeat(" ", t.indent) + xn((e.line - l + 1).toString(), h) + " | " + c.str + `
` + s;
  for (c = yn(e.buffer, i[o], n[o], e.position, u), s += wt.repeat(" ", t.indent) + xn((e.line + 1).toString(), h) + " | " + c.str + `
...
function Uh(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    ...
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = jh(t.styleAliases || null), Sy.indexOf(this.kind) === -1)
...
p(On, "Schema$1");
On.prototype.extend = /* @__PURE__ */ p(function(t) {
  var r = [], i = [];
  if (t instanceof Mt)
    i.push(t);
  ...
  var n = Object.create(On.prototype);
  return n.implicit = (this.implicit || []).concat(r), n.explicit = (this.explicit || []).concat(i), n.compiledImplicit = bs(n, "implicit"), n.compiledExplicit = bs(n, "explicit"), n.compiledTypeMap = Yh(n.compiledImplicit, n.compiledExplicit), n;
}, "extend");
var Ty = On, By = new Mt("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : "";
  }, "construct")
}), Ly = new Mt("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : [];
  }, "construct")
}), Ay = new Mt("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : {};
  }, "construct")
...
p(Gh, "resolveYamlNull");
function Xh() {
  return null;
}
p(Xh, "constructYamlNull");
function Vh(e) {
  return e === null;
}
p(Vh, "isNull");
var Ey = new Mt("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: Gh,
  construct: Xh,
  predicate: Vh,
...
p(Zh, "resolveYamlBoolean");
function Kh(e) {
  return e === "true" || e === "True" || e === "TRUE";
}
p(Kh, "constructYamlBoolean");
function Qh(e) {
  return Object.prototype.toString.call(e) === "[object Boolean]";
}
p(Qh, "isBoolean");
var $y = new Mt("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: Zh,
  construct: Kh,
  predicate: Qh,
...
function ru(e) {
  ...
  for (; r < t; r++)
    if (n = e[r], n !== "_") {
      if (!eu(e.charCodeAt(r)))
        return !1;
      i = !0;
    }
  return !(!i || n === "_");
}
p(ru, "resolveYamlInteger");
function iu(e) {
  var t = e, r = 1, i;
...
p(iu, "constructYamlInteger");
function nu(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && e % 1 === 0 && !wt.isNegativeZero(e);
}
p(nu, "isInteger");
var Fy = new Mt("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: ru,
  construct: iu,
  predicate: nu,
...
function au(e) {
  return !(e === null || !Oy.test(e) || // Quick hack to not allow integers end with `_`
  // Probably should update regexp & check speed
  e[e.length - 1] === "_");
}
p(au, "resolveYamlFloat");
function su(e) {
  var t, r;
  return t = e.replace(/_/g, "").toLowerCase(), r = t[0] === "-" ? -1 : 1, "+-".indexOf(t[0]) >= 0 && (t = t.slice(1)), t === ".inf" ? r === 1 ? Number.POSITIVE_INFINITY : Number.NEGATIVE_INFINITY : t === ".nan" ? NaN : r * parseFloat(t, 10);
}
p(su, "constructYamlFloat");
var Dy = /^[-+]?[0-9]+e/;
function ou(e, t) {
  var r;
  if (isNaN(e))
  ...
  else if (wt.isNegativeZero(e))
    return "-0.0";
  return r = e.toString(10), Dy.test(r) ? r.replace("e", ".e") : r;
}
p(ou, "representYamlFloat");
function lu(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || wt.isNegativeZero(e));
}
p(lu, "isFloat");
var Ry = new Mt("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: au,
  construct: su,
  predicate: lu,
...
function fu(e) {
  return e === null ? !1 : hu.exec(e) !== null || uu.exec(e) !== null;
}
p(fu, "resolveYamlTimestamp");
function du(e) {
  var t, r, i, n, a, o, s, l = 0, c = null, h, u, f;
  if (t = hu.exec(e), t === null && (t = uu.exec(e)), t === null) throw new Error("Date resolve error");
...
p(du, "constructYamlTimestamp");
function pu(e) {
  return e.toISOString();
}
p(pu, "representYamlTimestamp");
var Py = new Mt("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: fu,
  construct: du,
  instanceOf: Date,
...
p(gu, "resolveYamlMerge");
var Ny = new Mt("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: gu
...
p(mu, "resolveYamlBinary");
function yu(e) {
  var t, r, i = e.replace(/[\r\n=]/g, ""), n = i.length, a = xo, o = 0, s = [];
  for (t = 0; t < n; t++)
...
p(yu, "constructYamlBinary");
function xu(e) {
  var t = "", r = 0, i, n, a = e.length, o = xo;
  for (i = 0; i < a; i++)
...
p(xu, "representYamlBinary");
function bu(e) {
  return Object.prototype.toString.call(e) === "[object Uint8Array]";
}
p(bu, "isBinary");
var zy = new Mt("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: mu,
  construct: yu,
  predicate: bu,
  represent: xu
}), Wy = Object.prototype.hasOwnProperty, qy = Object.prototype.toString;
function wu(e) {
  if (e === null) return !0;
  var t = [], r, i, n, a, o, s = e;
  for (r = 0, i = s.length; r < i; r += 1) {
    if (n = s[r], o = !1, qy.call(n) !== "[object Object]") return !1;
    for (a in n)
      if (Wy.call(n, a))
        if (!o) o = !0;
        else return !1;
...
p(wu, "resolveYamlOmap");
function vu(e) {
  return e !== null ? e : [];
}
p(vu, "constructYamlOmap");
var Hy = new Mt("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: wu,
  construct: vu
...
function _u(e) {
  ...
  for (a = new Array(o.length), t = 0, r = o.length; t < r; t += 1) {
    if (i = o[t], jy.call(i) !== "[object Object]" || (n = Object.keys(i), n.length !== 1)) return !1;
    a[t] = [n[0], i[n[0]]];
  }
  return !0;
}
p(_u, "resolveYamlPairs");
function Cu(e) {
  if (e === null) return [];
  var t, r, i, n, a, o = e;
  for (a = new Array(o.length), t = 0, r = o.length; t < r; t += 1)
...
p(Cu, "constructYamlPairs");
var Uy = new Mt("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: _u,
  construct: Cu
...
p(Su, "constructYamlSet");
var Gy = new Mt("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: ku,
  construct: Su
}), Tu = Iy.extend({
...
}), He = Object.prototype.hasOwnProperty, Dn = 1, Bu = 2, Lu = 3, Rn = 4, Qa = 1, Xy = 2, Yl = 3, Vy = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zy = /[\x85\u2028\u2029]/, Ky = /[,\[\]\{\}]/, Au = /^(?:!|!!|![a-z\-]+!)$/i, Mu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function ws(e) {
...
p(Fu, "fromDecimalCode");
function vs(e) {
  return e === 48 ? "\0" : e === 97 ? "\x07" : e === 98 ? "\b" : e === 116 || e === 9 ? "	" : e === 110 ? `
` : e === 118 ? "\v" : e === 102 ? "\f" : e === 114 ? "\r" : e === 101 ? "\x1B" : e === 32 ? " " : e === 34 ? '"' : e === 47 ? "/" : e === 92 ? "\\" : e === 78 ? "" : e === 95 ? " " : e === 76 ? "\u2028" : e === 80 ? "\u2029" : "";
}
p(vs, "simpleEscapeSequence");
function Ou(e) {
...
p(Ou, "charFromCodepoint");
var Du = new Array(256), Ru = new Array(256);
for (Ke = 0; Ke < 256; Ke++)
  Du[Ke] = vs(Ke) ? 1 : 0, Ru[Ke] = vs(Ke);
var Ke;
function Iu(e, t) {
  this.input = e, this.filename = t.filename || null, this.schema = t.schema || Tu, this.onWarning = t.onWarning || null, this.legacy = t.legacy || !1, this.json = t.json || !1, this.listener = t.listener || null, this.implicitTypes = this.schema.compiledImplicit, this.typeMap = this.schema.compiledTypeMap, this.length = e.length, this.position = 0, this.line = 0, this.lineStart = 0, this.lineIndent = 0, this.firstTabInLine = -1, this.documents = [];
}
p(Iu, "State$1");
function bo(e, t) {
  var r = {
  ...
  return r.snippet = Cy(r), new jt(t, r);
}
p(bo, "generateError");
function K(e, t) {
  throw bo(e, t);
...
var Gl = {
  YAML: /* @__PURE__ */ p(function(t, r, i) {
    var n, a, o;
    t.version !== null && K(t, "duplication of %YAML directive"), i.length !== 1 && K(t, "YAML directive accepts exactly one argument"), n = /^([0-9]+)\.([0-9]+)$/.exec(i[0]), n === null && K(t, "ill-formed argument of the YAML directive"), a = parseInt(n[1], 10), o = parseInt(n[2], 10), a !== 1 && K(t, "unacceptable YAML version of the document"), t.version = i[0], t.checkLineBreaks = o < 2, o !== 1 && o !== 2 && Ti(t, "unsupported YAML version of the document");
  }, "handleYamlDirective"),
  TAG: /* @__PURE__ */ p(function(t, r, i) {
    var n, a;
    i.length !== 2 && K(t, "TAG directive accepts exactly two arguments"), n = i[0], a = i[1], Au.test(n) || K(t, "ill-formed tag handle (first argument) of the TAG directive"), He.call(t.tagMap, n) && K(t, 'there is a previously declared suffix for "' + n + '" tag handle'), Mu.test(a) || K(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ae(e, t, r, i) {
  ...
  if (t < r) {
    ...
    else Vy.test(s) && K(e, "the stream contains non-printable characters");
    e.result += s;
  }
}
p(Ae, "captureSegment");
function _s(e, t, r, i) {
  var n, a, o, s;
  for (wt.isObject(r) || K(e, "cannot merge mappings; the provided source object is unacceptable"), n = Object.keys(r), o = 0, s = n.length; o < s; o += 1)
...
function nr(e, t, r, i, n, a, o, s, l) {
  ...
  if (Array.isArray(n))
    for (n = Array.prototype.slice.call(n), c = 0, h = n.length; c < h; c += 1)
      Array.isArray(n[c]) && K(e, "nested arrays are not supported inside keys"), typeof n == "object" && ws(n[c]) === "[object Object]" && (n[c] = "[object Object]");
  if (typeof n == "object" && ws(n) === "[object Object]" && (n = "[object Object]"), n = String(n), t === null && (t = {}), i === "tag:yaml.org,2002:merge")
    ...
    !e.json && !He.call(r, n) && He.call(t, n) && (e.line = o || e.line, e.lineStart = s || e.lineStart, e.position = l || e.position, K(e, "duplicated mapping key")), n === "__proto__" ? Object.defineProperty(t, n, {
      configurable: !0,
      enumerable: !0,
      writable: !0,
      value: a
...
p(zi, "testDocumentSeparator");
function ya(e, t) {
  t === 1 ? e.result += " " : t > 1 && (e.result += wt.repeat(`
`, t - 1));
}
p(ya, "writeFoldedLines");
function Pu(e, t, r) {
  var i, n, a, o, s, l, c, h, u = e.kind, f = e.result, d;
  if (d = e.input.charCodeAt(e.position), Rt(d) || ir(d) || d === 35 || d === 38 || d === 42 || d === 33 || d === 124 || d === 62 || d === 39 || d === 34 || d === 37 || d === 64 || d === 96 || (d === 63 || d === 45) && (n = e.input.charCodeAt(e.position + 1), Rt(n) || r && ir(n)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = o = e.position, s = !1; d !== 0; ) {
    if (d === 58) {
      if (n = e.input.charCodeAt(e.position + 1), Rt(n) || r && ir(n))
        break;
    } else if (d === 35) {
      if (i = e.input.charCodeAt(e.position - 1), Rt(i))
        break;
    } else {
      if (e.position === e.lineStart && zi(e) || r && ir(d))
        break;
      if (oe(d))
        if (l = e.line, c = e.lineStart, h = e.lineIndent, yt(e, !1, -1), e.lineIndent >= t) {
    ...
    s && (Ae(e, a, o, !1), ya(e, e.line - l), a = o = e.position, s = !1), qe(d) || (o = e.position + 1), d = e.input.charCodeAt(++e.position);
  }
  return Ae(e, a, o, !1), e.result ? !0 : (e.kind = u, e.result = f, !1);
}
p(Pu, "readPlainScalar");
function Nu(e, t) {
  var r, i, n;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, i = n = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (Ae(e, i, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        i = e.position, e.position++, n = e.position;
      else
        return !0;
    else oe(r) ? (Ae(e, i, n, !0), ya(e, yt(e, !1, t)), i = n = e.position) : e.position === e.lineStart && zi(e) ? K(e, "unexpected end of the document within a single quoted scalar") : (e.position++, n = e.position);
  K(e, "unexpected end of the stream within a single quoted scalar");
}
p(Nu, "readSingleQuotedScalar");
function zu(e, t) {
  var r, i, n, a, o, s;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    if (s === 34)
      return Ae(e, r, e.position, !0), e.position++, !0;
    if (s === 92) {
      if (Ae(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), oe(s))
        yt(e, !1, t);
      else if (s < 256 && Du[s])
        e.result += Ru[s], e.position++;
      else if ((o = $u(s)) > 0) {
        for (n = o, a = 0; n > 0; n--)
          s = e.input.charCodeAt(++e.position), (o = Eu(s)) >= 0 ? a = (a << 4) + o : K(e, "expected hexadecimal character");
        e.result += Ou(a), e.position++;
      } else
        K(e, "unknown escape sequence");
      r = i = e.position;
    } else oe(s) ? (Ae(e, r, i, !0), ya(e, yt(e, !1, t)), r = i = e.position) : e.position === e.lineStart && zi(e) ? K(e, "unexpected end of the document within a double quoted scalar") : (e.position++, i = e.position);
  }
  K(e, "unexpected end of the stream within a double quoted scalar");
}
p(zu, "readDoubleQuotedScalar");
function Wu(e, t) {
  var r = !0, i, n, a, o = e.tag, s, l = e.anchor, c, h, u, f, d, g = /* @__PURE__ */ Object.create(null), m, y, x, b;
...
function qu(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      Qa === n ? n = u === 43 ? Yl : Xy : K(e, "repeat of a chomping mode identifier");
    else if ((h = Fu(u)) >= 0)
  ...
  for (; u !== 0; ) {
    ...
    if (!o && e.lineIndent > s && (s = e.lineIndent), oe(u)) {
      l++;
      continue;
    }
    if (e.lineIndent < s) {
      n === Yl ? e.result += wt.repeat(`
`, a ? 1 + l : l) : n === Qa && a && (e.result += `
`);
      break;
    }
    for (i ? qe(u) ? (c = !0, e.result += wt.repeat(`
`, a ? 1 + l : l)) : c ? (c = !1, e.result += wt.repeat(`
`, l + 1)) : l === 0 ? a && (e.result += " ") : e.result += wt.repeat(`
`, l) : e.result += wt.repeat(`
`, a ? 1 + l : l), a = !0, o = !0, l = 0, r = e.position; !oe(u) && u !== 0; )
      u = e.input.charCodeAt(++e.position);
    Ae(e, r, e.position, !1);
  }
  return !0;
...
function Cs(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), !(l !== 45 || (o = e.input.charCodeAt(e.position + 1), !Rt(o)))); ) {
    if (s = !0, e.position++, yt(e, !0, -1) && e.lineIndent <= t) {
      a.push(null), l = e.input.charCodeAt(e.position);
      continue;
    }
    if (r = e.line, cr(e, t, Lu, !1, !0), a.push(e.result), yt(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
p(Cs, "readBlockSequence");
function Hu(e, t, r) {
  var i, n, a, o, s, l, c = e.tag, h = e.anchor, u = {}, f = /* @__PURE__ */ Object.create(null), d = null, g = null, m = null, y = !1, x = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!y && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), i = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Rt(i))
      b === 63 ? (y && (nr(e, u, f, d, g, null, o, s, l), d = g = m = null), x = !0, y = !0, n = !0) : y ? (y = !1, n = !0) : K(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = i;
    else {
      if (o = e.line, s = e.lineStart, l = e.position, !cr(e, r, Bu, !1, !0))
        break;
      if (e.line === a) {
        for (b = e.input.charCodeAt(e.position); qe(b); )
          b = e.input.charCodeAt(++e.position);
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Rt(b) || K(e, "a whitespace character is expected after the key-value separator within a block mapping"), y && (nr(e, u, f, d, g, null, o, s, l), d = g = m = null), x = !0, y = !1, n = !1, d = e.tag, g = e.result;
        else if (x)
    ...
    if ((e.line === a || e.lineIndent > t) && (y && (o = e.line, s = e.lineStart, l = e.position), cr(e, t, Rn, !0, n) && (y ? g = e.result : m = e.result), y || (nr(e, u, f, d, g, m, o, s, l), d = g = m = null), yt(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      K(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return y && nr(e, u, f, d, g, null, o, s, l), x && (e.tag = c, e.anchor = h, e.kind = "mapping", e.result = u), x;
}
p(Hu, "readBlockMapping");
function ju(e) {
  var t, r = !1, i = !1, n, a, o;
  ...
  if (e.tag !== null && K(e, "duplication of a tag property"), o = e.input.charCodeAt(++e.position), o === 60 ? (r = !0, o = e.input.charCodeAt(++e.position)) : o === 33 ? (i = !0, n = "!!", o = e.input.charCodeAt(++e.position)) : n = "!", t = e.position, r) {
    ...
    for (; o !== 0 && !Rt(o); )
      o === 33 && (i ? K(e, "tag suffix cannot contain exclamation marks") : (n = e.input.slice(t - 1, e.position + 1), Au.test(n) || K(e, "named tag handle cannot contain such characters"), i = !0, t = e.position + 1)), o = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), Ky.test(a) && K(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !Mu.test(a) && K(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
    K(e, "tag name is malformed: " + a);
  }
  return r ? e.tag = a : He.call(e.tagMap, n) ? e.tag = e.tagMap[n] + a : n === "!" ? e.tag = "!" + a : n === "!!" ? e.tag = "tag:yaml.org,2002:" + a : K(e, 'undeclared tag handle "' + n + '"'), !0;
}
p(ju, "readTagProperty");
function Uu(e) {
  var t, r;
  if (r = e.input.charCodeAt(e.position), r !== 38) return !1;
  for (e.anchor !== null && K(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Rt(r) && !ir(r); )
...
p(Uu, "readAnchorProperty");
function Yu(e) {
  var t, r, i;
  if (i = e.input.charCodeAt(e.position), i !== 42) return !1;
  for (i = e.input.charCodeAt(++e.position), t = e.position; i !== 0 && !Rt(i) && !ir(i); )
    i = e.input.charCodeAt(++e.position);
  return e.position === t && K(e, "name of an alias node must contain at least one character"), r = e.input.slice(t, e.position), He.call(e.anchorMap, r) || K(e, 'unidentified alias "' + r + '"'), e.result = e.anchorMap[r], yt(e, !0, -1), !0;
}
p(Yu, "readAlias");
function cr(e, t, r, i, n) {
  var a, o, s, l = 1, c = !1, h = !1, u, f, d, g, m, y;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = o = s = Rn === r || Lu === r, i && yt(e, !0, -1) && (c = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; ju(e) || Uu(e); )
      yt(e, !0, -1) ? (c = !0, s = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : s = !1;
  if (s && (s = c || n), (l === 1 || Rn === r) && (Dn === r || Bu === r ? m = t : m = t + 1, y = e.position - e.lineStart, l === 1 ? s && (Cs(e, y) || Hu(e, y, m)) || Wu(e, m) ? h = !0 : (o && qu(e, m) || Nu(e, m) || zu(e, m) ? h = !0 : Yu(e) ? (h = !0, (e.tag !== null || e.anchor !== null) && K(e, "alias node should not have any properties")) : Pu(e, m, Dn === r) && (h = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (h = s && Cs(e, y))), e.tag === null)
...
function Gu(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (o = e.input.charCodeAt(e.position)) !== 0 && (yt(e, !0, -1), o = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || o !== 37)); ) {
    for (a = !0, o = e.input.charCodeAt(++e.position), r = e.position; o !== 0 && !Rt(o); )
      o = e.input.charCodeAt(++e.position);
    ...
    o !== 0 && ma(e), He.call(Gl, i) ? Gl[i](e, i, n) : Ti(e, 'unknown document directive "' + i + '"');
  }
  if (yt(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, yt(e, !0, -1)) : a && K(e, "directives end mark is expected"), cr(e, e.lineIndent - 1, Rn, !1, !0), yt(e, !0, -1), e.checkLineBreaks && Zy.test(e.input.slice(t, e.position)) && Ti(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && zi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new Iu(e, t), i = e.indexOf("\0");
...
var Jy = Xu, tx = {
  load: Jy
}, Vu = Object.prototype.toString, Zu = Object.prototype.hasOwnProperty, vo = 65279, ex = 9, Bi = 10, rx = 13, ix = 32, nx = 33, ax = 34, ks = 35, sx = 37, ox = 38, lx = 39, cx = 42, Ku = 44, hx = 45, In = 58, ux = 61, fx = 62, dx = 63, px = 64, Qu = 91, Ju = 93, gx = 96, tf = 123, mx = 124, ef = 125, Et = {};
Et[0] = "\\0";
Et[7] = "\\a";
Et[8] = "\\b";
Et[9] = "\\t";
...
function rf(e, t) {
  ...
  for (r = {}, i = Object.keys(t), n = 0, a = i.length; n < a; n += 1)
    o = i[n], s = String(t[o]), o.slice(0, 2) === "!!" && (o = "tag:yaml.org,2002:" + o.slice(2)), l = e.compiledTypeMap.fallback[o], l && Zu.call(l.styleAliases, s) && (s = l.styleAliases[s]), r[o] = s;
  return r;
}
p(rf, "compileStyleMap");
function nf(e) {
  var t, r, i;
  ...
  return "\\" + r + wt.repeat("0", i - t.length) + t;
}
p(nf, "encodeHex");
var bx = 1, Li = 2;
function af(e) {
  this.schema = e.schema || Tu, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = wt.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = rf(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Li : bx, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
p(af, "State");
function Ss(e, t) {
  for (var r = wt.repeat(" ", t), i = 0, n = -1, a = "", o, s = e.length; i < s; )
    n = e.indexOf(`
...
function Pn(e, t) {
  return `
` + wt.repeat(" ", e.indent * t);
}
p(Pn, "generateNextLine");
function sf(e, t) {
  var r, i, n;
...
p(Pr, "isPrintable");
function Ts(e) {
  return Pr(e) && e !== vo && e !== rx && e !== Bi;
}
p(Ts, "isNsCharOrWhitespace");
function Bs(e, t, r) {
  var i = Ts(e), n = i && !Ai(e);
  return (
    // ns-plain-safe
    (r ? (
      // c = flow-in
      i
    ) : i && e !== Ku && e !== Qu && e !== Ju && e !== tf && e !== ef) && e !== ks && !(t === In && !n) || Ts(t) && !Ai(t) && e === ks || t === In && n
  );
}
p(Bs, "isPlainSafe");
function of(e) {
  return Pr(e) && e !== vo && !Ai(e) && e !== hx && e !== dx && e !== In && e !== Ku && e !== Qu && e !== Ju && e !== tf && e !== ef && e !== ks && e !== ox && e !== cx && e !== nx && e !== mx && e !== ux && e !== fx && e !== lx && e !== ax && e !== sx && e !== px && e !== gx;
}
p(of, "isPlainSafeFirst");
function lf(e) {
  return !Ai(e) && e !== In;
}
p(lf, "isPlainSafeLast");
function Lr(e, t) {
...
p(_o, "needIndentIndicator");
var cf = 1, Ls = 2, hf = 3, uf = 4, Tr = 5;
function ff(e, t, r, i, n, a, o, s) {
  var l, c = 0, h = null, u = !1, f = !1, d = i !== -1, g = -1, m = of(Lr(e, 0)) && lf(Lr(e, e.length - 1));
  if (t || o)
  ...
  return !u && !f ? m && !o && !n(e) ? cf : a === Li ? Tr : Ls : r > 9 && _o(e) ? Tr : o ? a === Li ? Tr : Ls : f ? uf : hf;
}
p(ff, "chooseScalarStyle");
function df(e, t, r, i, n) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === Li ? '""' : "''";
    if (!e.noCompatMode && (yx.indexOf(t) !== -1 || xx.test(t)))
    ...
    switch (p(l, "testAmbiguity"), ff(
      ...
      case Ls:
        return "'" + t.replace(/'/g, "''") + "'";
      case hf:
        return "|" + As(t, e.indent) + Ms(Ss(t, a));
      case uf:
        return ">" + As(t, e.indent) + Ms(Ss(pf(t, o), a));
      case Tr:
        return '"' + gf(t) + '"';
      default:
...
p(df, "writeScalar");
function As(e, t) {
  var r = _o(e) ? String(t) : "", i = e[e.length - 1] === `
`, n = i && (e[e.length - 2] === `
` || e === `
`), a = n ? "+" : i ? "" : "-";
  return r + a + `
...
p(Ms, "dropEndingNewline");
function pf(e, t) {
  for (var r = /(\n+)([^\n]*)/g, i = function() {
    var c = e.indexOf(`
`);
    return c = c !== -1 ? c : e.length, r.lastIndex = c, Es(e.slice(0, c), t);
  }(), n = e[0] === `
` || e[0] === " ", a, o; o = r.exec(e); ) {
    var s = o[1], l = o[2];
    a = l[0] === " ", i += s + (!n && !a && l !== "" ? `
...
function gf(e) {
  for (var t = "", r = 0, i, n = 0; n < e.length; r >= 65536 ? n += 2 : n++)
    r = Lr(e, n), i = Et[r], !i && Pr(r) ? (t += e[n], r >= 65536 && (t += e[n + 1])) : t += i || nf(r);
  return t;
}
p(gf, "escapeString");
function mf(e, t, r) {
  ...
  for (a = 0, o = r.length; a < o; a += 1)
    s = r[a], e.replacer && (s = e.replacer.call(r, String(a), s)), (xe(e, t, s, !1, !1) || typeof s > "u" && xe(e, t, null, !1, !1)) && (i !== "" && (i += "," + (e.condenseFlow ? "" : " ")), i += e.dump);
  e.tag = n, e.dump = "[" + i + "]";
}
p(mf, "writeFlowSequence");
function $s(e, t, r, i) {
  var n = "", a = e.tag, o, s, l;
  for (o = 0, s = r.length; o < s; o += 1)
    l = r[o], e.replacer && (l = e.replacer.call(r, String(o), l)), (xe(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && xe(e, t + 1, null, !0, !0, !1, !0)) && ((!i || n !== "") && (n += Pn(e, t)), e.dump && Bi === e.dump.charCodeAt(0) ? n += "-" : n += "- ", n += e.dump);
  e.tag = a, e.dump = n || "[]";
}
p($s, "writeBlockSequence");
function yf(e, t, r) {
  var i = "", n = e.tag, a = Object.keys(r), o, s, l, c, h;
  for (o = 0, s = a.length; o < s; o += 1)
    h = "", i !== "" && (h += ", "), e.condenseFlow && (h += '"'), l = a[o], c = r[l], e.replacer && (c = e.replacer.call(r, l, c)), xe(e, t, l, !1, !1) && (e.dump.length > 1024 && (h += "? "), h += e.dump + (e.condenseFlow ? '"' : "") + ":" + (e.condenseFlow ? "" : " "), xe(e, t, c, !1, !1) && (h += e.dump, i += h));
  e.tag = n, e.dump = "{" + i + "}";
}
p(yf, "writeFlowMapping");
function xf(e, t, r, i) {
  ...
  for (s = 0, l = o.length; s < l; s += 1)
    f = "", (!i || n !== "") && (f += Pn(e, t)), c = o[s], h = r[c], e.replacer && (h = e.replacer.call(r, c, h)), xe(e, t + 1, c, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && Bi === e.dump.charCodeAt(0) ? f += "?" : f += "? "), f += e.dump, u && (f += Pn(e, t)), xe(e, t + 1, h, !0, u) && (e.dump && Bi === e.dump.charCodeAt(0) ? f += ":" : f += ": ", f += e.dump, n += f));
  e.tag = a, e.dump = n || "{}";
}
p(xf, "writeBlockMapping");
function Fs(e, t, r) {
  var i, n, a, o, s, l;
...
p(Fs, "detectType");
function xe(e, t, r, i, n, a, o) {
  e.tag = null, e.dump = r, Fs(e, r, !1) || Fs(e, r, !0);
  var s = Vu.call(e.dump), l = i, c;
  ...
  if (h && (u = e.duplicates.indexOf(r), f = u !== -1), (e.tag !== null && e.tag !== "?" || f || e.indent !== 2 && t > 0) && (n = !1), f && e.usedDuplicates[u])
    ...
    if (h && f && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), s === "[object Object]")
      i && Object.keys(e.dump).length !== 0 ? (xf(e, t, e.dump, n), f && (e.dump = "&ref_" + u + e.dump)) : (yf(e, t, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    else if (s === "[object Array]")
      i && e.dump.length !== 0 ? (e.noArrayIndent && !o && t > 0 ? $s(e, t - 1, e.dump, n) : $s(e, t, e.dump, n), f && (e.dump = "&ref_" + u + e.dump)) : (mf(e, t, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    else if (s === "[object String]")
      e.tag !== "?" && df(e, e.dump, t, a, l);
    else {
...
function bf(e, t) {
  var r = [], i = [], n, a;
  for (Nn(e, r, i), n = 0, a = i.length; n < a; n += 1)
    t.duplicates.push(r[i[n]]);
  t.usedDuplicates = new Array(a);
}
p(bf, "getDuplicateReferences");
function Nn(e, t, r) {
  var i, n, a;
...
function wx(e, t) {
  ...
  r.noRefs || bf(e, r);
  var i = e;
  return r.replacer && (i = r.replacer.call({ "": i }, "", i)), xe(r, 0, i, !0, !0) ? r.dump + `
` : "";
}
p(wx, "dump$1");
function vx(e, t) {
...
p(di, "calculateDeltaAndAngle");
var mt = /* @__PURE__ */ p((e) => Array.isArray(e) ? { x: e[0], y: e[1] } : e, "pointTransformer"), kx = /* @__PURE__ */ p((e) => ({
  x: /* @__PURE__ */ p(function(t, r, i) {
    let n = 0;
    const a = mt(i[0]).x < mt(i[i.length - 1]).x ? "left" : "right";
    if (r === 0 && Object.hasOwn(Qt, e.arrowTypeStart)) {
      const { angle: d, deltaX: g } = di(i[0], i[1]);
      n = Qt[e.arrowTypeStart] * Math.cos(d) * (g >= 0 ? 1 : -1);
    } else if (r === i.length - 1 && Object.hasOwn(Qt, e.arrowTypeEnd)) {
      const { angle: d, deltaX: g } = di(
        i[i.length - 1],
        i[i.length - 2]
      );
      n = Qt[e.arrowTypeEnd] * Math.cos(d) * (g >= 0 ? 1 : -1);
    }
    const o = Math.abs(
      mt(t).x - mt(i[i.length - 1]).x
    ), s = Math.abs(
      mt(t).y - mt(i[i.length - 1]).y
    ), l = Math.abs(mt(t).x - mt(i[0]).x), c = Math.abs(mt(t).y - mt(i[0]).y), h = Qt[e.arrowTypeStart], u = Qt[e.arrowTypeEnd], f = 1;
    if (o < u && o > 0 && s < u) {
      let d = u + f - o;
      d *= a === "right" ? -1 : 1, n -= d;
    }
  ...
  y: /* @__PURE__ */ p(function(t, r, i) {
    ...
    if (r === 0 && Object.hasOwn(Qt, e.arrowTypeStart)) {
      const { angle: d, deltaY: g } = di(i[0], i[1]);
      n = Qt[e.arrowTypeStart] * Math.abs(Math.sin(d)) * (g >= 0 ? 1 : -1);
    } else if (r === i.length - 1 && Object.hasOwn(Qt, e.arrowTypeEnd)) {
      const { angle: d, deltaY: g } = di(
        i[i.length - 1],
        i[i.length - 2]
      );
      n = Qt[e.arrowTypeEnd] * Math.abs(Math.sin(d)) * (g >= 0 ? 1 : -1);
    }
    const o = Math.abs(
      mt(t).y - mt(i[i.length - 1]).y
    ), s = Math.abs(
      mt(t).x - mt(i[i.length - 1]).x
    ), l = Math.abs(mt(t).y - mt(i[0]).y), c = Math.abs(mt(t).x - mt(i[0]).x), h = Qt[e.arrowTypeStart], u = Qt[e.arrowTypeEnd], f = 1;
    if (o < u && o > 0 && s < u) {
      let d = u + f - o;
      d *= a === "up" ? -1 : 1, n -= d;
    }
...
const Sx = Object.freeze(
  ...
  if (r && i === "") {
    ...
    return Ja(s, r) ? s : null;
  }
  return null;
}, Ja = (e, t) => e ? !!// Check prefix: cannot be empty, unless allowSimpleName is enabled
...
function Xl(e, t) {
  const r = Mx(e, t);
  for (const i in Tx)
    i in zn ? i in e && !(i in r) && (r[i] = zn[i]) : i in t ? r[i] = t[i] : i in e && (r[i] = e[i]);
  return r;
}
function Ex(e, t) {
...
function Vl(e, t, r) {
  ...
  return o(t), r.forEach(o), Xl(e, a);
}
function $x(e, t) {
  if (e.icons[t])
    return Vl(e, t, []);
  const r = Ex(e, [t])[t];
  return r ? Vl(e, t, r) : null;
}
const Fx = /(-?[0-9.]*[0-9]+[0-9.]*)/g, Ox = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Zl(e, t, r) {
  if (t === 1)
    return e;
...
function Ix(e, t, r) {
  const i = Dx(e);
  return Rx(i.defs, t + i.content + r);
}
const Px = (e) => e === "unset" || e === "undefined" || e === "none";
function Nx(e, t) {
  const r = {
    ...wf,
    ...e
  ...
  [r, i].forEach((m) => {
    ...
    switch (w < 0 && (w -= Math.floor(w / 4) * 4), w = w % 4, w) {
      ...
      case 2:
        ...
        break;
      case 3:
        C = n.width / 2 + n.left, y.unshift(
          "rotate(-90 " + C.toString() + " " + C.toString() + ")"
        );
        break;
    }
    w % 2 === 1 && (n.left !== n.top && (C = n.left, n.left = n.top, n.top = C), n.width !== n.height && (C = n.width, n.width = n.height, n.height = C)), y.length && (a = Ix(
      a,
      '<g transform="' + y.join(" ") + '">',
      "</g>"
    ));
  ...
  let h, u;
  o === null ? (u = s === null ? "1em" : s === "auto" ? c : s, h = Zl(u, l / c)) : (h = o === "auto" ? l : o, u = s === null ? Zl(h, c / l) : s === "auto" ? c : s);
  const f = {}, d = (m, y) => {
    Px(y) || (f[m] = y.toString());
  };
...
const zx = /\sid="(\S+)"/g, Wx = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16);
let qx = 0;
function Hx(e, t = Wx) {
  const r = [];
  let i;
  ...
  return r.forEach((a) => {
    const o = typeof t == "function" ? t(a) : t + (qx++).toString(), s = a.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    e = e.replace(
...
var Ux = {
  ...
  height: 80,
  width: 80
}, Os = /* @__PURE__ */ new Map(), vf = /* @__PURE__ */ new Map(), Yx = /* @__PURE__ */ p((e) => {
  for (const t of e) {
    if (!t.name)
      throw new Error(
...
}, "registerIconPacks"), Gx = /* @__PURE__ */ p(async (e, t) => {
  const r = Ax(e, !0, t !== void 0);
  if (!r)
  ...
  return a;
}, "getRegisteredIconData"), xa = /* @__PURE__ */ p(async (e, t) => {
  let r;
  try {
    r = await Gx(e, t?.fallbackPrefix);
  } catch (a) {
    F.error(a), r = Ux;
  }
  const i = Nx(r, t);
  return jx(Hx(i.body), i.attributes);
}, "getIconSVG"), ni = {}, bt = {}, Kl;
function Xx() {
  return Kl || (Kl = 1, Object.defineProperty(bt, "__esModule", { value: !0 }), bt.BLANK_URL = bt.relativeFirstCharacters = bt.whitespaceEscapeCharsRegex = bt.urlSchemeRegex = bt.ctrlCharactersRegex = bt.htmlCtrlEntityRegex = bt.htmlEntitiesRegex = bt.invalidProtocolRegex = void 0, bt.invalidProtocolRegex = /^([^\w]*)(javascript|data|vbscript)/im, bt.htmlEntitiesRegex = /&#(\w+)(^\w|;)?/g, bt.htmlCtrlEntityRegex = /&(newline|tab);/gi, bt.ctrlCharactersRegex = /[\u0000-\u001F\u007F-\u009F\u2000-\u200D\uFEFF]/gim, bt.urlSchemeRegex = /^.+(:|&colon;)/gim, bt.whitespaceEscapeCharsRegex = /(\\|%5[cC])((%(6[eE]|72|74))|[nrt])/g, bt.relativeFirstCharacters = [".", "/"], bt.BLANK_URL = "about:blank"), bt;
}
var Ql;
function Vx() {
  if (Ql) return ni;
  Ql = 1, Object.defineProperty(ni, "__esModule", { value: !0 }), ni.sanitizeUrl = void 0;
  var e = Xx();
  function t(o) {
...
bn.prototype = _f.prototype = {
  constructor: bn,
  on: function(e, t) {
    var r = this._, i = Qx(e + "", r), n, a = -1, o = i.length;
    if (arguments.length < 2) {
      for (; ++a < o; ) if ((n = (e = i[a]).type) && (n = Jx(r[n], e.name))) return n;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++a < o; )
      if (n = (e = i[a]).type) r[n] = Jl(r[n], e.name, t);
      else if (t == null) for (n in r) r[n] = Jl(r[n], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function Jl(e, t, r) {
  for (var i = 0, n = e.length; i < n; ++i)
    if (e[i].name === t) {
      e[i] = Kx, e = e.slice(0, i).concat(e.slice(i + 1));
      break;
    }
...
function ob(e) {
  typeof e == "function" ? e = sb(e) : e = kf(e);
...
var lb = Array.prototype.find;
function cb(e) {
  return function() {
    return lb.call(this.children, e);
  };
}
function hb() {
...
function ub(e) {
  return this.select(e == null ? hb : cb(typeof e == "function" ? e : Tf(e)));
}
var fb = Array.prototype.filter;
function db() {
  return Array.from(this.children);
}
function pb(e) {
  return function() {
    return fb.call(this.children, e);
  };
}
function gb(e) {
  return this.selectAll(e == null ? db : pb(typeof e == "function" ? e : Tf(e)));
}
function mb(e) {
...
function yb() {
  return new Vt(this._enter || this._groups.map(Bf), this._parents);
}
function Wn(e, t) {
...
function wb(e, t, r, i, n, a, o) {
  ...
  for (s = 0; s < u; ++s)
    d = o.call(e, a[s], s, a) + "", (l = c.get(d)) ? (i[s] = l, l.__data__ = a[s], c.delete(d)) : r[s] = new Wn(e, a[s]);
  for (s = 0; s < h; ++s)
...
function _b(e, t) {
  ...
  var r = t ? wb : bb, i = this._parents, n = this._groups;
  typeof e != "function" && (e = xb(e));
  for (var a = n.length, o = new Array(a), s = new Array(a), l = new Array(a), c = 0; c < a; ++c) {
    var h = i[c], u = n[c], f = u.length, d = Cb(e.call(h, h && h.__data__, c, i)), g = d.length, m = s[c] = new Array(g), y = o[c] = new Array(g), x = l[c] = new Array(f);
    r(h, u, m, y, x, d, t);
    for (var b = 0, w = 0, C, k; b < g; ++b)
      if (C = m[b]) {
        for (b >= w && (w = b + 1); !(k = y[w]) && ++w < g; ) ;
        C._next = k || null;
      }
  }
  return o = new Vt(o, i), o._enter = s, o._exit = l, o;
}
function Cb(e) {
  return typeof e == "object" && "length" in e ? e : Array.from(e);
}
function kb() {
  return new Vt(this._exit || this._groups.map(Bf), this._parents);
}
function Sb(e, t, r) {
...
function Lb(e) {
  ...
  return new Vt(n, this._parents).order();
}
function Ab(e, t) {
...
function qb(e, t) {
  ...
  return this.each((t == null ? r.local ? Ib : Rb : typeof t == "function" ? r.local ? Wb : zb : r.local ? Nb : Pb)(r, t));
}
function Lf(e) {
...
function Yb(e, t, r) {
  return arguments.length > 1 ? this.each((t == null ? Hb : typeof t == "function" ? Ub : jb)(e, t, r ?? "")) : Nr(this.node(), e);
}
function Nr(e, t) {
...
function Zb(e, t) {
  return arguments.length > 1 ? this.each((t == null ? Gb : typeof t == "function" ? Vb : Xb)(e, t)) : this.node()[e];
}
function Af(e) {
...
function Mf(e) {
  this._node = e, this._names = Af(e.getAttribute("class") || "");
}
Mf.prototype = {
  add: function(e) {
...
function Ef(e, t) {
  for (var r = So(e), i = -1, n = t.length; ++i < n; ) r.add(t[i]);
}
function $f(e, t) {
  for (var r = So(e), i = -1, n = t.length; ++i < n; ) r.remove(t[i]);
}
function Kb(e) {
  return function() {
    Ef(this, e);
...
function Jb(e, t) {
  return function() {
    (t.apply(this, arguments) ? Ef : $f)(this, e);
  };
}
function t1(e, t) {
  var r = Af(e + "");
  if (arguments.length < 2) {
    for (var i = So(this.node()), n = -1, a = r.length; ++n < a; ) if (!i.contains(r[n])) return !1;
    return !0;
  }
  return this.each((typeof t == "function" ? Jb : t ? Kb : Qb)(r, t));
}
function e1() {
  this.textContent = "";
}
...
function n1(e) {
  return arguments.length ? this.each(e == null ? e1 : (typeof e == "function" ? i1 : r1)(e)) : this.node().textContent;
}
function a1() {
  this.innerHTML = "";
}
...
function l1(e) {
  return arguments.length ? this.each(e == null ? a1 : (typeof e == "function" ? o1 : s1)(e)) : this.node().innerHTML;
}
function c1() {
...
function g1(e, t) {
  var r = typeof e == "function" ? e : Cf(e), i = t == null ? p1 : typeof t == "function" ? t : ko(t);
  return this.select(function() {
...
function T1(e, t, r) {
  ...
  for (s = t ? S1 : k1, n = 0; n < a; ++n) this.each(s(i[n], t, r));
  return this;
}
function Ff(e, t, r) {
  var i = Lf(e), n = i.CustomEvent;
...
function A1(e, t) {
  return this.each((typeof t == "function" ? L1 : B1)(e, t));
}
function* M1() {
  for (var e = this._groups, t = 0, r = e.length; t < r; ++t)
...
function Wi() {
  return new Vt([[document.documentElement]], Of);
}
function E1() {
  return this;
}
...
function lt(e) {
  return typeof e == "string" ? new Vt([[document.querySelector(e)]], [document.documentElement]) : new Vt([[e]], Of);
}
function To(e, t, r) {
...
var Mi = 0.7, qn = 1 / Mi, Mr = "\\s*([+-]?\\d+)\\s*", Ei = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", me = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", $1 = /^#([0-9a-f]{3,8})$/, F1 = new RegExp(`^rgb\\(${Mr},${Mr},${Mr}\\)$`), O1 = new RegExp(`^rgb\\(${me},${me},${me}\\)$`), D1 = new RegExp(`^rgba\\(${Mr},${Mr},${Mr},${Ei}\\)$`), R1 = new RegExp(`^rgba\\(${me},${me},${me},${Ei}\\)$`), I1 = new RegExp(`^hsl\\(${Ei},${me},${me}\\)$`), P1 = new RegExp(`^hsla\\(${Ei},${me},${me},${Ei}\\)$`), ec = {
  aliceblue: 15792383,
...
function $i(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = $1.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? nc(t) : r === 3 ? new Ut(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? nn(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? nn(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = F1.exec(e)) ? new Ut(t[1], t[2], t[3], 1) : (t = O1.exec(e)) ? new Ut(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = D1.exec(e)) ? nn(t[1], t[2], t[3], t[4]) : (t = R1.exec(e)) ? nn(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = I1.exec(e)) ? oc(t[1], t[2] / 100, t[3] / 100, 1) : (t = P1.exec(e)) ? oc(t[1], t[2] / 100, t[3] / 100, t[4]) : ec.hasOwnProperty(e) ? nc(ec[e]) : e === "transparent" ? new Ut(NaN, NaN, NaN, 0) : null;
}
function nc(e) {
  return new Ut(e >> 16 & 255, e >> 8 & 255, e & 255, 1);
}
function nn(e, t, r, i) {
  return i <= 0 && (e = t = r = NaN), new Ut(e, t, r, i);
}
function W1(e) {
  return e instanceof qi || (e = $i(e)), e ? (e = e.rgb(), new Ut(e.r, e.g, e.b, e.opacity)) : new Ut();
}
function Rs(e, t, r, i) {
  return arguments.length === 1 ? W1(e) : new Ut(e, t, r, i ?? 1);
}
function Ut(e, t, r, i) {
...
To(Ut, Rs, Df(qi, {
  brighter(e) {
    return e = e == null ? qn : Math.pow(qn, e), new Ut(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Mi : Math.pow(Mi, e), new Ut(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new Ut(or(this.r), or(this.g), or(this.b), Hn(this.opacity));
  },
  displayable() {
...
function Rf(e) {
  ...
  if (e instanceof qi || (e = $i(e)), !e) return new se();
  if (e instanceof se) return e;
  e = e.rgb();
  var t = e.r / 255, r = e.g / 255, i = e.b / 255, n = Math.min(t, r, i), a = Math.max(t, r, i), o = NaN, s = a - n, l = (a + n) / 2;
  return s ? (t === a ? o = (r - i) / s + (r < i) * 6 : r === a ? o = (i - t) / s + 2 : o = (t - r) / s + 4, s /= l < 0.5 ? a + n : 2 - a - n, o *= 60) : s = l > 0 && l < 1 ? 0 : o, new se(o, s, l, e.opacity);
}
function H1(e, t, r, i) {
  return arguments.length === 1 ? Rf(e) : new se(e, t, r, i ?? 1);
}
function se(e, t, r, i) {
...
To(se, H1, Df(qi, {
  brighter(e) {
    return e = e == null ? qn : Math.pow(qn, e), new se(this.h, this.s, this.l * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Mi : Math.pow(Mi, e), new se(this.h, this.s, this.l * e, this.opacity);
  },
  rgb() {
    var e = this.h % 360 + (this.h < 0) * 360, t = isNaN(e) || isNaN(this.s) ? 0 : this.s, r = this.l, i = r + (r < 0.5 ? r : 1 - r) * t, n = 2 * r - i;
    return new Ut(
      ts(e >= 240 ? e - 240 : e + 120, n, i),
      ts(e, n, i),
      ts(e < 120 ? e + 240 : e - 120, n, i),
      this.opacity
    );
  },
  clamp() {
    return new se(lc(this.h), an(this.s), an(this.l), Hn(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Hn(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${lc(this.h)}, ${an(this.s) * 100}%, ${an(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function lc(e) {
...
function HL(e, t) {
  var r = t - e;
  return r ? If(e, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : Bo(isNaN(e) ? t : e);
}
function U1(e) {
  return (e = +e) == 1 ? Pf : function(t, r) {
    return r - t ? j1(t, r, e) : Bo(isNaN(t) ? r : t);
  };
}
function Pf(e, t) {
  var r = t - e;
  return r ? If(e, r) : Bo(isNaN(e) ? t : e);
}
const cc = function e(t) {
  var r = U1(t);
  function i(n, a) {
    var o = r((n = Rs(n)).r, (a = Rs(a)).r), s = r(n.g, a.g), l = r(n.b, a.b), c = Pf(n.opacity, a.opacity);
    return function(h) {
...
var Is = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, es = new RegExp(Is.source, "g");
function Y1(e) {
  return function() {
    return e;
  };
...
function X1(e, t) {
  var r = Is.lastIndex = es.lastIndex = 0, i, n, a, o = -1, s = [], l = [];
  for (e = e + "", t = t + ""; (i = Is.exec(e)) && (n = es.exec(t)); )
    (a = n.index) > r && (a = t.slice(r, a), s[o] ? s[o] += a : s[++o] = a), (i = i[0]) === (n = n[0]) ? s[o] ? s[o] += n : s[++o] = n : (s[++o] = null, l.push({ i: o, x: ze(i, n) })), r = es.lastIndex;
  return r < t.length && (a = t.slice(r), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? l[0] ? G1(l[0].x) : Y1(t) : (t = l.length, function(c) {
    for (var h = 0, u; h < t; ++h) s[(u = l[h]).i] = u.x(c);
    return s.join("");
  });
}
var hc = 180 / Math.PI, Ps = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function V1(e) {
  ...
  return t.isIdentity ? Ps : Nf(t.a, t.b, t.c, t.d, t.e, t.f);
}
function Z1(e) {
  return e == null || (sn || (sn = document.createElementNS("http://www.w3.org/2000/svg", "g")), sn.setAttribute("transform", e), !(e = sn.transform.baseVal.consolidate())) ? Ps : (e = e.matrix, Nf(e.a, e.b, e.c, e.d, e.e, e.f));
}
function zf(e, t, r, i) {
  function n(c) {
...
var K1 = zf(V1, "px, ", "px)", "deg)"), Q1 = zf(Z1, ", ", ")", ")"), zr = 0, pi = 0, ai = 0, Wf = 1e3, jn, gi, Un = 0, hr = 0, wa = 0, Fi = typeof performance == "object" && performance.now ? performance : Date, qf = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function Lo() {
  return hr || (qf(J1), hr = Fi.now() + wa);
}
function J1() {
  hr = 0;
}
...
Yn.prototype = Hf.prototype = {
  constructor: Yn,
  restart: function(e, t, r) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    r = (r == null ? Lo() : +r) + (t == null ? 0 : +t), !this._next && gi !== this && (gi ? gi._next = this : jn = this, gi = this), this._call = e, this._time = r, Ns();
  },
  stop: function() {
...
function Ns(e) {
  if (!zr) {
    ...
    var t = e - hr;
    t > 24 ? (e < 1 / 0 && (pi = setTimeout(uc, e - Fi.now() - wa)), ai && (ai = clearInterval(ai))) : (ai || (Un = Fi.now(), ai = setInterval(ew, Wf)), zr = 1, qf(uc));
  }
}
function fc(e, t, r) {
  var i = new Yn();
...
var iw = _f("start", "end", "cancel", "interrupt"), nw = [], jf = 0, dc = 1, zs = 2, wn = 3, pc = 4, Ws = 5, vn = 6;
...
function Ao(e, t) {
  var r = ce(e, t);
  if (r.state > jf) throw new Error("too late; already scheduled");
  return r;
}
function be(e, t) {
  var r = ce(e, t);
  if (r.state > wn) throw new Error("too late; already running");
  return r;
}
function ce(e, t) {
  ...
  function o(c) {
    ...
    for (h in i)
      if (d = i[h], d.name === r.name) {
        if (d.state === wn) return fc(o);
        d.state === pc ? (d.state = vn, d.timer.stop(), d.on.call("interrupt", e, e.__data__, d.index, d.group), delete i[h]) : +h < t && (d.state = vn, d.timer.stop(), d.on.call("cancel", e, e.__data__, d.index, d.group), delete i[h]);
      }
    if (fc(function() {
      r.state === wn && (r.state = pc, r.timer.restart(s, r.delay, r.time), s(c));
    }), r.state = zs, r.on.call("start", e, e.__data__, r.index, r.group), r.state === zs) {
      for (r.state = wn, n = new Array(f = r.tween.length), h = 0, u = -1; h < f; ++h)
        (d = r.tween[h].value.call(e, e.__data__, r.index, r.group)) && (n[++u] = d);
      n.length = u + 1;
    }
  }
  function s(c) {
    for (var h = c < r.duration ? r.ease.call(null, c / r.duration) : (r.timer.restart(l), r.state = Ws, 1), u = -1, f = n.length; ++u < f; )
      n[u].call(e, h);
    r.state === Ws && (r.on.call("end", e, e.__data__, r.index, r.group), l());
  }
  function l() {
    r.state = vn, r.timer.stop(), delete i[t];
...
function sw(e, t) {
  ...
  if (r) {
    ...
    for (o in r) {
      ...
      n = i.state > zs && i.state < Ws, i.state = vn, i.timer.stop(), i.on.call(n ? "interrupt" : "cancel", e, e.__data__, i.index, i.group), delete r[o];
    }
...
function hw(e, t) {
  ...
  if (e += "", arguments.length < 2) {
    for (var i = ce(this.node(), r).tween, n = 0, a = i.length, o; n < a; ++n)
      if ((o = i[n]).name === e)
        return o.value;
    return null;
  }
  return this.each((t == null ? lw : cw)(r, e, t));
}
function Mo(e, t, r) {
  var i = e._id;
...
function Uf(e, t) {
  var r;
  return (typeof t == "number" ? ze : t instanceof $i ? cc : (r = $i(t)) ? (t = r, cc) : X1)(e, t);
}
function uw(e) {
  return function() {
    this.removeAttribute(e);
...
function yw(e, t) {
  var r = ba(e), i = r === "transform" ? Q1 : Uf;
  return this.attrTween(e, typeof t == "function" ? (r.local ? mw : gw)(r, i, Mo(this, "attr." + e, t)) : t == null ? (r.local ? fw : uw)(r) : (r.local ? pw : dw)(r, i, t));
}
function xw(e, t) {
  return function(r) {
...
function _w(e, t) {
  ...
  var i = ba(e);
  return this.tween(r, (i.local ? ww : vw)(i, t));
}
function Cw(e, t) {
  return function() {
...
function Sw(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Cw : kw)(t, e)) : ce(this.node(), t).delay;
}
function Tw(e, t) {
  return function() {
...
function Lw(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Tw : Bw)(t, e)) : ce(this.node(), t).duration;
}
function Aw(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function Mw(e) {
  var t = this._id;
  return arguments.length ? this.each(Aw(t, e)) : ce(this.node(), t).ease;
}
function Ew(e, t) {
  return function() {
    var r = t.apply(this, arguments);
...
function $w(e) {
  ...
  return this.each(Ew(this._id, e));
}
function Fw(e) {
  typeof e != "function" && (e = Sf(e));
  for (var t = this._groups, r = t.length, i = new Array(r), n = 0; n < r; ++n)
...
function Iw(e, t) {
  var r = this._id;
  return arguments.length < 2 ? ce(this.node(), r).on.on(e) : this.each(Rw(r, e, t));
}
function Pw(e) {
  return function() {
...
function Nw() {
  return this.on("end.remove", Pw(this._id));
}
function zw(e) {
  ...
  for (var i = this._groups, n = i.length, a = new Array(n), o = 0; o < n; ++o)
    for (var s = i[o], l = s.length, c = a[o] = new Array(l), h, u, f = 0; f < l; ++f)
      (h = s[f]) && (u = e.call(h, h.__data__, f, s)) && ("__data__" in h && (u.__data__ = h.__data__), c[f] = u, va(c[f], t, r, f, c, ce(h, r)));
  return new Me(a, this._parents, t, r);
}
function Ww(e) {
  var t = this._name, r = this._id;
  ...
  for (var i = this._groups, n = i.length, a = [], o = [], s = 0; s < n; ++s)
    for (var l = i[s], c = l.length, h, u = 0; u < c; ++u)
      if (h = l[u]) {
        for (var f = e.call(h, h.__data__, u, l), d, g = ce(h, r), m = 0, y = f.length; m < y; ++m)
          (d = f[m]) && va(d, t, r, m, f, g);
        a.push(f), o.push(h);
      }
  return new Me(a, o, t, r);
}
var qw = Wi.prototype.constructor;
function Hw() {
...
function jw(e, t) {
  var r, i, n;
  return function() {
    var a = Nr(this, e), o = (this.style.removeProperty(e), Nr(this, e));
...
function Yw(e, t, r) {
  var i, n, a;
  return function() {
    var o = Nr(this, e), s = r(this), l = s + "";
    return s == null && (l = s = (this.style.removeProperty(e), Nr(this, e))), o === l ? null : o === i && l === n ? a : (n = l, a = t(i = o, s));
  };
}
function Gw(e, t) {
  var r, i, n, a = "style." + t, o = "end." + a, s;
  return function() {
    var l = be(this, e), c = l.on, h = l.value[a] == null ? s || (s = Yf(t)) : void 0;
    (c !== r || n !== h) && (i = (r = c).copy()).on(o, n = h), l.on = i;
  };
}
function Xw(e, t, r) {
  var i = (e += "") == "transform" ? K1 : Uf;
  return t == null ? this.styleTween(e, jw(e, i)).on("end.style." + e, Yf(e)) : typeof t == "function" ? this.styleTween(e, Yw(e, i, Mo(this, "style." + e, t))).each(Gw(this._id, e)) : this.styleTween(e, Uw(e, i, t), r).on("end.style." + e, null);
}
function Vw(e, t, r) {
  return function(i) {
...
function t2(e) {
  return this.tween("text", typeof e == "function" ? Jw(Mo(this, "text", e)) : Qw(e == null ? "" : e + ""));
}
function e2(e) {
  return function(t) {
...
function n2() {
  for (var e = this._name, t = this._id, r = Gf(), i = this._groups, n = i.length, a = 0; a < n; ++a)
...
function h2(e) {
  var t, r;
  e instanceof Me ? (t = e._id, e = e._name) : (t = Gf(), (r = l2).time = Lo(), e = e == null ? null : e + "");
  for (var i = this._groups, n = i.length, a = 0; a < n; ++a)
    for (var o = i[a], s = o.length, l, c = 0; c < s; ++c)
      (l = o[c]) && va(l, e, t, c, o, r || c2(l, t));
  return new Me(i, this._parents, e, t);
}
Wi.prototype.interrupt = ow;
Wi.prototype.transition = h2;
const qs = Math.PI, Hs = 2 * qs, Je = 1e-6, u2 = Hs - Je;
function Xf(e) {
  this._ += e[0];
...
class d2 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? Xf : f2(t);
  }
  moveTo(t, r) {
  ...
  arcTo(t, r, i, n, a) {
    ...
    if (this._x1 === null)
      ...
      let d = i - o, g = n - s, m = l * l + c * c, y = d * d + g * g, x = Math.sqrt(m), b = Math.sqrt(f), w = a * Math.tan((qs - Math.acos((m + f - y) / (2 * x * b))) / 2), C = w / b, k = w / x;
      Math.abs(C - 1) > Je && this._append`L${t + C * h},${r + C * u}`, this._append`A${a},${a},0,0,${+(u * d > h * g)},${this._x1 = t + k * l},${this._y1 = r + k * c}`;
    }
  }
  arc(t, r, i, n, a, o) {
    if (t = +t, r = +r, i = +i, o = !!o, i < 0) throw new Error(`negative radius: ${i}`);
    let s = i * Math.cos(n), l = i * Math.sin(n), c = t + s, h = r + l, u = 1 ^ o, f = o ? n - a : a - n;
    this._x1 === null ? this._append`M${c},${h}` : (Math.abs(this._x1 - c) > Je || Math.abs(this._y1 - h) > Je) && this._append`L${c},${h}`, i && (f < 0 && (f = f % Hs + Hs), f > u2 ? this._append`A${i},${i},0,1,${u},${t - s},${r - l}A${i},${i},0,1,${u},${this._x1 = c},${this._y1 = h}` : f > Je && this._append`A${i},${i},0,${+(f >= qs)},${u},${this._x1 = t + i * Math.cos(a)},${this._y1 = r + i * Math.sin(a)}`);
  }
  rect(t, r, i, n) {
...
const jL = Math.abs, UL = Math.atan2, YL = Math.cos, GL = Math.max, XL = Math.min, VL = Math.sin, ZL = Math.sqrt, gc = 1e-12, Eo = Math.PI, mc = Eo / 2, KL = 2 * Eo;
function QL(e) {
  return e > 1 ? 0 : e < -1 ? Eo : Math.acos(e);
}
function JL(e) {
...
function x2(e, t) {
  var r = kr(!0), i = null, n = Gn, a = null, o = p2(s);
  e = typeof e == "function" ? e : e === void 0 ? m2 : kr(e), t = typeof t == "function" ? t : t === void 0 ? y2 : kr(t);
  function s(l) {
    var c, h = (l = g2(l)).length, u, f = !1, d;
  ...
  return s.x = function(l) {
    return arguments.length ? (e = typeof l == "function" ? l : kr(+l), s) : e;
  }, s.y = function(l) {
    return arguments.length ? (t = typeof l == "function" ? l : kr(+l), s) : t;
  }, s.defined = function(l) {
    return arguments.length ? (r = typeof l == "function" ? l : kr(!!l), s) : r;
  }, s.curve = function(l) {
...
function ed(e, t) {
  this._basis = new _a(e), this._beta = t;
}
ed.prototype = {
  lineStart: function() {
...
const v2 = function e(t) {
  function r(i) {
    return t === 1 ? new _a(i) : new ed(i, t);
  }
...
const k2 = function e(t) {
  function r(i) {
    return t ? new ad(i, t) : new Fo(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
const S2 = function e(t) {
  function r(i) {
    return t ? new sd(i, t) : new Oo(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        rs(this, this._t0, bc(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, rs(this, bc(this, r = xc(this, e, t)), r);
          break;
        default:
          rs(this, this._t0, r = xc(this, e, t));
          break;
      }
...
function ld(e) {
  this._context = new cd(e);
}
(ld.prototype = Object.create(Zn.prototype)).point = function(e, t) {
...
mi.prototype;
var yd = typeof global == "object" && global && global.Object === Object && global, B2 = typeof self == "object" && self && self.Object === Object && self, we = yd || B2 || Function("return this")(), Kn = we.Symbol, xd = Object.prototype, L2 = xd.hasOwnProperty, A2 = xd.toString, si = Kn ? Kn.toStringTag : void 0;
function M2(e) {
  var t = L2.call(e, si), r = e[si];
  try {
    e[si] = void 0;
    var i = !0;
  } catch {
  ...
  var n = A2.call(e);
  return i && (t ? e[si] = r : delete e[si]), n;
}
var E2 = Object.prototype, $2 = E2.toString;
function F2(e) {
  return $2.call(e);
}
var O2 = "[object Null]", D2 = "[object Undefined]", vc = Kn ? Kn.toStringTag : void 0;
function Ur(e) {
  return e == null ? e === void 0 ? D2 : O2 : vc && vc in Object(e) ? M2(e) : F2(e);
}
function pr(e) {
  var t = typeof e;
  return e != null && (t == "object" || t == "function");
}
var R2 = "[object AsyncFunction]", I2 = "[object Function]", P2 = "[object GeneratorFunction]", N2 = "[object Proxy]";
function Ro(e) {
  if (!pr(e))
    return !1;
  var t = Ur(e);
  return t == I2 || t == P2 || t == R2 || t == N2;
}
var is = we["__core-js_shared__"], _c = function() {
...
var W2 = Function.prototype, q2 = W2.toString;
function gr(e) {
  if (e != null) {
    try {
      return q2.call(e);
...
var H2 = /[\\^$.*+?()[\]{}|]/g, j2 = /^\[object .+?Constructor\]$/, U2 = Function.prototype, Y2 = Object.prototype, G2 = U2.toString, X2 = Y2.hasOwnProperty, V2 = RegExp(
  "^" + G2.call(X2).replace(H2, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Z2(e) {
  if (!pr(e) || z2(e))
    return !1;
...
var tv = "__lodash_hash_undefined__", ev = Object.prototype, rv = ev.hasOwnProperty;
function iv(e) {
  var t = this.__data__;
  if (Oi) {
    var r = t[e];
...
var nv = Object.prototype, av = nv.hasOwnProperty;
function sv(e) {
  var t = this.__data__;
  return Oi ? t[e] !== void 0 : av.call(t, e);
}
var ov = "__lodash_hash_undefined__";
function lv(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = Oi && t === void 0 ? ov : t, this;
}
function ur(e) {
...
ur.prototype.clear = Q2;
ur.prototype.delete = J2;
ur.prototype.get = iv;
ur.prototype.has = sv;
ur.prototype.set = lv;
function cv() {
...
var hv = Array.prototype, uv = hv.splice;
function fv(e) {
  var t = this.__data__, r = Sa(t, e);
  if (r < 0)
    return !1;
  var i = t.length - 1;
  return r == i ? t.pop() : uv.call(t, r, 1), --this.size, !0;
}
function dv(e) {
  var t = this.__data__, r = Sa(t, e);
...
Fe.prototype.clear = cv;
Fe.prototype.delete = fv;
Fe.prototype.get = dv;
Fe.prototype.has = pv;
Fe.prototype.set = gv;
var Di = mr(we, "Map");
...
Xe.prototype.clear = mv;
Xe.prototype.delete = xv;
Xe.prototype.get = bv;
Xe.prototype.has = wv;
Xe.prototype.set = vv;
...
function Hi(e, t) {
  ...
  return r.cache = new (Hi.Cache || Xe)(), r;
}
Hi.Cache = Xe;
function Cv() {
...
function js(e, t, r) {
  (r !== void 0 && !ka(e[t], r) || r === void 0 && !(t in e)) && Io(e, t, r);
}
function Av(e) {
...
var Mv = Av(), bd = typeof exports == "object" && exports && !exports.nodeType && exports, Cc = bd && typeof module == "object" && module && !module.nodeType && module, Ev = Cc && Cc.exports === bd, kc = Ev ? we.Buffer : void 0, Sc = kc ? kc.allocUnsafe : void 0;
function $v(e, t) {
  if (t)
    return e.slice();
  var r = e.length, i = Sc ? Sc(r) : new e.constructor(r);
  return e.copy(i), i;
}
var Tc = we.Uint8Array;
function Fv(e) {
...
var Bc = Object.create, Rv = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!pr(t))
...
var vd = wd(Object.getPrototypeOf, Object), Iv = Object.prototype;
function Ba(e) {
  var t = e && e.constructor, r = typeof t == "function" && t.prototype || Iv;
  return e === r;
}
function Pv(e) {
  return typeof e.constructor == "function" && !Ba(e) ? Rv(vd(e)) : {};
}
function ji(e) {
...
var _d = Object.prototype, zv = _d.hasOwnProperty, Wv = _d.propertyIsEnumerable, Jn = Lc(/* @__PURE__ */ function() {
  return arguments;
}()) ? Lc : function(e) {
  return ji(e) && zv.call(e, "callee") && !Wv.call(e, "callee");
}, ta = Array.isArray, qv = 9007199254740991;
function Cd(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= qv;
}
function La(e) {
  return e != null && Cd(e.length) && !Ro(e);
}
function Hv(e) {
  return ji(e) && La(e);
}
...
var kd = typeof exports == "object" && exports && !exports.nodeType && exports, Ac = kd && typeof module == "object" && module && !module.nodeType && module, Uv = Ac && Ac.exports === kd, Mc = Uv ? we.Buffer : void 0, Yv = Mc ? Mc.isBuffer : void 0, Po = Yv || jv, Gv = "[object Object]", Xv = Function.prototype, Vv = Object.prototype, Sd = Xv.toString, Zv = Vv.hasOwnProperty, Kv = Sd.call(Object);
function Qv(e) {
  if (!ji(e) || Ur(e) != Gv)
    return !1;
  var t = vd(e);
  ...
  return typeof r == "function" && r instanceof r && Sd.call(r) == Kv;
}
var Jv = "[object Arguments]", t_ = "[object Array]", e_ = "[object Boolean]", r_ = "[object Date]", i_ = "[object Error]", n_ = "[object Function]", a_ = "[object Map]", s_ = "[object Number]", o_ = "[object Object]", l_ = "[object RegExp]", c_ = "[object Set]", h_ = "[object String]", u_ = "[object WeakMap]", f_ = "[object ArrayBuffer]", d_ = "[object DataView]", p_ = "[object Float32Array]", g_ = "[object Float64Array]", m_ = "[object Int8Array]", y_ = "[object Int16Array]", x_ = "[object Int32Array]", b_ = "[object Uint8Array]", w_ = "[object Uint8ClampedArray]", v_ = "[object Uint16Array]", __ = "[object Uint32Array]", pt = {};
pt[p_] = pt[g_] = pt[m_] = pt[y_] = pt[x_] = pt[b_] = pt[w_] = pt[v_] = pt[__] = !0;
pt[Jv] = pt[t_] = pt[f_] = pt[e_] = pt[d_] = pt[r_] = pt[i_] = pt[n_] = pt[a_] = pt[s_] = pt[o_] = pt[l_] = pt[c_] = pt[h_] = pt[u_] = !1;
function C_(e) {
  return ji(e) && Cd(e.length) && !!pt[Ur(e)];
}
function k_(e) {
  return function(t) {
    return e(t);
...
var Td = typeof exports == "object" && exports && !exports.nodeType && exports, ki = Td && typeof module == "object" && module && !module.nodeType && module, S_ = ki && ki.exports === Td, ns = S_ && yd.process, Ec = function() {
  try {
    var e = ki && ki.require && ki.require("util").types;
    return e || ns && ns.binding && ns.binding("util");
  } catch {
  }
}(), $c = Ec && Ec.isTypedArray, No = $c ? k_($c) : C_;
function Us(e, t) {
  if (!(t === "constructor" && typeof e[t] == "function") && t != "__proto__")
    return e[t];
}
var T_ = Object.prototype, B_ = T_.hasOwnProperty;
function L_(e, t, r) {
  var i = e[t];
  (!(B_.call(e, t) && ka(i, r)) || r === void 0 && !(t in e)) && Io(e, t, r);
}
function A_(e, t, r, i) {
  var n = !r;
  r || (r = {});
  for (var a = -1, o = t.length; ++a < o; ) {
    var s = t[a], l = void 0;
    l === void 0 && (l = e[s]), n ? Io(r, s, l) : L_(r, s, l);
  }
  return r;
}
function M_(e, t) {
...
var E_ = 9007199254740991, $_ = /^(?:0|[1-9]\d*)$/;
function Bd(e, t) {
  var r = typeof e;
  return t = t ?? E_, !!t && (r == "number" || r != "symbol" && $_.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var F_ = Object.prototype, O_ = F_.hasOwnProperty;
function D_(e, t) {
  var r = ta(e), i = !r && Jn(e), n = !r && !i && Po(e), a = !r && !i && !n && No(e), o = r || i || n || a, s = o ? M_(e.length, String) : [], l = s.length;
  for (var c in e)
    (t || O_.call(e, c)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var I_ = Object.prototype, P_ = I_.hasOwnProperty;
function N_(e) {
  if (!pr(e))
    return R_(e);
  var t = Ba(e), r = [];
  for (var i in e)
    i == "constructor" && (t || !P_.call(e, i)) || r.push(i);
  return r;
}
function Ld(e) {
  return La(e) ? D_(e, !0) : N_(e);
}
function z_(e) {
  return A_(e, Ld(e));
}
function W_(e, t, r, i, n, a, o) {
  var s = Us(e, r), l = Us(t, r), c = o.get(l);
  if (c) {
    js(e, r, c);
    return;
  }
  ...
  if (u) {
    var f = ta(l), d = !f && Po(l), g = !f && !d && No(l);
    h = l, f || d || g ? ta(s) ? h = s : Hv(s) ? h = Dv(s) : d ? (u = !1, h = $v(l, !0)) : g ? (u = !1, h = Ov(l, !0)) : h = [] : Qv(l) || Jn(l) ? (h = s, Jn(s) ? h = z_(s) : (!pr(s) || Ro(s)) && (h = Pv(l))) : u = !1;
  }
  u && (o.set(l, h), n(h, l, i, a, o), o.delete(l)), js(e, r, h);
}
function Ad(e, t, r, i, n) {
  e !== t && Mv(t, function(a, o) {
    if (n || (n = new Yr()), pr(a))
      W_(e, t, o, r, Ad, i, n);
    else {
      var s = i ? i(Us(e, o), a, o + "", e, t, n) : void 0;
...
function H_(e, t, r) {
  return t = Fc(t === void 0 ? e.length - 1 : t, 0), function() {
    for (var i = arguments, n = -1, a = Fc(i.length - t, 0), o = Array(a); ++n < a; )
      o[n] = i[t + n];
    n = -1;
    for (var s = Array(t + 1); ++n < t; )
      s[n] = i[n];
    return s[t] = r(o), q_(e, this, s);
  };
}
function j_(e) {
  return function() {
...
var Z_ = V_(U_);
function K_(e, t) {
  return Z_(H_(e, t, Md), e + "");
}
function Q_(e, t, r) {
  if (!pr(r))
    return !1;
  var i = typeof t;
  return (i == "number" ? La(r) && Bd(t, r.length) : i == "string" && t in r) ? ka(r[t], e) : !1;
}
function J_(e) {
  return K_(function(t, r) {
    var i = -1, n = r.length, a = n > 1 ? r[n - 1] : void 0, o = n > 2 ? r[2] : void 0;
    for (a = e.length > 3 && typeof a == "function" ? (n--, a) : void 0, o && Q_(r[0], r[1], o) && (a = n < 3 ? void 0 : a, n = 1), t = Object(t); ++i < n; ) {
      var s = r[i];
      s && e(t, s, i, a);
    }
    return t;
...
var tC = J_(function(e, t, r) {
  ...
  curveBumpY: Qf,
  curveBundle: v2,
  curveCardinalClosed: _2,
  curveCardinalOpen: C2,
  curveCardinal: rd,
  curveCatmullRomClosed: k2,
  curveCatmullRomOpen: S2,
  curveCatmullRom: nd,
  curveLinear: Gn,
  curveLinearClosed: T2,
  curveMonotoneX: hd,
  curveMonotoneY: ud,
  curveNatural: dd,
  curveStep: pd,
  curveStepAfter: md,
  curveStepBefore: gd
}, iC = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, nC = /* @__PURE__ */ p(function(e, t) {
  const r = Ed(e, /(?:init\b)|(?:initialize\b)/);
  let i = {};
  if (Array.isArray(r)) {
...
}, "detectInit"), Ed = /* @__PURE__ */ p(function(e, t = null) {
  try {
    const r = new RegExp(
      `[%]{2}(?![{]${iC.source})(?=[}][%]{2}).*
`,
    ...
    let i;
    const n = [];
    for (; (i = _i.exec(e)) !== null; )
      if (i.index === _i.lastIndex && _i.lastIndex++, i && !t || t && i[1]?.match(t) || t && i[2]?.match(t)) {
...
}, "detectDirective"), aC = /* @__PURE__ */ p(function(e) {
  return e.replace(_i, "");
...
p(zo, "interpolateToCurve");
function $d(e, t) {
  const r = e.trim();
  if (r)
    return t.securityLevel !== "loose" ? Zx.sanitizeUrl(r) : r;
}
p($d, "formatUrl");
...
p(Fd, "traverseEdge");
function Od(e) {
  return e.length === 1 ? e[0] : Fd(e);
}
p(Od, "calcLabelPosition");
var Oc = /* @__PURE__ */ p((e, t = 2) => {
  const r = Math.pow(10, t);
  return Math.round(e * r) / r;
}, "roundNumber"), qo = /* @__PURE__ */ p((e, t) => {
  let r, i = t;
  for (const n of e) {
    if (r) {
      const a = Wo(n, r);
      ...
      if (a < i)
        ...
        if (o > 0 && o < 1)
          return {
            x: Oc((1 - o) * r.x + o * n.x, 5),
            y: Oc((1 - o) * r.y + o * n.y, 5)
          };
      }
    }
    r = n;
...
}, "calculatePoint"), lC = /* @__PURE__ */ p((e, t, r) => {
  F.info(`our points ${JSON.stringify(t)}`), t[0] !== r && (t = t.reverse());
  const n = qo(t, 25), a = e ? 10 : 5, o = Math.atan2(t[0].y - n.y, t[0].x - n.x), s = { x: 0, y: 0 };
...
function Dd(e, t, r) {
  ...
  const n = 25 + e, a = qo(i, n), o = 10 + e * 0.5, s = Math.atan2(i[0].y - a.y, i[0].x - a.x), l = { x: 0, y: 0 };
  return t === "start_left" ? (l.x = Math.sin(s + Math.PI) * o + (i[0].x + a.x) / 2, l.y = -Math.cos(s + Math.PI) * o + (i[0].y + a.y) / 2) : t === "end_right" ? (l.x = Math.sin(s - Math.PI) * o + (i[0].x + a.x) / 2 - 5, l.y = -Math.cos(s - Math.PI) * o + (i[0].y + a.y) / 2 - 5) : t === "end_left" ? (l.x = Math.sin(s) * o + (i[0].x + a.x) / 2 - 5, l.y = -Math.cos(s) * o + (i[0].y + a.y) / 2 - 5) : (l.x = Math.sin(s) * o + (i[0].x + a.x) / 2, l.y = -Math.cos(s) * o + (i[0].y + a.y) / 2), l;
}
p(Dd, "calcTerminalLabelPosition");
function Rd(e) {
  let t = "", r = "";
  for (const i of e)
...
p(Rd, "getStylesFromArray");
var Dc = 0, cC = /* @__PURE__ */ p(() => (Dc++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Dc), "generateId");
function Id(e) {
  let t = "";
...
p(Id, "makeRandomHex");
var hC = /* @__PURE__ */ p((e) => Id(e.length), "random"), uC = /* @__PURE__ */ p(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
}, "getTextObj"), fC = /* @__PURE__ */ p(function(e, t) {
  const r = t.text.replace(jr.lineBreakRegex, " "), [, i] = Aa(t.fontSize), n = e.append("text");
  ...
  (e, t, r) => {
    ...
    return i.forEach((o, s) => {
      const l = Ee(`${o} `, r), c = Ee(a, r);
      if (l > t) {
        const { hyphenatedStrings: f, remainingWord: d } = pC(o, t, "-", r);
        n.push(a, ...f), a = d;
...
function Pd(e, t) {
  return Ho(e, t).height;
}
p(Pd, "calculateTextHeight");
function Ee(e, t) {
  return Ho(e, t).width;
}
...
var Ho = Hi(
  (e, t) => {
    ...
    const [, a] = Aa(r), o = ["sans-serif", i], s = e.split(jr.lineBreakRegex), l = [], c = lt("body");
    if (!c.remove)
    ...
    for (const f of o) {
      ...
      for (const m of s) {
        const y = uC();
        y.text = m || eC;
        const x = fC(h, y).style("font-size", a).style("font-weight", n).style("font-family", f), b = (x._groups || x)[0][0].getBBox();
...
}, on, mC = /* @__PURE__ */ p(function(e) {
  return on = on || document.createElement("div"), e = escape(e).replace(/%26/g, "&").replace(/%23/g, "#").replace(/%3B/g, ";"), on.innerHTML = e, unescape(on.textContent);
}, "entityDecode");
function jo(e) {
  return "str" in e;
}
p(jo, "isDetailedError");
...
var ge = {
  assignWithDepth: Bt,
  wrapLabel: dC,
  calculateTextHeight: Pd,
  calculateTextWidth: Ee,
  calculateTextDimensions: Ho,
  cleanAndMerge: Uo,
  detectInit: nC,
  detectDirective: Ed,
  isSubstringInArray: sC,
  interpolateToCurve: zo,
  calcLabelPosition: Od,
  calcCardinalityPosition: lC,
  calcTerminalLabelPosition: Dd,
  formatUrl: $d,
  getStylesFromArray: Rd,
  generateId: cC,
  random: hC,
  runFunc: oC,
  entityDecode: mC,
...
}, "encodeEntities"), yr = /* @__PURE__ */ p(function(e) {
  return e.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities"), tA = /* @__PURE__ */ p((e, t, {
  counter: r = 0,
  prefix: i,
  suffix: n
...
function ft(e, t = "") {
  ...
  const i = {
    replace: (n, a) => {
      ...
      return o = o.replace(It.caret, "$1"), r = r.replace(n, o), i;
    },
...
const It = {
...
}, bC = /^(?:[ \t]*(?:\n|$))+/, wC = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, vC = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, Ui = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, _C = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, Go = /(?:[*+-]|\d{1,9}[.)])/, zd = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Wd = ft(zd).replace(/bull/g, Go).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), CC = ft(zd).replace(/bull/g, Go).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), Xo = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, kC = /^[^\n]+/, Vo = /(?!\s*\])(?:\\.|[^\[\]\\])+/, SC = ft(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", Vo).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), TC = ft(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, Go).getRegex(), Ma = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", Zo = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, BC = ft("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", Zo).replace("tag", Ma).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), qd = ft(Xo).replace("hr", Ui).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Ma).getRegex(), LC = ft(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", qd).getRegex(), Ko = {
  blockquote: LC,
  code: wC,
  def: SC,
  fences: vC,
  ...
  table: Si,
  text: kC
}, Rc = ft("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Ui).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Ma).getRegex(), AC = {
  ...Ko,
  lheading: CC,
  table: Rc,
  paragraph: ft(Xo).replace("hr", Ui).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Rc).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Ma).getRegex()
}, MC = {
  ...Ko,
  html: ft(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", Zo).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),
  def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,
  heading: /^(#{1,6})(.*)(?:\n+|$)/,
  fences: Si,
  // fences not supported
  lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
  paragraph: ft(Xo).replace("hr", Ui).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", Wd).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex()
}, EC = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, $C = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Hd = /^( {2,}|\\)\n(?!\s*$)/, FC = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, Ea = /[\p{P}\p{S}]/u, Qo = /[\s\p{P}\p{S}]/u, jd = /[^\s\p{P}\p{S}]/u, OC = ft(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, Qo).getRegex(), Ud = /(?!~)[\p{P}\p{S}]/u, DC = /(?!~)[\s\p{P}\p{S}]/u, RC = /(?:[^\s\p{P}\p{S}]|~)/u, IC = /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g, Yd = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, PC = ft(Yd, "u").replace(/punct/g, Ea).getRegex(), NC = ft(Yd, "u").replace(/punct/g, Ud).getRegex(), Gd = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", zC = ft(Gd, "gu").replace(/notPunctSpace/g, jd).replace(/punctSpace/g, Qo).replace(/punct/g, Ea).getRegex(), WC = ft(Gd, "gu").replace(/notPunctSpace/g, RC).replace(/punctSpace/g, DC).replace(/punct/g, Ud).getRegex(), qC = ft("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, jd).replace(/punctSpace/g, Qo).replace(/punct/g, Ea).getRegex(), HC = ft(/\\(punct)/, "gu").replace(/punct/g, Ea).getRegex(), jC = ft(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), UC = ft(Zo).replace("(?:-->|$)", "-->").getRegex(), YC = ft("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", UC).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), ea = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, GC = ft(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", ea).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), Xd = ft(/^!?\[(label)\]\[(ref)\]/).replace("label", ea).replace("ref", Vo).getRegex(), Vd = ft(/^!?\[(ref)\](?:\[\])?/).replace("ref", Vo).getRegex(), XC = ft("reflink|nolink(?!\\()", "g").replace("reflink", Xd).replace("nolink", Vd).getRegex(), Jo = {
  _backpedal: Si,
  ...
  ...Jo,
  link: ft(/^!?\[(label)\]\((.*?)\)/).replace("label", ea).getRegex(),
  reflink: ft(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", ea).getRegex()
}, Ys = {
  ...Jo,
  ...
  ...Ys,
  br: ft(Hd).replace("{2,}", "*").getRegex(),
  text: ft(Ys.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
}, ln = {
  normal: Ko,
  gfm: AC,
  pedantic: MC
...
function fe(e, t) {
  if (t) {
    if (It.escapeTest.test(e))
      return e.replace(It.escapeReplace, Ic);
  } else if (It.escapeTestNoEncode.test(e))
    return e.replace(It.escapeReplaceNoEncode, Ic);
  return e;
}
function Pc(e) {
  try {
...
function Nc(e, t) {
  const r = e.replace(It.findPipe, (a, o, s) => {
    let l = !1, c = o;
    for (; --c >= 0 && s[c] === "\\"; )
      l = !l;
    return l ? "|" : " |";
  }), i = r.split(It.splitPipe);
  let n = 0;
  if (i[0].trim() || i.shift(), i.length > 0 && !i.at(-1)?.trim() && i.pop(), t)
    if (i.length > t)
      ...
      for (; i.length < t; )
        i.push("");
  for (; n < i.length; n++)
    i[n] = i[n].trim().replace(It.slashPipe, "|");
  return i;
}
function li(e, t, r) {
  const i = e.length;
  ...
  code(t) {
    ...
    if (r) {
      ...
      return {
        ...
        text: this.options.pedantic ? i : li(i, `
`)
      };
    }
  }
  fences(t) {
    ...
    if (r) {
      const i = r[0], n = JC(i, r[3] || "", this.rules);
      return {
        type: "code",
        raw: i,
...
` + i.join(`
`), y = this.list(m);
          o[o.length - 1] = y, n = n.substring(0, n.length - d.raw.length) + y.raw, a = a.substring(0, a.length - g.raw.length) + y.raw, i = m.substring(o.at(-1).raw.length).split(`
`);
          continue;
        }
      }
...
`, t = t.substring(d.length + 1), c = !0), !c) {
          const b = this.rules.other.nextBulletRegex(m), w = this.rules.other.hrRegex(m), C = this.rules.other.fencesBeginRegex(m), k = this.rules.other.headingBeginRegex(m), L = this.rules.other.htmlBeginRegex(m);
          for (; t; ) {
            const S = t.split(`
`, 1)[0];
            let D;
            if (d = S, this.options.pedantic ? (d = d.replace(this.rules.other.listReplaceNesting, "  "), D = d) : D = d.replace(this.rules.other.tabCharGlobal, "    "), C.test(d) || k.test(d) || L.test(d) || b.test(d) || w.test(d))
              break;
            if (D.search(this.rules.other.nonSpaceChar) >= m || !d.trim())
              u += `
` + D.slice(m);
            else {
              if (g || f.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || C.test(f) || k.test(f) || w.test(f))
                break;
              u += `
` + d;
            }
...
`, t = t.substring(S.length + 1), f = D.slice(m);
  ...
  table(t) {
    ...
    if (!r || !this.rules.other.tableDelimiter.test(r[2]))
      return;
    const i = Nc(r[1]), n = r[2].replace(this.rules.other.tableAlignChars, "").split("|"), a = r[3]?.trim() ? r[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], o = {
      type: "table",
      raw: r[0],
      header: [],
    ...
    if (i.length === n.length) {
      ...
      for (const s of a)
        o.rows.push(Nc(s, o.header.length).map((l, c) => ({
          text: l,
  ...
  link(t) {
    ...
    if (r) {
      ...
      if (this.options.pedantic) {
        ...
        a = r[3] ? r[3].slice(1, -1) : "";
      return n = n.trim(), this.rules.other.startAngleBracket.test(n) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(i) ? n = n.slice(1) : n = n.slice(1, -1)), zc(r, {
    ...
    if (!(n[1] || n[2] || "") || !i || this.rules.inline.punctuation.exec(i)) {
      ...
      for (u.lastIndex = 0, r = r.slice(-1 * t.length + o); (n = u.exec(r)) != null; ) {
        ...
        if (c -= l, c > 0)
          continue;
        l = Math.min(l, l + c + h);
        const f = [...n[0]][0].length, d = t.slice(0, o + n.index + f + l);
        if (Math.min(o, l) % 2) {
          const m = d.slice(1, -1);
          return {
            type: "em",
...
class Jt {
  ...
  inlineQueue;
  constructor(t) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = t || xr, this.options.tokenizer = this.options.tokenizer || new ra(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: !1,
      inRawBlock: !1,
      top: !0
    };
    ...
    this.options.pedantic ? (r.block = ln.pedantic, r.inline = oi.pedantic) : this.options.gfm && (r.block = ln.gfm, this.options.breaks ? r.inline = oi.breaks : r.inline = oi.gfm), this.tokenizer.rules = r;
  }
  /**
   * Expose Rules
   */
   ...
   */
  static lex(t, r) {
    return new Jt(r).lex(t);
  }
  /**
   * Static Lex Inline Method
   */
  static lexInline(t, r) {
    return new Jt(r).inlineTokens(t);
  }
  /**
   * Preprocessing
   */
...
`), this.blockTokens(t, this.tokens);
  ...
  blockTokens(t, r = [], i = !1) {
    for (this.options.pedantic && (t = t.replace(It.tabCharGlobal, "    ").replace(It.spaceLine, "")); t; ) {
      let n;
      if (this.options.extensions?.block?.some((o) => (n = o.call({ lexer: this }, t, r)) ? (t = t.substring(n.raw.length), r.push(n), !0) : !1))
        continue;
...
` + n.raw, this.inlineQueue.at(-1).src = o.text) : this.tokens.links[n.tag] || (this.tokens.links[n.tag] = {
      ...
      if (this.options.extensions?.startBlock) {
        ...
        this.options.extensions.startBlock.forEach((c) => {
          l = c.call({ lexer: this }, s), typeof l == "number" && l >= 0 && (o = Math.min(o, l));
        }), o < 1 / 0 && o >= 0 && (a = t.substring(0, o + 1));
      }
      if (this.state.top && (n = this.tokenizer.paragraph(a))) {
        const o = r.at(-1);
        i && o?.type === "paragraph" ? (o.raw += `
` + n.raw, o.text += `
` + n.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : r.push(n), i = a.length !== t.length, t = t.substring(n.raw.length);
        continue;
      }
...
` + n.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : r.push(n);
  ...
  inlineTokens(t, r = []) {
    ...
    if (this.tokens.links) {
      ...
      if (s.length > 0)
        for (; (n = this.tokenizer.rules.inline.reflinkSearch.exec(i)) != null; )
          s.includes(n[0].slice(n[0].lastIndexOf("[") + 1, -1)) && (i = i.slice(0, n.index) + "[" + "a".repeat(n[0].length - 2) + "]" + i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
    }
    ...
    for (; t; ) {
      a || (o = ""), a = !1;
      let s;
      if (this.options.extensions?.inline?.some((c) => (s = c.call({ lexer: this }, t, r)) ? (t = t.substring(s.raw.length), r.push(s), !0) : !1))
        continue;
      ...
      if (s = this.tokenizer.reflink(t, this.tokens.links)) {
        ...
        const c = r.at(-1);
        s.type === "text" && c?.type === "text" ? (c.raw += s.raw, c.text += s.text) : r.push(s);
        continue;
      }
      if (s = this.tokenizer.emStrong(t, i, o)) {
        t = t.substring(s.raw.length), r.push(s);
        continue;
      }
      ...
      if (s = this.tokenizer.inlineText(l)) {
        t = t.substring(s.raw.length), s.raw.slice(-1) !== "_" && (o = s.raw.slice(-1)), a = !0;
        const c = r.at(-1);
        c?.type === "text" ? (c.raw += s.raw, c.text += s.text) : r.push(s);
        continue;
      }
      if (t) {
...
class ia {
  ...
  code({ text: t, lang: r, escaped: i }) {
    const n = (r || "").match(It.notSpaceStart)?.[0], a = t.replace(It.endingNewline, "") + `
`;
...
`;
  ...
  listitem(t) {
    ...
    if (t.task) {
      ...
      t.loose ? t.tokens[0]?.type === "paragraph" ? (t.tokens[0].text = i + " " + t.tokens[0].text, t.tokens[0].tokens && t.tokens[0].tokens.length > 0 && t.tokens[0].tokens[0].type === "text" && (t.tokens[0].tokens[0].text = i + " " + fe(t.tokens[0].tokens[0].text), t.tokens[0].tokens[0].escaped = !0)) : t.tokens.unshift({
        type: "text",
        raw: i + " ",
        text: i + " ",
        escaped: !0
...
`;
  ...
  link({ href: t, title: r, tokens: i }) {
    const n = this.parser.parseInline(i), a = Pc(t);
    if (a === null)
      return n;
    t = a;
    let o = '<a href="' + t + '"';
    return r && (o += ' title="' + fe(r) + '"'), o += ">" + n + "</a>", o;
  }
...
class te {
  ...
  textRenderer;
  constructor(t) {
    this.options = t || xr, this.options.renderer = this.options.renderer || new ia(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new tl();
  }
  /**
   * Static Parse Method
   */
...
class tk {
      ...
      switch (i = i.concat(r.call(this, n)), n.type) {
        case "table": {
          ...
          for (const o of a.rows)
            for (const s of o)
              i = i.concat(this.walkTokens(s.tokens, r));
          break;
        }
        case "list": {
          const a = n;
        ...
        default: {
          ...
          this.defaults.extensions?.childTokens?.[a.type] ? this.defaults.extensions.childTokens[a.type].forEach((o) => {
            const s = a[o].flat(1 / 0);
            i = i.concat(this.walkTokens(s, r));
    ...
    return t.forEach((i) => {
      ...
      if (i.hooks) {
        ...
        for (const o in i.hooks) {
          ...
          Cn.passThroughHooks.has(o) ? a[s] = (h) => {
  ...
  lexer(t, r) {
    return Jt.lex(t, r ?? this.defaults);
  }
  parser(t, r) {
    return te.parse(t, r ?? this.defaults);
  }
  parseMarkdown(t) {
    return (i, n) => {
      ...
      const l = o.hooks ? o.hooks.provideLexer() : t ? Jt.lex : Jt.lexInline, c = o.hooks ? o.hooks.provideParser() : t ? te.parse : te.parseInline;
      if (o.async)
...
Please report this to https://github.com/markedjs/marked.`, t) {
        const n = "<p>An error occurred:</p><pre>" + fe(i.message + "", !0) + "</pre>";
...
ut.options = ut.setOptions = function(e) {
  return fr.setOptions(e), ut.defaults = fr.defaults, Nd(ut.defaults), ut;
};
ut.getDefaults = Yo;
ut.defaults = xr;
ut.use = function(...e) {
  return fr.use(...e), ut.defaults = fr.defaults, Nd(ut.defaults), ut;
};
ut.walkTokens = function(e, t) {
  return fr.walkTokens(e, t);
};
ut.parseInline = fr.parseInline;
ut.Parser = te;
ut.parser = te.parse;
ut.Renderer = ia;
ut.TextRenderer = tl;
...
function Kd(e, { markdownAutoWrap: t }) {
  const i = e.replace(/<br\/>/g, `
`).replace(/\n{2,}/g, `
`), n = Zd(i);
  return t === !1 ? n.replace(/ /g, "&nbsp;") : n;
}
p(Kd, "preprocessMarkdown");
function Qd(e, t = {}) {
  const r = Kd(e, t), i = ut.lexer(r), n = [[]];
  let a = 0;
...
`).forEach((h, u) => {
  ...
  return p(o, "processNode"), i.forEach((s) => {
    s.type === "paragraph" ? s.tokens?.forEach((l) => {
      o(l);
    }) : s.type === "html" && n[a].push({ content: s.text, type: "normal" });
  }), n;
}
p(Qd, "markdownToLines");
function Jd(e, { markdownAutoWrap: t } = {}) {
  const r = ut.lexer(e);
  function i(n) {
    return n.type === "text" ? t === !1 ? n.text.replace(/\n */g, "<br/>").replace(/ /g, "&nbsp;") : n.text.replace(/\n */g, "<br/>") : n.type === "strong" ? `<strong>${n.tokens?.map(i).join("")}</strong>` : n.type === "em" ? `<em>${n.tokens?.map(i).join("")}</em>` : n.type === "paragraph" ? `<p>${n.tokens?.map(i).join("")}</p>` : n.type === "space" ? "" : n.type === "html" ? `${n.text}` : n.type === "escape" ? n.text : `Unsupported markdown: ${n.type}`;
  }
...
p(tp, "splitTextToChars");
function ep(e, t) {
  const r = tp(t.content);
  return el(e, [], r, t.type);
}
p(ep, "splitWordToFitWidth");
function el(e, t, r, i) {
  if (r.length === 0)
    return [
  ...
  const [n, ...a] = r, o = [...t, n];
  return e([{ content: o.join(""), type: i }]) ? el(e, o, a, i) : (t.length === 0 && n && (t.push(n), r.shift()), [
    { content: t.join(""), type: i },
    { content: r.join(""), type: i }
  ]);
}
p(el, "splitWordToFitWidthRecursion");
function rp(e, t) {
...
p(na, "splitLineToFitWidthRecursion");
function Gs(e, t) {
  t && e.attr("style", t);
}
p(Gs, "applyStyle");
async function ip(e, t, r, i, n = !1) {
  const a = e.append("foreignObject");
  a.attr("width", `${10 * r}px`), a.attr("height", `${10 * r}px`);
  const o = a.append("xhtml:div");
  let s = t.label;
  t.label && Rr(t.label) && (s = await co(t.label.replace(jr.lineBreakRegex, `
`), ht()));
  const l = t.isNode ? "nodeLabel" : "edgeLabel", c = o.append("span");
  c.html(s), Gs(c, t.labelStyle), c.attr("class", `${l} ${i}`), Gs(o, t.labelStyle), o.style("display", "table-cell"), o.style("white-space", "nowrap"), o.style("line-height", "1.5"), o.style("max-width", r + "px"), o.style("text-align", "center"), o.attr("xmlns", "http://www.w3.org/1999/xhtml"), n && o.attr("class", "labelBkg");
...
p($a, "createTspan");
function np(e, t, r) {
  const i = e.append("text"), n = $a(i, 1, t);
  Fa(n, r);
  const a = n.node().getComputedTextLength();
  return i.remove(), a;
}
p(np, "computeWidthOfText");
function ek(e, t, r) {
  const i = e.append("text"), n = $a(i, 1, t);
  Fa(n, [{ content: r, type: "normal" }]);
  const a = n.node()?.getBoundingClientRect();
  return a && i.remove(), a;
}
p(ek, "computeDimensionOfText");
function ap(e, t, r, i = !1) {
  const a = t.append("g"), o = a.insert("rect").attr("class", "background").attr("style", "stroke: none"), s = a.append("text").attr("y", "-10.1");
  let l = 0;
  for (const c of r) {
    const h = /* @__PURE__ */ p((f) => np(a, 1.1, f) <= e, "checkWidth"), u = h(c) ? [c] : rp(c, h);
    for (const f of u) {
      const d = $a(s, l, 1.1);
      Fa(d, f), l++;
    }
...
p(Fa, "updateTextContentAndStyles");
function sp(e) {
  return e.replace(
    /fa[bklrs]?:fa-[\w-]+/g,
    // cspell: disable-line
...
p(sp, "replaceIconSubstring");
var Ve = /* @__PURE__ */ p(async (e, t = "", {
  style: r = "",
  isTitle: i = !1,
  classes: n = "",
  useHtmlLabels: a = !0,
  ...
  if (F.debug(
    ...
    const h = Jd(t, c), u = sp(yr(h)), f = t.replace(/\\\\/g, "\\"), d = {
      isNode: o,
      label: Rr(t) ? f : u,
      labelStyle: r.replace("fill:", "color:")
    };
    return await ip(e, d, s, n, l);
  } else {
    const h = t.replace(/<br\s*\/?>/g, "<br/>"), u = Qd(h.replace("<br>", "<br/>"), c), f = ap(
      s,
      e,
      u,
      t ? l : !1
...
function ik(e, t, r, i = 1) {
  const n = r, a = Math.max(t, 0.1), o = e[0] && e[0][0] && typeof e[0][0] == "number" ? [e] : e, s = [0, 0];
  if (n) for (const c of o) as(c, s, n);
  const l = function(c, h, u) {
    const f = [];
    for (const b of c) {
      const w = [...b];
      rk(w[0], w[w.length - 1]) || w.push([w[0][0], w[0][1]]), w.length > 2 && f.push(w);
    }
    const d = [];
    h = Math.max(h, 0.1);
    const g = [];
    for (const b of f) for (let w = 0; w < b.length - 1; w++) {
      const C = b[w], k = b[w + 1];
      if (C[1] !== k[1]) {
        const L = Math.min(C[1], k[1]);
        g.push({ ymin: L, ymax: Math.max(C[1], k[1]), x: L === C[1] ? C[0] : k[0], islope: (k[0] - C[0]) / (k[1] - C[1]) });
      }
    }
    ...
    for (; m.length || g.length; ) {
      ...
      if (m = m.filter((b) => !(b.edge.ymax <= y)), m.sort((b, w) => b.edge.x === w.edge.x ? 0 : (b.edge.x - w.edge.x) / Math.abs(b.edge.x - w.edge.x)), (u !== 1 || x % h == 0) && m.length > 1) for (let b = 0; b < m.length; b += 2) {
        const w = b + 1;
        if (w >= m.length) break;
        const C = m[b].edge, k = m[w].edge;
        d.push([[Math.round(C.x), y], [Math.round(k.x), y]]);
      }
      y += u, m.forEach((b) => {
  ...
  if (n) {
    for (const c of o) as(c, s, -n);
    (function(c, h, u) {
      const f = [];
      c.forEach((d) => f.push(...d)), as(f, h, u);
    })(l, s, -n);
  }
  return l;
}
function Yi(e, t) {
  ...
  let a = 1;
  return t.roughness >= 1 && (((r = t.randomizer) === null || r === void 0 ? void 0 : r.next()) || Math.random()) > 0.7 && (a = n), ik(e, n, i, a || 1);
}
class rl {
  constructor(t) {
    this.helper = t;
...
class nk extends rl {
  fillPolygons(t, r) {
    ...
    for (const [c, h] of n) Oa([c, h]) && o.push([[c[0] - s, c[1] + l], [...h]], [[c[0] + s, c[1] - l], [...h]]);
...
class sk {
  ...
  dotsOnLines(t, r) {
    ...
    const o = n / 4;
    for (const s of t) {
      const l = Oa(s), c = l / n, h = Math.ceil(c) - 1, u = l - h * n, f = (s[0][0] + s[1][0]) / 2 - n / 4, d = Math.min(s[0][1], s[1][1]);
      for (let g = 0; g < h; g++) {
        const m = d + u + g * n, y = f - o + 2 * Math.random() * o, x = m - o + 2 * Math.random() * o, b = this.helper.ellipse(y, x, a, a, r);
        i.push(...b.ops);
      }
    }
...
class ok {
  ...
  dashedLine(t, r) {
    ...
    return t.forEach((o) => {
      const s = Oa(o), l = Math.floor(s / (i + n)), c = (s + n - l * (i + n)) / 2;
      let h = o[0], u = o[1];
      h[0] > u[0] && (h = o[1], u = o[0]);
...
class lk {
  ...
  zigzagLines(t, r, i) {
    const n = [];
    return t.forEach((a) => {
      const o = Oa(a), s = Math.round(o / (2 * r));
      let l = a[0], c = a[1];
      l[0] > c[0] && (l = a[1], c = a[0]);
...
const hk = 0, ss = 1, Wc = 2, cn = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 2, t: 2, V: 1, v: 1, Z: 0, z: 0 };
function os(e, t) {
  return e.type === t;
}
function il(e) {
  const t = [], r = function(o) {
    ...
    else if (o.match(/^([aAcChHlLmMqQsStTvVzZ])/)) s[s.length] = { type: hk, text: RegExp.$1 }, o = o.substr(RegExp.$1.length);
    else {
      if (!o.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/)) return [];
      s[s.length] = { type: ss, text: `${parseFloat(RegExp.$1)}` }, o = o.substr(RegExp.$1.length);
    }
    return s[s.length] = { type: Wc, text: "" }, s;
  }(e);
  let i = "BOD", n = 0, a = r[n];
  for (; !os(a, Wc); ) {
    let o = 0;
    const s = [];
    if (i === "BOD") {
      if (a.text !== "M" && a.text !== "m") return il("M0,0" + e);
      n++, o = cn[a.text], i = a.text;
    } else os(a, ss) ? o = cn[i] : (n++, o = cn[a.text], i = a.text);
    if (!(n + o < r.length)) throw new Error("Path data ended short");
    for (let l = n; l < n + o; l++) {
      const c = r[l];
      if (!os(c, ss)) throw new Error("Param not a number: " + i + "," + c.text);
      s[s.length] = +c.text;
    }
    if (typeof cn[i] != "number") throw new Error("Bad segment: " + i);
    {
  ...
  for (const { key: c, data: h } of e) {
    switch (c) {
      ...
      case "T": {
        ...
        t.push({ key: "C", data: [m, y, x, b, u, f] }), s = d, l = g, i = u, n = f;
        break;
      }
      case "Q": {
        const [u, f, d, g] = h, m = i + 2 * (u - i) / 3, y = n + 2 * (f - n) / 3, x = d + 2 * (u - d) / 3, b = g + 2 * (f - g) / 3;
        t.push({ key: "C", data: [m, y, x, b, d, g] }), s = u, l = f, i = d, n = g;
        break;
      }
      case "A": {
...
function cp(e, t, r, i, n, a, o, s, l, c) {
  ...
  if (c) [d, g, m, y] = c;
    ...
    const P = (e - r) / 2, E = (t - i) / 2;
    let M = P * P / (n * n) + E * E / (a * a);
    M > 1 && (M = Math.sqrt(M), n *= M, a *= M);
    const T = n * n, $ = a * a, A = T * $ - T * E * E - $ * P * P, N = T * E * E + $ * P * P, q = (s === l ? -1 : 1) * Math.sqrt(Math.abs(A / N));
    m = q * n * E / a + (e + r) / 2, y = q * -a * P / n + (t + i) / 2, d = Math.asin(parseFloat(((t - y) / a).toFixed(9))), g = Math.asin(parseFloat(((i - y) / a).toFixed(9))), e < m && (d = Math.PI - d), r < m && (g = Math.PI - g), d < 0 && (d = 2 * Math.PI + d), g < 0 && (g = 2 * Math.PI + g), l && d > g && (d -= 2 * Math.PI), !l && g > d && (g -= 2 * Math.PI);
  }
  let x = g - d;
  if (Math.abs(x) > 120 * Math.PI / 180) {
    const P = g, E = r, M = i;
    g = l && g > d ? d + 120 * Math.PI / 180 * 1 : d + 120 * Math.PI / 180 * -1, f = cp(r = m + n * Math.cos(g), i = y + a * Math.sin(g), E, M, n, a, o, 0, l, [g, P, m, y]);
  }
  x = g - d;
  const b = Math.cos(d), w = Math.sin(d), C = Math.cos(g), k = Math.sin(g), L = Math.tan(x / 4), S = 4 / 3 * n * L, D = 4 / 3 * a * L, R = [e, t], O = [e + S * w, t - D * b], B = [r + S * k, i - D * C], z = [r, i];
  if (O[0] = 2 * R[0] - O[0], O[1] = 2 * R[1] - O[1], c) return [O, B, z].concat(f);
  {
    f = [O, B, z].concat(f);
    const P = [];
    for (let E = 0; E < f.length; E += 3) {
      const M = ci(f[E][0], f[E][1], h), T = ci(f[E + 1][0], f[E + 1][1], h), $ = ci(f[E + 2][0], f[E + 2][1], h);
      P.push([M[0], M[1], T[0], T[1], $[0], $[1]]);
    }
    return P;
  }
}
const uk = { randOffset: function(e, t) {
  return tt(e, t);
}, randOffsetWithRange: function(e, t, r) {
  return aa(e, t, r);
}, ellipse: function(e, t, r, i, n) {
  const a = up(r, i, n);
  return Xs(e, t, n, a).opset;
}, doubleLineOps: function(e, t, r, i, n) {
  return Ue(e, t, r, i, n, !0);
} };
function hp(e, t, r, i, n) {
  return { type: "path", ops: Ue(e, t, r, i, n) };
}
function kn(e, t, r) {
  const i = (e || []).length;
  if (i > 2) {
    const n = [];
    for (let a = 0; a < i - 1; a++) n.push(...Ue(e[a][0], e[a][1], e[a + 1][0], e[a + 1][1], r));
    return t && n.push(...Ue(e[i - 1][0], e[i - 1][1], e[0][0], e[0][1], r)), { type: "path", ops: n };
  }
  return i === 2 ? hp(e[0][0], e[0][1], e[1][0], e[1][1], r) : { type: "path", ops: [] };
}
function fk(e, t, r, i, n) {
  return function(a, o) {
    return kn(a, !0, o);
...
function qc(e, t) {
  if (e.length) {
    const r = typeof e[0][0] == "number" ? [e] : e, i = hn(r[0], 1 * (1 + 0.2 * t.roughness), t), n = t.disableMultiStroke ? [] : hn(r[0], 1.5 * (1 + 0.22 * t.roughness), Uc(t));
    for (let a = 1; a < r.length; a++) {
      const o = r[a];
      if (o.length) {
        const s = hn(o, 1 * (1 + 0.2 * t.roughness), t), l = t.disableMultiStroke ? [] : hn(o, 1.5 * (1 + 0.22 * t.roughness), Uc(t));
...
function Xs(e, t, r, i) {
  const [n, a] = Yc(i.increment, e, t, i.rx, i.ry, 1, i.increment * aa(0.1, aa(0.4, 1, r), r), r);
  let o = sa(n, null, r);
  if (!r.disableMultiStroke && r.roughness !== 0) {
    const [s] = Yc(i.increment, e, t, i.rx, i.ry, 1.5, 0, r), l = sa(s, null, r);
    o = o.concat(l);
  }
  return { estimatedPoints: a, opset: { type: "path", ops: o } };
}
function Hc(e, t, r, i, n, a, o, s, l) {
  const c = e, h = t;
  ...
  const m = 2 * Math.PI / l.curveStepCount, y = Math.min(m / 2, (g - d) / 2), x = Gc(y, c, h, u, f, d, g, 1, l);
  if (!l.disableMultiStroke) {
    const b = Gc(y, c, h, u, f, d, g, 1.5, l);
    x.push(...b);
  }
  return o && (s ? x.push(...Ue(c, h, c + u * Math.cos(d), h + f * Math.sin(d), l), ...Ue(c, h, c + u * Math.cos(g), h + f * Math.sin(g), l)) : x.push({ op: "lineTo", data: [c, h] }, { op: "lineTo", data: [c + u * Math.cos(d), h + f * Math.sin(d)] })), { type: "path", ops: x };
}
function jc(e, t) {
  const r = lp(op(il(e))), i = [];
  let n = [0, 0], a = [0, 0];
  for (const { key: o, data: s } of r) switch (o) {
    case "M":
      ...
      break;
    case "L":
      i.push(...Ue(a[0], a[1], s[0], s[1], t)), a = [s[0], s[1]];
      break;
    case "C": {
      const [l, c, h, u, f, d] = s;
      i.push(...dk(l, c, h, u, f, d, a, t)), a = [f, d];
      break;
    }
    case "Z":
      i.push(...Ue(a[0], a[1], n[0], n[1], t)), a = [n[0], n[1]];
  }
  ...
  return function(r, i) {
    ...
    if (!qt[n]) switch (n) {
      ...
      case "zigzag-line":
        ...
        break;
      default:
        n = "hachure", qt[n] || (qt[n] = new rl(i));
    }
    return qt[n];
  }(t, uk).fillPolygons(e, t);
}
function Uc(e) {
...
function fp(e) {
  return e.randomizer || (e.randomizer = new ck(e.seed || 0)), e.randomizer.next();
}
function aa(e, t, r, i = 1) {
  return r.roughness * i * (fp(r) * (t - e) + e);
}
function tt(e, t, r = 1) {
  return aa(-e, e, t, r);
}
function Ue(e, t, r, i, n, a = !1) {
  const o = a ? n.disableMultiStrokeFill : n.disableMultiStroke, s = Vs(e, t, r, i, n, !0, !1);
  if (o) return s;
  const l = Vs(e, t, r, i, n, !0, !0);
  return s.concat(l);
}
function Vs(e, t, r, i, n, a, o) {
  const s = Math.pow(e - r, 2) + Math.pow(t - i, 2), l = Math.sqrt(s);
  let c = 1;
  c = l < 200 ? 1 : l > 500 ? 0.4 : -16668e-7 * l + 1.233334;
  let h = n.maxRandomnessOffset || 0;
  h * h * 100 > s && (h = l / 10);
  const u = h / 2, f = 0.2 + 0.2 * fp(n);
  let d = n.bowing * n.maxRandomnessOffset * (i - t) / 200, g = n.bowing * n.maxRandomnessOffset * (e - r) / 200;
  d = tt(d, n, c), g = tt(g, n, c);
  const m = [], y = () => tt(u, n, c), x = () => tt(h, n, c), b = n.preserveVertices;
  return o ? m.push({ op: "move", data: [e + (b ? 0 : y()), t + (b ? 0 : y())] }) : m.push({ op: "move", data: [e + (b ? 0 : tt(h, n, c)), t + (b ? 0 : tt(h, n, c))] }), o ? m.push({ op: "bcurveTo", data: [d + e + (r - e) * f + y(), g + t + (i - t) * f + y(), d + e + 2 * (r - e) * f + y(), g + t + 2 * (i - t) * f + y(), r + (b ? 0 : y()), i + (b ? 0 : y())] }) : m.push({ op: "bcurveTo", data: [d + e + (r - e) * f + x(), g + t + (i - t) * f + x(), d + e + 2 * (r - e) * f + x(), g + t + 2 * (i - t) * f + x(), r + (b ? 0 : x()), i + (b ? 0 : x())] }), m;
}
function hn(e, t, r) {
  if (!e.length) return [];
  const i = [];
...
function sa(e, t, r) {
  ...
  } else i === 3 ? (n.push({ op: "move", data: [e[1][0], e[1][1]] }), n.push({ op: "bcurveTo", data: [e[1][0], e[1][1], e[2][0], e[2][1], e[2][0], e[2][1]] })) : i === 2 && n.push(...Vs(e[0][0], e[0][1], e[1][0], e[1][1], r, !0, !0));
  return n;
}
function Yc(e, t, r, i, n, a, o, s) {
  const l = [], c = [];
  if (s.roughness === 0) {
    ...
    for (let f = h; f < u; f += e) {
      const d = [tt(a, s) + t + i * Math.cos(f), tt(a, s) + r + n * Math.sin(f)];
      l.push(d), c.push(d);
    }
...
function Gc(e, t, r, i, n, a, o, s, l) {
  ...
  return h.push([t + i * Math.cos(o), r + n * Math.sin(o)]), h.push([t + i * Math.cos(o), r + n * Math.sin(o)]), sa(h, null, l);
}
function dk(e, t, r, i, n, a, o, s) {
  const l = [], c = [s.maxRandomnessOffset || 1, (s.maxRandomnessOffset || 1) + 0.3];
  let h = [0, 0];
  const u = s.disableMultiStroke ? 1 : 2, f = s.preserveVertices;
  for (let d = 0; d < u; d++) d === 0 ? l.push({ op: "move", data: [o[0], o[1]] }) : l.push({ op: "move", data: [o[0] + (f ? 0 : tt(c[0], s)), o[1] + (f ? 0 : tt(c[0], s))] }), h = f ? [n, a] : [n + tt(c[d], s), a + tt(c[d], s)], l.push({ op: "bcurveTo", data: [e + tt(c[d], s), t + tt(c[d], s), r + tt(c[d], s), i + tt(c[d], s), h[0], h[1]] });
  return l;
}
function hi(e) {
  return [...e];
...
function Xc(e, t = 0) {
  ...
  const i = [];
  if (r === 3) i.push(hi(e[0]), hi(e[1]), hi(e[2]), hi(e[2]));
  else {
    const n = [];
    n.push(e[0], e[0]);
...
function pk(e, t, r) {
  const i = Sn(t, r);
  if (i === 0) return Sn(e, t);
  let n = ((e[0] - t[0]) * (r[0] - t[0]) + (e[1] - t[1]) * (r[1] - t[1])) / i;
  return n = Math.max(0, Math.min(1, n)), Sn(e, tr(t, r, n));
}
function tr(e, t, r) {
...
function Zs(e, t, r, i) {
  ...
  if (function(s, l) {
    ...
    const s = e[t + 0];
    n.length ? (a = n[n.length - 1], o = s, Math.sqrt(Sn(a, o)) > 1 && n.push(s)) : n.push(s), n.push(e[t + 3]);
  } else {
    const l = e[t + 0], c = e[t + 1], h = e[t + 2], u = e[t + 3], f = tr(l, c, 0.5), d = tr(c, h, 0.5), g = tr(h, u, 0.5), m = tr(f, d, 0.5), y = tr(d, g, 0.5), x = tr(m, y, 0.5);
    Zs([l, f, m, x], 0, r, n), Zs([x, y, g, u], 0, r, n);
  }
  var a, o;
  return n;
}
function gk(e, t) {
  return oa(e, 0, e.length, t);
}
function oa(e, t, r, i, n) {
  ...
  return Math.sqrt(l) > i ? (oa(e, t, c + 1, i, a), oa(e, c, r, i, a)) : (a.length || a.push(o), a.push(s)), a;
}
...
class la {
  ...
  line(t, r, i, n, a) {
    const o = this._o(a);
    return this._d("line", [hp(t, r, i, n, o)], o);
  }
  rectangle(t, r, i, n, a) {
    const o = this._o(a), s = [], l = fk(t, r, i, n, o);
    if (o.fill) {
      const c = [[t, r], [t + i, r], [t + i, r + n], [t, r + n]];
      o.fillStyle === "solid" ? s.push(ls([c], o)) : s.push(Sr([c], o));
    }
    return o.stroke !== Xt && s.push(l), this._d("rectangle", s, o);
  }
  ellipse(t, r, i, n, a) {
    const o = this._o(a), s = [], l = up(i, n, o), c = Xs(t, r, o, l);
    if (o.fill) if (o.fillStyle === "solid") {
      const h = Xs(t, r, o, l).opset;
      h.type = "fillPath", s.push(h);
    } else s.push(Sr([c.estimatedPoints], o));
  ...
  linearPath(t, r) {
    const i = this._o(r);
    return this._d("linearPath", [kn(t, !1, i)], i);
  }
  arc(t, r, i, n, a, o, s = !1, l) {
    const c = this._o(l), h = [], u = Hc(t, r, i, n, a, o, s, !0, c);
    if (s && c.fill) if (c.fillStyle === "solid") {
      const f = Object.assign({}, c);
      f.disableMultiStroke = !0;
      const d = Hc(t, r, i, n, a, o, !0, !1, f);
      ...
      const R = (D - S) / b.curveStepCount, O = [];
      for (let B = S; B <= D; B += R) O.push([w + k * Math.cos(B), C + L * Math.sin(B)]);
      return O.push([w + k * Math.cos(D), C + L * Math.sin(D)]), O.push([w, C]), Sr([O], b);
    }(t, r, i, n, a, o, c));
  ...
  curve(t, r) {
    ...
    if (i.fill && i.fill !== Xt) if (i.fillStyle === "solid") {
      ...
      if (s.length) {
        ...
        for (const c of l) c.length < 3 ? o.push(...c) : c.length === 3 ? o.push(...cs(Xc([c[0], c[0], c[1], c[2]]), 10, (1 + i.roughness) / 2)) : o.push(...cs(Xc(c), 10, (1 + i.roughness) / 2));
      }
      o.length && n.push(Sr([o], i));
    }
    return i.stroke !== Xt && n.push(a), this._d("curve", n, i);
  }
  polygon(t, r) {
    const i = this._o(r), n = [], a = kn(t, !0, i);
    return i.fill && (i.fillStyle === "solid" ? n.push(ls([t], i)) : n.push(Sr([t], i))), i.stroke !== Xt && n.push(a), this._d("polygon", n, i);
  }
  path(t, r) {
    const i = this._o(r), n = [];
    if (!t) return this._d("path", n, i);
    t = (t || "").replace(/\n/g, " ").replace(/(-\s)/g, "-").replace("/(ss)/g", " ");
    const a = i.fill && i.fill !== "transparent" && i.fill !== Xt, o = i.stroke !== Xt, s = !!(i.simplification && i.simplification < 1), l = function(h, u, f) {
      const d = lp(op(il(h))), g = [];
      let m = [], y = [0, 0], x = [];
      const b = () => {
      ...
      for (const { key: k, data: L } of d) switch (k) {
        case "M":
          w(), y = [L[0], L[1]], m.push(y);
          break;
        case "L":
          b(), m.push([L[0], L[1]]);
          break;
      ...
      return C;
    }(t, 1, s ? 4 - 4 * (i.simplification || 1) : (1 + i.roughness) / 2), c = jc(t, i);
    if (a) if (i.fillStyle === "solid") if (l.length === 1) {
      const h = jc(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
  ...
  toPaths(t) {
    ...
    for (const a of r) {
      ...
      switch (a.type) {
        case "path":
          o = { d: this.opsToPath(a), stroke: i.stroke, strokeWidth: i.strokeWidth, fill: Xt };
          break;
        case "fillPath":
          o = { d: this.opsToPath(a), stroke: Xt, strokeWidth: 0, fill: i.fill || Xt };
          break;
        case "fillSketch":
...
class yk {
  ...
  draw(t) {
    const r = t.sets || [], i = t.options || this.getDefaultOptions(), n = this.svg.ownerDocument || window.document, a = n.createElementNS(un, "g"), o = t.options.fixedDecimalPlaceDigits;
    for (const s of r) {
      let l = null;
      switch (s.type) {
        case "path":
          l = n.createElementNS(un, "path"), l.setAttribute("d", this.opsToPath(s, o)), l.setAttribute("stroke", i.stroke), l.setAttribute("stroke-width", i.strokeWidth + ""), l.setAttribute("fill", "none"), i.strokeLineDash && l.setAttribute("stroke-dasharray", i.strokeLineDash.join(" ").trim()), i.strokeLineDashOffset && l.setAttribute("stroke-dashoffset", `${i.strokeLineDashOffset}`);
          break;
        case "fillPath":
          l = n.createElementNS(un, "path"), l.setAttribute("d", this.opsToPath(s, o)), l.setAttribute("stroke", "none"), l.setAttribute("stroke-width", "0"), l.setAttribute("fill", i.fill || ""), t.shape !== "curve" && t.shape !== "polygon" || l.setAttribute("fill-rule", "evenodd");
          break;
        case "fillSketch":
...
var U = { canvas: (e, t) => new mk(e, t), svg: (e, t) => new yk(e, t), generator: (e) => new la(e), newSeed: () => la.newSeed() }, it = /* @__PURE__ */ p(async (e, t, r) => {
  let i;
  const n = t.useHtmlLabels || vt(ht()?.htmlLabels);
  r ? i = r : i = "node default";
  const a = e.insert("g").attr("class", i).attr("id", t.domId || t.id), o = a.insert("g").attr("class", "label").attr("style", Pt(t.labelStyle));
  let s;
  t.label === void 0 ? s = "" : s = typeof t.label == "string" ? t.label : t.label[0];
  const l = await Ve(o, lr(yr(s), ht()), {
    useHtmlLabels: n,
  ...
  if (n) {
    const u = l.children[0], f = lt(l), d = u.getElementsByTagName("img");
    if (d) {
          ...
          (m) => new Promise((y) => {
            function x() {
              if (m.style.display = "flex", m.style.flexDirection = "column", g) {
                const b = ht().fontSize ? ht().fontSize : window.getComputedStyle(document.body).fontSize, w = 5, [C = Bh.fontSize] = Aa(b), k = C * w + "px";
...
}, "labelHelper"), hs = /* @__PURE__ */ p(async (e, t, r) => {
  const i = r.useHtmlLabels || vt(ht()?.flowchart?.htmlLabels), n = e.insert("g").attr("class", "label").attr("style", r.labelStyle || ""), a = await Ve(n, lr(yr(t), ht()), {
    useHtmlLabels: i,
...
p(Ye, "generateFullSineWavePoints");
function nl(e, t, r, i, n, a) {
...
p(nl, "generateCirclePoints");
var xk = /* @__PURE__ */ p((e, t) => {
...
async function pp(e) {
  ...
  let i = e.label;
  e.label && Rr(e.label) && (i = await co(e.label.replace(jr.lineBreakRegex, `
`), ht()));
  ...
  return r.html(
    ...
    ">" + i + "</span>"
  ), dp(r, e.labelStyle), r.style("display", "inline-block"), r.style("padding-right", "1px"), r.style("white-space", "nowrap"), r.attr("xmlns", "http://www.w3.org/1999/xhtml"), t.node();
}
p(pp, "addHtmlLabel");
var bk = /* @__PURE__ */ p(async (e, t, r, i) => {
  let n = e || "";
  if (typeof n == "object" && (n = n[0]), vt(ht().flowchart.htmlLabels)) {
...
}, "createLabel"), sr = bk, Oe = /* @__PURE__ */ p((e, t, r, i, n) => [
  "M",
  e + n,
  t,
  ...
  "Z"
  // Close the path
].join(" "), "createRoundedRectPathD"), wk = /* @__PURE__ */ p((e) => {
...
}, "solidStateFill"), Xr = /* @__PURE__ */ p((e) => {
  const t = vk([...e.cssCompiledStyles || [], ...e.cssStyles || []]);
  return { stylesMap: t, stylesArray: [...t] };
}, "compileStyles"), vk = /* @__PURE__ */ p((e) => {
  const t = /* @__PURE__ */ new Map();
  return e.forEach((r) => {
    const [i, n] = r.split(":");
    t.set(i.trim(), n?.trim());
  }), t;
}, "styles2Map"), gp = /* @__PURE__ */ p((e) => e === "color" || e === "font-size" || e === "font-family" || e === "font-weight" || e === "font-style" || e === "text-decoration" || e === "text-align" || e === "text-transform" || e === "line-height" || e === "letter-spacing" || e === "word-spacing" || e === "text-shadow" || e === "text-overflow" || e === "white-space" || e === "word-wrap" || e === "word-break" || e === "overflow-wrap" || e === "hyphens", "isLabelStyle"), V = /* @__PURE__ */ p((e) => {
  const { stylesArray: t } = Xr(e), r = [], i = [], n = [], a = [];
  return t.forEach((o) => {
    const s = o[0];
    gp(s) ? r.push(o.join(":") + " !important") : (i.push(o.join(":") + " !important"), s.includes("stroke") && n.push(o.join(":") + " !important"), s === "fill" && a.push(o.join(":") + " !important"));
  }), {
    labelStyles: r.join(";"),
    nodeStyles: i.join(";"),
    stylesArray: t,
...
}, "styles2String"), G = /* @__PURE__ */ p((e, t) => {
  const { themeVariables: r, handDrawnSeed: i } = ht(), { nodeBorder: n, mainBkg: a } = r, { stylesMap: o } = Xr(e);
  ...
  if (t.look === "handDrawn") {
    const S = U.svg(u), D = G(t, {
      ...
      fillWeight: 3,
      seed: n
    }), R = S.path(Oe(b, w, y, x, 0), D);
    C = u.insert(() => (F.debug("Rough node insert CXC", R), R), ":first-child"), C.select("path:nth-child(2)").attr("style", c.join(";")), C.select("path").attr("style", h.join(";").replace("fill", "stroke"));
  } else
    C = u.insert("rect", ":first-child"), C.attr("style", l).attr("rx", t.rx).attr("ry", t.ry).attr("x", b).attr("y", w).attr("width", y).attr("height", x);
  ...
  return t.offsetX = 0, t.width = L.width, t.height = L.height, t.offsetY = m.height - t.padding / 2, t.intersect = function(S) {
    return Gr(t, S);
  }, { cluster: u, labelBBox: m };
}, "rect"), _k = /* @__PURE__ */ p((e, t) => {
...
}, "noteGroup"), Ck = /* @__PURE__ */ p(async (e, t) => {
  const r = ht(), { themeVariables: i, handDrawnSeed: n } = r, { altBackground: a, compositeBackground: o, compositeTitleBackground: s, nodeBorder: l } = i, c = e.insert("g").attr("class", t.cssClasses).attr("id", t.id).attr("data-id", t.id).attr("data-look", t.look), h = c.insert("g", ":first-child"), u = c.insert("g").attr("class", "cluster-label");
  let f = c.append("rect");
  const d = u.node().appendChild(await sr(t.label, t.labelStyle, void 0, !0));
  let g = d.getBBox();
  if (vt(r.flowchart.htmlLabels)) {
    const R = d.children[0], O = lt(d);
  ...
  const b = t.height + m, w = t.height + m - g.height - 6, C = t.x - x / 2, k = t.y - b / 2;
  t.width = x;
  const L = t.y - t.height / 2 - y + g.height + 2;
  let S;
  if (t.look === "handDrawn") {
    const R = t.cssClasses.includes("statediagram-cluster-alt"), O = U.svg(c), B = t.rx || t.ry ? O.path(Oe(C, k, x, b, 10), {
      roughness: 0.7,
      fill: s,
      fillStyle: "solid",
      stroke: l,
      seed: n
    }) : O.rectangle(C, k, x, b, { seed: n });
    S = c.insert(() => B, ":first-child");
    const z = O.rectangle(C, L, x, w, {
      fill: R ? a : o,
      fillStyle: R ? "hachure" : "solid",
      stroke: l,
      seed: n
    });
    S = c.insert(() => B, ":first-child"), f = c.insert(() => z);
  } else
    S = h.insert("rect", ":first-child"), S.attr("class", "outer").attr("x", C).attr("y", k).attr("width", x).attr("height", b).attr("data-look", t.look), f.attr("class", "inner").attr("x", C).attr("y", L).attr("width", x).attr("height", w);
  u.attr(
    "transform",
    `translate(${t.x - g.width / 2}, ${k + 1 - (vt(r.flowchart.htmlLabels) ? 0 : 3)})`
  );
...
}, "roundedWithTitle"), kk = /* @__PURE__ */ p(async (e, t) => {
  F.info("Creating subgraph rect for ", t.id, t);
  const r = ht(), { themeVariables: i, handDrawnSeed: n } = r, { clusterBkg: a, clusterBorder: o } = i, { labelStyles: s, nodeStyles: l, borderStyles: c, backgroundStyles: h } = V(t), u = e.insert("g").attr("class", "cluster " + t.cssClasses).attr("id", t.id).attr("data-look", t.look), f = vt(r.flowchart.htmlLabels), d = u.insert("g").attr("class", "cluster-label "), g = await Ve(d, t.label, {
    style: t.labelStyle,
    useHtmlLabels: f,
...
}, "kanbanSection"), Sk = /* @__PURE__ */ p((e, t) => {
  const r = ht(), { themeVariables: i, handDrawnSeed: n } = r, { nodeBorder: a } = i, o = e.insert("g").attr("class", t.cssClasses).attr("id", t.id).attr("data-look", t.look), s = o.insert("g", ":first-child"), l = 0 * t.padding, c = t.width + l;
  t.diff = -t.padding;
  ...
  divider: Sk,
  kanbanSection: kk
}, yp = /* @__PURE__ */ new Map(), Lk = /* @__PURE__ */ p(async (e, t) => {
  const r = t.shape || "rect", i = await Bk[r](e, t);
  return yp.set(t.id, i), i;
}, "insertCluster"), eA = /* @__PURE__ */ p(() => {
  yp = /* @__PURE__ */ new Map();
}, "clear");
function xp(e, t) {
...
p(bp, "intersectEllipse");
var wp = bp;
function vp(e, t, r) {
  return wp(e, t, t, r);
}
p(vp, "intersectCircle");
var Mk = vp;
function _p(e, t, r, i) {
  var n, a, o, s, l, c, h, u, f, d, g, m, y, x, b;
  if (n = t.y - e.y, o = e.x - t.x, l = t.x * e.y - e.x * t.y, f = n * r.x + o * r.y + l, d = n * i.x + o * i.y + l, !(f !== 0 && d !== 0 && Ks(f, d)) && (a = i.y - r.y, s = r.x - i.x, c = i.x * r.y - r.x * i.y, h = a * e.x + s * e.y + c, u = a * t.x + s * t.y + c, !(h !== 0 && u !== 0 && Ks(h, u)) && (g = n * s - a * o, g !== 0)))
...
function Cp(e, t, r) {
  ...
  for (let h = 0; h < t.length; h++) {
    let u = t[h], f = t[h < t.length - 1 ? h + 1 : 0], d = Ek(
      e,
      r,
      { x: l + u.x, y: c + u.y },
      { x: l + f.x, y: c + f.y }
...
function kp(e, t) {
  ...
  let n = i;
  i || (n = "anchor");
  const a = e.insert("g").attr("class", n).attr("id", t.domId || t.id), o = 1, { cssStyles: s } = t, l = U.svg(a), c = G(t, { fill: "black", stroke: "none", fillStyle: "solid" });
  t.look !== "handDrawn" && (c.roughness = 0);
  const h = l.circle(0, 0, o * 2, c), u = a.insert(() => h, ":first-child");
  return u.attr("class", "anchor").attr("style", Pt(s)), X(t, u), t.intersect = function(f) {
    return F.info("Circle intersect", t, o, f), j.circle(t, o, f);
  }, a;
}
p(kp, "anchor");
function Qs(e, t, r, i, n, a, o) {
  ...
  const L = [];
  for (let S = 0; S < 20; S++) {
    const D = S / 19, R = w + D * k, O = x + n * Math.cos(R), B = b + a * Math.sin(R);
    L.push({ x: O, y: B });
  }
  return L;
}
p(Qs, "generateArcPoints");
async function Sp(e, t) {
  ...
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = a.width + t.padding + 20, s = a.height + t.padding, l = s / 2, c = l / (2.5 + s / 50), { cssStyles: h } = t, u = [
    { x: o / 2, y: -s / 2 },
    { x: -o / 2, y: -s / 2 },
    ...Qs(-o / 2, -s / 2, -o / 2, s / 2, c, l, !1),
    { x: o / 2, y: s / 2 },
    ...Qs(o / 2, s / 2, o / 2, -s / 2, c, l, !0)
  ], f = U.svg(n), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = ct(u), m = f.path(g, d), y = n.insert(() => m, ":first-child");
  return y.attr("class", "basic label-container"), h && t.look !== "handDrawn" && y.selectAll("path").attr("style", h), i && t.look !== "handDrawn" && y.selectAll("path").attr("style", i), y.attr("transform", `translate(${c / 2}, 0)`), X(t, y), t.intersect = function(x) {
    return j.polygon(t, u, x);
  }, n;
}
p(Sp, "bowTieRect");
function De(e, t, r, i) {
...
p(De, "insertPolygonShape");
async function Tp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = a.height + t.padding, s = 12, l = a.width + t.padding + s, c = 0, h = l, u = -o, f = 0, d = [
    { x: c + s, y: u },
    { x: h, y: u },
    { x: h, y: f },
    { x: c, y: f },
  ...
  const { cssStyles: m } = t;
  if (t.look === "handDrawn") {
    const y = U.svg(n), x = G(t, {}), b = ct(d), w = y.path(b, x);
    g = n.insert(() => w, ":first-child").attr("transform", `translate(${-l / 2}, ${o / 2})`), m && g.attr("style", m);
  } else
    g = De(n, l, o, d);
  return i && g.attr("style", i), X(t, g), t.intersect = function(y) {
...
function Bp(e, t) {
  ...
  const c = ct(o), h = s.path(c, l), u = i.insert(() => h, ":first-child");
...
async function Lp(e, t) {
  ...
  const { cssStyles: c } = t;
  if (t.look === "handDrawn") {
    const h = U.svg(n), u = G(t, {}), f = h.circle(0, 0, s * 2, u);
    l = n.insert(() => f, ":first-child"), l.attr("class", "basic label-container").attr("style", Pt(c));
  } else
    l = n.insert("circle", ":first-child").attr("class", "basic label-container").attr("style", i).attr("r", s).attr("cx", 0).attr("cy", 0);
  return X(t, l), t.intersect = function(h) {
    return F.info("Circle intersect", t, s, h), j.circle(t, s, h);
  }, n;
}
p(Lp, "circle");
function Ap(e) {
...
function Mp(e, t) {
  ...
  const n = e.insert("g").attr("class", et(t)).attr("id", t.domId ?? t.id), a = Math.max(30, t?.width ?? 0), { cssStyles: o } = t, s = U.svg(n), l = G(t, {});
  t.look !== "handDrawn" && (l.roughness = 0, l.fillStyle = "solid");
  const c = s.circle(0, 0, a * 2, l), h = Ap(a), u = s.path(h, l), f = n.insert(() => c, ":first-child");
  return f.insert(() => u), o && t.look !== "handDrawn" && f.selectAll("path").attr("style", o), i && t.look !== "handDrawn" && f.selectAll("path").attr("style", i), X(t, f), t.intersect = function(d) {
    return F.info("crossedCircle intersect", t, { radius: a, point: d }), j.circle(t, a, d);
  }, n;
}
p(Mp, "crossedCircle");
...
async function Ep(e, t) {
  ...
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = a.width + (t.padding ?? 0), l = a.height + (t.padding ?? 0), c = Math.max(5, l * 0.1), { cssStyles: h } = t, u = [
    ...
    { x: -s / 2 - c, y: -c },
    ...Te(s / 2 + s * 0.1, -c, c, 20, -180, -270),
    ...Te(s / 2 + s * 0.1, c, c, 20, -90, -180),
    { x: -s / 2 - c, y: l / 2 },
    ...Te(s / 2, l / 2, c, 20, 0, 90),
    { x: -s / 2, y: l / 2 + c },
    { x: s / 2, y: l / 2 + c }
  ], d = U.svg(n), g = G(t, { fill: "none" });
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const y = ct(u).replace("Z", ""), x = d.path(y, g), b = ct(f), w = d.path(b, { ...g }), C = n.insert("g", ":first-child");
  return C.insert(() => w, ":first-child").attr("stroke-opacity", 0), C.insert(() => x, ":first-child"), C.attr("class", "text"), h && t.look !== "handDrawn" && C.selectAll("path").attr("style", h), i && t.look !== "handDrawn" && C.selectAll("path").attr("style", i), C.attr("transform", `translate(${c}, 0)`), o.attr(
    "transform",
    `translate(${-s / 2 + c - (a.x - (a.left ?? 0))},${-l / 2 + (t.padding ?? 0) / 2 - (a.y - (a.top ?? 0))})`
  ), X(t, C), t.intersect = function(k) {
    return j.polygon(t, f, k);
  }, n;
}
p(Ep, "curlyBraceLeft");
...
async function $p(e, t) {
  ...
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = a.width + (t.padding ?? 0), l = a.height + (t.padding ?? 0), c = Math.max(5, l * 0.1), { cssStyles: h } = t, u = [
    ...Be(s / 2, -l / 2, c, 20, -90, 0),
    { x: s / 2 + c, y: -c },
    ...Be(s / 2 + c * 2, -c, c, 20, -180, -270),
    ...Be(s / 2 + c * 2, c, c, 20, -90, -180),
    { x: s / 2 + c, y: l / 2 },
    ...Be(s / 2, l / 2, c, 20, 0, 90)
  ], f = [
    { x: -s / 2, y: -l / 2 - c },
    { x: s / 2, y: -l / 2 - c },
    ...Be(s / 2, -l / 2, c, 20, -90, 0),
...
p($p, "curlyBraceRight");
function St(e, t, r, i = 100, n = 0, a = 180) {
  const o = [], s = n * Math.PI / 180, h = (a * Math.PI / 180 - s) / (i - 1);
  for (let u = 0; u < i; u++) {
    const f = s + u * h, d = e + r * Math.cos(f), g = t + r * Math.sin(f);
    o.push({ x: -d, y: -g });
...
p(St, "generateCirclePoints");
async function Fp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = a.width + (t.padding ?? 0), l = a.height + (t.padding ?? 0), c = Math.max(5, l * 0.1), { cssStyles: h } = t, u = [
    ...St(s / 2, -l / 2, c, 30, -90, 0),
    { x: -s / 2 - c, y: c },
    ...St(s / 2 + c * 2, -c, c, 20, -180, -270),
    ...St(s / 2 + c * 2, c, c, 20, -90, -180),
    { x: -s / 2 - c, y: -l / 2 },
    ...St(s / 2, l / 2, c, 20, 0, 90)
  ], f = [
    ...St(-s / 2 + c + c / 2, -l / 2, c, 20, -90, -180),
    { x: s / 2 - c / 2, y: c },
    ...St(-s / 2 - c / 2, -c, c, 20, 0, 90),
    ...St(-s / 2 - c / 2, c, c, 20, -90, 0),
    { x: s / 2 - c / 2, y: -c },
    ...St(-s / 2 + c + c / 2, l / 2, c, 30, -180, -270)
  ], d = [
    { x: s / 2, y: -l / 2 - c },
    { x: -s / 2, y: -l / 2 - c },
    ...St(s / 2, -l / 2, c, 20, -90, 0),
    { x: -s / 2 - c, y: -c },
    ...St(s / 2 + c * 2, -c, c, 20, -180, -270),
    ...St(s / 2 + c * 2, c, c, 20, -90, -180),
    { x: -s / 2 - c, y: l / 2 },
    ...
    { x: s / 2 - c / 2, y: -c },
    ...St(-s / 2 + c + c / 2, l / 2, c, 30, -180, -270)
  ], g = U.svg(n), m = G(t, { fill: "none" });
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const x = ct(u).replace("Z", ""), b = g.path(x, m), C = ct(f).replace("Z", ""), k = g.path(C, m), L = ct(d), S = g.path(L, { ...m }), D = n.insert("g", ":first-child");
  return D.insert(() => S, ":first-child").attr("stroke-opacity", 0), D.insert(() => b, ":first-child"), D.insert(() => k, ":first-child"), D.attr("class", "text"), h && t.look !== "handDrawn" && D.selectAll("path").attr("style", h), i && t.look !== "handDrawn" && D.selectAll("path").attr("style", i), D.attr("transform", `translate(${c - c / 4}, 0)`), o.attr(
    "transform",
    `translate(${-s / 2 + (t.padding ?? 0) / 2 - (a.x - (a.left ?? 0))},${-l / 2 + (t.padding ?? 0) / 2 - (a.y - (a.top ?? 0))})`
  ), X(t, D), t.intersect = function(R) {
    return j.polygon(t, d, R);
  }, n;
}
p(Fp, "curlyBraces");
async function Op(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = 80, s = 20, l = Math.max(o, (a.width + (t.padding ?? 0) * 2) * 1.25, t?.width ?? 0), c = Math.max(s, a.height + (t.padding ?? 0) * 2, t?.height ?? 0), h = c / 2, { cssStyles: u } = t, f = U.svg(n), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = l, m = c, y = g - h, x = m / 4, b = [
    ...
    { x, y: m },
    { x: y, y: m },
    ...nl(-y, -m / 2, h, 50, 270, 90)
  ], w = ct(b), C = f.path(w, d), k = n.insert(() => C, ":first-child");
  return k.attr("class", "basic label-container"), u && t.look !== "handDrawn" && k.selectChildren("path").attr("style", u), i && t.look !== "handDrawn" && k.selectChildren("path").attr("style", i), k.attr("transform", `translate(${-l / 2}, ${-c / 2})`), X(t, k), t.intersect = function(L) {
    return j.polygon(t, b, L);
  }, n;
}
p(Op, "curvedTrapezoid");
var Fk = /* @__PURE__ */ p((e, t, r, i, n, a) => [
  `M${e},${t + a}`,
  `a${n},${a} 0,0,0 ${r},0`,
  `a${n},${a} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${n},${a} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createCylinderPathD"), Ok = /* @__PURE__ */ p((e, t, r, i, n, a) => [
  `M${e},${t + a}`,
  `M${e + r},${t + a}`,
  `a${n},${a} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${n},${a} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createOuterCylinderPathD"), Dk = /* @__PURE__ */ p((e, t, r, i, n, a) => [`M${e - r / 2},${-i / 2}`, `a${n},${a} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD");
async function Dp(e, t) {
  ...
  const { cssStyles: f } = t;
  if (t.look === "handDrawn") {
    const d = U.svg(n), g = Ok(0, 0, s, h, l, c), m = Dk(0, c, s, h, l, c), y = d.path(g, G(t, {})), x = d.path(m, G(t, { fill: "none" }));
    u = n.insert(() => x, ":first-child"), u = n.insert(() => y, ":first-child"), u.attr("class", "basic label-container"), f && u.attr("style", f);
  } else {
    const d = Fk(0, 0, s, h, l, c);
    u = n.insert("path", ":first-child").attr("d", d).attr("class", "basic label-container").attr("style", Pt(f)).attr("style", i);
  }
  return u.attr("label-offset-y", c), u.attr("transform", `translate(${-s / 2}, ${-(h / 2 + c)})`), X(t, u), o.attr(
    "transform",
    `translate(${-(a.width / 2) - (a.x - (a.left ?? 0))}, ${-(a.height / 2) + (t.padding ?? 0) / 1.5 - (a.y - (a.top ?? 0))})`
  ), t.intersect = function(d) {
    const g = j.rect(t, d), m = g.x - (t.x ?? 0);
...
async function Rp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = a.width + t.padding, l = a.height + t.padding, c = l * 0.2, h = -s / 2, u = -l / 2 - c / 2, { cssStyles: f } = t, d = U.svg(n), g = G(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const m = [
    { x: h, y: u + c },
    { x: -h, y: u + c },
  ...
  ), X(t, x), t.intersect = function(b) {
    return j.rect(t, b);
  }, n;
}
p(Rp, "dividedRectangle");
async function Ip(e, t) {
  ...
  const { cssStyles: u } = t;
  if (t.look === "handDrawn") {
    const f = U.svg(n), d = G(t, { roughness: 0.2, strokeWidth: 2.5 }), g = G(t, { roughness: 0.2, strokeWidth: 1.5 }), m = f.circle(0, 0, l * 2, d), y = f.circle(0, 0, c * 2, g);
    h = n.insert("g", ":first-child"), h.attr("class", Pt(t.cssClasses)).attr("style", Pt(u)), h.node()?.appendChild(m), h.node()?.appendChild(y);
  } else {
  ...
  return X(t, h), t.intersect = function(f) {
    return F.info("DoubleCircle intersect", t, l, f), j.circle(t, l, f);
  }, n;
}
p(Ip, "doublecircle");
function Pp(e, t, { config: { themeVariables: r } }) {
  const { labelStyles: i, nodeStyles: n } = V(t);
  t.label = "", t.labelStyle = i;
  const a = e.insert("g").attr("class", et(t)).attr("id", t.domId ?? t.id), o = 7, { cssStyles: s } = t, l = U.svg(a), { nodeBorder: c } = r, h = G(t, { fillStyle: "solid" });
  t.look !== "handDrawn" && (h.roughness = 0);
  const u = l.circle(0, 0, o * 2, h), f = a.insert(() => u, ":first-child");
  return f.selectAll("path").attr("style", `fill: ${c} !important;`), s && s.length > 0 && t.look !== "handDrawn" && f.selectAll("path").attr("style", s), n && t.look !== "handDrawn" && f.selectAll("path").attr("style", n), X(t, f), t.intersect = function(d) {
    return F.info("filledCircle intersect", t, { radius: o, point: d }), j.circle(t, o, d);
  }, a;
}
p(Pp, "filledCircle");
async function Np(e, t) {
  ...
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = a.width + (t.padding ?? 0), l = s + a.height, c = s + a.height, h = [
    ...
    { x: c, y: -l },
    { x: c / 2, y: 0 }
  ], { cssStyles: u } = t, f = U.svg(n), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = ct(h), m = f.path(g, d), y = n.insert(() => m, ":first-child").attr("transform", `translate(${-l / 2}, ${l / 2})`);
  return u && t.look !== "handDrawn" && y.selectChildren("path").attr("style", u), i && t.look !== "handDrawn" && y.selectChildren("path").attr("style", i), t.width = s, t.height = l, X(t, y), o.attr(
    "transform",
    `translate(${-a.width / 2 - (a.x - (a.left ?? 0))}, ${-l / 2 + (t.padding ?? 0) / 2 + (a.y - (a.top ?? 0))})`
  ), t.intersect = function(x) {
    return F.info("Triangle intersect", t, h, x), j.polygon(t, h, x);
  }, n;
}
p(Np, "flippedTriangle");
function zp(e, t, { dir: r, config: { state: i, themeVariables: n } }) {
  const { nodeStyles: a } = V(t);
  t.label = "";
  ...
  const h = -1 * l / 2, u = -1 * c / 2, f = U.svg(o), d = G(t, {
    stroke: n.lineColor,
    fill: n.lineColor
  });
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = f.rectangle(h, u, l, c, d), m = o.insert(() => g, ":first-child");
  s && t.look !== "handDrawn" && m.selectAll("path").attr("style", s), a && t.look !== "handDrawn" && m.selectAll("path").attr("style", a), X(t, m);
  const y = i?.padding ?? 0;
...
async function Wp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const n = 80, a = 50, { shapeSvg: o, bbox: s } = await it(e, t, et(t)), l = Math.max(n, s.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a, s.height + (t.padding ?? 0) * 2, t?.height ?? 0), h = c / 2, { cssStyles: u } = t, f = U.svg(o), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = [
    { x: -l / 2, y: -c / 2 },
    { x: l / 2 - h, y: -c / 2 },
    ...nl(-l / 2 + h, 0, h, 50, 90, 270),
    { x: l / 2 - h, y: c / 2 },
    { x: -l / 2, y: c / 2 }
  ], m = ct(g), y = f.path(m, d), x = o.insert(() => y, ":first-child");
  return x.attr("class", "basic label-container"), u && t.look !== "handDrawn" && x.selectChildren("path").attr("style", u), i && t.look !== "handDrawn" && x.selectChildren("path").attr("style", i), X(t, x), t.intersect = function(b) {
    return F.info("Pill intersect", t, { radius: h, point: b }), j.polygon(t, g, b);
  }, o;
}
p(Wp, "halfRoundedRectangle");
var Rk = /* @__PURE__ */ p((e, t, r, i, n) => [
  `M${e + n},${t}`,
  `L${e + r - n},${t}`,
  `L${e + r},${t - i / 2}`,
  `L${e + r - n},${t - i}`,
...
async function qp(e, t) {
  ...
  const { cssStyles: f } = t;
  if (t.look === "handDrawn") {
    const d = U.svg(n), g = G(t, {}), m = Rk(0, 0, c, s, l), y = d.path(m, g);
    u = n.insert(() => y, ":first-child").attr("transform", `translate(${-c / 2}, ${s / 2})`), f && u.attr("style", f);
  } else
    u = De(n, c, s, h);
  return i && u.attr("style", i), t.width = c, t.height = s, X(t, u), t.intersect = function(d) {
    return j.polygon(t, h, d);
  }, n;
}
p(qp, "hexagon");
async function Hp(e, t) {
  ...
  const { shapeSvg: n } = await it(e, t, et(t)), a = Math.max(30, t?.width ?? 0), o = Math.max(30, t?.height ?? 0), { cssStyles: s } = t, l = U.svg(n), c = G(t, {});
  ...
  const h = [
    ...
    { x: 0, y: o },
    { x: a, y: o }
  ], u = ct(h), f = l.path(u, c), d = n.insert(() => f, ":first-child");
  return d.attr("class", "basic label-container"), s && t.look !== "handDrawn" && d.selectChildren("path").attr("style", s), i && t.look !== "handDrawn" && d.selectChildren("path").attr("style", i), d.attr("transform", `translate(${-a / 2}, ${-o / 2})`), X(t, d), t.intersect = function(g) {
    return F.info("Pill intersect", t, { points: h }), j.polygon(t, h, g);
  }, n;
}
p(Hp, "hourglass");
async function jp(e, t, { config: { themeVariables: r, flowchart: i } }) {
  ...
  const { shapeSvg: c, bbox: h, label: u } = await it(e, t, "icon-shape default"), f = t.pos === "t", d = s, g = s, { nodeBorder: m } = r, { stylesMap: y } = Xr(t), x = -g / 2, b = -d / 2, w = t.label ? 8 : 0, C = U.svg(c), k = G(t, { stroke: "none", fill: "none" });
  t.look !== "handDrawn" && (k.roughness = 0, k.fillStyle = "solid");
  const L = C.rectangle(x, b, g, d, k), S = Math.max(g, h.width), D = d + h.height + w, R = C.rectangle(-S / 2, -D / 2, S, D, {
    ...k,
    fill: "transparent",
    stroke: "none"
  }), O = c.insert(() => L, ":first-child"), B = c.insert(() => R);
  if (t.icon) {
    const z = c.append("g");
    z.html(
      `<g>${await xa(t.icon, {
    ...
    const P = z.node().getBBox(), E = P.width, M = P.height, T = P.x, $ = P.y;
    z.attr(
      "transform",
      `translate(${-E / 2 - T},${f ? h.height / 2 + w / 2 - M / 2 - $ : -h.height / 2 - w / 2 - M / 2 - $})`
  ...
  ), X(t, B), t.intersect = function(z) {
    if (F.info("iconSquare intersect", t, z), !t.label)
      return j.rect(t, z);
    const P = t.x ?? 0, E = t.y ?? 0, M = t.height ?? 0;
    let T = [];
    return f ? T = [
      { x: P - h.width / 2, y: E - M / 2 },
      { x: P + h.width / 2, y: E - M / 2 },
      { x: P + h.width / 2, y: E - M / 2 + h.height + w },
      { x: P + g / 2, y: E - M / 2 + h.height + w },
      { x: P + g / 2, y: E + M / 2 },
      { x: P - g / 2, y: E + M / 2 },
      { x: P - g / 2, y: E - M / 2 + h.height + w },
      { x: P - h.width / 2, y: E - M / 2 + h.height + w }
      ...
      { x: P + g / 2, y: E - M / 2 },
      { x: P + g / 2, y: E - M / 2 + d },
      { x: P + h.width / 2, y: E - M / 2 + d },
      { x: P + h.width / 2 / 2, y: E + M / 2 },
      { x: P - h.width / 2, y: E + M / 2 },
      { x: P - h.width / 2, y: E - M / 2 + d },
      { x: P - g / 2, y: E - M / 2 + d }
    ], j.polygon(t, T, z);
...
async function Up(e, t, { config: { themeVariables: r, flowchart: i } }) {
  ...
  const a = t.assetHeight ?? 48, o = t.assetWidth ?? 48, s = Math.max(a, o), l = i?.wrappingWidth;
  t.width = Math.max(s, l ?? 0);
  const { shapeSvg: c, bbox: h, label: u } = await it(e, t, "icon-shape default"), f = 20, d = t.label ? 8 : 0, g = t.pos === "t", { nodeBorder: m, mainBkg: y } = r, { stylesMap: x } = Xr(t), b = U.svg(c), w = G(t, {});
  ...
  const L = k.node().getBBox(), S = L.width, D = L.height, R = L.x, O = L.y, B = Math.max(S, D) * Math.SQRT2 + f * 2, z = b.circle(0, 0, B, w), P = Math.max(B, h.width), E = B + h.height + d, M = b.rectangle(-P / 2, -E / 2, P, E, {
    ...w,
    fill: "transparent",
    stroke: "none"
  }), T = c.insert(() => z, ":first-child"), $ = c.insert(() => M);
  return k.attr(
    "transform",
    `translate(${-S / 2 - R},${g ? h.height / 2 + d / 2 - D / 2 - O : -h.height / 2 - d / 2 - D / 2 - O})`
  ...
  ), X(t, $), t.intersect = function(A) {
    return F.info("iconSquare intersect", t, A), j.rect(t, A);
  }, c;
}
p(Up, "iconCircle");
async function Yp(e, t, { config: { themeVariables: r, flowchart: i } }) {
  const { labelStyles: n } = V(t);
  t.labelStyle = n;
  const a = t.assetHeight ?? 48, o = t.assetWidth ?? 48, s = Math.max(a, o), l = i?.wrappingWidth;
  t.width = Math.max(s, l ?? 0);
  const { shapeSvg: c, bbox: h, halfPadding: u, label: f } = await it(
    ...
    t,
    "icon-shape default"
  ), d = t.pos === "t", g = s + u * 2, m = s + u * 2, { nodeBorder: y, mainBkg: x } = r, { stylesMap: b } = Xr(t), w = -m / 2, C = -g / 2, k = t.label ? 8 : 0, L = U.svg(c), S = G(t, {});
  t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
  const D = b.get("fill");
  S.stroke = D ?? x;
  const R = L.path(Oe(w, C, m, g, 5), S), O = Math.max(m, h.width), B = g + h.height + k, z = L.rectangle(-O / 2, -B / 2, O, B, {
    ...S,
    fill: "transparent",
    stroke: "none"
  }), P = c.insert(() => R, ":first-child").attr("class", "icon-shape2"), E = c.insert(() => z);
  if (t.icon) {
    const M = c.append("g");
    M.html(
      `<g>${await xa(t.icon, {
    ...
    const T = M.node().getBBox(), $ = T.width, A = T.height, N = T.x, q = T.y;
    M.attr(
      "transform",
      `translate(${-$ / 2 - N},${d ? h.height / 2 + k / 2 - A / 2 - q : -h.height / 2 - k / 2 - A / 2 - q})`
    ), M.attr("style", `color: ${b.get("stroke") ?? y};`);
  }
  return f.attr(
    "transform",
    `translate(${-h.width / 2 - (h.x - (h.left ?? 0))},${d ? -B / 2 : B / 2 - h.height})`
  ), P.attr(
    "transform",
    `translate(0,${d ? h.height / 2 + k / 2 : -h.height / 2 - k / 2})`
  ), X(t, E), t.intersect = function(M) {
    if (F.info("iconSquare intersect", t, M), !t.label)
      return j.rect(t, M);
    const T = t.x ?? 0, $ = t.y ?? 0, A = t.height ?? 0;
    let N = [];
    return d ? N = [
      { x: T - h.width / 2, y: $ - A / 2 },
      { x: T + h.width / 2, y: $ - A / 2 },
      { x: T + h.width / 2, y: $ - A / 2 + h.height + k },
      { x: T + m / 2, y: $ - A / 2 + h.height + k },
      { x: T + m / 2, y: $ + A / 2 },
      { x: T - m / 2, y: $ + A / 2 },
      { x: T - m / 2, y: $ - A / 2 + h.height + k },
      { x: T - h.width / 2, y: $ - A / 2 + h.height + k }
      ...
      { x: T + m / 2, y: $ - A / 2 },
      { x: T + m / 2, y: $ - A / 2 + g },
      { x: T + h.width / 2, y: $ - A / 2 + g },
      { x: T + h.width / 2 / 2, y: $ + A / 2 },
      { x: T - h.width / 2, y: $ + A / 2 },
      { x: T - h.width / 2, y: $ - A / 2 + g },
      { x: T - m / 2, y: $ - A / 2 + g }
    ], j.polygon(t, N, M);
...
p(Yp, "iconRounded");
async function Gp(e, t, { config: { themeVariables: r, flowchart: i } }) {
  const { labelStyles: n } = V(t);
  t.labelStyle = n;
  const a = t.assetHeight ?? 48, o = t.assetWidth ?? 48, s = Math.max(a, o), l = i?.wrappingWidth;
  t.width = Math.max(s, l ?? 0);
  ...
  const D = b.get("fill");
  S.stroke = D ?? x;
  const R = L.path(Oe(w, C, m, g, 0.1), S), O = Math.max(m, h.width), B = g + h.height + k, z = L.rectangle(-O / 2, -B / 2, O, B, {
    ...S,
    fill: "transparent",
    stroke: "none"
  }), P = c.insert(() => R, ":first-child"), E = c.insert(() => z);
  if (t.icon) {
    const M = c.append("g");
    M.html(
      `<g>${await xa(t.icon, {
...
p(Gp, "iconSquare");
async function Xp(e, t, { config: { flowchart: r } }) {
  const i = new Image();
  ...
  const { shapeSvg: u, bbox: f, label: d } = await it(e, t, "image-shape default"), g = t.pos === "t", m = -c / 2, y = -h / 2, x = t.label ? 8 : 0, b = U.svg(u), w = G(t, {});
  t.look !== "handDrawn" && (w.roughness = 0, w.fillStyle = "solid");
  const C = b.rectangle(m, y, c, h, w), k = Math.max(c, f.width), L = h + f.height + x, S = b.rectangle(-k / 2, -L / 2, k, L, {
    ...w,
    fill: "none",
    stroke: "none"
  }), D = u.insert(() => C, ":first-child"), R = u.insert(() => S);
  if (t.img) {
  ...
  ), X(t, R), t.intersect = function(O) {
    if (F.info("iconSquare intersect", t, O), !t.label)
      return j.rect(t, O);
    const B = t.x ?? 0, z = t.y ?? 0, P = t.height ?? 0;
    let E = [];
    return g ? E = [
      { x: B - f.width / 2, y: z - P / 2 },
      { x: B + f.width / 2, y: z - P / 2 },
      { x: B + f.width / 2, y: z - P / 2 + f.height + x },
      { x: B + c / 2, y: z - P / 2 + f.height + x },
      { x: B + c / 2, y: z + P / 2 },
      { x: B - c / 2, y: z + P / 2 },
      { x: B - c / 2, y: z - P / 2 + f.height + x },
      { x: B - f.width / 2, y: z - P / 2 + f.height + x }
      ...
      { x: B + c / 2, y: z - P / 2 },
      { x: B + c / 2, y: z - P / 2 + h },
      { x: B + f.width / 2, y: z - P / 2 + h },
      { x: B + f.width / 2 / 2, y: z + P / 2 },
      { x: B - f.width / 2, y: z + P / 2 },
      { x: B - f.width / 2, y: z - P / 2 + h },
      { x: B - c / 2, y: z - P / 2 + h }
    ], j.polygon(t, E, O);
...
async function Vp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), l = [
    { x: 0, y: 0 },
    { x: o, y: 0 },
    { x: o + 3 * s / 6, y: -s },
    { x: -3 * s / 6, y: -s }
  ...
  const { cssStyles: h } = t;
  if (t.look === "handDrawn") {
    const u = U.svg(n), f = G(t, {}), d = ct(l), g = u.path(d, f);
    c = n.insert(() => g, ":first-child").attr("transform", `translate(${-o / 2}, ${s / 2})`), h && c.attr("style", h);
  } else
    c = De(n, o, s, l);
  return i && c.attr("style", i), t.width = o, t.height = s, X(t, c), t.intersect = function(u) {
...
async function Gi(e, t, r) {
  const { labelStyles: i, nodeStyles: n } = V(t);
  t.labelStyle = i;
  const { shapeSvg: a, bbox: o } = await it(e, t, et(t)), s = Math.max(o.width + r.labelPaddingX * 2, t?.width || 0), l = Math.max(o.height + r.labelPaddingY * 2, t?.height || 0), c = -s / 2, h = -l / 2;
  let u, { rx: f, ry: d } = t;
  const { cssStyles: g } = t;
  if (r?.rx && r.ry && (f = r.rx, d = r.ry), t.look === "handDrawn") {
    const m = U.svg(a), y = G(t, {}), x = f || d ? m.path(Oe(c, h, s, l, f || 0), y) : m.rectangle(c, h, s, l, y);
    u = a.insert(() => x, ":first-child"), u.attr("class", "basic label-container").attr("style", Pt(g));
  } else
    u = a.insert("rect", ":first-child"), u.attr("class", "basic label-container").attr("style", n).attr("rx", Pt(f)).attr("ry", Pt(d)).attr("x", c).attr("y", h).attr("width", s).attr("height", l);
  return X(t, u), t.intersect = function(m) {
    return j.rect(t, m);
  }, a;
}
p(Gi, "drawRect");
...
async function Kp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = Math.max(a.width + (t.padding ?? 0), t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0), t?.height ?? 0), l = [
    { x: 0, y: 0 },
    { x: o + 3 * s / 6, y: 0 },
    { x: o, y: -s },
    { x: -(3 * s) / 6, y: -s }
...
function Jp(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.label = "", t.labelStyle = r;
  const n = e.insert("g").attr("class", et(t)).attr("id", t.domId ?? t.id), { cssStyles: a } = t, o = Math.max(35, t?.width ?? 0), s = Math.max(35, t?.height ?? 0), l = 7, c = [
    { x: o, y: 0 },
    { x: 0, y: s + l / 2 },
    { x: o - 2 * l, y: s + l / 2 },
    { x: 0, y: 2 * s },
  ...
  const f = ct(c), d = h.path(f, u), g = n.insert(() => d, ":first-child");
  return a && t.look !== "handDrawn" && g.selectAll("path").attr("style", a), i && t.look !== "handDrawn" && g.selectAll("path").attr("style", i), g.attr("transform", `translate(-${o / 2},${-s})`), X(t, g), t.intersect = function(m) {
    return F.info("lightningBolt intersect", t, m), j.polygon(t, c, m);
  }, n;
}
p(Jp, "lightningBolt");
var Ik = /* @__PURE__ */ p((e, t, r, i, n, a, o) => [
  `M${e},${t + a}`,
  `a${n},${a} 0,0,0 ${r},0`,
  `a${n},${a} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + a + o}`,
  `a${n},${a} 0,0,0 ${r},0`
].join(" "), "createCylinderPathD"), Pk = /* @__PURE__ */ p((e, t, r, i, n, a, o) => [
  `M${e},${t + a}`,
  `M${e + r},${t + a}`,
  `a${n},${a} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + a + o}`,
  `a${n},${a} 0,0,0 ${r},0`
].join(" "), "createOuterCylinderPathD"), Nk = /* @__PURE__ */ p((e, t, r, i, n, a) => [`M${e - r / 2},${-i / 2}`, `a${n},${a} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD");
async function tg(e, t) {
  ...
  const { cssStyles: d } = t;
  if (t.look === "handDrawn") {
    const g = U.svg(n), m = Pk(0, 0, s, h, l, c, u), y = Nk(0, c, s, h, l, c), x = G(t, {}), b = g.path(m, x), w = g.path(y, x);
    n.insert(() => w, ":first-child").attr("class", "line"), f = n.insert(() => b, ":first-child"), f.attr("class", "basic label-container"), d && f.attr("style", d);
  } else {
    const g = Ik(0, 0, s, h, l, c, u);
    f = n.insert("path", ":first-child").attr("d", g).attr("class", "basic label-container").attr("style", Pt(d)).attr("style", i);
  }
  return f.attr("label-offset-y", c), f.attr("transform", `translate(${-s / 2}, ${-(h / 2 + c)})`), X(t, f), o.attr(
    "transform",
    `translate(${-(a.width / 2) - (a.x - (a.left ?? 0))}, ${-(a.height / 2) + c - (a.y - (a.top ?? 0))})`
  ), t.intersect = function(g) {
    const m = j.rect(t, g), y = m.x - (t.x ?? 0);
...
async function eg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = l / 4, h = l + c, { cssStyles: u } = t, f = U.svg(n), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = [
    { x: -s / 2 - s / 2 * 0.1, y: -h / 2 },
    { x: -s / 2 - s / 2 * 0.1, y: h / 2 },
  ...
  ), X(t, y), t.intersect = function(x) {
    return j.polygon(t, g, x);
  }, n;
}
p(eg, "linedWaveEdgedRect");
async function rg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = 5, h = -s / 2, u = -l / 2, { cssStyles: f } = t, d = U.svg(n), g = G(t, {}), m = [
    { x: h - c, y: u + c },
    { x: h - c, y: u + l + c },
    { x: h + s - c, y: u + l + c },
    { x: h + s - c, y: u + l },
  ...
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const x = ct(m), b = d.path(x, g), w = ct(y), C = d.path(w, { ...g, fill: "none" }), k = n.insert(() => C, ":first-child");
  ...
  ), X(t, k), t.intersect = function(L) {
    return j.polygon(t, m, L);
  }, n;
}
p(rg, "multiRect");
async function ig(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = l / 4, h = l + c, u = -s / 2, f = -h / 2, d = 5, { cssStyles: g } = t, m = Ye(
    u - d,
    f + h + d,
    u + s - d,
    f + h + d,
  ...
  t.look !== "handDrawn" && (C.roughness = 0, C.fillStyle = "solid");
  const k = ct(x), L = w.path(k, C), S = ct(b), D = w.path(S, C), R = n.insert(() => L, ":first-child");
  return R.insert(() => D), R.attr("class", "basic label-container"), g && t.look !== "handDrawn" && R.selectAll("path").attr("style", g), i && t.look !== "handDrawn" && R.selectAll("path").attr("style", i), R.attr("transform", `translate(0,${-c / 2})`), o.attr(
    ...
    return j.polygon(t, x, O);
  }, n;
}
p(ig, "multiWaveEdgedRectangle");
async function ng(e, t, { config: { themeVariables: r } }) {
  const { labelStyles: i, nodeStyles: n } = V(t);
  t.labelStyle = i, t.useHtmlLabels || Yt().flowchart?.htmlLabels !== !1 || (t.centerLabel = !0);
  const { shapeSvg: o, bbox: s } = await it(e, t, et(t)), l = Math.max(s.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(s.height + (t.padding ?? 0) * 2, t?.height ?? 0), h = -l / 2, u = -c / 2, { cssStyles: f } = t, d = U.svg(o), g = G(t, {
    fill: r.noteBkgColor,
    stroke: r.noteBorderColor
  });
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const m = d.rectangle(h, u, l, c, g), y = o.insert(() => m, ":first-child");
  return y.attr("class", "basic label-container"), f && t.look !== "handDrawn" && y.selectAll("path").attr("style", f), n && t.look !== "handDrawn" && y.selectAll("path").attr("style", n), X(t, y), t.intersect = function(x) {
    return j.rect(t, x);
  }, o;
}
p(ng, "note");
var zk = /* @__PURE__ */ p((e, t, r) => [
  `M${e + r / 2},${t}`,
  `L${e + r},${t - r / 2}`,
  `L${e + r / 2},${t - r}`,
  `L${e},${t - r / 2}`,
...
async function ag(e, t) {
  ...
  const { cssStyles: u } = t;
  if (t.look === "handDrawn") {
    const f = U.svg(n), d = G(t, {}), g = zk(0, 0, l), m = f.path(g, d);
    h = n.insert(() => m, ":first-child").attr("transform", `translate(${-l / 2}, ${l / 2})`), u && h.attr("style", u);
  } else
    h = De(n, l, l, c);
  return i && h.attr("style", i), X(t, h), t.intersect = function(f) {
    return F.debug(
...
async function sg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0), t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0), t?.height ?? 0), c = -s / 2, h = -l / 2, u = h / 2, f = [
    { x: c + u, y: h },
    { x: c, y: 0 },
    { x: c + u, y: -h },
    { x: -c, y: -h },
    { x: -c, y: h }
  ], { cssStyles: d } = t, g = U.svg(n), m = G(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = ct(f), x = g.path(y, m), b = n.insert(() => x, ":first-child");
  ...
  ), X(t, b), t.intersect = function(w) {
    return j.polygon(t, f, w);
  }, n;
}
p(sg, "rect_left_inv_arrow");
async function og(e, t) {
  ...
  if (vt(ht()?.flowchart?.htmlLabels)) {
    const D = h.children[0], R = lt(h);
    u = D.getBoundingClientRect(), R.attr("width", u.width), R.attr("height", u.height);
  }
  F.info("Text 2", l);
  ...
  const b = u.width + (t.padding || 0), w = u.height + (t.padding || 0), C = -u.width / 2 - x, k = -u.height / 2 - x;
  let L, S;
  if (t.look === "handDrawn") {
    const D = U.svg(a), R = G(t, {}), O = D.path(
      Oe(C, k, b, w, t.rx || 0),
      R
    ), B = D.line(
      -u.width / 2 - x,
...
async function cg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = t?.padding ?? 0, l = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), h = -a.width / 2 - s, u = -a.height / 2 - s, { cssStyles: f } = t, d = U.svg(n), g = G(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const m = [
    { x: h, y: u },
    { x: h + l + 8, y: u },
  ...
  return x.attr("class", "basic label-container").attr("style", Pt(f)), i && t.look !== "handDrawn" && x.selectAll("path").attr("style", i), f && t.look !== "handDrawn" && x.selectAll("path").attr("style", i), o.attr(
    "transform",
...
async function hg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = -s / 2, h = -l / 2, { cssStyles: u } = t, f = U.svg(n), d = G(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  const g = [
    { x: c, y: h },
    { x: c, y: h + l },
    { x: c + s, y: h + l },
    { x: c + s, y: h - l / 2 }
  ], m = ct(g), y = f.path(m, d), x = n.insert(() => y, ":first-child");
...
async function fg(e, t) {
  ...
  const { cssStyles: c } = t;
  if (t.look === "handDrawn") {
    const h = U.svg(n), u = G(t, {}), f = Oe(-s / 2, -o / 2, s, o, o / 2), d = h.path(f, u);
    l = n.insert(() => d, ":first-child"), l.attr("class", "basic label-container").attr("style", Pt(c));
  } else
...
p(dg, "state");
function pg(e, t, { config: { themeVariables: r } }) {
  const { labelStyles: i, nodeStyles: n } = V(t);
  t.labelStyle = i;
  const { cssStyles: a } = t, { lineColor: o, stateBorder: s, nodeBorder: l } = r, c = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), h = U.svg(c), u = G(t, {});
  t.look !== "handDrawn" && (u.roughness = 0, u.fillStyle = "solid");
  ...
  return m.insert(() => g), a && m.selectAll("path").attr("style", a), n && m.selectAll("path").attr("style", n), X(t, m), t.intersect = function(y) {
...
function gg(e, t, { config: { themeVariables: r } }) {
  ...
  let a;
  if (t.look === "handDrawn") {
    const s = U.svg(n).circle(0, 0, 14, wk(i));
  ...
  return X(t, a), t.intersect = function(o) {
...
async function mg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = (t?.padding || 0) / 2, s = a.width + t.padding, l = a.height + t.padding, c = -a.width / 2 - o, h = -a.height / 2 - o, u = [
    { x: 0, y: 0 },
    { x: s, y: 0 },
    { x: s, y: -l },
    { x: 0, y: -l },
  ...
  if (t.look === "handDrawn") {
    const f = U.svg(n), d = G(t, {}), g = f.rectangle(c - 8, h, s + 16, l, d), m = f.line(c, h, c, h + l, d), y = f.line(c + s, h, c + s, h + l, d);
    n.insert(() => m, ":first-child"), n.insert(() => y, ":first-child");
    const x = n.insert(() => g, ":first-child"), { cssStyles: b } = t;
    x.attr("class", "basic label-container").attr("style", Pt(b)), X(t, x);
  } else {
    const f = De(n, s, l, u);
    i && f.attr("style", i), X(t, f);
  }
...
async function yg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), l = -o / 2, c = -s / 2, h = 0.2 * s, u = 0.2 * s, { cssStyles: f } = t, d = U.svg(n), g = G(t, {}), m = [
    { x: l - h / 2, y: c },
    { x: l + o + h / 2, y: c },
    { x: l + o + h / 2, y: c + s },
    { x: l - h / 2, y: c + s }
  ...
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const x = ct(m), b = d.path(x, g), w = ct(y), C = d.path(w, { ...g, fillStyle: "solid" }), k = n.insert(() => C, ":first-child");
  return k.insert(() => b, ":first-child"), k.attr("class", "basic label-container"), f && t.look !== "handDrawn" && k.selectAll("path").attr("style", f), i && t.look !== "handDrawn" && k.selectAll("path").attr("style", i), X(t, k), t.intersect = function(L) {
    return j.polygon(t, m, L);
  }, n;
}
p(yg, "taggedRect");
async function xg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = l / 4, h = 0.2 * s, u = 0.2 * l, f = l + c, { cssStyles: d } = t, g = U.svg(n), m = G(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = [
    { x: -s / 2 - s / 2 * 0.1, y: f / 2 },
    ...Ye(
  ...
  ], C = ct(y), k = g.path(C, m), L = ct(w), S = g.path(L, {
    ...m,
    fillStyle: "solid"
  }), D = n.insert(() => S, ":first-child");
  return D.insert(() => k, ":first-child"), D.attr("class", "basic label-container"), d && t.look !== "handDrawn" && D.selectAll("path").attr("style", d), i && t.look !== "handDrawn" && D.selectAll("path").attr("style", i), D.attr("transform", `translate(0,${-c / 2})`), o.attr(
    "transform",
    `translate(${-s / 2 + (t.padding ?? 0) - (a.x - (a.left ?? 0))},${-l / 2 + (t.padding ?? 0) - c / 2 - (a.y - (a.top ?? 0))})`
  ), X(t, D), t.intersect = function(R) {
    return j.polygon(t, y, R);
  }, n;
}
p(xg, "taggedWaveEdgedRectangle");
async function bg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = Math.max(a.width + t.padding, t?.width || 0), s = Math.max(a.height + t.padding, t?.height || 0), l = -o / 2, c = -s / 2, h = n.insert("rect", ":first-child");
  return h.attr("class", "text").attr("style", i).attr("rx", 0).attr("ry", 0).attr("x", l).attr("y", c).attr("width", o).attr("height", s), X(t, h), t.intersect = function(u) {
    return j.rect(t, u);
  }, n;
}
p(bg, "text");
var Wk = /* @__PURE__ */ p((e, t, r, i, n, a) => `M${e},${t}
    a${n},${a} 0,0,1 0,${-i}
    l${r},0
    a${n},${a} 0,0,1 0,${i}
    M${r},${-i}
    a${n},${a} 0,0,0 0,${i}
    l${-r},0`, "createCylinderPathD"), qk = /* @__PURE__ */ p((e, t, r, i, n, a) => [
  `M${e},${t}`,
  `M${e + r},${t}`,
  `a${n},${a} 0,0,0 0,${-i}`,
  `l${-r},0`,
  `a${n},${a} 0,0,0 0,${i}`,
  `l${r},0`
].join(" "), "createOuterCylinderPathD"), Hk = /* @__PURE__ */ p((e, t, r, i, n, a) => [`M${e + r / 2},${-i / 2}`, `a${n},${a} 0,0,0 0,${i}`].join(" "), "createInnerCylinderPathD");
async function wg(e, t) {
  ...
  let g;
  if (t.look === "handDrawn") {
    const m = U.svg(n), y = qk(0, 0, f, c, u, h), x = Hk(0, 0, f, c, u, h), b = m.path(y, G(t, {})), w = m.path(x, G(t, { fill: "none" }));
    g = n.insert(() => w, ":first-child"), g = n.insert(() => b, ":first-child"), g.attr("class", "basic label-container"), d && g.attr("style", d);
  } else {
    const m = Wk(0, 0, f, c, u, h);
    g = n.insert("path", ":first-child").attr("d", m).attr("class", "basic label-container").attr("style", Pt(d)).attr("style", i), g.attr("class", "basic label-container"), d && g.selectAll("path").attr("style", d), i && g.selectAll("path").attr("style", i);
  }
...
async function _g(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = 60, s = 20, l = Math.max(o, a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(s, a.height + (t.padding ?? 0) * 2, t?.height ?? 0), { cssStyles: h } = t, u = U.svg(n), f = G(t, {});
  ...
  const d = [
    ...
    { x: -l / 2, y: c / 2 },
    { x: -l / 2, y: -c / 2 * 0.6 }
  ], g = ct(d), m = u.path(g, f), y = n.insert(() => m, ":first-child");
  return y.attr("class", "basic label-container"), h && t.look !== "handDrawn" && y.selectChildren("path").attr("style", h), i && t.look !== "handDrawn" && y.selectChildren("path").attr("style", i), X(t, y), t.intersect = function(x) {
    return j.polygon(t, d, x);
  }, n;
}
p(_g, "trapezoidalPentagon");
async function Cg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = vt(ht().flowchart?.htmlLabels), l = a.width + (t.padding ?? 0), c = l + a.height, h = l + a.height, u = [
    { x: 0, y: 0 },
    { x: h, y: 0 },
    { x: h / 2, y: -c }
  ], { cssStyles: f } = t, d = U.svg(n), g = G(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const m = ct(u), y = d.path(m, g), x = n.insert(() => y, ":first-child").attr("transform", `translate(${-c / 2}, ${c / 2})`);
  return f && t.look !== "handDrawn" && x.selectChildren("path").attr("style", f), i && t.look !== "handDrawn" && x.selectChildren("path").attr("style", i), t.width = l, t.height = c, X(t, x), o.attr(
    "transform",
    `translate(${-a.width / 2 - (a.x - (a.left ?? 0))}, ${c / 2 - (a.height + (t.padding ?? 0) / (s ? 2 : 1) - (a.y - (a.top ?? 0)))})`
  ), t.intersect = function(b) {
    return F.info("Triangle intersect", t, u, b), j.polygon(t, u, b);
  }, n;
}
p(Cg, "triangle");
async function kg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a, label: o } = await it(e, t, et(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = l / 8, h = l + c, { cssStyles: u } = t, d = 70 - s, g = d > 0 ? d / 2 : 0, m = U.svg(n), y = G(t, {});
  ...
  const x = [
    ...
    { x: s / 2 + g, y: -h / 2 },
    { x: -s / 2 - g, y: -h / 2 }
  ], b = ct(x), w = m.path(b, y), C = n.insert(() => w, ":first-child");
  return C.attr("class", "basic label-container"), u && t.look !== "handDrawn" && C.selectAll("path").attr("style", u), i && t.look !== "handDrawn" && C.selectAll("path").attr("style", i), C.attr("transform", `translate(0,${-c / 2})`), o.attr(
    ...
    return j.polygon(t, x, k);
  }, n;
}
p(kg, "waveEdgedRectangle");
async function Sg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: n, bbox: a } = await it(e, t, et(t)), o = 100, s = 50, l = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), h = l / c;
  let u = l, f = c;
  u > f * h ? f = u / h : u = f * h, u = Math.max(u, o), f = Math.max(f, s);
  const d = Math.min(f * 0.2, f / 4), g = f + d * 2, { cssStyles: m } = t, y = U.svg(n), x = G(t, {});
  t.look !== "handDrawn" && (x.roughness = 0, x.fillStyle = "solid");
  const b = [
    { x: -u / 2, y: g / 2 },
    ...Ye(-u / 2, g / 2, u / 2, g / 2, d, 1),
    { x: u / 2, y: -g / 2 },
    ...Ye(u / 2, -g / 2, -u / 2, -g / 2, d, -1)
  ], w = ct(b), C = y.path(w, x), k = n.insert(() => C, ":first-child");
  return k.attr("class", "basic label-container"), m && t.look !== "handDrawn" && k.selectAll("path").attr("style", m), i && t.look !== "handDrawn" && k.selectAll("path").attr("style", i), X(t, k), t.intersect = function(L) {
    return j.polygon(t, b, L);
  }, n;
}
p(Sg, "waveRectangle");
...
async function al(e, t) {
  ...
  if (r.alias && (t.label = r.alias), t.look === "handDrawn") {
    const { themeVariables: N } = Yt(), { background: q } = N, Z = {
      ...t,
      id: t.id + "-background",
      look: "default",
  ...
  const { cssStyles: o } = t, { labelStyles: s } = V(t);
  if (r.attributes.length === 0 && t.label) {
    ...
    Ee(t.label, i) + N.labelPaddingX * 2 < i.er.minEntityWidth && (t.width = i.er.minEntityWidth);
    const q = await Gi(e, t, N);
    if (!vt(i.htmlLabels)) {
      const Z = q.select("text"), at = Z.node()?.getBBox();
      Z.attr("transform", `translate(${-at.width / 2}, 0)`);
    }
    return q;
  }
  ...
  let l = et(t);
  l || (l = "node default");
  const c = e.insert("g").attr("class", l).attr("id", t.domId || t.id), h = await Br(c, t.label ?? "", i, 0, 0, ["name"], s);
  h.height += a;
  let u = 0;
  const f = [];
  let d = 0, g = 0, m = 0, y = 0, x = !0, b = !0;
  for (const N of r.attributes) {
    ...
    y = Math.max(y, nt.width + n), u += Math.max(q.height, Z.height, at.height, nt.height) + a, f.push(u);
  }
  f.pop();
  let w = 4;
  m <= n && (x = !1, m = 0, w--), y <= n && (b = !1, y = 0, w--);
  const C = c.node().getBBox();
  if (h.width + n * 2 - (d + g + m + y) > 0) {
    const N = h.width + n * 2 - (d + g + m + y);
    d += N / w, g += N / w, m > 0 && (m += N / w), y > 0 && (y += N / w);
  }
  const k = d + g + m + y, L = U.svg(c), S = G(t, {});
  t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
  const D = Math.max(C.width + n * 2, t?.width || 0, k), R = Math.max(C.height + (f[0] || u) + a, t?.height || 0), O = -D / 2, B = -R / 2;
  c.selectAll("g:not(:first-child)").each((N, q, Z) => {
    const at = lt(Z[q]), nt = at.attr("transform");
    let dt = 0, st = 0;
    if (nt) {
      const $t = RegExp(/translate\(([^,]+),([^)]+)\)/).exec(nt);
      $t && (dt = parseFloat($t[1]), st = parseFloat($t[2]), at.attr("class").includes("attribute-name") ? dt += d : at.attr("class").includes("attribute-keys") ? dt += d + g : at.attr("class").includes("attribute-comment") && (dt += d + g + m));
    }
    at.attr(
      "transform",
      `translate(${O + n / 2 + dt}, ${st + B + h.height + a / 2})`
    );
  }), c.select(".name").attr("transform", "translate(" + -h.width / 2 + ", " + (B + a / 2) + ")");
  const z = L.rectangle(O, B, D, R, S), P = c.insert(() => z, ":first-child").attr("style", o.join("")), { themeVariables: E } = Yt(), { rowEven: M, rowOdd: T, nodeBorder: $ } = E;
  f.push(0);
  for (const [N, q] of f.entries()) {
    if (N === 0 && f.length > 1)
      continue;
    const Z = N % 2 === 0 && q !== 0, at = L.rectangle(O, h.height + B + q, D, h.height, {
      ...S,
      fill: Z ? M : T,
      stroke: $
    });
    c.insert(() => at, "g.label").attr("style", o.join("")).attr("class", `row-rect-${N % 2 === 0 ? "even" : "odd"}`);
  }
  let A = L.line(O, h.height + B, D + O, h.height + B, S);
  c.insert(() => A).attr("class", "divider"), A = L.line(d + O, h.height + B, d + O, R + B, S), c.insert(() => A).attr("class", "divider"), x && (A = L.line(
    d + g + O,
    h.height + B,
    d + g + O,
    R + B,
    S
  ), c.insert(() => A).attr("class", "divider")), b && (A = L.line(
    d + g + m + O,
    h.height + B,
    d + g + m + O,
    R + B,
    S
  ), c.insert(() => A).attr("class", "divider"));
  for (const N of f)
    A = L.line(
      O,
      h.height + B + N,
...
p(al, "erBox");
async function Br(e, t, r, i = 0, n = 0, a = [], o = "") {
...
p(Br, "addText");
async function Bg(e, t, r, i, n = r.class.padding ?? 12) {
...
async function yi(e, t, r, i = []) {
  const n = e.insert("g").attr("class", "label").attr("style", i.join("; ")), a = Yt();
  let o = "useHtmlLabels" in t ? t.useHtmlLabels : vt(a.htmlLabels) ?? !0, s = "";
  "text" in t ? s = t.text : s = t.label, !o && s.startsWith("\\") && (s = s.substring(1)), Rr(s) && (o = !0);
  const l = await Ve(
    n,
    go(yr(s)),
    {
      ...
      await Promise.all(
        [...d].map(
          (m) => new Promise((y) => {
            function x() {
              if (m.style.display = "flex", m.style.flexDirection = "column", g) {
                const b = a.fontSize?.toString() ?? window.getComputedStyle(document.body).fontSize, C = parseInt(b, 10) * 5 + "px";
...
p(yi, "addText");
async function Lg(e, t) {
  const r = ht(), i = r.class.padding ?? 12, n = i, a = t.useHtmlLabels ?? vt(r.htmlLabels) ?? !0, o = t;
  o.annotations = o.annotations ?? [], o.members = o.members ?? [], o.methods = o.methods ?? [];
  const { shapeSvg: s, bbox: l } = await Bg(e, t, r, a, n), { labelStyles: c, nodeStyles: h } = V(t);
  t.labelStyle = c, t.cssStyles = o.styles || "";
  const u = o.styles?.join(";") || h || "";
  t.cssStyles || (t.cssStyles = u.replaceAll("!important", "").split(";"));
  const f = o.members.length === 0 && o.methods.length === 0 && !r.class?.hideEmptyMembersBox, d = U.svg(s), g = G(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  const m = l.width;
  let y = l.height;
  o.members.length === 0 && o.methods.length === 0 ? y += n : o.members.length > 0 && o.methods.length === 0 && (y += n * 2);
  const x = -m / 2, b = -y / 2, w = d.rectangle(
    x - i,
    b - i - (f ? i : o.members.length === 0 && o.methods.length === 0 ? -i / 2 : 0),
    m + 2 * i,
    y + 2 * i + (f ? i * 2 : o.members.length === 0 && o.methods.length === 0 ? -i : 0),
    g
  ), C = s.insert(() => w, ":first-child");
  C.attr("class", "basic label-container");
  const k = C.node().getBBox();
  s.selectAll(".text").each((R, O, B) => {
    const z = lt(B[O]), P = z.attr("transform");
    let E = 0;
    if (P) {
      const A = RegExp(/translate\(([^,]+),([^)]+)\)/).exec(P);
      A && (E = parseFloat(A[2]));
    }
    let M = E + b + i - (f ? i : o.members.length === 0 && o.methods.length === 0 ? -i / 2 : 0);
    a || (M -= 4);
    let T = x;
    (z.attr("class").includes("label-group") || z.attr("class").includes("annotation-group")) && (T = -z.node()?.getBBox().width / 2 || 0, s.selectAll("text").each(function($, A, N) {
      window.getComputedStyle(N[A]).textAnchor === "middle" && (T = 0);
    })), z.attr("transform", `translate(${T}, ${M})`);
  });
  const L = s.select(".annotation-group").node().getBBox().height - (f ? i / 2 : 0) || 0, S = s.select(".label-group").node().getBBox().height - (f ? i / 2 : 0) || 0, D = s.select(".members-group").node().getBBox().height - (f ? i / 2 : 0) || 0;
  if (o.members.length > 0 || o.methods.length > 0 || f) {
    ...
    s.insert(() => R).attr("class", "divider").attr("style", u);
  }
  ...
  if (o.look !== "handDrawn" && s.selectAll("path").attr("style", u), C.select(":nth-child(2)").attr("style", u), s.selectAll(".divider").select("path").attr("style", u), t.labelStyle ? s.selectAll("span").attr("style", t.labelStyle) : s.selectAll("span").attr("style", u), !a) {
    const R = RegExp(/color\s*:\s*([^;]*)/), O = R.exec(u);
    if (O) {
      ...
      const B = R.exec(c);
      if (B) {
        const z = B[0].replace("color", "fill");
        s.selectAll("tspan").attr("style", z);
      }
    }
  }
  return X(t, C), t.intersect = function(R) {
    return j.rect(t, R);
  }, s;
}
p(Lg, "classBox");
async function Ag(e, t) {
  ...
  l ? u = await de(
    ...
    0,
    t.labelStyle
  ) : u = await de(h, "&lt;&lt;Element&gt;&gt;", 0, t.labelStyle);
  let f = u;
  const d = await de(
    h,
    n.name,
  ...
  const g = (h.node()?.getBBox().width ?? 200) + o, m = (h.node()?.getBBox().height ?? 200) + o, y = -g / 2, x = -m / 2, b = U.svg(h), w = G(t, {});
  t.look !== "handDrawn" && (w.roughness = 0, w.fillStyle = "solid");
  const C = b.rectangle(y, x, g, m, w), k = h.insert(() => C, ":first-child");
  if (k.attr("class", "basic label-container").attr("style", i), h.selectAll(".label").each((L, S, D) => {
    const R = lt(D[S]), O = R.attr("transform");
    let B = 0, z = 0;
    if (O) {
      const T = RegExp(/translate\(([^,]+),([^)]+)\)/).exec(O);
      T && (B = parseFloat(T[1]), z = parseFloat(T[2]));
    }
    const P = z - m / 2;
    let E = y + o / 2;
    (S === 0 || S === 1) && (E = B), R.attr("transform", `translate(${E}, ${P + o})`);
  }), f > u + d + s) {
    const L = b.line(
      y,
      x + u + d + s,
  ...
  return X(t, k), t.intersect = function(L) {
    return j.rect(t, L);
  }, h;
}
p(Ag, "requirementBox");
async function de(e, t, r, i = "") {
  if (t === "")
    return 0;
  const n = e.insert("g").attr("class", "label").attr("style", i), a = ht(), o = a.htmlLabels ?? !0, s = await Ve(
    n,
    go(yr(t)),
    {
      width: Ee(t, a) + 50,
...
async function Mg(e, t, { config: r }) {
  const { labelStyles: i, nodeStyles: n } = V(t);
  t.labelStyle = i || "";
  ...
  let u = "", f;
  "ticket" in t && t.ticket && r?.kanban?.ticketBaseUrl && (u = r?.kanban?.ticketBaseUrl.replace("#TICKET#", t.ticket), f = s.insert("svg:a", ":first-child").attr("class", "kanban-ticket-link").attr("xlink:href", u).attr("target", "_blank"));
  const d = {
  ...
  let g, m;
  f ? { label: g, bbox: m } = await hs(
    f,
    "ticket" in t && t.ticket || "",
    d
  ) : { label: g, bbox: m } = await hs(
    s,
    "ticket" in t && t.ticket || "",
    d
  );
  const { label: y, bbox: x } = await hs(
    s,
    "assigned" in t && t.assigned || "",
    d
  );
  t.width = o;
  const b = 10, w = t?.width || 0, C = Math.max(m.height, x.height) / 2, k = Math.max(l.height + b * 2, t?.height || 0) + C, L = -w / 2, S = -k / 2;
  c.attr(
    "transform",
    "translate(" + (h - w / 2) + ", " + (-C - l.height / 2) + ")"
  ), g.attr(
    "transform",
    "translate(" + (h - w / 2) + ", " + (-C + l.height / 2) + ")"
  ), y.attr(
    "transform",
    "translate(" + (h + w / 2 - x.width - 2 * a) + ", " + (-C + l.height / 2) + ")"
  );
  let D;
  const { rx: R, ry: O } = t, { cssStyles: B } = t;
  if (t.look === "handDrawn") {
    const z = U.svg(s), P = G(t, {}), E = R || O ? z.path(Oe(L, S, w, k, R || 0), P) : z.rectangle(L, S, w, k, P);
    D = s.insert(() => E, ":first-child"), D.attr("class", "basic label-container").attr("style", B || null);
  } else {
    D = s.insert("rect", ":first-child"), D.attr("class", "basic label-container __APA__").attr("style", n).attr("rx", R ?? 5).attr("ry", O ?? 5).attr("x", L).attr("y", S).attr("width", w).attr("height", k);
    const z = "priority" in t && t.priority;
    if (z) {
      const P = s.append("line"), E = L + 2, M = S + Math.floor((R ?? 0) / 2), T = S + k - Math.floor((R ?? 0) / 2);
      P.attr("x1", E).attr("y1", M).attr("x2", E).attr("y2", T).attr("stroke-width", "4").attr("stroke", jk(z));
    }
  }
  return X(t, D), t.height = k, t.intersect = function(z) {
    return j.rect(t, z);
  }, s;
}
p(Mg, "kanbanItem");
...
async function $g(e, t, r) {
  ...
  const a = t.shape ? Eg[t.shape] : void 0;
  if (!a)
  ...
  if (t.link) {
    ...
    n = await a(e, t, r), i = n;
  return t.tooltip && n.attr("title", t.tooltip), Da.set(t.id, i), t.haveCallback && i.attr("class", i.attr("class") + " clickable"), i;
}
p($g, "insertNode");
var rA = /* @__PURE__ */ p((e, t) => {
  Da.set(t.id, e);
}, "setNodeElem"), iA = /* @__PURE__ */ p(() => {
  Da.clear();
}, "clear"), nA = /* @__PURE__ */ p((e) => {
  const t = Da.get(e.id);
  F.trace(
    "Transforming node",
    e.diff,
...
}, "positionNode"), Xk = /* @__PURE__ */ p((e, t, r, i, n, a) => {
  t.arrowTypeStart && Vc(e, "start", t.arrowTypeStart, r, i, n, a), t.arrowTypeEnd && Vc(e, "end", t.arrowTypeEnd, r, i, n, a);
}, "addEdgeMarkers"), Vk = {
  ...
  if (o && o.trim() !== "") {
    const u = o.replace(/[^\dA-Za-z]/g, "_"), f = `${h}_${u}`;
...
}, "addEdgeMarker"), ca = /* @__PURE__ */ new Map(), Tt = /* @__PURE__ */ new Map(), aA = /* @__PURE__ */ p(() => {
  ca.clear(), Tt.clear();
}, "clear"), ui = /* @__PURE__ */ p((e) => e ? e.reduce((r, i) => r + ";" + i, "") : "", "getLabelStyles"), Zk = /* @__PURE__ */ p(async (e, t) => {
  let r = vt(ht().flowchart.htmlLabels);
  const i = await Ve(e, t.label, {
  ...
  let o = i.getBBox();
  if (r) {
    const l = i.children[0], c = lt(i);
    o = l.getBoundingClientRect(), c.attr("width", o.width), c.attr("height", o.height);
  }
  a.attr("transform", "translate(" + -o.width / 2 + ", " + -o.height / 2 + ")"), ca.set(t.id, n), t.width = o.width, t.height = o.height;
  let s;
  if (t.startLabelLeft) {
    const l = await sr(
      t.startLabelLeft,
    ...
    const u = l.getBBox();
    h.attr("transform", "translate(" + -u.width / 2 + ", " + -u.height / 2 + ")"), Tt.get(t.id) || Tt.set(t.id, {}), Tt.get(t.id).startLeft = c, xi(s, t.startLabelLeft);
  }
  if (t.startLabelRight) {
    ...
    const u = l.getBBox();
    h.attr("transform", "translate(" + -u.width / 2 + ", " + -u.height / 2 + ")"), Tt.get(t.id) || Tt.set(t.id, {}), Tt.get(t.id).startRight = c, xi(s, t.startLabelRight);
  }
  if (t.endLabelLeft) {
    const l = await sr(t.endLabelLeft, ui(t.labelStyle)), c = e.insert("g").attr("class", "edgeTerminals"), h = c.insert("g").attr("class", "inner");
    s = h.node().appendChild(l);
    const u = l.getBBox();
    h.attr("transform", "translate(" + -u.width / 2 + ", " + -u.height / 2 + ")"), c.node().appendChild(l), Tt.get(t.id) || Tt.set(t.id, {}), Tt.get(t.id).endLeft = c, xi(s, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const l = await sr(t.endLabelRight, ui(t.labelStyle)), c = e.insert("g").attr("class", "edgeTerminals"), h = c.insert("g").attr("class", "inner");
    s = h.node().appendChild(l);
    const u = l.getBBox();
    h.attr("transform", "translate(" + -u.width / 2 + ", " + -u.height / 2 + ")"), c.node().appendChild(l), Tt.get(t.id) || Tt.set(t.id, {}), Tt.get(t.id).endRight = c, xi(s, t.endLabelRight);
  }
  return i;
}, "insertEdgeLabel");
function xi(e, t) {
...
p(xi, "setTerminalWidth");
var Kk = /* @__PURE__ */ p((e, t) => {
  F.debug("Moving label abc88 ", e.id, e.label, ca.get(e.id), t);
  let r = t.updatedPath ? t.updatedPath : t.originalPath;
  const i = ht(), { subGraphTitleTotalMargin: n } = Co(i);
  if (e.label) {
    const a = ca.get(e.id);
    let o = e.x, s = e.y;
    if (r) {
      const l = ge.calcLabelPosition(r);
      F.debug(
  ...
  if (e.startLabelLeft) {
    const a = Tt.get(e.id).startLeft;
    let o = e.x, s = e.y;
    if (r) {
      const l = ge.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_left", r);
      o = l.x, s = l.y;
    }
    a.attr("transform", `translate(${o}, ${s})`);
  }
  if (e.startLabelRight) {
    const a = Tt.get(e.id).startRight;
    let o = e.x, s = e.y;
    if (r) {
  ...
  if (e.endLabelLeft) {
    const a = Tt.get(e.id).endLeft;
    let o = e.x, s = e.y;
    if (r) {
      const l = ge.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_left", r);
      o = l.x, s = l.y;
    }
    a.attr("transform", `translate(${o}, ${s})`);
  }
  if (e.endLabelRight) {
    const a = Tt.get(e.id).endRight;
    let o = e.x, s = e.y;
    if (r) {
      const l = ge.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_right", r);
      o = l.x, s = l.y;
    }
    a.attr("transform", `translate(${o}, ${s})`);
  }
}, "positionEdgeLabel"), Qk = /* @__PURE__ */ p((e, t) => {
  const r = e.x, i = e.y, n = Math.abs(t.x - r), a = Math.abs(t.y - i), o = e.width / 2, s = e.height / 2;
  return n >= o || a >= s;
}, "outsideNode"), Jk = /* @__PURE__ */ p((e, t, r) => {
...
}, "intersection"), Zc = /* @__PURE__ */ p((e, t) => {
  F.warn("abc88 cutPathAtIntersect", e, t);
  let r = [], i = e[0], n = !1;
  return e.forEach((a) => {
    if (F.info("abc88 checking point", a, t), !Qk(t, a) && !n) {
      const o = Jk(t, i, a);
...
var Kc = /* @__PURE__ */ p(function(e, t, r) {
  const i = t.x - e.x, n = t.y - e.y, a = Math.sqrt(i * i + n * n), o = r / a;
  return { x: t.x - o * i, y: t.y - o * n };
}, "findAdjacentPoint"), tS = /* @__PURE__ */ p(function(e) {
  const { cornerPointPositions: t } = Fg(e), r = [];
  for (let i = 0; i < e.length; i++)
    if (t.includes(i)) {
      const n = e[i - 1], a = e[i + 1], o = e[i], s = Kc(n, o, 5), l = Kc(a, o, 5), c = l.x - s.x, h = l.y - s.y;
      r.push(s);
      ...
      r.push(e[i]);
  return r;
}, "fixCorners"), eS = /* @__PURE__ */ p(function(e, t, r, i, n, a, o) {
  const { handDrawnSeed: s } = ht();
  let l = t.points, c = !1;
  const h = n;
  var u = a;
  const f = [];
  for (const R in t.cssCompiledStyles)
    gp(R) || f.push(t.cssCompiledStyles[R]);
  ...
  ), l.push(u.intersect(l[l.length - 1]))), t.toCluster && (F.info("to cluster abc88", r.get(t.toCluster)), l = Zc(t.points, r.get(t.toCluster).node), c = !0), t.fromCluster && (F.debug(
    "from cluster abc88",
    r.get(t.fromCluster),
    JSON.stringify(l, null, 2)
  ), l = Zc(l.reverse(), r.get(t.fromCluster).node).reverse(), c = !0);
  let d = l.filter((R) => !Number.isNaN(R.y));
  d = tS(d);
  let g = _n;
  switch (g = Gn, t.curve) {
    case "linear":
  ...
  const { x: m, y } = kx(t), x = x2().x(m).y(y).curve(g);
  let b;
  switch (t.thickness) {
    case "normal":
  ...
  let L = k.find((R) => R?.startsWith("stroke:"));
  if (t.look === "handDrawn") {
    const R = U.svg(e);
    Object.assign([], d);
    const O = R.path(C, {
    ...
    b += " transition", w = lt(O).select("path").attr("id", t.id).attr("class", " " + b + (t.classes ? " " + t.classes : "")).attr("style", k ? k.reduce((z, P) => z + ";" + P, "") : "");
    let B = w.attr("d");
    w.attr("d", B), e.node().appendChild(w.node());
  } else {
    const R = f.join(";"), O = k ? k.reduce((P, E) => P + E + ";", "") : "";
    let B = "";
    ...
    ).attr("style", z), L = z.match(/stroke:([^;]+)/)?.[1];
  }
  let S = "";
  (ht().flowchart.arrowMarkerAbsolute || ht().state.arrowMarkerAbsolute) && (S = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, S = S.replace(/\(/g, "\\(").replace(/\)/g, "\\)")), F.info("arrowTypeStart", t.arrowTypeStart), F.info("arrowTypeEnd", t.arrowTypeEnd), Xk(w, t, S, o, i, L);
  let D = {};
  return c && (D.updatedPath = l), D.originalPath = t.points, D;
}, "insertEdge"), rS = /* @__PURE__ */ p((e, t, r, i) => {
  t.forEach((n) => {
    xS[n](e, r, i);
  });
}, "insertMarkers"), iS = /* @__PURE__ */ p((e, t, r) => {
...
}, "composition"), aS = /* @__PURE__ */ p((e, t, r) => {
...
}, "aggregation"), sS = /* @__PURE__ */ p((e, t, r) => {
...
}, "dependency"), oS = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_one"), pS = /* @__PURE__ */ p((e, t, r) => {
...
}, "one_or_more"), gS = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_more"), mS = /* @__PURE__ */ p((e, t, r) => {
...
}, "requirement_arrow"), yS = /* @__PURE__ */ p((e, t, r) => {
  ...
  one_or_more: pS,
  zero_or_more: gS,
  requirement_arrow: mS,
  requirement_contains: yS
}, bS = rS, wS = {
  common: jr,
  getConfig: Yt,
  insertCluster: Lk,
  ...
  labelHelper: it,
  log: F,
  positionEdgeLabel: Kk
}, Ri = {}, Og = /* @__PURE__ */ p((e) => {
  for (const t of e)
    Ri[t.name] = t;
}, "registerLayoutLoaders"), vS = /* @__PURE__ */ p(() => {
  Og([
    {
      name: "dagre",
      loader: /* @__PURE__ */ p(async () => await import("./dagre-OKDRZEBW-LbcepEE5.js"), "loader")
    }
  ]);
}, "registerDefaultLayoutLoaders");
vS();
var sA = /* @__PURE__ */ p(async (e, t) => {
  if (!(e.layoutAlgorithm in Ri))
    throw new Error(`Unknown layout algorithm: ${e.layoutAlgorithm}`);
  const r = Ri[e.layoutAlgorithm];
  return (await r.loader()).render(e, t, wS, {
    algorithm: r.algorithm
  });
}, "render"), oA = /* @__PURE__ */ p((e = "", { fallback: t = "dagre" } = {}) => {
  if (e in Ri)
    return e;
  if (t in Ri)
...
}, "getRegisteredLayoutAlgorithm"), Qc = {
  version: "11.6.0"
}, _S = /* @__PURE__ */ p((e) => {
  ...
  return r.select(`#${e}`);
}, "selectSvgElement"), Dg = "comm", Rg = "rule", Ig = "decl", CS = "@import", kS = "@namespace", SS = "@keyframes", TS = "@layer", Pg = Math.abs, sl = String.fromCharCode;
function Ng(e) {
  return e.trim();
}
function Tn(e, t, r) {
...
var Ra = 1, qr = 1, zg = 0, re = 0, xt = 0, Vr = "";
function ol(e, t, r, i, n, a, o, s) {
  return { value: e, root: t, parent: r, type: i, props: n, children: a, line: Ra, column: qr, length: o, return: "", siblings: s };
}
function AS() {
  return xt;
}
function MS() {
  return xt = re > 0 ? Er(Vr, --re) : 0, qr--, xt === 10 && (qr = 1, Ra--), xt;
}
function le() {
  return xt = re < zg ? Er(Vr, re++) : 0, qr++, xt === 10 && (qr = 1, Ra++), xt;
}
function We() {
  return Er(Vr, re);
}
...
function ES(e) {
  return Ra = qr = 1, zg = pe(Vr = e), re = 0, [];
}
function $S(e) {
  return Vr = "", e;
}
function us(e) {
  return Ng(Ia(re - 1, Js(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function FS(e) {
  for (; (xt = We()) && xt < 33; )
    le();
  return Ii(e) > 2 || Ii(xt) > 3 ? "" : " ";
}
function OS(e, t) {
  for (; --t && le() && !(xt < 48 || xt > 102 || xt > 57 && xt < 65 || xt > 70 && xt < 97); )
    ;
  return Ia(e, Bn() + (t < 6 && We() == 32 && le() == 32));
}
function Js(e) {
  for (; le(); )
    switch (xt) {
...
function IS(e) {
  return $S(Ln("", null, null, null, [""], e = ES(e), 0, [0], e));
}
function Ln(e, t, r, i, n, a, o, s, l) {
  for (var c = 0, h = 0, u = o, f = 0, d = 0, g = 0, m = 1, y = 1, x = 1, b = 0, w = "", C = n, k = a, L = i, S = w; y; )
    switch (g = b, b = le()) {
      // (
      case 40:
        if (g != 108 && Er(S, u - 1) == 58) {
          BS(S += Tn(us(b), "&", "&\f"), "&\f", Pg(c ? s[c - 1] : 0)) != -1 && (x = -1);
          break;
        }
      // " ' [
      case 34:
      ...
      case 47:
        switch (We()) {
          case 42:
          case 47:
            fn(PS(DS(le(), Bn()), t, r, l), l), (Ii(g || 1) == 5 || Ii(We() || 1) == 5) && pe(S) && Wr(S, -1, void 0) !== " " && (S += " ");
            break;
          default:
            S += "/";
        }
      ...
      case 0:
        switch (b) {
          ...
          // ;
          case 59 + h:
            x == -1 && (S = Tn(S, /\f/g, "")), d > 0 && (pe(S) - u || m === 0 && g === 47) && fn(d > 32 ? th(S + ";", i, r, u - 1, l) : th(Tn(S, " ", "") + ";", i, r, u - 2, l), l);
            break;
          // @ ;
          case 59:
            S += ";";
          // { rule/at-rule
          default:
            if (fn(L = Jc(S, t, r, c, h, n, s, w, C = [], k = [], u, a), a), b === 123)
              if (h === 0)
                Ln(S, t, L, L, C, a, u, s, k);
              else {
                switch (f) {
                  // c(ontainer)
                  case 99:
                ...
                h ? Ln(e, L, L, i && fn(Jc(e, L, L, 0, 0, n, s, w, n, C = [], u, k), k), n, k, u, s, i ? C : k) : Ln(S, L, L, L, [""], k, 0, s, k);
              }
        }
        c = h = d = 0, m = x = 1, w = S = "", u = o;
        break;
      // :
      case 58:
        u = 1 + pe(S), d = g;
      default:
        ...
        switch (S += sl(b), b * m) {
          ...
          // @
          case 64:
            We() === 45 && (S += us(le())), f = We(), h = u = pe(w = S += RS(Bn())), b++;
            break;
          // -
          case 45:
            g === 45 && pe(S) == 2 && (m = 0);
...
function Jc(e, t, r, i, n, a, o, s, l, c, h, u) {
  for (var f = n - 1, d = n === 0 ? a : [""], g = LS(d), m = 0, y = 0, x = 0; m < i; ++m)
    for (var b = 0, w = Wr(e, f + 1, f = Pg(y = o[m])), C = e; b < g; ++b)
      (C = Ng(y > 0 ? d[b] + " " + w : Tn(w, /&\f/g, d[b]))) && (l[x++] = C);
  return ol(e, t, r, n === 0 ? Rg : s, l, c, h, u);
}
function PS(e, t, r, i) {
  return ol(e, t, r, Dg, sl(AS()), Wr(e, 2, -2), 0, i);
}
function th(e, t, r, i, n) {
  return ol(e, t, r, Ig, Wr(e, 0, i), Wr(e, i + 1, -1), i, n);
}
function to(e, t) {
...
function NS(e, t, r, i) {
  ...
  return pe(r = to(e.children, i)) ? e.return = e.value + "{" + r + "}" : "";
}
var zS = wd(Object.keys, Object), WS = Object.prototype, qS = WS.hasOwnProperty;
function HS(e) {
  if (!Ba(e))
    return zS(e);
  var t = [];
...
var eo = mr(we, "DataView"), ro = mr(we, "Promise"), io = mr(we, "Set"), no = mr(we, "WeakMap"), eh = "[object Map]", jS = "[object Object]", rh = "[object Promise]", ih = "[object Set]", nh = "[object WeakMap]", ah = "[object DataView]", US = gr(eo), YS = gr(Di), GS = gr(ro), XS = gr(io), VS = gr(no), er = Ur;
(eo && er(new eo(new ArrayBuffer(1))) != ah || Di && er(new Di()) != eh || ro && er(ro.resolve()) != rh || io && er(new io()) != ih || no && er(new no()) != nh) && (er = function(e) {
  var t = Ur(e), r = t == jS ? e.constructor : void 0, i = r ? gr(r) : "";
  if (i)
    switch (i) {
      case US:
        return ah;
...
var ZS = "[object Map]", KS = "[object Set]", QS = Object.prototype, JS = QS.hasOwnProperty;
function sh(e) {
  if (e == null)
    return !0;
  if (La(e) && (ta(e) || typeof e == "string" || typeof e.splice == "function" || Po(e) || No(e) || Jn(e)))
    return !e.length;
  var t = er(e);
  if (t == ZS || t == KS)
    return !e.size;
...
var Wg = "c4", tT = /* @__PURE__ */ p((e) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(e), "detector"), eT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./c4Diagram-VJAJSXHY-CnqvQcXk.js");
  return { id: Wg, diagram: e };
}, "loader"), rT = {
  id: Wg,
  detector: tT,
  loader: eT
}, iT = rT, qg = "flowchart", nT = /* @__PURE__ */ p((e, t) => t?.flowchart?.defaultRenderer === "dagre-wrapper" || t?.flowchart?.defaultRenderer === "elk" ? !1 : /^\s*graph/.test(e), "detector"), aT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./flowDiagram-4HSFHLVR-HS80Z4oG.js");
  return { id: qg, diagram: e };
}, "loader"), sT = {
  id: qg,
  detector: nT,
  loader: aT
}, oT = sT, Hg = "flowchart-v2", lT = /* @__PURE__ */ p((e, t) => t?.flowchart?.defaultRenderer === "dagre-d3" ? !1 : (t?.flowchart?.defaultRenderer === "elk" && (t.layout = "elk"), /^\s*graph/.test(e) && t?.flowchart?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*flowchart/.test(e)), "detector"), cT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./flowDiagram-4HSFHLVR-HS80Z4oG.js");
  ...
  detector: lT,
  loader: cT
}, uT = hT, jg = "er", fT = /* @__PURE__ */ p((e) => /^\s*erDiagram/.test(e), "detector"), dT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./erDiagram-Q7BY3M3F-BxTdsVRU.js");
  return { id: jg, diagram: e };
}, "loader"), pT = {
  id: jg,
  detector: fT,
  loader: dT
}, gT = pT, Ug = "gitGraph", mT = /* @__PURE__ */ p((e) => /^\s*gitGraph/.test(e), "detector"), yT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./gitGraphDiagram-7IBYFJ6S-DGu4xwNA.js");
  return { id: Ug, diagram: e };
}, "loader"), xT = {
  id: Ug,
  detector: mT,
  loader: yT
}, bT = xT, Yg = "gantt", wT = /* @__PURE__ */ p((e) => /^\s*gantt/.test(e), "detector"), vT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./ganttDiagram-APWFNJXF-BJyOu3JP.js");
  return { id: Yg, diagram: e };
}, "loader"), _T = {
  id: Yg,
  detector: wT,
  loader: vT
}, CT = _T, Gg = "info", kT = /* @__PURE__ */ p((e) => /^\s*info/.test(e), "detector"), ST = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./infoDiagram-PH2N3AL5-BQB1NzyA.js");
  return { id: Gg, diagram: e };
}, "loader"), TT = {
  id: Gg,
  detector: kT,
  loader: ST
}, Xg = "pie", BT = /* @__PURE__ */ p((e) => /^\s*pie/.test(e), "detector"), LT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./pieDiagram-IB7DONF6-NGTYT9ID.js");
  return { id: Xg, diagram: e };
}, "loader"), AT = {
  id: Xg,
  detector: BT,
  loader: LT
}, Vg = "quadrantChart", MT = /* @__PURE__ */ p((e) => /^\s*quadrantChart/.test(e), "detector"), ET = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./quadrantDiagram-7GDLP6J5-8ssUEuZM.js");
  return { id: Vg, diagram: e };
}, "loader"), $T = {
  id: Vg,
  detector: MT,
  loader: ET
}, FT = $T, Zg = "xychart", OT = /* @__PURE__ */ p((e) => /^\s*xychart-beta/.test(e), "detector"), DT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./xychartDiagram-VJFVF3MP-DwtjIIDr.js");
  return { id: Zg, diagram: e };
}, "loader"), RT = {
  id: Zg,
  detector: OT,
  loader: DT
}, IT = RT, Kg = "requirement", PT = /* @__PURE__ */ p((e) => /^\s*requirement(Diagram)?/.test(e), "detector"), NT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./requirementDiagram-KVF5MWMF-Bdkrw98n.js");
  return { id: Kg, diagram: e };
}, "loader"), zT = {
  id: Kg,
  detector: PT,
  loader: NT
}, WT = zT, Qg = "sequence", qT = /* @__PURE__ */ p((e) => /^\s*sequenceDiagram/.test(e), "detector"), HT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./sequenceDiagram-X6HHIX6F-BKznqhof.js");
  return { id: Qg, diagram: e };
}, "loader"), jT = {
  id: Qg,
  detector: qT,
  loader: HT
}, UT = jT, Jg = "class", YT = /* @__PURE__ */ p((e, t) => t?.class?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*classDiagram/.test(e), "detector"), GT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./classDiagram-GIVACNV2-DktCiuuK.js");
  return { id: Jg, diagram: e };
}, "loader"), XT = {
  id: Jg,
  detector: YT,
  loader: GT
}, VT = XT, tm = "classDiagram", ZT = /* @__PURE__ */ p((e, t) => /^\s*classDiagram/.test(e) && t?.class?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*classDiagram-v2/.test(e), "detector"), KT = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./classDiagram-v2-COTLJTTW-DktCiuuK.js");
  return { id: tm, diagram: e };
}, "loader"), QT = {
  id: tm,
  detector: ZT,
  loader: KT
}, JT = QT, em = "state", tB = /* @__PURE__ */ p((e, t) => t?.state?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*stateDiagram/.test(e), "detector"), eB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./stateDiagram-DGXRK772-BktODb9P.js");
  return { id: em, diagram: e };
}, "loader"), rB = {
  id: em,
  detector: tB,
  loader: eB
}, iB = rB, rm = "stateDiagram", nB = /* @__PURE__ */ p((e, t) => !!(/^\s*stateDiagram-v2/.test(e) || /^\s*stateDiagram/.test(e) && t?.state?.defaultRenderer === "dagre-wrapper"), "detector"), aB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./stateDiagram-v2-YXO3MK2T-Bi4Dc0II.js");
  return { id: rm, diagram: e };
}, "loader"), sB = {
  id: rm,
  detector: nB,
  loader: aB
}, oB = sB, im = "journey", lB = /* @__PURE__ */ p((e) => /^\s*journey/.test(e), "detector"), cB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./journeyDiagram-U35MCT3I-CAW5QWpl.js");
  return { id: im, diagram: e };
}, "loader"), hB = {
  id: im,
  detector: lB,
  loader: cB
}, uB = hB, fB = /* @__PURE__ */ p((e, t, r) => {
  F.debug(`rendering svg for syntax error
`);
  const i = _S(t), n = i.append("g");
  i.attr("viewBox", "0 0 2412 512"), Rh(i, 100, 512, !0), n.append("path").attr("class", "error-icon").attr(
    "d",
  ...
  detector: mB,
  loader: yB
}, bB = xB, sm = "timeline", wB = /* @__PURE__ */ p((e) => /^\s*timeline/.test(e), "detector"), vB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./timeline-definition-BDJGKUSR-BwJdc8CV.js");
  return { id: sm, diagram: e };
}, "loader"), _B = {
  id: sm,
  detector: wB,
  loader: vB
}, CB = _B, om = "mindmap", kB = /* @__PURE__ */ p((e) => /^\s*mindmap/.test(e), "detector"), SB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./mindmap-definition-ALO5MXBD-CxpSD6uL.js");
  return { id: om, diagram: e };
}, "loader"), TB = {
  id: om,
  detector: kB,
  loader: SB
}, BB = TB, lm = "kanban", LB = /* @__PURE__ */ p((e) => /^\s*kanban/.test(e), "detector"), AB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./kanban-definition-NDS4AKOZ-W-BFDCLL.js");
  return { id: lm, diagram: e };
}, "loader"), MB = {
  id: lm,
  detector: LB,
  loader: AB
}, EB = MB, cm = "sankey", $B = /* @__PURE__ */ p((e) => /^\s*sankey-beta/.test(e), "detector"), FB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./sankeyDiagram-QLVOVGJD-BxCqT_Ov.js");
  return { id: cm, diagram: e };
}, "loader"), OB = {
  id: cm,
  detector: $B,
  loader: FB
}, DB = OB, hm = "packet", RB = /* @__PURE__ */ p((e) => /^\s*packet-beta/.test(e), "detector"), IB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-VNBRO52H-DK3xOtcQ.js");
  return { id: hm, diagram: e };
}, "loader"), PB = {
  id: hm,
  detector: RB,
  loader: IB
}, um = "radar", NB = /* @__PURE__ */ p((e) => /^\s*radar-beta/.test(e), "detector"), zB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-SSKATNLV-DW9QqLfD.js");
  return { id: um, diagram: e };
}, "loader"), WB = {
  id: um,
  detector: NB,
  loader: zB
}, fm = "block", qB = /* @__PURE__ */ p((e) => /^\s*block-beta/.test(e), "detector"), HB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./blockDiagram-JOT3LUYC-BCbmRTKR.js");
  return { id: fm, diagram: e };
}, "loader"), jB = {
  id: fm,
  detector: qB,
  loader: HB
}, UB = jB, dm = "architecture", YB = /* @__PURE__ */ p((e) => /^\s*architecture/.test(e), "detector"), GB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./architectureDiagram-IEHRJDOE-CU4VrxxV.js");
  return { id: dm, diagram: e };
}, "loader"), XB = {
  id: dm,
  detector: YB,
  loader: GB
}, VB = XB, oh = !1, Pa = /* @__PURE__ */ p(() => {
  oh || (oh = !0, Fn("error", gB, (e) => e.toLowerCase().trim() === "error"), Fn(
    "---",
...
}, "addDiagrams"), ZB = /* @__PURE__ */ p(async () => {
  F.debug("Loading registered diagrams");
  const t = (await Promise.allSettled(
    Object.entries(Fr).map(async ([r, { detector: i, loader: n }]) => {
      if (n)
        try {
          xs(r);
        } catch {
          try {
            ...
            throw F.error(`Failed to load external diagram with key ${r}. Removing from detectors.`), delete Fr[r], a;
          }
        }
    })
...
}, "loadRegisteredDiagrams"), KB = "graphics-document document";
function pm(e, t) {
  e.attr("role", KB), t !== "" && e.attr("aria-roledescription", t);
}
p(pm, "setA11yDiagramInfo");
function gm(e, t, r, i) {
  if (e.insert !== void 0) {
    if (r) {
...
p(gm, "addSVGa11yTitleDescription");
var ao = class mm {
...
`;
    try {
      ...
      const c = k0(n);
      if (!c)
        throw new _h(`Diagram ${n} not found.`);
      const { id: h, diagram: u } = await c();
      Fn(h, u);
    }
    const { db: a, parser: o, renderer: s, init: l } = xs(n);
    return o.parser && (o.parser.yy = a), a.clear?.(), l?.(i), r.title && a.setDiagramTitle?.(r.title), await o.parse(t), new mm(n, t, a, o, s);
  }
  async render(t, r) {
...
}, "attachFunctions"), JB = /* @__PURE__ */ p((e) => e.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart(), "cleanupComments");
function ym(e) {
  const t = e.match(vh);
  if (!t)
    return {
...
p(ym, "extractFrontMatter");
var tL = /* @__PURE__ */ p((e) => e.replace(/\r\n?/g, `
`).replace(
  /<(\w+)([^>]*)>/g,
  (t, r, i) => "<" + r + i.replace(/="([^"]*)"/g, "='$1'") + ">"
), "cleanupText"), eL = /* @__PURE__ */ p((e) => {
  const { text: t, metadata: r } = ym(e), { displayMode: i, title: n, config: a = {} } = r;
  return i && (a.gantt || (a.gantt = {}), a.gantt.displayMode = i), { title: n, config: a, text: t };
}, "processFrontmatter"), rL = /* @__PURE__ */ p((e) => {
  const t = ge.detectInit(e) ?? {}, r = ge.detectDirective(e, "wrap");
...
function ll(e) {
  const t = tL(e), r = eL(t), i = rL(r.text), n = Uo(r.config, i.directive);
  return e = JB(i.text), {
    code: e,
    title: r.title,
    config: n
...
p(ll, "preprocessDiagram");
function xm(e) {
  const t = new TextEncoder().encode(e), r = Array.from(t, (i) => String.fromCodePoint(i)).join("");
  return btoa(r);
}
p(xm, "toBase64");
var iL = 5e4, nL = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa", aL = "sandbox", sL = "loose", oL = "http://www.w3.org/2000/svg", lL = "http://www.w3.org/1999/xlink", cL = "http://www.w3.org/1999/xhtml", hL = "100%", uL = "100%", fL = "border:0;margin:0;", dL = "margin:0", pL = "allow-top-navigation-by-user-activation allow-popups", gL = 'The "iframe" tag is not supported by your browser.', mL = ["foreignobject"], yL = ["dominant-baseline"];
function cl(e) {
  const t = ll(e);
  return En(), z0(t.config ?? {}), t;
}
p(cl, "processAndSetConfigs");
async function bm(e, t) {
  Pa();
  try {
    const { code: r, config: i } = cl(e);
    return { diagramType: (await vm(r)).type, config: i };
  } catch (r) {
    if (t?.suppressErrors)
      return !1;
    throw r;
...
p(bm, "parse");
var ch = /* @__PURE__ */ p((e, t, r = []) => `
.${e} ${t} { ${r.join(" !important; ")} !important; }`, "cssImportantStyles"), xL = /* @__PURE__ */ p((e, t = /* @__PURE__ */ new Map()) => {
  let r = "";
...
:root { --mermaid-alt-font-family: ${e.altFontFamily}}`), t instanceof Map) {
    ...
    t.forEach((s) => {
      sh(s.styles) || o.forEach((l) => {
        r += ch(s.id, l, s.styles);
      }), sh(s.textStyles) || (r += ch(
        s.id,
        "tspan",
        (s?.textStyles || []).map((l) => l.replace("color", "fill"))
      ));
    });
  }
  return r;
}, "createCssStyles"), bL = /* @__PURE__ */ p((e, t, r, i) => {
  const n = xL(e, r), a = ay(t, n, e.themeVariables);
  return to(IS(`${i}{${a}}`), NS);
}, "createUserStyles"), wL = /* @__PURE__ */ p((e = "", t, r) => {
  let i = e;
  return !r && !t && (i = i.replace(
    /marker-end="url\([\d+./:=?A-Za-z-]*?#/g,
    'marker-end="url(#'
  )), i = yr(i), i = i.replace(/<br>/g, "<br/>"), i;
}, "cleanUpSvgCode"), vL = /* @__PURE__ */ p((e = "", t) => {
  const r = t?.viewBox?.baseVal?.height ? t.viewBox.baseVal.height + "px" : uL, i = xm(`<body style="${dL}">${e}</body>`);
  return `<iframe style="width:${hL};height:${r};${fL}" src="data:text/html;charset=UTF-8;base64,${i}" sandbox="${pL}">
  ${gL}
</iframe>`;
}, "putIntoIFrame"), hh = /* @__PURE__ */ p((e, t, r, i, n) => {
  const a = e.append("div");
  a.attr("id", r), i && a.attr("style", i);
  const o = a.append("svg").attr("id", t).attr("width", "100%").attr("xmlns", oL);
...
var _L = /* @__PURE__ */ p((e, t, r, i) => {
  e.getElementById(t)?.remove(), e.getElementById(r)?.remove(), e.getElementById(i)?.remove();
}, "removeExistingElements"), CL = /* @__PURE__ */ p(async function(e, t, r) {
  Pa();
  const i = cl(t);
  t = i.code;
  const n = Yt();
  F.debug(n), t.length > (n?.maxTextSize ?? iL) && (t = nL);
  const a = "#" + e, o = "i" + e, s = "#" + o, l = "d" + e, c = "#" + l, h = /* @__PURE__ */ p(() => {
    const P = lt(f ? s : c).node();
    P && "remove" in P && P.remove();
  }, "removeTempElements");
  let u = lt("body");
  const f = n.securityLevel === aL, d = n.securityLevel === sL, g = n.fontFamily;
  if (r !== void 0) {
    if (r && (r.innerHTML = ""), f) {
      const z = so(lt(r), o);
      u = lt(z.nodes()[0].contentDocument.body), u.node().style.margin = 0;
    } else
      u = lt(r);
    hh(u, e, l, `font-family: ${g}`, lL);
  } else {
    if (_L(document, e, l, o), f) {
      const z = so(lt("body"), o);
      u = lt(z.nodes()[0].contentDocument.body), u.node().style.margin = 0;
    } else
      u = lt("body");
    hh(u, e, l);
  ...
  let m, y;
  try {
    m = await ao.fromText(t, { title: i.title });
  } catch (z) {
    if (n.suppressErrorRendering)
      throw h(), z;
    m = await ao.fromText("error"), y = z;
  }
  const x = u.select(c).node(), b = m.type, w = x.firstChild, C = w.firstChild, k = m.renderer.getClasses?.(t, m), L = bL(n, b, k, a), S = document.createElement("style");
  S.innerHTML = L, w.insertBefore(S, C);
  try {
    await m.renderer.draw(t, e, Qc.version, m);
  } catch (z) {
    throw n.suppressErrorRendering ? h() : dB.draw(t, e, Qc.version), z;
  }
  const D = u.select(`${c} svg`), R = m.db.getAccTitle?.(), O = m.db.getAccDescription?.();
  _m(b, D, R, O), u.select(`[id="${e}"]`).selectAll("foreignobject > *").attr("xmlns", cL);
  let B = u.select(c).node().innerHTML;
  if (F.debug("config.arrowMarkerAbsolute", n.arrowMarkerAbsolute), B = wL(B, f, vt(n.arrowMarkerAbsolute)), f) {
    const z = u.select(c + " svg").node();
    B = vL(B, z);
  } else d || (B = $r.sanitize(B, {
    ADD_TAGS: mL,
    ADD_ATTR: yL,
...
function wm(e = {}) {
  const t = Bt({}, e);
  t?.fontFamily && !t.themeVariables?.fontFamily && (t.themeVariables || (t.themeVariables = {}), t.themeVariables.fontFamily = t.fontFamily), P0(t), t?.theme && t.theme in Le ? t.themeVariables = Le[t.theme].getThemeVariables(
    t.themeVariables
  ) : t && (t.themeVariables = Le.default.getThemeVariables(t.themeVariables));
  const r = typeof t == "object" ? I0(t) : Ah();
  oo(r.logLevel), Pa();
}
p(wm, "initialize");
var vm = /* @__PURE__ */ p((e, t = {}) => {
  const { code: r } = ll(e);
  return ao.fromText(r, t);
}, "getDiagramFromText");
function _m(e, t, r, i) {
  pm(t, e), gm(t, r, i, t.attr("id"));
}
p(_m, "addA11yInfo");
var dr = Object.freeze({
  render: CL,
  parse: bm,
  getDiagramFromText: vm,
  initialize: wm,
  getConfig: Yt,
  setConfig: Mh,
  getSiteConfig: Ah,
...
var kL = /* @__PURE__ */ p((e, t, r) => {
  F.warn(e), jo(e) ? (r && r(e.str, e.hash), t.push({ ...e, message: e.str, error: e })) : (r && r(e), e instanceof Error && t.push({
    str: e.message,
    message: e.message,
    hash: e.name,
    error: e
  }));
}, "handleError"), Cm = /* @__PURE__ */ p(async function(e = {
  querySelector: ".mermaid"
}) {
  try {
    await SL(e);
  } catch (t) {
    if (jo(t) && F.error(t.str), $e.parseError && $e.parseError(t), !e.suppressErrors)
      throw F.error("Use the suppressErrors option to suppress these errors"), t;
  }
}, "run"), SL = /* @__PURE__ */ p(async function({ postRenderCallback: e, querySelector: t, nodes: r } = {
  querySelector: ".mermaid"
}) {
  ...
  F.debug(`Found ${n.length} diagrams`), i?.startOnLoad !== void 0 && (F.debug("Start On Load: " + i?.startOnLoad), dr.updateSiteConfig({ startOnLoad: i?.startOnLoad }));
  const a = new ge.InitIDGenerator(i.deterministicIds, i.deterministicIDSeed);
  let o;
  const s = [];
  for (const l of Array.from(n)) {
    ...
    o = l.innerHTML, o = Zd(ge.entityDecode(o)).trim().replace(/<br\s*\/?>/gi, "<br/>");
    const h = ge.detectInit(o);
    h && F.debug("Detected early reinit: ", h);
    try {
      const { svg: u, bindFunctions: f } = await Bm(c, o, l);
  ...
  if (s.length > 0)
    throw s[0];
}, "runThrowsErrors"), km = /* @__PURE__ */ p(function(e) {
  dr.initialize(e);
}, "initialize"), TL = /* @__PURE__ */ p(async function(e, t, r) {
  F.warn("mermaid.init is deprecated. Please use run instead."), e && km(e);
  const i = { postRenderCallback: r, querySelector: ".mermaid" };
  typeof t == "string" ? i.querySelector = t : t && (t instanceof HTMLElement ? i.nodes = [t] : i.nodes = t), await Cm(i);
}, "init"), BL = /* @__PURE__ */ p(async (e, {
  lazyLoad: t = !0
} = {}) => {
  Pa(), Ch(...e), t === !1 && await ZB();
}, "registerExternalDiagrams"), Sm = /* @__PURE__ */ p(function() {
  if ($e.startOnLoad) {
    const { startOnLoad: e } = dr.getConfig();
    e && $e.run().catch((t) => F.error("Mermaid failed to initialize", t));
  }
}, "contentLoaded");
typeof document < "u" && window.addEventListener("load", Sm, !1);
var LL = /* @__PURE__ */ p(function(e) {
  $e.parseError = e;
}, "setParseErrorHandler"), ha = [], fs = !1, Tm = /* @__PURE__ */ p(async () => {
  if (!fs) {
    for (fs = !0; ha.length > 0; ) {
      const e = ha.shift();
      if (e)
        try {
          await e();
...
}, "executeQueue"), AL = /* @__PURE__ */ p(async (e, t) => new Promise((r, i) => {
  const n = /* @__PURE__ */ p(() => new Promise((a, o) => {
    dr.parse(e, t).then(
      ...
      (s) => {
        F.error("Error parsing", s), $e.parseError?.(s), o(s), i(s);
      }
    );
  }), "performCall");
  ha.push(n), Tm().catch(i);
}), "parse"), Bm = /* @__PURE__ */ p((e, t, r) => new Promise((i, n) => {
  const a = /* @__PURE__ */ p(() => new Promise((o, s) => {
    dr.render(e, t, r).then(
      ...
      (l) => {
        F.error("Error parsing", l), $e.parseError?.(l), s(l), n(l);
      }
    );
  }), "performCall");
  ha.push(a), Tm().catch(n);
}), "render"), $e = {
  startOnLoad: !0,
  mermaidAPI: dr,
  parse: AL,
  ...
  init: TL,
  run: Cm,
  registerExternalDiagrams: BL,
  registerLayoutLoaders: Og,
  initialize: km,
  parseError: void 0,
  contentLoaded: Sm,
  setParseErrorHandler: LL,
  detectType: lo,
  registerIconPacks: Yx
}, An = $e;
/*! Check if previously processed */
/*!
 * Wait for document loaded before starting the execution
 */
var ML = Object.defineProperty, EL = Object.getOwnPropertyDescriptor, Re = (e, t, r, i) => {
  for (var n = i > 1 ? void 0 : i ? EL(t, r) : t, a = e.length - 1, o; a >= 0; a--)
    (o = e[a]) && (n = (i ? o(t, r, n) : o(n)) || n);
  return i && n && ML(t, r, n), n;
};
An.initialize({
  startOnLoad: !1
});
let ua = class extends uh {
  constructor() {
    super(...arguments), this.config = {
      name: "mermaid",
      version: "0.1.1"
    }, this.initialStatus = "code", this.errorHandlingType = "notHandled", this.handleInstance = (e) => {
      Ml(
        e.detail.el,
        bi`<ys-mermaid-render
  ...
  firstUpdated() {
    this.dataset.register = this.config.name, this.parentElement && (this.parentElement.addEventListener(`${this.config.name}-instance`, this.handleInstance), this.parentElement.addEventListener(`${this.config.name}-update`, this.handleUpdate));
  }
  disconnectedCallback() {
    this.parentElement && (this.parentElement.removeEventListener(`${this.config.name}-instance`, this.handleInstance), this.parentElement.removeEventListener(`${this.config.name}-update`, this.handleUpdate)), super.disconnectedCallback();
  }
};
Re([
  Hr({ type: String, attribute: "initial-status" })
], ua.prototype, "initialStatus", 2);
Re([
  Hr({ type: String, attribute: "error-handling" })
], ua.prototype, "errorHandlingType", 2);
ua = Re([
  fh("ys-mermaid")
], ua);
let Ge = class extends uh {
  constructor() {
    super(...arguments), this.content = "", this.errorHandlingType = "notHandled", this.status = "code", this.currentMermaidTheme = "default", this.mermaidBoxRef = Pm();
  }
  // 计算属性：是否为深色模式
  get isDarkMode() {
  ...
  updated(e) {
    if (e.has("content") && this.content && this.status === "view" && this._renderMermaid(), e.has("themeData")) {
      const t = this.isDarkMode ? "dark" : "default";
      this.currentMermaidTheme !== t && (this.currentMermaidTheme = t, An.initialize({
        startOnLoad: !1,
        theme: t
      }), this.status === "view" && this._renderMermaid());
    }
  }
  _checkStatus(e) {
    this.status !== e && (this.status = e, e === "code" ? this.mermaidBoxRef.value && (this.mermaidBoxRef.value.innerHTML = "") : e === "view" && this._renderMermaid());
  }
  /**
   * 渲染方法
   */
  _renderMermaid() {
    this.content.trim() && An.parse(this.content).then(() => {
      const e = `mermaid_${Date.now()}_${Math.random().toString(36).slice(2, 6)}`;
      An.render(e, this.content).then((t) => {
        this.mermaidBoxRef.value && (this.mermaidBoxRef.value.innerHTML = t.svg);
      }).catch((t) => {
        !!Ll.disableWarning && console.error("[Mermaid render error]", t), this.mermaidBoxRef.value && (this.mermaidBoxRef.value.innerHTML = '<div class="text-red-500 p-2">❌ 图表渲染失败</div>'), this._cleanupErrorElements();
      });
    }).catch((e) => {
      !!Ll.disableWarning && console.error("[Mermaid parse error] 语法校验错误"), this.errorHandlingType === "errorHandling" && (this.mermaidBoxRef.value.innerHTML = '<div class="text-red-500 p-2">❌ 图表渲染失败</div>'), this._cleanupErrorElements();
    });
  }
  // 添加一个清理方法
  _cleanupErrorElements() {
    setTimeout(() => {
      document.querySelectorAll('[id^="dmermaid_"]').forEach((e) => {
        e.remove();
      });
    }, 0);
  }
  render() {
    const e = this.isDarkMode, t = {
      flex: !0,
      "min-w-16": !0,
      "cursor-pointer": !0,
      "items-center": !0,
      ...
      ...t,
      // 激活状态
      "bg-white": !e && this.status === "code",
      "text-blue-600": !e && this.status === "code",
      "shadow-sm": this.status === "code",
      "bg-gray-700": e && this.status === "code",
      "text-blue-400": e && this.status === "code",
      // 非激活状态
      "bg-transparent": this.status !== "code",
      "text-gray-600": !e && this.status !== "code",
      "text-gray-400": e && this.status !== "code",
      "hover:bg-gray-200": !e && this.status !== "code",
      "hover:bg-gray-800": e && this.status !== "code",
      "hover:text-gray-800": !e && this.status !== "code",
      "hover:text-gray-200": e && this.status !== "code"
    }, i = {
      ...t,
      // 激活状态
      "bg-white": !e && this.status === "view",
      "text-blue-600": !e && this.status === "view",
      "shadow-sm": this.status === "view",
      "bg-gray-700": e && this.status === "view",
      "text-blue-400": e && this.status === "view",
      // 非激活状态
      "bg-transparent": this.status !== "view",
      "text-gray-600": !e && this.status !== "view",
      "text-gray-400": e && this.status !== "view",
      "hover:bg-gray-200": !e && this.status !== "view",
      "hover:bg-gray-800": e && this.status !== "view",
      "hover:text-gray-800": !e && this.status !== "view",
      "hover:text-gray-200": e && this.status !== "view"
    };
    return bi`<div class="mb-4">
      <!-- 甘特图卡片 -->
      <div class="${e ? "border-gray-700" : "border-gray-300"} overflow-hidden rounded-md border border-solid">
        <!-- 顶部工具栏 -->
        <div class="${e ? "bg-gray-900" : ""} flex h-10 items-center justify-between gap-2 py-2 pr-2 pl-3 select-none">
          <div class="${e ? "bg-gray-800" : "bg-gray-100"} inline-flex h-8 rounded-md p-1">
            <button class=${Al(r)} @click=${() => this._checkStatus("code")}>
              <span>代码</span>
            </button>
            <button class=${Al(i)} @click=${() => this._checkStatus("view")}>
              <span>图表</span>
            </button>
          </div>
        </div>
        ...
        <!-- 内容区域 - 代码视图 -->
        ${this.status === "code" ? bi`<div class="max-w-full overflow-x-auto">
              <pre class="${e ? "bg-[#1e2939]" : ""} !m-0 max-w-full rounded-t-none p-4"><code>${this.content}</code></pre>
            </div>` : bi`<div class="${e ? "bg-[#1e2939]" : "bg-white"} min-h-20 w-full p-4">
              <div ${Nm(this.mermaidBoxRef)} class="flex justify-center">
...
Re([
  Hr()
], Ge.prototype, "errorHandlingType", 2);
Re([
  Hr()
], Ge.prototype, "status", 2);
Re([
  zm({ context: Wm, subscribe: !0 }),
  Hr({ attribute: !1 })
], Ge.prototype, "themeData", 2);
Re([
  Im()
], Ge.prototype, "currentMermaidTheme", 2);
Ge = Re([
  fh("ys-mermaid-render")
], Ge);
export {
  p2 as $,
  vi as A,
