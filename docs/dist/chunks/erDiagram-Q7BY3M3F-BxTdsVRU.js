import { g as vt, s as Dt } from "./chunk-RZ5BOZE2-B0kcaVf8.js";
import { _ as o, b as wt, a as Vt, s as Lt, g as Mt, p as Bt, q as Ft, c as $, l as D, y as Yt, x as Pt, A as zt, B as Gt, o as Kt, r as Zt, d as Ut, u as jt } from "./index-BX-ZM0Ir.js";
import { c as Wt } from "./channel-U8dKMW8C.js";
var ut = function() {
  var e = /* @__PURE__ */ o(function(N, n, a, c) {
    ...
    parse: /* @__PURE__ */ o(function(n) {
      var a = this, c = [0], r = [], u = [null], t = [], G = this.table, s = "", q = 0, kt = 0, Rt = 2, St = 1, xt = t.slice.call(arguments, 1), f = Object.create(this.lexer), x = { yy: {} };
      ...
      o(Tt, "lex");
      for (var y, I, b, ot, v = {}, H, E, Ot, J; ; ) {
        if (I = c[c.length - 1], this.defaultActions[I] ? b = this.defaultActions[I] : ((y === null || typeof y > "u") && (y = Tt()), b = G[I] && G[I][y]), typeof b > "u" || !b.length || !b[0]) {
          var ht = "";
          J = [];
          for (H in G[I])
...
Expecting ` + J.join(", ") + ", got '" + (this.terminals_[y] || y) + "'" : ht = "Parse error on line " + (q + 1) + ": Unexpected " + (y == St ? "end of input" : "'" + (this.terminals_[y] || y) + "'"), this.parseError(ht, {
        ...
        if (b[0] instanceof Array && b.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + I + ", token: " + y);
        switch (b[0]) {
          case 1:
...
var qt = /* @__PURE__ */ o(async function(e, i, d, l) {
  ...
  g.type = l.type, g.layoutAlgorithm = Kt(R), g.config.flowchart.nodeSpacing = p?.nodeSpacing || 140, g.config.flowchart.rankSpacing = p?.rankSpacing || 80, g.direction = l.db.getDirection(), g.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], g.diagramId = i, await Zt(g, m), g.layoutAlgorithm === "elk" && m.select(".edges").lower();
