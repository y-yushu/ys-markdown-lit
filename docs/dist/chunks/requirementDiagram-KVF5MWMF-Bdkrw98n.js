import { g as je, s as Ge } from "./chunk-RZ5BOZE2-B0kcaVf8.js";
import { _ as o, b as ze, a as Xe, s as Je, g as Ze, p as et, q as tt, c as ke, l as Ne, y as st, B as it, o as rt, r as nt, u as at } from "./index-BX-ZM0Ir.js";
var qe = function() {
  var e = /* @__PURE__ */ o(function(P, i, a, c) {
    for (a = a || {}, c = P.length; c--; a[P[c]] = i) ;
    return a;
  }, "o"), u = [1, 3], h = [1, 4], r = [1, 5], n = [1, 6], E = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], g = [1, 22], R = [2, 7], _ = [1, 26], b = [1, 27], N = [1, 28], q = [1, 29], A = [1, 33], C = [1, 34], V = [1, 35], v = [1, 36], x = [1, 37], L = [1, 38], D = [1, 24], O = [1, 31], w = [1, 32], M = [1, 30], d = [1, 39], p = [1, 40], m = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], $ = [1, 61], X = [89, 90], Ae = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 29, 41, 42, 43, 44, 45, 46, 54, 61, 63, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], Ee = [27, 29], Ce = [1, 70], Ve = [1, 71], ve = [1, 72], xe = [1, 73], Le = [1, 74], De = [1, 75], Oe = [1, 76], Z = [1, 83], U = [1, 80], ee = [1, 84], te = [1, 85], se = [1, 86], ie = [1, 87], re = [1, 88], ne = [1, 89], ae = [1, 90], le = [1, 91], ce = [1, 92], de = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], Y = [63, 64], we = [1, 101], Me = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 76, 77, 89, 90], T = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], B = [1, 110], Q = [1, 106], H = [1, 107], K = [1, 108], W = [1, 109], j = [1, 111], oe = [1, 116], he = [1, 117], ue = [1, 114], fe = [1, 115], _e = {
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var a = this, c = [0], s = [], f = [null], t = [], me = this.table, l = "", Re = 0, Fe = 0, Qe = 2, Pe = 1, He = t.slice.call(arguments, 1), y = Object.create(this.lexer), G = { yy: {} };
      for (var Se in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Se) && (G.yy[Se] = this.yy[Se]);
      y.setInput(i, G.yy), G.yy.lexer = y, G.yy.parser = this, typeof y.yylloc > "u" && (y.yylloc = {});
      var Ie = y.yylloc;
      t.push(Ie);
      ...
      o($e, "lex");
      for (var S, z, k, be, J = {}, ye, F, Ue, ge; ; ) {
        if (z = c[c.length - 1], this.defaultActions[z] ? k = this.defaultActions[z] : ((S === null || typeof S > "u") && (S = $e()), k = me[z] && me[z][S]), typeof k > "u" || !k.length || !k[0]) {
          var Te = "";
          ge = [];
          for (ye in me[z])
...
var lt = qe, ct = class {
  ...
  setClass(e, u) {
    for (const h of e) {
      ...
      if (r)
        for (const n of u) {
          r.classes.push(n);
          const E = this.classes.get(n)?.styles;
          E && r.cssStyles.push(...E);
        }
    }
  }
  defineClass(e, u) {
    for (const h of e) {
      ...
      r === void 0 && (r = { id: h, styles: [], textStyles: [] }, this.classes.set(h, r)), u && u.forEach(function(n) {
        if (/color/.exec(n)) {
          const E = n.replace("fill", "bgFill");
          r.textStyles.push(E);
        }
        r.styles.push(n);
      }), this.requirements.forEach((n) => {
        n.classes.includes(h) && n.cssStyles.push(...u.flatMap((E) => E.split(",")));
  ...
  getData() {
    ...
    for (const r of this.relations) {
      let n = 0;
      const E = r.type === this.Relationships.CONTAINS, g = {
        id: `${r.src}-${r.dst}-${n}`,
        ...
        style: ["fill:none", E ? "" : "stroke-dasharray: 10,7"],
        labelpos: "c",
        thickness: "normal",
        type: "normal",
        pattern: E ? "normal" : "dashed",
        arrowTypeStart: E ? "requirement_contains" : "",
        arrowTypeEnd: E ? "" : "requirement_arrow",
        look: e.look
      };
      h.push(g), n++;
    }
...
var ut = /* @__PURE__ */ o(async function(e, u, h, r) {
  ...
  const { securityLevel: n, state: E, layout: g } = ke(), R = r.db.getData(), _ = je(u, n);
  R.type = r.type, R.layoutAlgorithm = rt(g), R.nodeSpacing = E?.nodeSpacing ?? 50, R.rankSpacing = E?.rankSpacing ?? 50, R.markers = ["requirement_contains", "requirement_arrow"], R.diagramId = u, await nt(R, _);
  const b = 8;
  at.insertTitle(
    _,
  ...
  ), Ge(_, b, "requirementDiagram", E?.useMaxWidth ?? !0);
}, "draw"), Et = {
  parser: lt,
  get db() {
    return new ct();
