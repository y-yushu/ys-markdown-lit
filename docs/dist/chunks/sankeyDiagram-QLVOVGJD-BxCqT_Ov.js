import { _ as g, p as mt, q as kt, s as _t, g as xt, b as vt, a as bt, c as ot, z as wt, d as G, U as St, y as Lt, k as Et } from "./index-BX-ZM0Ir.js";
...
function $t() {
  let t = 0, n = 0, i = 1, a = 1, h = 24, b = 8, p, k = Ot, s = gt, o, l, _ = zt, x = Dt, y = 6;
  function v() {
  ...
  function P(e, f, u) {
    for (let c = 1, r = e.length; c < r; ++c) {
      ...
      for (const w of m) {
        let L = 0, R = 0;
        for (const { source: V, value: Z } of w.targetLinks) {
          let W = Z * (w.layer - V.layer);
          L += $(V, w) * W, R += W;
        }
        if (!(R > 0)) continue;
        let U = (L / R - w.y0) * f;
  ...
  function j(e, f, u) {
    for (let c = e.length, r = c - 2; r >= 0; --r) {
      ...
      for (const w of m) {
        let L = 0, R = 0;
        for (const { target: V, value: Z } of w.sourceLinks) {
          let W = Z * (V.layer - w.layer);
          L += I(w, V) * W, R += W;
        }
        if (!(R > 0)) continue;
        let U = (L / R - w.y0) * f;
  ...
  function O(e, f) {
    ...
    d(e, c.y0 - p, u - 1, f), z(e, c.y1 + p, u + 1, f), d(e, a, e.length - 1, f), z(e, n, 0, f);
  }
  function z(e, f, u, c) {
    for (; u < e.length; ++u) {
...
it.prototype = pt.prototype = {
  ...
  arcTo: function(t, n, i, a, h) {
    ...
    if (this._x1 === null)
      ...
      var x = i - b, y = a - p, v = k * k + s * s, M = x * x + y * y, T = Math.sqrt(v), N = Math.sqrt(_), C = h * Math.tan((et - Math.acos((v + _ - M) / (2 * T * N))) / 2), D = C / N, B = C / T;
      Math.abs(D - 1) > F && (this._ += "L" + (t + D * o) + "," + (n + D * l)), this._ += "A" + h + "," + h + ",0,0," + +(l * x > o * y) + "," + (this._x1 = t + B * k) + "," + (this._y1 = n + B * s);
    }
  },
  arc: function(t, n, i, a, h, b) {
    ...
    this._x1 === null ? this._ += "M" + s + "," + o : (Math.abs(this._x1 - s) > F || Math.abs(this._y1 - o) > F) && (this._ += "L" + s + "," + o), i && (_ < 0 && (_ = _ % nt + nt), _ > jt ? this._ += "A" + i + "," + i + ",0,1," + l + "," + (t - p) + "," + (n - k) + "A" + i + "," + i + ",0,1," + l + "," + (this._x1 = s) + "," + (this._y1 = o) : _ > F && (this._ += "A" + i + "," + i + ",0," + +(_ >= et) + "," + l + "," + (this._x1 = t + i * Math.cos(h)) + "," + (this._y1 = n + i * Math.sin(h))));
  },
...
function Wt(t) {
  var n = Ut, i = Vt, a = Bt, h = Rt, b = null;
  function p() {
...
var st = function() {
  var t = /* @__PURE__ */ g(function(k, s, o, l) {
    ...
    parse: /* @__PURE__ */ g(function(s) {
      var o = this, l = [0], _ = [], x = [null], y = [], v = this.table, M = "", T = 0, N = 0, C = 2, D = 1, B = y.slice.call(arguments, 1), S = Object.create(this.lexer), P = { yy: {} };
...
st.parser = st;
var H = st, Q = [], K = [], X = /* @__PURE__ */ new Map(), Qt = /* @__PURE__ */ g(() => {
  ...
  let n = X.get(t);
  return n === void 0 && (n = new Jt(t), X.set(t, n), K.push(n)), n;
  ...
  const { securityLevel: h, sankey: b } = ot(), p = wt.sankey;
  let k;
  h === "sandbox" && (k = G("#i" + n));
  ...
  $t().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (T ? 15 : 0)).nodeAlign(C).extent([
    [0, 0],
    [l, _]
  ])(N);
  const S = At(Mt);
...
${v}${Math.round(E * 100) / 100}${M}` : d, "getText");
  ...
  const j = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(N.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), O = b?.linkColor ?? "gradient";
  if (O === "gradient") {
  ...
  j.append("path").attr("d", Xt()).attr("stroke", z).attr("stroke-width", (d) => Math.max(1, d.width)), St(void 0, o, 0, x);
}, "draw"), ae = {
  draw: oe
}, le = /* @__PURE__ */ g((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing"), ce = /* @__PURE__ */ g((t) => `.label {
      font-family: ${t.fontFamily};
    }`, "getStyles"), ue = ce, he = H.parse.bind(H);
H.parse = (t) => he(le(t));
var de = {
  styles: ue,
  parser: H,
