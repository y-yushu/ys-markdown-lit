import { E as l } from "./custom-element-DwLosoKP.js";
import { i as $, t as a, e as f } from "./directive-kLG6oqUu.js";
/**
 * @license
...
const r = /* @__PURE__ */ new WeakMap(), m = f(class extends p {
  render(t) {
    return l;
  }
  update(t, [s]) {
    const e = s !== this.Y;
    return e && this.Y !== void 0 && this.rt(void 0), (e || this.lt !== this.ct) && (this.Y = s, this.ht = t.options?.host, this.rt(this.ct = t.element)), l;
  }
  rt(t) {
    if (this.isConnected || (t = void 0), typeof this.Y == "function") {
      const s = this.ht ?? globalThis;
      let e = r.get(s);
      e === void 0 && (e = /* @__PURE__ */ new WeakMap(), r.set(s, e)), e.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), e.set(this.Y, t), t !== void 0 && this.Y.call(this.ht, t);
    } else this.Y.value = t;
  }
  get lt() {
    return typeof this.Y == "function" ? r.get(this.ht ?? globalThis)?.get(this.Y) : this.Y?.value;
  }
  disconnected() {
