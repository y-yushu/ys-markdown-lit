import { _ as o, l as te, c as M, H as fe, ae as ye, af as be, ag as me, U as _e, F as K, i as j, t as Ee, J as ke, V as Se, W as ce, X as le } from "./index-BX-ZM0Ir.js";
var $ = function() {
  var e = /* @__PURE__ */ o(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), u = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], E = [1, 16], b = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], _ = [6, 7, 11], G = [1, 31], N = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], m = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], U = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(i, n, r, a, h, t, H) {
      var c = t.length - 1;
      switch (h) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: u }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: u }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l }, e(D, [2, 3]), { 1: [2, 2] }, e(D, [2, 4]), e(D, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l }, { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l }, { 6: I, 7: g, 10: 23, 11: w }, e(_, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: b, 23: l }), e(_, [2, 19]), e(_, [2, 21], { 15: 30, 24: G }), e(_, [2, 22]), e(_, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: I, 7: g, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l }, e(V, [2, 14], { 7: m, 11: A }), e(L, [2, 8]), e(L, [2, 9]), e(L, [2, 10]), e(_, [2, 16], { 15: 37, 24: G }), e(_, [2, 17]), e(_, [2, 18]), e(_, [2, 20], { 24: U }), e(N, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(V, [2, 13], { 7: m, 11: A }), e(L, [2, 11]), e(L, [2, 12]), e(_, [2, 15], { 24: U }), e(N, [2, 30]), { 22: [1, 41] }, e(N, [2, 27]), e(N, [2, 29])],
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var n = this, r = [0], a = [], h = [null], t = [], H = this.table, c = "", W = 0, se = 0, ue = 2, re = 1, ge = t.slice.call(arguments, 1), y = Object.create(this.lexer), R = { yy: {} };
      ...
      for (var k, P, x, Q, F = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((k === null || typeof k > "u") && (k = ae()), x = H[P] && H[P][k]), typeof x > "u" || !x.length || !x[0]) {
          var Z = "";
          X = [];
          for (z in H[P])
        ...
        switch (x[0]) {
          ...
          case 2:
            if (C = this.productions_[x[1]][1], F.$ = h[h.length - C], F._$ = {
              ...
              return Q;
            C && (r = r.slice(0, -1 * C * 2), h = h.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), h.push(F.$), t.push(F._$), oe = H[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
...
var Ne = $, v = [], ne = [], ee = 0, ie = {}, xe = /* @__PURE__ */ o(() => {
  ...
  const E = M();
  let b = E.mindmap?.padding ?? K.mindmap.padding;
  switch (s) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  const l = {
    ...
    level: e,
    label: j(p, E),
    width: E.mindmap?.maxNodeWidth ?? K.mindmap.maxNodeWidth,
    padding: b,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + e);
  ...
  for (const m of g) {
    const A = G[V];
    V = V + 1;
    const L = b?.kanban?.sectionWidth || 200, U = -L * 3 / 2 + N;
    let T = U;
    const Y = E.nodes.filter((i) => i.parentId === m.id);
    for (const i of Y) {
      if (i.isGroup)
    ...
    const B = A.cluster.select("rect"), O = Math.max(T - U + 3 * _, 50) + (N - 25);
    B.attr("height", O);
  }
  _e(
    void 0,
    l,
    b.mindmap?.padding ?? K.kanban.padding,
    b.mindmap?.useMaxWidth ?? K.kanban.useMaxWidth
  );
}, "draw"), Be = {
  draw: Ve
}, Fe = /* @__PURE__ */ o((e) => {
