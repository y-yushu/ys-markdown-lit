import { _ as S, l as z, c as ot, H as Nt, U as Dt, F as it, i as nt, V as mt, W as Ot, X as At, d as It, aj as Ct, N as Rt } from "./index-BX-ZM0Ir.js";
import { c as dt } from "./cytoscape.esm-CLJeCTRC.js";
import { g as xt } from "./_commonjsHelpers-C6fGbg64.js";
...
var Pt = at, Z = [], vt = 0, ht = {}, Yt = /* @__PURE__ */ S(() => {
  ...
  const v = ot();
  let r = v.mindmap?.padding ?? it.mindmap.padding;
  switch (m) {
    case W.ROUNDED_RECT:
    case W.RECT:
    case W.HEXAGON:
  ...
  const t = {
    ...
    type: m,
    children: [],
    width: v.mindmap?.maxNodeWidth ?? it.mindmap.maxNodeWidth,
    padding: r
  }, e = Xt(I);
  if (e)
...
}, "roundedRectBkg"), se = /* @__PURE__ */ S(async function(I, w, f, m, v) {
  const r = v.htmlLabels, t = m % (Kt - 1), e = w.append("g");
  f.section = t;
  let i = "section-" + t;
...
`);
  ...
  const y = g.node().getBBox(), [n] = Rt(v.fontSize);
...
async function lt(I, w, f, m, v) {
  await se(I, w, f, m, v), f.children && await Promise.all(
    f.children.map(
...
function Lt(I, w) {
  return new Promise((f) => {
    const m = It("body").append("div").attr("id", "cy").attr("style", "display:none"), v = dt({
