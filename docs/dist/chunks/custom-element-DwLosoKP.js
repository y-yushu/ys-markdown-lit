 ...
 */
const x = globalThis, k = x.ShadowRoot && (x.ShadyCSS === void 0 || x.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, z = Symbol(), j = /* @__PURE__ */ new WeakMap();
let G = class {
  constructor(t, e, s) {
...
const st = (r) => new G(typeof r == "string" ? r : r + "", void 0, z), Ct = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: rt, defineProperty: nt, getOwnPropertyDescriptor: ot, getOwnPropertyNames: ht, getOwnPropertySymbols: at, getPrototypeOf: lt } = Object, O = globalThis, D = O.trustedTypes, ct = D ? D.emptyScript : "", dt = O.reactiveElementPolyfillSupport, S = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ct : null;
      break;
  ...
  return e;
} }, Q = (r, t) => !rt(r, t), V = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: Q };
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[S("elementProperties")] = /* @__PURE__ */ new Map(), g[S("finalized")] = /* @__PURE__ */ new Map(), dt?.({ ReactiveElement: g }), (O.reactiveElementVersions ??= []).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const L = globalThis, T = L.trustedTypes, W = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, X = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, Y = "?" + _, pt = `<${Y}>`, m = document, b = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, ut = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", R = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, q = /-->/g, J = />/g, f = RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), K = /'/g, Z = /"/g, tt = /^(?:script|style|textarea|title)$/i, $t = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), wt = $t(1), y = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), F = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function et(r, t) {
...
const _t = (r, t) => {
  ...
  for (let p = 0; p < e; p++) {
    const h = r[p];
    let l, d, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, d = o.exec(h), d !== null); ) u = o.lastIndex, o === E ? d[1] === "!--" ? o = q : d[1] !== void 0 ? o = J : d[2] !== void 0 ? (tt.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = f) : d[3] !== void 0 && (o = f) : o === f ? d[0] === ">" ? (o = i ?? E, a = -1) : d[1] === void 0 ? a = -2 : (a = o.lastIndex - d[2].length, l = d[1], o = d[3] === void 0 ? f : d[3] === '"' ? Z : K) : o === Z || o === K ? o = f : o === q || o === J ? o = E : (o = f, i = void 0);
    const $ = o === f && r[p + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + pt : a >= 0 ? (s.push(l), h.slice(0, a) + X + h.slice(a) + _ + $) : h + _ + (a === -2 ? p : $);
  }
...
class w {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = w.createElement(l, s), A.currentNode = this.el.content, e === 2 || e === 3) {
...
class ft {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let l;
        h.type === 2 ? l = new P(n, n.nextSibling, this, t) : h.type === 1 ? l = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (l = new yt(n, this, t)), this._$AV.push(l), h = s[++p];
      }
...
class P {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), C(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ut(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== c && C(this._$AH) ? this._$AA.nextSibling.data = t : this.T(m.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = w.createElement(et(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return e === void 0 && F.set(t.strings, e = new w(t)), e;
  }
  k(t) {
...
class N {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = v(this, t, e, 0), o = !C(t) || t !== this._$AH && t !== y, o && (this._$AH = t);
      ...
      const p = t;
      let h, l;
      for (t = n[0], h = 0; h < n.length - 1; h++) l = v(this, p[s + h], e, h), l === y && (l = this._$AH[h]), o ||= !C(l) || l !== this._$AH[h], l === c ? t = c : t !== c && (t += (l ?? "") + n[h + 1]), this._$AH[h] = l;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
vt?.(w, P), (L.litHtmlVersions ??= []).push("3.2.1");
const Et = (r, t, e) => {
