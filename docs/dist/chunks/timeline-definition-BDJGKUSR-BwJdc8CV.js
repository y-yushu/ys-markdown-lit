import { _ as s, c as xt, l as E, d as j, U as kt, V as vt, W as _t, X as bt, B as wt, Y as St, y as Et } from "./index-BX-ZM0Ir.js";
import { d as nt } from "./arc-BfM7Ot4R.js";
var Q = function() {
  var n = /* @__PURE__ */ s(function(x, i, a, c) {
    ...
    parse: /* @__PURE__ */ s(function(i) {
      var a = this, c = [0], p = [], y = [null], o = [], w = this.table, v = "", N = 0, A = 0, z = 2, q = 1, $ = o.slice.call(arguments, 1), g = Object.create(this.lexer), b = { yy: {} };
      ...
      function tt() {
        var T;
        return T = p.pop() || g.lex() || q, typeof T != "number" && (T instanceof Array && (p = T, T = p.pop()), T = a.symbols_[T] || T), T;
      }
      s(tt, "lex");
      for (var S, C, I, J, R = {}, B, M, et, O; ; ) {
        if (C = c[c.length - 1], this.defaultActions[C] ? I = this.defaultActions[C] : ((S === null || typeof S > "u") && (S = tt()), I = w[C] && w[C][S]), typeof I > "u" || !I.length || !I[0]) {
          ...
          O = [];
          for (B in w[C])
            this.terminals_[B] && B > z && O.push("'" + this.terminals_[B] + "'");
          g.showPosition ? K = "Parse error on line " + (N + 1) + `:
` + g.showPosition() + `
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : K = "Parse error on line " + (N + 1) + ": Unexpected " + (S == q ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(K, {
            text: g.match,
...
var F = "", lt = 0, X = [], G = [], V = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  ...
  addTaskOrg: gt,
  addEvent: yt
}, Nt = 12, U = /* @__PURE__ */ s(function(n, t) {
  ...
  r.x = t.x, r.y = t.y, r.fill = t.fill, r.width = e.width, r.height = e.height, r.class = "journey-section section-type-" + t.num, r.rx = 3, r.ry = 3, U(l, r), mt(e)(
    t.text,
    l,
    r.x,
    r.y,
  ...
  const h = Y();
  h.x = t.x, h.y = t.y, h.fill = t.fill, h.width = e.width, h.height = e.height, h.class = "task task-type-" + t.num, h.rx = 3, h.ry = 3, U(r, h), mt(e)(
    t.task,
    r,
    h.x,
    h.y,
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  const h = d.append("g"), f = d.append("g"), u = f.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(D, t.width).node().getBBox(), k = l.fontSize?.replace ? l.fontSize.replace("px", "") : l.fontSize;
  return t.height = u.height + k * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, f.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), zt(h, t, r, l), t;
  ...
  E.debug("bounds", z), _ && u.append("text").text(_).attr("x", z.width / 2 - d).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = v ? i + a + 150 : a + 100, u.append("g").attr("class", "lineWrapper").append("line").attr("x1", d).attr("y1", c).attr("x2", z.width + 3 * d).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), kt(
    void 0,
    u,
