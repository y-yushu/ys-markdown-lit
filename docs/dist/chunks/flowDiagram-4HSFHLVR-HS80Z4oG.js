import { _ as A, n as Pt, l as J, c as N1, d as m1, o as Yt, r as Ht, u as st, b as qt, s as Xt, p as Qt, a as Jt, g as Zt, q as $t, k as te, t as ee, J as se, v as ie, x as et, y as re, z as ae, A as ne } from "./index-BX-ZM0Ir.js";
import { g as ue, s as oe } from "./chunk-RZ5BOZE2-B0kcaVf8.js";
import { c as le } from "./channel-U8dKMW8C.js";
var ce = "flowchart-", he = class {
  // cspell:ignore funs
  constructor() {
    this.vertexCounter = 0, this.config = N1(), this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = qt, this.setAccDescription = Xt, this.setDiagramTitle = Qt, this.getAccTitle = Jt, this.getAccDescription = Zt, this.getDiagramTitle = $t, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = {
  ...
  sanitizeText(t) {
    return te.sanitizeText(t, this.config);
  }
  /**
...
` + b + `
    ...
    const d = this.edges.find((D) => D.id === t);
    if (d) {
      const D = n;
      D?.animate !== void 0 && (d.animate = D.animate), D?.animation !== void 0 && (d.animation = D.animation);
      return;
    }
    let _, g = this.vertices.get(t);
    if (g === void 0 && (g = {
      id: t,
      labelType: "text",
      domId: ce + t + "-" + this.vertexCounter,
      styles: [],
      classes: []
    }, this.vertices.set(t, g)), this.vertexCounter++, i !== void 0 ? (this.config = N1(), _ = this.sanitizeText(i.text.trim()), g.labelType = i.type, _.startsWith('"') && _.endsWith('"') && (_ = _.substring(1, _.length - 1)), g.text = _) : g.text === void 0 && (g.text = t), r !== void 0 && (g.type = r), a?.forEach((D) => {
      g.styles.push(D);
    }), o?.forEach((D) => {
      g.classes.push(D);
    }), p !== void 0 && (g.dir = p), g.props === void 0 ? g.props = l : l !== void 0 && Object.assign(g.props, l), n !== void 0) {
      if (n.shape) {
      ...
      n?.label && (g.text = n?.label), n?.icon && (g.icon = n?.icon, !n.label?.trim() && g.text === t && (g.text = "")), n?.form && (g.form = n?.form), n?.pos && (g.pos = n?.pos), n?.img && (g.img = n?.img, !n.label?.trim() && g.text === t && (g.text = "")), n?.constraint && (g.constraint = n.constraint), n.w && (g.assetWidth = Number(n.w)), n.h && (g.assetHeight = Number(n.h));
    }
  }
  /**
  ...
  addSingleLink(t, i, r, a) {
    ...
    const b = r.text;
    if (b !== void 0 && (l.text = this.sanitizeText(b.text.trim()), l.text.startsWith('"') && l.text.endsWith('"') && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = b.type), r !== void 0 && (l.type = r.type, l.stroke = r.stroke, l.length = r.length > 10 ? 10 : r.length), a && !this.edges.some((n) => n.id === a))
      l.id = a, l.isUserDefinedId = !0;
    else {
      const n = this.edges.filter((d) => d.start === l.start && d.end === l.end);
      n.length === 0 ? l.id = et(l.start, l.end, { counter: 0, prefix: "L" }) : l.id = et(l.start, l.end, {
        counter: n.length + 1,
        prefix: "L"
      });
    }
...
You have to call mermaid.initialize.`
  ...
  addLink(t, i, r) {
    ...
    J.info("addLink", t, i, a);
    for (const o of t)
      for (const p of i) {
        const l = o === t[t.length - 1], b = p === i[0];
        l && b ? this.addSingleLink(o, p, r, a) : this.addSingleLink(o, p, r, void 0);
      }
  }
  /**
  ...
  addClass(t, i) {
    ...
    t.split(",").forEach((a) => {
      ...
      o === void 0 && (o = { id: a, styles: [], textStyles: [] }, this.classes.set(a, o)), r?.forEach((p) => {
        if (/color/.exec(p)) {
  ...
  setClickFun(t, i, r) {
    ...
    if (N1().securityLevel !== "loose" || i === void 0)
      return;
    let o = [];
    if (typeof r == "string") {
      o = r.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
    ...
    o.length === 0 && o.push(t);
    const p = this.vertices.get(t);
    p && (p.haveCallback = !0, this.funs.push(() => {
  ...
  setupToolTips(t) {
    ...
    (i._groups || i)[0][0] === null && (i = m1("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), m1(t).select("svg").selectAll("g.node").on("mouseover", (o) => {
      const p = m1(o.currentTarget);
      if (p.attr("title") === null)
        return;
      const b = o.currentTarget?.getBoundingClientRect();
      i.transition().duration(200).style("opacity", ".9"), i.text(p.attr("title")).style("left", window.scrollX + b.left + (b.right - b.left) / 2 + "px").style("top", window.scrollY + b.bottom + "px"), i.html(i.html().replace(/&lt;br\/&gt;/g, "<br/>")), p.classed("hover", !0);
    }).on("mouseout", (o) => {
      i.transition().duration(500).style("opacity", 0), m1(o.currentTarget).classed("hover", !1);
    });
  }
  /**
   ...
   */
  clear(t = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = t, this.config = N1(), re();
  }
  setGen(t) {
  ...
  addSubGraph(t, i, r) {
    ...
    const p = /* @__PURE__ */ A((d) => {
      const _ = { boolean: {}, number: {}, string: {} }, g = [];
      let D;
      return { nodeList: d.filter(function(k) {
        const x = typeof k;
        return k.stmt && k.stmt === "dir" ? (D = k.value, !1) : k.trim() === "" ? !1 : x in _ ? _[x].hasOwnProperty(k) ? !1 : _[x][k] = !0 : g.includes(k) ? !1 : g.push(k);
      }), dir: D };
    }, "uniq"), { nodeList: l, dir: b } = p(i.flat());
    ...
    return J.info("Adding", n.id, n.nodes, n.dir), n.nodes = this.makeUniq(n, this.subGraphs).nodes, this.subGraphs.push(n), this.subGraphLookup.set(a, n), a;
  }
  getPosForId(t) {
  ...
  indexNodes2(t, i) {
    ...
    let a = 0, o = 1;
    for (; a < r.length; ) {
      const p = this.getPosForId(r[a]);
      if (p >= 0) {
        const l = this.indexNodes2(t, p);
        if (l.result)
          return {
            result: !0,
            count: o + l.count
  ...
  destructEndLink(t) {
    ...
    let o = "normal", p = r.length - 1;
    r.startsWith("=") && (o = "thick"), r.startsWith("~") && (o = "invisible");
    const l = this.countChar(".", r);
    return l && (o = "dotted", p = l), { type: a, stroke: o, length: p };
  }
  destructLink(t, i) {
  ...
  addNodeFromVertex(t, i, r, a, o, p) {
    const l = r.get(t.id), b = a.get(t.id) ?? !1, n = this.findNode(i, t.id);
    if (n)
      n.cssStyles = t.styles, n.cssCompiledStyles = this.getCompiledStyles(t.classes), n.cssClasses = t.classes.join(" ");
    else {
      const d = {
        id: t.id,
        label: t.text,
  ...
  getData() {
    const t = N1(), i = [], r = [], a = this.getSubGraphs(), o = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map();
    for (let n = a.length - 1; n >= 0; n--) {
      const d = a[n];
      d.nodes.length > 0 && p.set(d.id, !0);
      for (const _ of d.nodes)
        o.set(_, d.id);
    }
    for (let n = a.length - 1; n >= 0; n--) {
      const d = a[n];
    ...
    this.getVertices().forEach((n) => {
      this.addNodeFromVertex(n, i, o, p, t, t.look || "classic");
    });
    const b = this.getEdges();
    return b.forEach((n, d) => {
      const { arrowTypeStart: _, arrowTypeEnd: g } = this.destructEdgeType(n.type), D = [...b.defaultStyle ?? []];
      n.style && D.push(...n.style);
      const K = {
        id: et(n.start, n.end, { counter: d, prefix: "L" }, n.id),
        ...
        arrowTypeStart: n?.stroke === "invisible" || n?.type === "arrow_open" ? "none" : _,
...
}, de = /* @__PURE__ */ A(function(t, i) {
  return i.db.getClasses();
}, "getClasses"), pe = /* @__PURE__ */ A(async function(t, i, r, a) {
  J.info("REF0:"), J.info("Drawing state diagram (v2)", i);
  const { securityLevel: o, flowchart: p, layout: l } = N1();
  let b;
  o === "sandbox" && (b = m1("#i" + i));
  const n = o === "sandbox" ? b.nodes()[0].contentDocument : document;
  J.debug("Before getData: ");
  const d = a.db.getData();
  J.debug("Data: ", d);
  const _ = ue(i, o), g = a.db.getDirection();
  d.type = a.type, d.layoutAlgorithm = Yt(l), d.layoutAlgorithm === "dagre" && l === "elk" && J.warn(
    "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."
  ), d.direction = g, d.nodeSpacing = p?.nodeSpacing || 50, d.rankSpacing = p?.rankSpacing || 50, d.markers = ["point", "circle", "cross"], d.diagramId = i, J.debug("REF1:", d), await Ht(d, _);
  const D = d.config.flowchart?.diagramPadding ?? 8;
  st.insertTitle(
    _,
    "flowchartTitleText",
    p?.titleTopMargin || 0,
    a.db.getDiagramTitle()
  ), oe(_, D, "flowchart", p?.useMaxWidth || !1);
  for (const K of d.nodes) {
    const k = m1(`#${i} [id="${K.id}"]`);
    if (!k || !K.link)
      continue;
    const x = n.createElementNS("http://www.w3.org/2000/svg", "a");
    x.setAttributeNS("http://www.w3.org/2000/svg", "class", K.cssClasses), x.setAttributeNS("http://www.w3.org/2000/svg", "rel", "noopener"), o === "sandbox" ? x.setAttributeNS("http://www.w3.org/2000/svg", "target", "_top") : K.linkTarget && x.setAttributeNS("http://www.w3.org/2000/svg", "target", K.linkTarget);
    const p1 = k.insert(function() {
      return x;
    }, ":first-child"), f1 = k.select(".label-container");
    f1 && p1.append(function() {
      return f1.node();
    });
    const g1 = k.select(".label");
    g1 && p1.append(function() {
      return g1.node();
    });
  }
}, "draw"), fe = {
  ...
  var t = /* @__PURE__ */ A(function(d1, c, h, f) {
    for (h = h || {}, f = d1.length; f--; h[d1[f]] = c) ;
    return h;
    ...
    performAction: /* @__PURE__ */ A(function(c, h, f, u, F, e, G1) {
      var s = e.length - 1;
      switch (F) {
        case 2:
          this.$ = [];
        ...
        case 11:
          ...
          break;
        case 12:
          u.setDirection(e[s - 1]), this.$ = e[s - 1];
          break;
        case 27:
          this.$ = e[s - 1].nodes;
          break;
        ...
        case 32:
          ...
          break;
        case 33:
          this.$ = u.addSubGraph(e[s - 6], e[s - 1], e[s - 4]);
          break;
        case 34:
          this.$ = u.addSubGraph(e[s - 3], e[s - 1], e[s - 3]);
          break;
        case 35:
          this.$ = u.addSubGraph(void 0, e[s - 1], void 0);
          break;
        case 37:
        ...
        case 44:
          ...
          break;
        case 45:
          u.addVertex(e[s - 1][e[s - 1].length - 1], void 0, void 0, void 0, void 0, void 0, void 0, e[s]), u.addLink(e[s - 3].stmt, e[s - 1], e[s - 2]), this.$ = { stmt: e[s - 1], nodes: e[s - 1].concat(e[s - 3].nodes) };
          break;
        case 46:
          u.addLink(e[s - 2].stmt, e[s], e[s - 1]), this.$ = { stmt: e[s], nodes: e[s].concat(e[s - 2].nodes) };
          break;
        case 47:
          u.addLink(e[s - 3].stmt, e[s - 1], e[s - 2]), this.$ = { stmt: e[s - 1], nodes: e[s - 1].concat(e[s - 3].nodes) };
          break;
        case 48:
          this.$ = { stmt: e[s - 1], nodes: e[s - 1] };
          break;
        case 49:
          u.addVertex(e[s - 1][e[s - 1].length - 1], void 0, void 0, void 0, void 0, void 0, void 0, e[s]), this.$ = { stmt: e[s - 1], nodes: e[s - 1], shapeData: e[s] };
          break;
        case 50:
        ...
        case 51:
          ...
          break;
        case 52:
          u.addVertex(e[s - 5][e[s - 5].length - 1], void 0, void 0, void 0, void 0, void 0, void 0, e[s - 4]), this.$ = e[s - 5].concat(e[s]);
          break;
        case 53:
        ...
        case 54:
          ...
          break;
        case 55:
          this.$ = e[s - 2], u.setClass(e[s - 2], e[s]);
          break;
        case 56:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "square");
          break;
        case 57:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "doublecircle");
          break;
        case 58:
          this.$ = e[s - 5], u.addVertex(e[s - 5], e[s - 2], "circle");
          break;
        case 59:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "ellipse");
          break;
        case 60:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "stadium");
          break;
        case 61:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "subroutine");
          break;
        case 62:
          this.$ = e[s - 7], u.addVertex(e[s - 7], e[s - 1], "rect", void 0, void 0, void 0, Object.fromEntries([[e[s - 5], e[s - 3]]]));
          break;
        case 63:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "cylinder");
          break;
        case 64:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "round");
          break;
        case 65:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "diamond");
          break;
        case 66:
          this.$ = e[s - 5], u.addVertex(e[s - 5], e[s - 2], "hexagon");
          break;
        case 67:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "odd");
          break;
        case 68:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "trapezoid");
          break;
        case 69:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "inv_trapezoid");
          break;
        case 70:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "lean_right");
          break;
        case 71:
          this.$ = e[s - 3], u.addVertex(e[s - 3], e[s - 1], "lean_left");
          break;
        case 72:
          this.$ = e[s], u.addVertex(e[s]);
          break;
        case 73:
        ...
        case 76:
          ...
          break;
        case 77:
          var v = u.destructLink(e[s], e[s - 2]);
        ...
        case 103:
          ...
          break;
        case 105:
          this.$ = e[s - 4], u.addClass(e[s - 2], e[s]);
          break;
        case 106:
          this.$ = e[s - 4], u.setClass(e[s - 2], e[s]);
          break;
        case 107:
        case 115:
          this.$ = e[s - 1], u.setClickEvent(e[s - 1], e[s]);
          break;
        case 108:
        case 116:
          this.$ = e[s - 3], u.setClickEvent(e[s - 3], e[s - 2]), u.setTooltip(e[s - 3], e[s]);
          break;
        case 109:
          this.$ = e[s - 2], u.setClickEvent(e[s - 2], e[s - 1], e[s]);
          break;
        case 110:
          this.$ = e[s - 4], u.setClickEvent(e[s - 4], e[s - 3], e[s - 2]), u.setTooltip(e[s - 4], e[s]);
          break;
        case 111:
          this.$ = e[s - 2], u.setLink(e[s - 2], e[s]);
          break;
        case 112:
          this.$ = e[s - 4], u.setLink(e[s - 4], e[s - 2]), u.setTooltip(e[s - 4], e[s]);
          break;
        case 113:
          this.$ = e[s - 4], u.setLink(e[s - 4], e[s - 2], e[s]);
          break;
        case 114:
          this.$ = e[s - 6], u.setLink(e[s - 6], e[s - 4], e[s]), u.setTooltip(e[s - 6], e[s - 2]);
          break;
        case 117:
          this.$ = e[s - 1], u.setLink(e[s - 1], e[s]);
          break;
        case 118:
          this.$ = e[s - 3], u.setLink(e[s - 3], e[s - 2]), u.setTooltip(e[s - 3], e[s]);
          break;
        case 119:
          this.$ = e[s - 3], u.setLink(e[s - 3], e[s - 2], e[s]);
          break;
        case 120:
          this.$ = e[s - 5], u.setLink(e[s - 5], e[s - 4], e[s]), u.setTooltip(e[s - 5], e[s - 2]);
          break;
        case 121:
          this.$ = e[s - 4], u.addVertex(e[s - 2], void 0, void 0, e[s]);
          break;
        case 122:
          this.$ = e[s - 4], u.updateLink([e[s - 2]], e[s]);
          break;
        case 123:
          this.$ = e[s - 4], u.updateLink(e[s - 2], e[s]);
          break;
        case 124:
          this.$ = e[s - 8], u.updateLinkInterpolate([e[s - 6]], e[s - 2]), u.updateLink([e[s - 6]], e[s]);
          break;
        case 125:
          this.$ = e[s - 8], u.updateLinkInterpolate(e[s - 6], e[s - 2]), u.updateLink(e[s - 6], e[s]);
          break;
        case 126:
          this.$ = e[s - 6], u.updateLinkInterpolate([e[s - 4]], e[s]);
          break;
        case 127:
          this.$ = e[s - 6], u.updateLinkInterpolate(e[s - 4], e[s]);
          break;
    ...
    parse: /* @__PURE__ */ A(function(c) {
      var h = this, f = [0], u = [], F = [null], e = [], G1 = this.table, s = "", v = 0, It = 0, Wt = 2, Rt = 1, zt = e.slice.call(arguments, 1), M = Object.create(this.lexer), A1 = { yy: {} };
      ...
      function Kt(q) {
        f.length = f.length - 2 * q, F.length = F.length - q, e.length = e.length - q;
      }
      A(Kt, "popStack");
      function Nt() {
        var q;
        return q = u.pop() || M.lex() || Rt, typeof q != "number" && (q instanceof Array && (u = q, q = u.pop()), q = h.symbols_[q] || q), q;
      }
      A(Nt, "lex");
      for (var j, k1, X, $1, R1 = {}, H1, l1, Gt, q1; ; ) {
        if (k1 = f[f.length - 1], this.defaultActions[k1] ? X = this.defaultActions[k1] : ((j === null || typeof j > "u") && (j = Nt()), X = G1[k1] && G1[k1][j]), typeof X > "u" || !X.length || !X[0]) {
          var tt = "";
          q1 = [];
          for (H1 in G1[k1])
            this.terminals_[H1] && H1 > Wt && q1.push("'" + this.terminals_[H1] + "'");
          M.showPosition ? tt = "Parse error on line " + (v + 1) + `:
` + M.showPosition() + `
Expecting ` + q1.join(", ") + ", got '" + (this.terminals_[j] || j) + "'" : tt = "Parse error on line " + (v + 1) + ": Unexpected " + (j == Rt ? "end of input" : "'" + (this.terminals_[j] || j) + "'"), this.parseError(tt, {
            text: M.match,
        ...
        switch (X[0]) {
          case 1:
            f.push(j), F.push(M.yytext), e.push(M.yylloc), f.push(X[1]), j = null, It = M.yyleng, s = M.yytext, v = M.yylineno, Z1 = M.yylloc;
            break;
          case 2:
            if (l1 = this.productions_[X[1]][1], R1.$ = F[F.length - l1], R1._$ = {
              first_line: e[e.length - (l1 || 1)].first_line,
              last_line: e[e.length - 1].last_line,
              first_column: e[e.length - (l1 || 1)].first_column,
              last_column: e[e.length - 1].last_column
            }, jt && (R1._$.range = [
              e[e.length - (l1 || 1)].range[0],
              e[e.length - 1].range[1]
            ]), $1 = this.performAction.apply(R1, [
              s,
              It,
              v,
              A1.yy,
              ...
              return $1;
            l1 && (f = f.slice(0, -1 * l1 * 2), F = F.slice(0, -1 * l1), e = e.slice(0, -1 * l1)), f.push(this.productions_[X[1]][0]), F.push(R1.$), e.push(R1._$), Gt = G1[f[f.length - 2]][f[f.length - 1]], f.push(Gt);
            break;
          case 3:
            return !0;
        }
    ...
    var d1 = {
      EOF: 1,
      parseError: /* @__PURE__ */ A(function(h, f) {
        if (this.yy.parser)
          this.yy.parser.parseError(h, f);
        else
          throw new Error(h);
      }, "parseError"),
      ...
      unput: /* @__PURE__ */ A(function(c) {
        ...
        return this.yylloc = {
          ...
          last_column: f ? (f.length === u.length ? this.yylloc.first_column : 0) + u[u.length - f.length].length - f[0].length : this.yylloc.first_column - h
        }, this.options.ranges && (this.yylloc.range = [F[0], F[0] + this.yyleng - h]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + h + "^";
      ...
      test_match: /* @__PURE__ */ A(function(c, h) {
        ...
        }, this.options.ranges && (F.yylloc.range = this.yylloc.range.slice(0))), u = c[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + c[0].length
        }, this.yytext += c[0], this.match += c[0], this.matches = c, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(c[0].length), this.matched += c[0], f = this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), f)
          return f;
        if (this._backtrack) {
          for (var e in F)
            this[e] = F[e];
      ...
      next: /* @__PURE__ */ A(function() {
        ...
        for (var F = this._currentRules(), e = 0; e < F.length; e++)
          if (f = this._input.match(this.rules[F[e]]), f && (!h || f[0].length > h[0].length)) {
            if (h = f, u = e, this.options.backtrack_lexer) {
              if (c = this.test_match(f, F[e]), c !== !1)
                return c;
              if (this._backtrack) {
                h = !1;
                continue;
        ...
        return h ? (c = this.test_match(h, F[u]), c !== !1 ? c : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ A(function(h, f, u, F) {
        switch (u) {
          case 0:
...
var ge = Mt, be = /* @__PURE__ */ A((t, i) => {
  const r = le, a = r(t, "r"), o = r(t, "g"), p = r(t, "b");
  return ne(a, o, p, i);
}, "fade"), Ae = /* @__PURE__ */ A((t) => `.label {
  ...
  .labelBkg {
    background-color: ${be(t.edgeLabelBackground, 0.5)};
    // background-color:
  }
