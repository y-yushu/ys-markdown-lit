import { _ as nt, g as qe, s as Je, a as Qe, b as Ke, q as je, p as _e, H as tr, U as er, y as rr, l as Pe, aj as Le, c as ge, aG as me, d as ir, F as ar, aH as nr, aI as or } from "./index-BX-ZM0Ir.js";
import { p as sr } from "./chunk-4BMEZGHF-BdmMgu3H.js";
import { I as lr } from "./chunk-XZIHB7SX-xCYMwkJb.js";
import { p as hr } from "./radar-MK3ICKWK-qg_lRv0H.js";
import { c as Ge } from "./cytoscape.esm-CLJeCTRC.js";
import { g as fr } from "./_commonjsHelpers-C6fGbg64.js";
      ...
      return (
        ...
        function(M) {
          ...
          function L(u) {
            ...
            return M[u].call(h.exports, h, h.exports, L), h.l = !0, h.exports;
          }
          return L.m = M, L.c = P, L.i = function(u) {
            return u;
          }, L.d = function(u, h, a) {
          ...
          function(M, P, L) {
            ...
            function r(f, i, v) {
              u.call(this, v), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = v, this.bendpoints = [], this.source = f, this.target = i;
            }
          ...
          /***/
          function(M, P, L) {
            var u = L(2), h = L(10), a = L(13), r = L(0), e = L(16), f = L(5);
            function i(t, o, s, c) {
          ...
          /***/
          function(M, P, L) {
            var u = L(2), h = L(10), a = L(0), r = L(7), e = L(3), f = L(1), i = L(13), v = L(12), t = L(11);
            function o(c, l, T) {
            ...
            o.prototype.getNodes = function() {
              ...
              if (c instanceof e) {
                ...
                var C = g.source.edges.indexOf(g), G = g.target.edges.indexOf(g);
                if (!(C > -1 && G > -1))
              ...
              for (var c = h.MAX_VALUE, l = h.MAX_VALUE, T, g, d, N = this.getNodes(), F = N.length, C = 0; C < F; C++) {
                var G = N[C];
                T = G.getTop(), g = G.getLeft(), c > T && (c = T), l > g && (l = g);
              }
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, F, C, G, B, U = this.nodes, K = U.length, D = 0; D < K; D++) {
                var at = U[D];
                c && at.child != null && at.updateBounds(), N = at.getLeft(), F = at.getRight(), C = at.getTop(), G = at.getBottom(), l > N && (l = N), T < F && (T = F), g > C && (g = C), d < G && (d = G);
              }
              var n = new i(l, g, T - l, d - g);
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, F, C, G, B = c.length, U = 0; U < B; U++) {
                var K = c[U];
                N = K.getLeft(), F = K.getRight(), C = K.getTop(), G = K.getBottom(), l > N && (l = N), T < F && (T = F), g > C && (g = C), d < G && (d = G);
              }
              var D = new i(l, g, T - l, d - g);
              return D;
              ...
              var l = new t(), T = /* @__PURE__ */ new Set(), g = this.nodes[0], d, N, F = g.withChildren();
              for (F.forEach(function(D) {
                ...
                for (var C = d.length, G = 0; G < C; G++) {
                  var B = d[G];
                  if (N = B.getOtherEndInGraph(g, this), N != null && !T.has(N)) {
          ...
          function(M, P, L) {
            ...
            h.calcSeparationAmount = function(a, r, e, f) {
              ...
              var o = a.getX(), s = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), g = a.getRight(), d = a.getWidthHalf(), N = a.getHeightHalf(), F = r.getX(), C = r.getY(), G = r.getRight(), B = r.getX(), U = r.getBottom(), K = r.getRight(), D = r.getWidthHalf(), at = r.getHeightHalf(), n = !1, m = !1;
              if (f === v) {
                if (i > t)
                  return e[0] = f, e[1] = s, e[2] = v, e[3] = U, !1;
                if (i < t)
                  return e[0] = f, e[1] = T, e[2] = v, e[3] = C, !1;
              } else if (i === t) {
                if (f > v)
                ...
                if (-p === y ? f > v ? (e[0] = l, e[1] = T, n = !0) : (e[0] = c, e[1] = s, n = !0) : p === y && (f > v ? (e[0] = o, e[1] = s, n = !0) : (e[0] = g, e[1] = T, n = !0)), -E === y ? v > f ? (e[2] = B, e[3] = U, m = !0) : (e[2] = G, e[3] = C, m = !0) : E === y && (v > f ? (e[2] = F, e[3] = C, m = !0) : (e[2] = K, e[3] = U, m = !0)), n && m)
                  return !1;
              ...
              var i = a.x, v = a.y, t = r.x, o = r.y, s = e.x, c = e.y, l = f.x, T = f.y, g = void 0, d = void 0, N = void 0, F = void 0, C = void 0, G = void 0, B = void 0, U = void 0, K = void 0;
              return N = o - v, C = i - t, B = t * v - i * o, F = T - c, G = s - l, U = l * c - s * T, K = N * G - F * C, K === 0 ? null : (g = (C * U - G * B) / K, d = (F * B - N * U) / K, new u(g, d));
              ...
              var i = a.x, v = a.y, t = r.x, o = r.y, s = e.x, c = e.y, l = f.x, T = f.y, g = (t - i) * (T - c) - (l - s) * (o - v);
              if (g === 0)
                return !1;
              var d = ((T - c) * (l - i) + (s - l) * (T - v)) / g, N = ((v - o) * (l - i) + (t - i) * (T - v)) / g;
              ...
              if (l >= 0) {
                var T = (-s + Math.sqrt(s * s - 4 * o * c)) / (2 * o), g = (-s - Math.sqrt(s * s - 4 * o * c)) / (2 * o), d = null;
          ...
          function(M, P, L) {
            ...
            u.MAX_VALUE = 2147483647, u.MIN_VALUE = -2147483648, M.exports = u;
          },
          /* 11 */
          /***/
          function(M, P, L) {
          ...
          function(M, P, L) {
            ...
            o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
              ...
              if (s == null)
                ...
                for (var c, l, T = s.getNodes(), g = 0; g < T.length; g++)
              ...
              for (var s = [], c = !0, l = this.graphManager.getRoot().getNodes(), T = !0, g = 0; g < l.length; g++)
                l[g].getChild() != null && (T = !1);
              if (!T)
                return s;
              var d = /* @__PURE__ */ new Set(), N = [], F = /* @__PURE__ */ new Map(), C = [];
              for (C = C.concat(l); C.length > 0 && c; ) {
                for (N.push(C[0]); N.length > 0 && c; ) {
                  var G = N[0];
                  N.splice(0, 1), d.add(G);
                  for (var B = G.getEdges(), g = 0; g < B.length; g++) {
                    var U = B[g].getOtherEnd(G);
                    if (F.get(G) != U)
                      if (!d.has(U))
                        N.push(U), F.set(U, G);
                      else {
              ...
              for (var c = [], l = s.source, T = this.graphManager.calcLowestCommonAncestor(s.source, s.target), g = 0; g < s.bendpoints.length; g++) {
              ...
              for (var c = 0; c < s.length; c++) {
                ...
                if (l.bendpoints.length > 0) {
                  for (var T = this.edgeToDummyNodes.get(l), g = 0; g < T.length; g++) {
                    var d = T[g], N = new i(d.getCenterX(), d.getCenterY()), F = l.bendpoints.get(g);
              ...
              if (l != null && T != null) {
                ...
                var F, C;
                return s <= 50 ? (F = 9 * c / 500, C = c / 10) : (F = 9 * c / 50, C = -8 * c), F * s + C;
              }
              ...
              for (var N = 0; N < c.length; N++) {
                var F = c[N], C = F.getNeighborsList().size;
                T.set(F, F.getNeighborsList().size), C == 1 && l.push(F);
              }
              var G = [];
              for (G = G.concat(l); !g; ) {
                var B = [];
                ...
                l = l.concat(G), (c.length == 1 || c.length == 2) && (g = !0, d = c[0]);
              }
              return d;
          ...
          function(M, P, L) {
            ...
            i.prototype.initParameters = function() {
              ...
              for (var t, o, s, c, l, T, g, d = this.getGraphManager().getAllEdges(), N = 0; N < d.length; N++)
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, s, c, l, T, g = this.getAllNodes(), d;
              if (this.useFRGridVariant)
                for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), d = /* @__PURE__ */ new Set(), s = 0; s < g.length; s++)
                  l = g[s], this.calculateRepulsionForceOfANode(l, d, t, o), d.add(l);
              else
                for (s = 0; s < g.length; s++)
                  for (l = g[s], c = s + 1; c < g.length; c++)
              ...
              var s = t.getSource(), c = t.getTarget(), l, T, g, d;
              if (this.uniformLeafNodeSizes && s.getChild() == null && c.getChild() == null)
                ...
                return;
              l = t.getLength(), l != 0 && (T = t.edgeElasticity * (l - o), g = T * (t.lengthX / l), d = T * (t.lengthY / l), s.springForceX += g, s.springForceY += d, c.springForceX -= g, c.springForceY -= d);
            }, i.prototype.calcRepulsionForce = function(t, o) {
              var s = t.getRect(), c = o.getRect(), l = new Array(2), T = new Array(4), g, d, N, F, C, G, B;
              if (s.intersects(c)) {
                ...
                this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null ? (g = c.getCenterX() - s.getCenterX(), d = c.getCenterY() - s.getCenterY()) : (e.getIntersection(s, c, T), g = T[2] - T[0], d = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = f.sign(g) * a.MIN_REPULSION_DIST), Math.abs(d) < a.MIN_REPULSION_DIST && (d = f.sign(d) * a.MIN_REPULSION_DIST), N = g * g + d * d, F = Math.sqrt(N), C = (t.nodeRepulsion / 2 + o.nodeRepulsion / 2) * t.noOfChildren * o.noOfChildren / N, G = C * g / F, B = C * d / F, t.repulsionForceX -= G, t.repulsionForceY -= B, o.repulsionForceX += G, o.repulsionForceY += B;
              ...
              var c = 0, l = 0, T = 0, g = 0;
              c = parseInt(Math.floor((t.getRect().x - o) / this.repulsionRange)), l = parseInt(Math.floor((t.getRect().width + t.getRect().x - o) / this.repulsionRange)), T = parseInt(Math.floor((t.getRect().y - s) / this.repulsionRange)), g = parseInt(Math.floor((t.getRect().height + t.getRect().y - s) / this.repulsionRange));
              for (var d = c; d <= l; d++)
                for (var N = T; N <= g; N++)
                ...
                for (var T, g = this.grid, d = t.startX - 1; d < t.finishX + 2; d++)
                  for (var N = t.startY - 1; N < t.finishY + 2; N++)
                    if (!(d < 0 || N < 0 || d >= g.length || N >= g[0].length)) {
                      for (var F = 0; F < g[d][N].length; F++)
                        if (T = g[d][N][F], !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !l.has(T)) {
          ...
          function(M, P, L) {
            var u = L(3), h = L(4);
            function a(e, f, i, v) {
              u.call(this, e, f, i, v), this.nodeRepulsion = h.DEFAULT_REPULSION_STRENGTH, this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            a.prototype = Object.create(u.prototype);
            for (var r in u)
              a[r] = u[r];
            ...
            u.svd = function(h) {
              ...
              for (var r = function(Nt) {
                ...
                if (t < v) {
                  ...
                  if (r[t] = -r[t], /* @__PURE__ */ function(Nt, Ct) {
                    return Nt && Ct;
                  }(t + 1 < this.m, r[t] !== 0)) {
              ...
              for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (J++, Rt) {
                  case 1:
                    {
                      ...
                      for (var gt = n - 2; gt >= J; gt--) {
                        var Tt = u.hypot(this.s[gt], rt), Mt = this.s[gt] / Tt, Dt = rt / Tt;
                        this.s[gt] = Tt, gt !== J && (rt = -Dt * r[gt - 1], r[gt - 1] = Mt * r[gt - 1]);
                        for (var mt = 0; mt < this.n; mt++)
                          Tt = Mt * this.V[mt][gt] + Dt * this.V[mt][n - 1], this.V[mt][n - 1] = -Dt * this.V[mt][gt] + Mt * this.V[mt][n - 1], this.V[mt][gt] = Tt;
                      }
                    }
                    break;
                  case 2:
                  ...
                  case 3:
                    {
                      var Ht = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(r[n - 2])), Math.abs(this.s[J])), Math.abs(r[J])), Bt = this.s[n - 1] / Ht, S = this.s[n - 2] / Ht, b = r[n - 2] / Ht, Z = this.s[J] / Ht, Q = r[J] / Ht, k = ((S + Bt) * (S - Bt) + b * b) / 2, it = Bt * b * (Bt * b), ut = 0;
                      /* @__PURE__ */ (function(Nt, Ct) {
                        return Nt || Ct;
                      })(k !== 0, it !== 0) && (ut = Math.sqrt(k * k + it), k < 0 && (ut = -ut), ut = it / (k + ut));
                      for (var ot = (Z + Bt) * (Z - Bt) + ut, tt = Z * Q, j = J; j < n - 1; j++) {
                  ...
                  case 4:
                    {
                      ...
                      for (; J < $ && !(this.s[J] >= this.s[J + 1]); ) {
                        var At = this.s[J];
                        if (this.s[J] = this.s[J + 1], this.s[J + 1] = At, J < this.n - 1)
                          for (var ct = 0; ct < this.n; ct++)
                            At = this.V[ct][J + 1], this.V[ct][J + 1] = this.V[ct][J], this.V[ct][J] = At;
                        if (J < this.m - 1)
                          for (var lt = 0; lt < this.m; lt++)
                            At = this.U[lt][J + 1], this.U[lt][J + 1] = this.U[lt][J], this.U[lt][J] = At;
                        J++;
                      }
                      n--;
                    }
        ...
        (() => {
          var P = {
            ...
            765: (
              /***/
              (a, r, e) => {
                var f = e(551).FDLayout, i = e(578), v = e(880), t = e(991), o = e(767), s = e(806), c = e(902), l = e(551).FDLayoutConstants, T = e(551).LayoutConstants, g = e(551).Point, d = e(551).PointD, N = e(551).DimensionD, F = e(551).Layout, C = e(551).Integer, G = e(551).IGeometry, B = e(551).LGraph, U = e(551).Transform, K = e(551).LinkedList;
                function D() {
                ...
                D.prototype.newGraphManager = function() {
                  ...
                  for (var m = new g(0, 0), p = Math.ceil(Math.sqrt(n.length)), E = 0, y = 0, I = 0, w = new d(0, 0), R = 0; R < n.length; R++) {
                  ...
                  for (var ht = Math.abs(E - p) / X, J = O; et != X; J = ++J % z) {
                  ...
                  var W = I / y, x = w / y, q = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y, V = (E - p + Math.sqrt(q)) / (2 * (W + E)), X;
                  ...
                  for (var V = 0; V < n.length; V++) {
                    var X = n[V];
                    if (w.rows.length == 0)
                      this.insertNodeToRow(w, X, 0, m);
                    else if (this.canAddHorizontal(w, X.rect.width, X.rect.height)) {
                      var et = w.rows.length - 1;
                      w.idealRowWidth || (et = this.getShortestRowIndex(w)), this.insertNodeToRow(w, X, et, m);
                    } else
                      this.insertNodeToRow(w, X, w.rows.length, m);
                  ...
                  if (E == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL)
                    ...
                    var y = p.startX, I = p.finishX, w = p.startY, R = p.finishY, W = 0, x = 0, q = 0, V = 0, X = [W, q, x, V];
                    if (w > 0)
                      for (var et = y; et <= I; et++)
                        X[0] += this.grid[et][w - 1].length + this.grid[et][w].length - 1;
                    if (I < this.grid.length - 1)
                      for (var et = w; et <= R; et++)
                        X[1] += this.grid[I + 1][et].length + this.grid[I][et].length - 1;
                    if (R < this.grid[0].length - 1)
                      for (var et = y; et <= I; et++)
                        X[2] += this.grid[et][R + 1].length + this.grid[et][R].length - 1;
                    if (y > 0)
                      for (var et = w; et <= R; et++)
                        X[3] += this.grid[y - 1][et].length + this.grid[y][et].length - 1;
                    for (var z = C.MAX_VALUE, O, H, $ = 0; $ < X.length; $++)
                      X[$] < z ? (z = X[$], O = 1, H = $) : X[$] == z && O++;
                    if (O == 3 && z == 0)
            ...
            902: (
              ...
              (a, r, e) => {
                ...
                s.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), d = [], N = [], F = c.getAllNodes(), C = 0, G = 0; G < F.length; G++) {
                    var B = F[G];
                    B.getChild() == null && (g.set(B.id, C++), d.push(B.getCenterX()), N.push(B.getCenterY()), T.set(B.id, B));
                  }
                  ...
                  var U = function(b, Z) {
                    return { x: b.x - Z.x, y: b.y - Z.y };
                  }, K = function(b) {
                    var Z = 0, Q = 0;
                    return b.forEach(function(k) {
                      Z += d[g.get(k)], Q += N[g.get(k)];
                    }), { x: Z / b.size, y: Q / b.size };
                  }, D = function(b, Z, Q, k, it) {
                    function ut(ft, st) {
                      var At = new Set(ft), ct = !0, lt = !1, Wt = void 0;
                      try {
                        for (var Nt = st[Symbol.iterator](), Ct; !(ct = (Ct = Nt.next()).done); ct = !0) {
                          var Zt = Ct.value;
                          At.add(Zt);
                        }
                      } catch (Gt) {
                    ...
                    b.forEach(function(ft, st) {
                      ...
                      ft.forEach(function(At) {
                        ot.set(At.id, ot.get(At.id) + 1);
                      });
                    });
                    var tt = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), dt = new v();
                    ot.forEach(function(ft, st) {
                      ft == 0 ? (dt.push(st), Q || (Z == "horizontal" ? tt.set(st, g.has(st) ? d[g.get(st)] : k.get(st)) : tt.set(st, g.has(st) ? N[g.get(st)] : k.get(st)))) : tt.set(st, Number.NEGATIVE_INFINITY), Q && j.set(st, /* @__PURE__ */ new Set([st]));
                      ...
                      if (ft.forEach(function(lt) {
                        ...
                        st.forEach(function(lt) {
                          Z == "horizontal" ? (tt.set(lt, g.has(lt) ? d[g.get(lt)] : k.get(lt)), At += tt.get(lt)) : (tt.set(lt, g.has(lt) ? N[g.get(lt)] : k.get(lt)), At += tt.get(lt));
                        }), At = At / st.length, ft.forEach(function(lt) {
                          Q.has(lt) || tt.set(lt, At);
                        });
                      } else {
                        var ct = 0;
                        ft.forEach(function(lt) {
                          Z == "horizontal" ? ct += g.has(lt) ? d[g.get(lt)] : k.get(lt) : ct += g.has(lt) ? N[g.get(lt)] : k.get(lt);
                    ...
                    for (var wt = function() {
                      var st = dt.shift(), At = b.get(st);
                      At.forEach(function(ct) {
                        if (tt.get(ct.id) < tt.get(st) + ct.gap)
                          if (Q && Q.has(ct.id)) {
                            var lt = void 0;
                            if (Z == "horizontal" ? lt = g.has(ct.id) ? d[g.get(ct.id)] : k.get(ct.id) : lt = g.has(ct.id) ? N[g.get(ct.id)] : k.get(ct.id), tt.set(ct.id, lt), lt < tt.get(st) + ct.gap) {
                    ...
                    if (Q) {
                      ...
                      j.forEach(function(ft, st) {
                        if (yt.has(st)) {
                          var At = !1, ct = !0, lt = !1, Wt = void 0;
                          try {
                            for (var Nt = ft[Symbol.iterator](), Ct; !(ct = (Ct = Nt.next()).done); ct = !0) {
                              var Zt = Ct.value;
                              Q.has(Zt) && (At = !0);
                            }
                          } catch (Ft) {
                        ...
                        var At = Number.POSITIVE_INFINITY, ct = Number.POSITIVE_INFINITY, lt = Number.NEGATIVE_INFINITY, Wt = Number.NEGATIVE_INFINITY, Nt = !0, Ct = !1, Zt = void 0;
                        try {
                          for (var Gt = ft[Symbol.iterator](), $t; !(Nt = ($t = Gt.next()).done); Nt = !0) {
                            var Ft = $t.value, qt = void 0;
                            Z == "horizontal" ? qt = g.has(Ft) ? d[g.get(Ft)] : k.get(Ft) : qt = g.has(Ft) ? N[g.get(Ft)] : k.get(Ft);
                            var _t = tt.get(Ft);
                            qt < At && (At = qt), qt > lt && (lt = qt), _t < ct && (ct = _t), _t > Wt && (Wt = _t);
                          }
                        } catch (ie) {
                          Ct = !0, Zt = ie;
                        } finally {
                        ...
                        var de = (At + lt) / 2 - (ct + Wt) / 2, Kt = !0, te = !1, ee = void 0;
                        try {
                    ...
                    var Z = 0, Q = 0, k = 0, it = 0;
                    if (b.forEach(function(j) {
                      j.left ? d[g.get(j.left)] - d[g.get(j.right)] >= 0 ? Z++ : Q++ : N[g.get(j.top)] - N[g.get(j.bottom)] >= 0 ? k++ : it++;
                    }), Z > Q && k > it)
                    ...
                    var Z = [], Q = new v(), k = /* @__PURE__ */ new Set(), it = 0;
                    return b.forEach(function(ut, ot) {
                      if (!k.has(ot)) {
                        Z[it] = [];
                        var tt = ot;
                        for (Q.push(tt), k.add(tt), Z[it].push(tt); Q.length != 0; ) {
                          tt = Q.shift();
                          var j = b.get(tt);
                          j.forEach(function(dt) {
                            k.has(dt.id) || (Q.push(dt.id), k.add(dt.id), Z[it].push(dt.id));
                          });
                        }
                        it++;
                      }
                    ...
                    return b.forEach(function(Q, k) {
                      ...
                      Q.forEach(function(it) {
                        Z.get(k).push(it), Z.get(it.id).push({ id: k, gap: it.gap, direction: it.direction });
                      });
                    }), Z;
                  }, p = function(b) {
                    var Z = /* @__PURE__ */ new Map();
                    return b.forEach(function(Q, k) {
                      ...
                      Q.forEach(function(it) {
                        Z.get(it.id).push({ id: k, gap: it.gap, direction: it.direction });
                      });
                    }), Z;
                  ...
                  if (l.fixedNodeConstraint && l.fixedNodeConstraint.forEach(function(S) {
                    ...
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      l.fixedNodeConstraint.forEach(function(S, b) {
                        E[b] = [S.position.x, S.position.y], y[b] = [d[g.get(S.nodeId)], N[g.get(S.nodeId)]];
                      }), I = !0;
                    else if (l.alignmentConstraint)
                      (function() {
                        var S = 0;
                        if (l.alignmentConstraint.vertical) {
                          for (var b = l.alignmentConstraint.vertical, Z = function(tt) {
                            ...
                            dt.size > 0 ? wt = d[g.get(dt.values().next().value)] : wt = K(j).x, b[tt].forEach(function(yt) {
                              E[S] = [wt, N[g.get(yt)]], y[S] = [d[g.get(yt)], N[g.get(yt)]], S++;
                            });
                          }, Q = 0; Q < b.length; Q++)
                            Z(Q);
                          I = !0;
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var k = l.alignmentConstraint.horizontal, it = function(tt) {
                            var j = /* @__PURE__ */ new Set();
                            ...
                            dt.size > 0 ? wt = d[g.get(dt.values().next().value)] : wt = K(j).y, k[tt].forEach(function(yt) {
                              E[S] = [d[g.get(yt)], wt], y[S] = [d[g.get(yt)], N[g.get(yt)]], S++;
                            });
                          }, ut = 0; ut < k.length; ut++)
                            it(ut);
                          I = !0;
                      ...
                      if (V < x.size / 2)
                        ...
                        q[X].forEach(function(S, b) {
                          y[b] = [d[g.get(S)], N[g.get(S)]], E[b] = [], $.has(S) ? E[b][0] = $.get(S) : E[b][0] = d[g.get(S)], _.has(S) ? E[b][1] = _.get(S) : E[b][1] = N[g.get(S)];
                        }), I = !0;
                      }
                    }
                    if (I) {
                      ...
                      for (var gt = 0; gt < g.size; gt++) {
                        var Tt = [d[gt], N[gt]], Mt = [ht[0][0], ht[1][0]], Dt = [ht[0][1], ht[1][1]];
                        d[gt] = t.dotProduct(Tt, Mt), N[gt] = t.dotProduct(Tt, Dt);
                      }
                  ...
                  if (i.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var mt = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(S, b) {
                        var Z = { x: d[g.get(S.nodeId)], y: N[g.get(S.nodeId)] }, Q = S.position, k = U(Q, Z);
                        mt.x += k.x, mt.y += k.y;
                        ...
                        d[g.get(S.nodeId)] = S.position.x, N[g.get(S.nodeId)] = S.position.y;
                      });
                    }
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var xt = l.alignmentConstraint.vertical, St = function(b) {
                          ...
                          var Q = new Set([].concat(f(Z)).filter(function(it) {
                            return R.has(it);
                          })), k = void 0;
                          Q.size > 0 ? k = d[g.get(Q.values().next().value)] : k = K(Z).x, Z.forEach(function(it) {
                            R.has(it) || (d[g.get(it)] = k);
                          });
                      ...
                      if (l.alignmentConstraint.horizontal)
                        for (var Xt = l.alignmentConstraint.horizontal, Ut = function(b) {
                          ...
                          Q.size > 0 ? k = N[g.get(Q.values().next().value)] : k = K(Z).y, Z.forEach(function(it) {
                            R.has(it) || (N[g.get(it)] = k);
                          });
                        }, bt = 0; bt < Xt.length; bt++)
                          Ut(bt);
                    }
                    l.relativePlacementConstraint && function() {
                      var S = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), it = /* @__PURE__ */ new Map(), ut = /* @__PURE__ */ new Set(), ot = /* @__PURE__ */ new Set();
                      if (R.forEach(function(Yt) {
                        ut.add(Yt), ot.add(Yt);
                      }), l.alignmentConstraint) {
                        if (l.alignmentConstraint.vertical)
                          for (var tt = l.alignmentConstraint.vertical, j = function(Et) {
                            Z.set("dummy" + Et, []), tt[Et].forEach(function(Ot) {
                              S.set(Ot, "dummy" + Et), Z.get("dummy" + Et).push(Ot), R.has(Ot) && ut.add("dummy" + Et);
                            }), k.set("dummy" + Et, d[g.get(tt[Et][0])]);
                        ...
                        if (l.alignmentConstraint.horizontal)
                          for (var wt = l.alignmentConstraint.horizontal, yt = function(Et) {
                            ...
                            }), it.set("dummy" + Et, N[g.get(wt[Et][0])]);
                          }, It = 0; It < wt.length; It++)
                            yt(It);
                      }
                      var ft = /* @__PURE__ */ new Map(), st = /* @__PURE__ */ new Map(), At = function(Et) {
                        W.get(Et).forEach(function(Ot) {
                          var Jt = void 0, kt = void 0;
                          Ot.direction == "horizontal" ? (Jt = S.get(Et) ? S.get(Et) : Et, S.get(Ot.id) ? kt = { id: S.get(Ot.id), gap: Ot.gap, direction: Ot.direction } : kt = Ot, ft.has(Jt) ? ft.get(Jt).push(kt) : ft.set(Jt, [kt]), ft.has(kt.id) || ft.set(kt.id, [])) : (Jt = b.get(Et) ? b.get(Et) : Et, b.get(Ot.id) ? kt = { id: b.get(Ot.id), gap: Ot.gap, direction: Ot.direction } : kt = Ot, st.has(Jt) ? st.get(Jt).push(kt) : st.set(Jt, [kt]), st.has(kt.id) || st.set(kt.id, []));
                        });
                      }, ct = !0, lt = !1, Wt = void 0;
                      try {
                        for (var Nt = W.keys()[Symbol.iterator](), Ct; !(ct = (Ct = Nt.next()).done); ct = !0) {
                          var Zt = Ct.value;
                          At(Zt);
                        }
                      } catch (Yt) {
                      ...
                      var ee = D(ft, "horizontal", ut, k, Kt), jt = D(st, "vertical", ot, it, te), se = function(Et) {
                        Z.get(Et) ? Z.get(Et).forEach(function(Ot) {
                          d[g.get(Ot)] = ee.get(Et);
                        }) : d[g.get(Et)] = ee.get(Et);
                      }, re = !0, ie = !1, Ce = void 0;
                      try {
                        for (var ve = ee.keys()[Symbol.iterator](), Me; !(re = (Me = ve.next()).done); re = !0) {
                          var pe = Me.value;
                          se(pe);
                        }
                      } catch (Yt) {
                      ...
                      var ke = function(Et) {
                        Q.get(Et) ? Q.get(Et).forEach(function(Ot) {
                          N[g.get(Ot)] = jt.get(Et);
                        }) : N[g.get(Et)] = jt.get(Et);
                      }, ye = !0, we = !1, Oe = void 0;
                      try {
                  ...
                  for (var Ht = 0; Ht < F.length; Ht++) {
                    var Bt = F[Ht];
                    Bt.getChild() == null && Bt.setCenter(d[g.get(Bt.id)], N[g.get(Bt.id)]);
                  }
                }, a.exports = s;
              }
            ),
...
var vr = he.exports, Re;
function pr() {
  return Re || (Re = 1, function(A, Y) {
    (function(P, L) {
      A.exports = L(dr());
    })(vr, function(M) {
      return (
            ...
            548: (
              ...
              (a, r, e) => {
                ...
                v.getTopMostNodes = function(t) {
                  ...
                  var l = new i(), T = /* @__PURE__ */ new Set(), g = [], d = void 0, N = void 0, F = void 0, C = !1, G = 1, B = [], U = [], K = function() {
                    var at = t.collection();
                    U.push(at);
                    var n = s[0], m = t.collection();
                    m.merge(n).merge(n.descendants().intersection(o)), g.push(n), m.forEach(function(y) {
                    ...
                    for (var p = function() {
                      ...
                      for (var w = 0; w < I.length; w++) {
                        ...
                        if (d = s.intersection(R.union(R.ancestors())), d != null && !T.has(d[0])) {
                          ...
                          W.forEach(function(x) {
                            l.push(x), T.add(x), at.merge(x), s.has(x) && g.push(x);
                          });
                        }
                      }
                    }; l.length != 0; )
                    ...
                    }), g.length == s.length && (C = !0), !C || C && G > 1) {
                      N = g[0], F = N.connectedEdges().length, g.forEach(function(y) {
                        y.connectedEdges().length < F && (F = y.connectedEdges().length, N = y);
                      }), B.push(N.id());
                      var E = t.collection();
                      E.merge(g[0]), g.forEach(function(y) {
                        E.merge(y);
                      }), g = [], s = s.difference(E), G++;
                    }
                  };
                  do
                    K();
                  ...
                  if (!s.fixedNodeConstraint) {
                    ...
                    if (s.quality == "draft") {
                      ...
                      try {
                        for (var C = o.nodeIndexes[Symbol.iterator](), G; !(d = (G = C.next()).done); d = !0) {
                      ...
                      Object.keys(o).forEach(function(x) {
                        var q = o[x], V = q.getRect().x, X = q.getRect().x + q.getRect().width, et = q.getRect().y, z = q.getRect().y + q.getRect().height;
                        V < c && (c = V), X > l && (l = X), et < T && (T = et), z > g && (g = z);
                      });
                  ...
                  for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, d = Number.MIN_SAFE_INTEGER, N = void 0, F = void 0, C = void 0, G = void 0, B = t.descendants().not(":parent"), U = B.length, K = 0; K < U; K++) {
                    var D = B[K];
                    N = o[c.get(D.id())] - D.width() / 2, F = o[c.get(D.id())] + D.width() / 2, C = s[c.get(D.id())] - D.height() / 2, G = s[c.get(D.id())] + D.height() / 2, l > N && (l = N), T < F && (T = F), g > C && (g = C), d < G && (d = G);
                  }
                  var at = {};
                  return at.topLeftX = l, at.topLeftY = g, at.width = T - l, at.height = d - g, at;
            ...
            816: (
              ...
              (a, r, e) => {
                var f = e(548), i = e(140).CoSELayout, v = e(140).CoSENode, t = e(140).layoutBase.PointD, o = e(140).layoutBase.DimensionD, s = e(140).layoutBase.LayoutConstants, c = e(140).layoutBase.FDLayoutConstants, l = e(140).CoSEConstants, T = function(d, N) {
                  var F = d.cy, C = d.eles, G = C.nodes(), B = C.edges(), U = void 0, K = void 0, D = void 0, at = {};
                  d.randomize && (U = N.nodeIndexes, K = N.xCoords, D = N.yCoords);
                  var n = function(x) {
                    return typeof x == "function";
                  }, m = function(x, q) {
                    return n(x) ? x(q) : x;
                  }, p = f.calcParentsWithoutChildren(F, C), E = function W(x, q, V, X) {
                    ...
                    for (var X = 0, et = 0, z = 0; z < V.length; z++) {
                      ...
                      if (H && $ && H !== $ && H.getEdgesBetween($).length == 0) {
                        ...
                        _.id = O.id(), _.idealLength = m(d.idealEdgeLength, O), _.edgeElasticity = m(d.edgeElasticity, O), X += _.idealLength, et++;
                      }
                    }
                    d.idealEdgeLength != null && (et > 0 ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = X / et : n(d.idealEdgeLength) ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50 : l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = d.idealEdgeLength, l.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST = c.DEFAULT_EDGE_LENGTH / 10, l.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH);
                  }, I = function(x, q) {
              ...
              (a, r, e) => {
                var f = /* @__PURE__ */ function() {
                  ...
                  return function(N, F, C) {
                    return F && d(N.prototype, F), C && d(N, C), N;
                  };
                }();
                function i(d, N) {
                  if (!(d instanceof N))
                ...
                var v = e(658), t = e(548), o = e(657), s = o.spectralLayout, c = e(816), l = c.coseLayout, T = Object.freeze({
                  ...
                  return f(d, [{
                    key: "run",
                    value: function() {
                      var F = this, C = this.options, G = C.cy, B = C.eles, U = [], K = [], D = void 0, at = [];
                      ...
                      var m = void 0, p = !1;
                      if (G.layoutUtilities && C.packComponents && (m = G.layoutUtilities("get"), m || (m = G.layoutUtilities()), p = !0), B.nodes().length > 0)
                        if (p) {
                          var I = t.getTopMostNodes(C.eles.nodes());
                          if (D = t.connectComponents(G, C.eles, I), D.forEach(function(vt) {
                            var rt = vt.boundingBox();
                            at.push({ x: rt.x1 + rt.w / 2, y: rt.y1 + rt.h / 2 });
                          }), C.randomize && D.forEach(function(vt) {
                            C.eles = vt, U.push(s(C));
                          }), C.quality == "default" || C.quality == "proof") {
                            var w = G.collection();
                            if (C.tile) {
                              var R = /* @__PURE__ */ new Map(), W = [], x = [], q = 0, V = { nodeIndexes: R, xCoords: W, yCoords: x }, X = [];
                              if (D.forEach(function(vt, rt) {
                                ...
                                for (var z = X.length - 1; z >= 0; z--)
                                  D.splice(X[z], 1), U.splice(X[z], 1), at.splice(X[z], 1);
                              }
                            }
                            D.forEach(function(vt, rt) {
                              C.eles = vt, K.push(l(C, U[rt])), t.relocateComponent(at[rt], K[rt], C);
                            });
                          } else
                            D.forEach(function(vt, rt) {
                              t.relocateComponent(at[rt], U[rt], C);
                            });
                          ...
                          if (D.length > 1) {
                            ...
                            D.forEach(function(vt, rt) {
                              var gt = void 0;
                              if (C.quality == "draft" && (gt = U[rt].nodeIndexes), vt.nodes().not($).length > 0) {
                                var Tt = {};
                                Tt.edges = [], Tt.nodes = [];
                                var Mt = void 0;
                                vt.nodes().not($).forEach(function(Dt) {
                                  if (C.quality == "draft")
                                    if (!Dt.isParent())
                                      Mt = gt.get(Dt.id()), Tt.nodes.push({ x: U[rt].xCoords[Mt] - Dt.boundingbox().w / 2, y: U[rt].yCoords[Mt] - Dt.boundingbox().h / 2, width: Dt.boundingbox().w, height: Dt.boundingbox().h });
                                    else {
                                      var mt = t.calcBoundingBox(Dt, U[rt].xCoords, U[rt].yCoords, gt);
                                  ...
                                  if (mt.css("display") != "none" && xt.css("display") != "none")
                                    if (C.quality == "draft") {
                                      ...
                                      if (mt.isParent()) {
                                        var bt = t.calcBoundingBox(mt, U[rt].xCoords, U[rt].yCoords, gt);
                                        Xt.push(bt.topLeftX + bt.width / 2), Xt.push(bt.topLeftY + bt.height / 2);
                                      } else
                                        Xt.push(U[rt].xCoords[St]), Xt.push(U[rt].yCoords[St]);
                                      if (xt.isParent()) {
                                        var Ht = t.calcBoundingBox(xt, U[rt].xCoords, U[rt].yCoords, gt);
                            ...
                            if (C.quality == "draft")
                              U.forEach(function(vt, rt) {
                                var gt = vt.xCoords.map(function(Mt) {
                                  return Mt + _[rt].dx;
                          ...
                          if (at.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), C.randomize) {
                            var y = s(C);
                            U.push(y);
                          }
                          C.quality == "default" || C.quality == "proof" ? (K.push(l(C, U[0])), t.relocateComponent(at[0], K[0], C)) : t.relocateComponent(at[0], U[0], C);
                        }
                      var J = function(rt, gt) {
                        if (C.quality == "default" || C.quality == "proof") {
                          ...
                          }), C.nodeDimensionsIncludeLabels && (Mt.labelWidth && (Mt.labelPosHorizontal == "left" ? Tt.x += Mt.labelWidth / 2 : Mt.labelPosHorizontal == "right" && (Tt.x -= Mt.labelWidth / 2)), Mt.labelHeight && (Mt.labelPosVertical == "top" ? Tt.y += Mt.labelHeight / 2 : Mt.labelPosVertical == "bottom" && (Tt.y -= Mt.labelHeight / 2))), Tt == null && (Tt = { x: rt.position("x"), y: rt.position("y") }), {
                            x: Tt.x,
                            y: Tt.y
                          };
                        } else {
                      ...
                      if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                        ...
                        C.eles = B.not(Lt), B.nodes().not(":parent").not(Lt).layoutPositions(F, C, J), Rt.length > 0 && Rt.forEach(function(vt) {
                          vt.position(J(vt));
                        });
                      } else
            ...
            657: (
              ...
              (a, r, e) => {
                var f = e(548), i = e(140).layoutBase.Matrix, v = e(140).layoutBase.SVD, t = function(s) {
                  var c = s.cy, l = s.eles, T = l.nodes(), g = l.nodes(":parent"), d = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), C = [], G = [], B = [], U = [], K = [], D = [], at = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, I = s.samplingType, w = s.nodeSeparation, R = void 0, W = function() {
                    for (var b = 0, Z = 0, Q = !1; Z < R; ) {
                    ...
                    for (var k = [], it = 0, ut = 0, ot = 0, tt = void 0, j = [], dt = 0, wt = 1, yt = 0; yt < m; yt++)
                      j[yt] = p;
                    for (k[ut] = b, j[b] = 0; ut >= it; ) {
                      ot = k[it++];
                      for (var It = C[ot], ft = 0; ft < It.length; ft++)
                        tt = N.get(It[ft]), j[tt] == p && (j[tt] = j[ot] + 1, k[++ut] = tt);
                      D[ot][Z] = j[ot] * w;
                    }
                    if (Q) {
                      for (var st = 0; st < m; st++)
                        D[st][Z] < K[st] && (K[st] = D[st][Z]);
                      for (var At = 0; At < m; At++)
                        K[At] > dt && (dt = K[At], wt = At);
                    }
                    return wt;
                  }, q = function(b) {
                    var Z = void 0;
                    ...
                    for (var b = v.svd(at), Z = b.S, Q = b.U, k = b.V, it = Z[0] * Z[0] * Z[0], ut = [], ot = 0; ot < R; ot++) {
                      ut[ot] = [];
                      for (var tt = 0; tt < R; tt++)
                        ut[ot][tt] = 0, ot == tt && (ut[ot][tt] = Z[ot] / (Z[ot] * Z[ot] + it / (Z[ot] * Z[ot])));
                    }
                    n = i.multMat(i.multMat(k, ut), i.transpose(Q));
                  }, X = function() {
                    for (var b = void 0, Z = void 0, Q = [], k = [], it = [], ut = [], ot = 0; ot < m; ot++)
                    ...
                    for (j = E; ; ) {
                      for (var It = 0; It < m; It++)
                        ut[It] = k[It];
                      if (ut = i.minusOp(ut, i.multCons(it, i.dotProduct(it, ut))), k = i.multGamma(i.multL(i.multGamma(ut), D, n)), Z = i.dotProduct(ut, k), k = i.normalize(k), tt = i.dotProduct(ut, k), dt = Math.abs(tt / j), dt <= 1 + y && dt >= 1)
                        break;
                      j = tt;
                    }
                    for (var ft = 0; ft < m; ft++)
                      ut[ft] = k[ft];
                    G = i.multCons(it, Math.sqrt(Math.abs(b))), B = i.multCons(ut, Math.sqrt(Math.abs(Z)));
                  };
                  f.connectComponents(c, l, f.getTopMostNodes(T), d), g.forEach(function(S) {
                  ...
                  g.forEach(function(S) {
                    ...
                    var Z = 0, Q = b.nodes(":childless")[0].connectedEdges().length;
                    b.nodes(":childless").forEach(function(k, it) {
                      k.connectedEdges().length < Q && (Q = k.connectedEdges().length, Z = it);
                    }), F.set(S.id(), b.nodes(":childless")[Z].id());
                  }), T.forEach(function(S) {
                    var b = void 0;
                    S.isParent() ? b = N.get(F.get(S.id())) : b = N.get(S.id()), S.neighborhood().nodes().forEach(function(Z) {
                      l.intersection(S.edgesWith(Z)).length > 0 && (Z.isParent() ? C[b].push(F.get(Z.id())) : C[b].push(Z.id()));
                    });
                  });
                  var Lt = function(b) {
                    var Z = N.get(b), Q = void 0;
                    d.get(b).forEach(function(k) {
                      c.getElementById(k).isParent() ? Q = F.get(k) : Q = k, C[Z].push(Q), C[N.get(Q)].push(b);
                    });
                  }, vt = !0, rt = !1, gt = void 0;
                  try {
                  ...
                  if (m > 2) {
                    ...
                    for (var St = 0; St < R; St++)
                      n[St] = [];
                    return s.quality == "draft" || s.step == "all" ? (q(I), V(), X(), mt = { nodeIndexes: N, xCoords: G, yCoords: B }) : (N.forEach(function(S, b) {
...
var Se = {
  ...
  L: /* @__PURE__ */ nt((A) => `${A},${A / 2} 0,${A} 0,0`, "L"),
  R: /* @__PURE__ */ nt((A) => `0,${A / 2} ${A},0 ${A},${A}`, "R"),
  T: /* @__PURE__ */ nt((A) => `0,0 ${A},0 ${A / 2},${A}`, "T"),
  B: /* @__PURE__ */ nt((A) => `${A / 2},0 ${A},${A} 0,${A}`, "B")
}, le = {
  L: /* @__PURE__ */ nt((A, Y) => A - Y + 2, "L"),
  R: /* @__PURE__ */ nt((A, Y) => A - 2, "R"),
  T: /* @__PURE__ */ nt((A, Y) => A - Y + 2, "T"),
  B: /* @__PURE__ */ nt((A, Y) => A - 2, "B")
}, mr = /* @__PURE__ */ nt(function(A) {
  return zt(A) ? A === "L" ? "R" : "L" : A === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), be = /* @__PURE__ */ nt(function(A) {
  const Y = A;
  return Y === "L" || Y === "R" || Y === "T" || Y === "B";
}, "isArchitectureDirection"), zt = /* @__PURE__ */ nt(function(A) {
  const Y = A;
  return Y === "L" || Y === "R";
}, "isArchitectureDirectionX"), Qt = /* @__PURE__ */ nt(function(A) {
  const Y = A;
  return Y === "T" || Y === "B";
}, "isArchitectureDirectionY"), Ae = /* @__PURE__ */ nt(function(A, Y) {
  const M = zt(A) && Qt(Y), P = Qt(A) && zt(Y);
  return M || P;
}, "isArchitectureDirectionXY"), Tr = /* @__PURE__ */ nt(function(A) {
  const Y = A[0], M = A[1], P = zt(Y) && Qt(M), L = Qt(Y) && zt(M);
  return P || L;
}, "isArchitecturePairXY"), Nr = /* @__PURE__ */ nt(function(A) {
  return A !== "LL" && A !== "RR" && A !== "TT" && A !== "BB";
}, "isValidArchitectureDirectionPair"), Te = /* @__PURE__ */ nt(function(A, Y) {
  const M = `${A}${Y}`;
  return Nr(M) ? M : void 0;
}, "getArchitectureDirectionPair"), Lr = /* @__PURE__ */ nt(function([A, Y], M) {
  const P = M[0], L = M[1];
  return zt(P) ? Qt(L) ? [A + (P === "L" ? -1 : 1), Y + (L === "T" ? 1 : -1)] : [A + (P === "L" ? -1 : 1), Y] : zt(L) ? [A + (L === "L" ? 1 : -1), Y + (P === "T" ? 1 : -1)] : [A, Y + (P === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Ar = /* @__PURE__ */ nt(function(A) {
  return A === "LT" || A === "TL" ? [1, 1] : A === "BL" || A === "LB" ? [1, -1] : A === "BR" || A === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Cr = /* @__PURE__ */ nt(function(A, Y) {
  return Ae(A, Y) ? "bend" : zt(A) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Mr = /* @__PURE__ */ nt(function(A) {
  return A.type === "service";
}, "isArchitectureService"), wr = /* @__PURE__ */ nt(function(A) {
  return A.type === "junction";
}, "isArchitectureJunction"), Ue = /* @__PURE__ */ nt((A) => A.data(), "edgeData"), ne = /* @__PURE__ */ nt((A) => A.data(), "nodeData"), Ye = ar.architecture, pt = new lr(() => ({
  nodes: {},
  groups: {},
  edges: [],
  registeredIds: {},
  ...
  if (pt.records.registeredIds[A] !== void 0)
    throw new Error(
      `The service id [${A}] is already in use by another ${pt.records.registeredIds[A]}`
    );
  if (M !== void 0) {
    if (A === M)
  ...
  pt.records.registeredIds[A] = "node", pt.records.nodes[A] = {
    id: A,
    type: "service",
    icon: Y,
    iconText: L,
...
}, "addService"), xr = /* @__PURE__ */ nt(() => Object.values(pt.records.nodes).filter(Mr), "getServices"), Ir = /* @__PURE__ */ nt(function({ id: A, in: Y }) {
  pt.records.registeredIds[A] = "node", pt.records.nodes[A] = {
    id: A,
    type: "junction",
    edges: [],
...
}, "addJunction"), Rr = /* @__PURE__ */ nt(() => Object.values(pt.records.nodes).filter(wr), "getJunctions"), Sr = /* @__PURE__ */ nt(() => Object.values(pt.records.nodes), "getNodes"), Ne = /* @__PURE__ */ nt((A) => pt.records.nodes[A], "getNode"), Fr = /* @__PURE__ */ nt(function({ id: A, icon: Y, in: M, title: P }) {
  if (pt.records.registeredIds[A] !== void 0)
    throw new Error(
      `The group id [${A}] is already in use by another ${pt.records.registeredIds[A]}`
    );
  if (M !== void 0) {
    if (A === M)
  ...
  pt.records.registeredIds[A] = "group", pt.records.groups[A] = {
    id: A,
    icon: Y,
    title: P,
    in: M
  ...
  if (!be(M))
    throw new Error(
      `Invalid direction given for left hand side of edge ${A}--${Y}. Expected (L,R,T,B) got ${M}`
    );
  if (!be(P))
    throw new Error(
      `Invalid direction given for right hand side of edge ${A}--${Y}. Expected (L,R,T,B) got ${P}`
    );
  if (pt.records.nodes[A] === void 0 && pt.records.groups[A] === void 0)
    throw new Error(
      `The left-hand id [${A}] does not yet exist. Please create the service/group before declaring an edge to it.`
    );
  if (pt.records.nodes[Y] === void 0 && pt.records.groups[A] === void 0)
    throw new Error(
      `The right-hand id [${Y}] does not yet exist. Please create the service/group before declaring an edge to it.`
    );
  const e = pt.records.nodes[A].in, f = pt.records.nodes[Y].in;
  if (h && e && f && e == f)
    throw new Error(
  ...
  if (a && e && f && e == f)
    throw new Error(
      `The right-hand id [${Y}] is modified to traverse the group boundary, but the edge does not pass through two groups.`
    );
  const i = {
    lhsId: A,
    lhsDir: M,
  ...
  pt.records.edges.push(i), pt.records.nodes[A] && pt.records.nodes[Y] && (pt.records.nodes[A].edges.push(pt.records.edges[pt.records.edges.length - 1]), pt.records.nodes[Y].edges.push(pt.records.edges[pt.records.edges.length - 1]));
}, "addEdge"), Gr = /* @__PURE__ */ nt(() => pt.records.edges, "getEdges"), Ur = /* @__PURE__ */ nt(() => {
  if (pt.records.dataStructures === void 0) {
    const A = {}, Y = Object.entries(pt.records.nodes).reduce((a, [r, e]) => (a[r] = e.edges.reduce((f, i) => {
      const v = Ne(i.lhsId)?.in, t = Ne(i.rhsId)?.in;
      if (v && t && v !== t) {
        const o = Cr(i.lhsDir, i.rhsDir);
        o !== "bend" && (A[v] ??= {}, A[v][t] = o, A[t] ??= {}, A[t][v] = o);
      }
      if (i.lhsId === r) {
        const o = Te(i.lhsDir, i.rhsDir);
        o && (f[o] = i.rhsId);
      } else {
        const o = Te(i.rhsDir, i.lhsDir);
        o && (f[o] = i.lhsId);
      }
      return f;
    }, {}), a), {}), M = Object.keys(Y)[0], P = { [M]: 1 }, L = Object.keys(Y).reduce(
      (a, r) => r === M ? a : { ...a, [r]: 1 },
      {}
    ), u = /* @__PURE__ */ nt((a) => {
      const r = { [a]: [0, 0] }, e = [a];
...
}, "getDataStructures"), Yr = /* @__PURE__ */ nt((A, Y) => {
  pt.records.elements[A] = Y;
}, "setElementForId"), Xr = /* @__PURE__ */ nt((A) => pt.records.elements[A], "getElementById"), ue = {
  clear: Or,
  setDiagramTitle: _e,
  getDiagramTitle: je,
  setAccTitle: Ke,
...
function Pt(A) {
  const Y = ge().architecture;
  return Y?.[A] ? Y[A] : Ye[A];
}
nt(Pt, "getConfigField");
var Hr = /* @__PURE__ */ nt((A, Y) => {
  sr(A, Y), A.groups.map(Y.addGroup), A.services.map((M) => Y.addService({ ...M, type: "service" })), A.junctions.map((M) => Y.addJunction({ ...M, type: "junction" })), A.edges.map(Y.addEdge);
}, "populateDb"), Wr = {
  parse: /* @__PURE__ */ nt(async (A) => {
    const Y = await hr("architecture", A);
    Pe.debug(Y), Hr(Y, ue);
  }, "parse")
}, Vr = /* @__PURE__ */ nt((A) => `
  .edge {
...
`, "getStyles"), zr = Vr, ae = /* @__PURE__ */ nt((A) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${A}</g>`, "wrapIcon"), oe = {
...
}, Br = /* @__PURE__ */ nt(async function(A, Y) {
  const M = Pt("padding"), P = Pt("iconSize"), L = P / 2, u = P / 6, h = u / 2;
  await Promise.all(
    Y.edges().map(async (a) => {
      const {
        source: r,
      ...
      const { x: g, y: d } = a[0].midpoint();
      let { x: N, y: F } = a[0].targetEndpoint();
      const C = M + 4;
      if (i && (zt(e) ? l += e === "L" ? -C : C : T += e === "T" ? -C : C + 18), s && (zt(t) ? N += t === "L" ? -C : C : F += t === "T" ? -C : C + 18), !i && ue.getNode(r)?.type === "junction" && (zt(e) ? l += e === "L" ? L : -L : T += e === "T" ? L : -L), !s && ue.getNode(v)?.type === "junction" && (zt(t) ? N += t === "L" ? L : -L : F += t === "T" ? L : -L), a[0]._private.rscratch) {
        const G = A.insert("g");
        if (G.insert("path").attr("d", `M ${l},${T} L ${g},${d} L${N},${F} `).attr("class", "edge"), f) {
          const B = zt(e) ? le[e](l, u) : l - h, U = Qt(e) ? le[e](T, u) : T - h;
          G.insert("polygon").attr("points", Fe[e](u)).attr("transform", `translate(${B},${U})`).attr("class", "arrow");
        }
        if (o) {
          const B = zt(t) ? le[t](N, u) : N - h, U = Qt(t) ? le[t](F, u) : F - h;
          G.insert("polygon").attr("points", Fe[t](u)).attr("transform", `translate(${B},${U})`).attr("class", "arrow");
        }
        if (c) {
          const B = Ae(e, t) ? "XY" : zt(e) ? "X" : "Y";
          let U = 0;
          ...
          if (await Le(
            ...
            K.attr("transform", "translate(" + g + ", " + d + ")");
          else if (B === "Y")
            K.attr("transform", "translate(" + g + ", " + d + ") rotate(-90)");
          else if (B === "XY") {
            const D = Te(e, t);
            if (D && Tr(D)) {
              const at = K.node().getBoundingClientRect(), [n, m] = Ar(D);
...
}, "drawEdges"), $r = /* @__PURE__ */ nt(async function(A, Y) {
  ...
  await Promise.all(
    Y.nodes().map(async (a) => {
      ...
      if (r.type === "group") {
        ...
        A.append("rect").attr("x", i + h).attr("y", v + h).attr("width", f).attr("height", e).attr("class", "node-bkg");
        const t = A.append("g");
        let o = i, s = v;
        if (r.icon) {
          const c = t.append("g");
          c.html(
            `<g>${await me(r.icon, { height: P, width: P, fallbackPrefix: oe.prefix })}</g>`
          ), c.attr(
            "transform",
...
}, "drawGroups"), Zr = /* @__PURE__ */ nt(async function(A, Y, M) {
  for (const P of M) {
    const L = Y.append("g"), u = Pt("iconSize");
    if (P.title) {
      const e = L.append("g");
      await Le(
        e,
    ...
    if (P.icon)
      h.html(
        `<g>${await me(P.icon, { height: u, width: u, fallbackPrefix: oe.prefix })}</g>`
      );
    else if (P.iconText) {
      h.html(
        `<g>${await me("blank", { height: u, width: u, fallbackPrefix: oe.prefix })}</g>`
      );
      const i = h.append("g").append("foreignObject").attr("width", u).attr("height", u).append("div").attr("class", "node-icon-text").attr("style", `height: ${u}px;`).append("div").html(P.iconText), v = parseInt(
        window.getComputedStyle(i.node(), null).getPropertyValue("font-size").replace(/\D/g, "")
      ) ?? 16;
      i.attr("style", `-webkit-line-clamp: ${Math.floor((u - 2) / v)};`);
    } else
    ...
    P.width = a, P.height = r, A.setElementForId(P.id, L);
  }
  return 0;
}, "drawServices"), kr = /* @__PURE__ */ nt(function(A, Y, M) {
  M.forEach((P) => {
    const L = Y.append("g"), u = Pt("iconSize");
    L.append("g").append("rect").attr("id", "node-" + P.id).attr("fill-opacity", "0").attr("width", u).attr("height", u), L.attr("class", "architecture-junction");
    const { width: a, height: r } = L._groups[0][0].getBBox();
    L.width = a, L.height = r, A.setElementForId(P.id, L);
  });
}, "drawJunctions");
nr([
  {
...
function We(A, Y) {
  Y.nodes().map((M) => {
    ...
    if (P.type === "group")
      return;
    P.x = M.position().x, P.y = M.position().y, A.getElementById(P.id).attr("transform", "translate(" + (P.x || 0) + "," + (P.y || 0) + ")");
  });
}
nt(We, "positionNodes");
function Ve(A, Y) {
...
function ze(A, Y) {
  A.forEach((M) => {
    const { lhsId: P, rhsId: L, lhsInto: u, lhsGroup: h, rhsInto: a, lhsDir: r, rhsDir: e, rhsGroup: f, title: i } = M, v = Ae(M.lhsDir, M.rhsDir) ? "segments" : "straight", t = {
      id: `${P}-${L}`,
      label: i,
      source: P,
      sourceDir: r,
...
function Be(A, Y, M) {
  const P = /* @__PURE__ */ nt((a, r) => Object.entries(a).reduce(
    ...
    {}
  ), "flattenAlignments"), L = Y.map((a) => {
    const r = {}, e = {};
    return Object.entries(a).forEach(([f, [i, v]]) => {
      const t = A.getNode(f)?.in ?? "default";
...
nt(Be, "getAlignments");
function $e(A) {
  const Y = [], M = /* @__PURE__ */ nt((L) => `${L[0]},${L[1]}`, "posToStr"), P = /* @__PURE__ */ nt((L) => L.split(",").map((u) => parseInt(u)), "strToPos");
  return A.forEach((L) => {
      ...
      if (e) {
        ...
        if (f) {
          ...
          Object.entries(r).forEach(([v, t]) => {
            const o = M([i[0] + t[0], i[1] + t[1]]), s = u[o];
            s && !a[o] && (h.push(o), Y.push({
              [Se[v]]: s,
              [Se[mr(v)]]: f,
              gap: 1.5 * Pt("iconSize")
            }));
...
function Ze(A, Y, M, P, L, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = ir("body").append("div").attr("id", "cy").attr("style", "display:none"), e = Ge({
    ...
    r.remove(), Ve(M, e), Xe(A, e), He(Y, e), ze(P, e);
    const f = Be(L, u, h), i = $e(u), v = e.layout({
      name: "fcose",
      quality: "proof",
      styleEnabled: !1,
      animate: !1,
    ...
    v.one("layoutstop", () => {
      function t(o, s, c, l) {
        let T, g;
        const { x: d, y: N } = o, { x: F, y: C } = s;
        g = (l - N + (d - c) * (N - C) / (d - F)) / Math.sqrt(1 + Math.pow((N - C) / (d - F), 2)), T = Math.sqrt(Math.pow(l - N, 2) + Math.pow(c - d, 2) - Math.pow(g, 2));
        const G = Math.sqrt(Math.pow(F - d, 2) + Math.pow(C - N, 2));
        T = T / G;
        let B = (F - d) * (l - N) - (C - N) * (c - d);
        switch (!0) {
          case B >= 0:
            B = 1;
            break;
      ...
      for (const o of Object.values(e.edges()))
        if (o.data?.()) {
          ...
          if (s !== l && c !== T) {
            const g = o.sourceEndpoint(), d = o.targetEndpoint(), { sourceDir: N } = Ue(o), [F, C] = Qt(N) ? [g.x, d.y] : [d.x, g.y], { weights: G, distances: B } = t(g, d, F, C);
...
var qr = /* @__PURE__ */ nt(async (A, Y, M, P) => {
  const L = P.db, u = L.getServices(), h = L.getJunctions(), a = L.getGroups(), r = L.getEdges(), e = L.getDataStructures(), f = tr(Y), i = f.append("g");
  i.attr("class", "architecture-edges");
  const v = f.append("g");
  v.attr("class", "architecture-services");
  const t = f.append("g");
  t.attr("class", "architecture-groups"), await Zr(L, v, u), kr(L, v, h);
  const o = await Ze(u, h, a, r, L, e);
  await Br(i, o), await $r(t, o), We(L, o), er(void 0, f, Pt("padding"), Pt("useMaxWidth"));
}, "draw"), Jr = { draw: qr }, ri = {
  parser: Wr,
  db: ue,
  renderer: Jr,
